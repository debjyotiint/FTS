...
{
    public partial class management_InterestGeneration : System.Web.UI.Page, System.Web.UI.ICallbackEventHandler
    {
        ...
        void procedure()
        {
            ...
            if (ddlAccountType.SelectedItem.Value.ToString().Trim() == "0")
            {
                MainAccount = "SYSTM00001";
            }
            if (ddlAccountType.SelectedItem.Value.ToString().Trim() == "1")
            {
                MainAccount = "SYSTM00002";
            }
            if (ddlAccountType.SelectedItem.Value.ToString().Trim() == "3")
            {
                MainAccount = HiddenField_txtMainAccountCode.Text.ToString().Trim();
            }
            if (rdbClientALL.Checked)
            {
                Client = "ALL";
            ...
            {
                Client = HiddenField_Client.Value;
            }

            ds = oManagement_BL.InterestCalculation(Convert.ToString(Session["LastCompany"]), Convert.ToString(HttpContext.Current.Session["UserSegID"]), Segment,
                Convert.ToString(HttpContext.Current.Session["LastFinYear"]), Convert.ToDateTime(DtFrom.Value).ToString("yyyy-MM-dd"), Convert.ToDateTime(DtTo.Value).ToString("yyyy-MM-dd"),
                MainAccount, Client, Convert.ToInt32(HttpContext.Current.Session["userid"]), Convert.ToString(DdlRptView.SelectedItem.Value.ToString().Trim()));
            ViewState["dataset"] = ds;
        }
        ...
        protected void BtnGenerate_Click(object sender, EventArgs e)
        {
            ...
            string MainAccountSubLedgerType = string.Empty;
            if (ddlAccountType.SelectedItem.Value.ToString().Trim() == "0" || ddlAccountType.SelectedItem.Value.ToString().Trim() == "1" || ddlAccountType.SelectedItem.Value.ToString().Trim() == "2")
            {
                MainAccountSubLedgerType = "Customers";
            }
            else
            {
                MainAccountSubLedgerType = HiddenField_txtSubLedgerType.Text.ToString().Trim();
            }

            NoofRowsAffect = oManagement_BL.InterestCalculation_1(TABLEReport, Convert.ToString(Session["LastCompany"].ToString()), Convert.ToString(Session["usersegid"].ToString()),
                Convert.ToDateTime(DtFrom.Value).ToString("yyyy-MM-dd"), Convert.ToDateTime(DtTo.Value).ToString("yyyy-MM-dd"), Convert.ToString(HttpContext.Current.Session["LastFinYear"]),
                Convert.ToInt32(HttpContext.Current.Session["userid"]), MainAccountSubLedgerType);
        ...
        protected void BtnDelete_Click(object sender, EventArgs e)
        {
            ...
            NoofRowsAffect = oManagement_BL.InterestCalculation_1(TABLEReport, Convert.ToString(Session["LastCompany"].ToString()), Convert.ToString(Session["usersegid"].ToString()),
                Convert.ToDateTime(DtFrom.Value).ToString("yyyy-MM-dd"), Convert.ToDateTime(DtTo.Value).ToString("yyyy-MM-dd"), null, Convert.ToInt32(HttpContext.Current.Session["userid"]), null);

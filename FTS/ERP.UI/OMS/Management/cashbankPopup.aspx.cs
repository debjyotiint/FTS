...
{
    public partial class management_cashbankPopup : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (HttpContext.Current.Session["EntryProfileType"] != null)
            {
                ...
                {
                    dsCashBank.ConnectionString = ConfigurationSettings.AppSettings["DBReadOnlyConnection"];
                    dsgrdClientbank.ConnectionString = ConfigurationSettings.AppSettings["DBReadOnlyConnection"];
                }
                else
                {
                    dsCashBank.ConnectionString = ConfigurationSettings.AppSettings["DBConnectionDefault"];
                    dsgrdClientbank.ConnectionString = ConfigurationSettings.AppSettings["DBConnectionDefault"];
                }
            }
            ...
            if (!IsPostBack)
            {
                ...
                string Year = Session["LastFinYear"].ToString();
                string[] Finyear = Year.Split('-');
                string fDate = null;
                int month = oDBEngine.GetDate().Month;
                int date = oDBEngine.GetDate().Day;
                if (month > 3)
                    fDate = month.ToString() + "/" + date.ToString() + "/" + Finyear[0].ToString();
                else
                    fDate = month.ToString() + "/" + date.ToString() + "/" + Finyear[1].ToString();
                dteDate.Value = Convert.ToDateTime(fDate);
                //txtNarration.Text = HttpContext.Current.Session["usersegid"].ToString();
                ForJournalDate = "03/31/" + Finyear[1].ToString();
                ...
                if (Payee[0, 0] != "n")
                {
                    clsDropDownList.AddDataToDropDownList(Payee, cmbPayee, true);
                }
        ...
        public void BindGridForFooter()
        {
            ...
            if (ViewState["add"] == null)
            {
                ...
                DtTable.Columns.Add(new DataColumn("CashReportID", typeof(String))); //0
                DtTable.Columns.Add(new DataColumn("CashBank_PayeeAccountID", typeof(String)));//1
                DtTable.Columns.Add(new DataColumn("CashBank_ID", typeof(String)));//2
                DtTable.Columns.Add(new DataColumn("CashBank_InstrumentDate1", typeof(String)));//3
                DtTable.Columns.Add(new DataColumn("CashBank_MainAccountID", typeof(String)));//4
                DtTable.Columns.Add(new DataColumn("SubAccountID", typeof(String)));//5
                DtTable.Columns.Add(new DataColumn("CashBank_InstrumentType", typeof(String)));//6
                DtTable.Columns.Add(new DataColumn("CashBank_InstrumentNumber", typeof(String)));//7
                DtTable.Columns.Add(new DataColumn("CashBank_InstrumentDate", typeof(String)));//8
                DtTable.Columns.Add(new DataColumn("CashBank_AmountWithdrawl", typeof(String)));//9
                DtTable.Columns.Add(new DataColumn("CashBank_AmountDeposit", typeof(String)));//10
                DtTable.Columns.Add(new DataColumn("LineNarration", typeof(String)));//11
                DtTable.Columns.Add(new DataColumn("IssuingBank", typeof(String)));//12
                DtTable.Columns.Add(new DataColumn("CustomerBank", typeof(string)));//13
                DtTable.Columns.Add(new DataColumn("AuthLetterRef", typeof(string)));//14
                DtTable.Columns.Add(new DataColumn("SubAccount1", typeof(string)));//15
                DtTable.Columns.Add(new DataColumn("MainAccount1", typeof(string)));//16
                DtTable.Columns.Add(new DataColumn("InstType1", typeof(string)));//17
                DtTable.Columns.Add(new DataColumn("Payee1", typeof(string)));//18
                DtTable.Columns.Add(new DataColumn("Bank", typeof(string)));//19
                DtTable.Columns.Add(new DataColumn("WithDrawl", typeof(string)));//20
                DtTable.Columns.Add(new DataColumn("Receipt", typeof(string)));//21
                DtTable.Columns.Add(new DataColumn("UserID", typeof(String)));//22       
        ...
        protected void grdAdd_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            grdAdd.DataSource = DtTab.DefaultView;
            grdAdd.DataBind();
        }
                            ...
                            if (cmbType.SelectedValue == "P")
                            {
                                if (InstrumentType == "C")
                                {
                                    if (DtTab.Rows[pos][7].ToString() != "")
                                    {
                                        ...
                                        string AlphaNVal = DtTab.Rows[pos][7].ToString();
                                        string AlChar = String.Empty;
                                        string AlNumber = String.Empty;
                                        for (int i = 0; i < AlphaNVal.Length; i++)
                                        {
                                            if (char.IsLetter(AlphaNVal[i]))
                                                AlChar += AlphaNVal[i];
                                            else if (char.IsNumber(AlphaNVal[i]))
                                                AlNumber += AlphaNVal[i];
                                        }
                                        int Length = Convert.ToInt32(AlNumber.Length);
                                        int InstrumentNo = Convert.ToInt32(AlNumber);
                                        ...
                                        FinalVal = AlChar + FinalVal + Convert.ToString(InstrumentNo);
        ...
        protected void grdAdd_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            reportRow[0][30] = txtNarration.Text;
            DtTab.AcceptChanges();
            ViewState["add"] = "a";
            grdAdd.EditIndex = -1;
        ...
        protected void btnInsert_Click(object sender, EventArgs e)
        {
            ...
            if (Request.QueryString["id"] == null)
            {
                ...
                if (cmbType.SelectedItem.Value != "C")
                {
                    ...
                    if (InstrumentNumber != "")
                    {
                        //SqlCommand cmd = new SqlCommand("CheckingForInstrumentNumber", con);
                        //cmd.CommandType = CommandType.StoredProcedure;
                        //cmd.Parameters.AddWithValue("@bankId", cmbCashBankAc.SelectedItem.Value);
                        //cmd.Parameters.AddWithValue("@ChkNumber", InstrumentNumber);
                        //cmd.CommandTimeout = 0;
                        //SqlDataAdapter Adap = new SqlDataAdapter();
                        //Adap.SelectCommand = cmd;
                        //Adap.Fill(DSInst);

                        DSInst = Management_BL.management_CheckingForInstrumentNumber(Convert.ToString(cmbCashBankAc.SelectedItem.Value), InstrumentNumber);
                        ...
                        else
                        {
                            ...
                            if (cmbType.SelectedValue == "C")
                            {
                                if (withdraw == receipt)
                                {
                                    ...
                                    Management_BL.management_xmlCashBankInsert(tabledata, Session["userid"].ToString(), FinYear, cmbCompany.SelectedItem.Value.ToString(),
                                         cmbCashBankAc.SelectedItem.Value.ToString(), Convert.ToDateTime(dteDate.Value));
            ...
            else
            {
                ...
                if (cmbType.SelectedValue == "C")
                {
                    if (withdraw == receipt)
                    {
                        //com.ExecuteNonQuery();
                        //com.CommandTimeout = 0;
                        Management_BL.management_xmlCashBankUpdate(tabledata, Session["userid"].ToString(), FinYear, cmbCompany.SelectedItem.Value.ToString(),
                            cmbCashBankAc.SelectedItem.Value.ToString(), Convert.ToDateTime(Olddate), Convert.ToDateTime(dteDate.Value), cmbCashBankAc.SelectedItem.Value,
                            cmbSegment.SelectedItem.Value, ViewState["OldSegment"].ToString());
        ...
        public static string GetContactName(string custid)
        {
            ...
            DBEngine oDbEngine1 = new DBEngine(ConfigurationManager.AppSettings["DBConnectionDefault"]);

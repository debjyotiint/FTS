<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" MasterPageFile="~/OMS/MasterPage/ERP.Master" CodeBehind="ActivityClarificationSales.aspx.cs" Inherits="ERP.OMS.Management.ActivityManagement.ActivityClarificationSales" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function BindAssignSupervisor() {
            ...
            $.ajax({
                type: "POST",
                url: 'ActivityClarificationSales.aspx/GetAllUserListBeforeSelect',
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel-heading">
        <div class="panel-title">
            <h3>Sales Activity Details - Clarification Required
            </h3>
                ...
                <dxe:PopupControlContentControl runat="server">
                    ...
                    <div class="Top clearfix">
                        ...
                        <table style="width: 94%">
                            ...
                            <tr>
                                <td>
                                    <asp:CheckBox ID="chkMail" runat="server" ClientIDMode="Static" />
                                    Send Mail
                                </td>

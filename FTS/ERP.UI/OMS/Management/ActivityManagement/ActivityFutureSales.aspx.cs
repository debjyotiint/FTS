...
{
    public partial class ActivityFutureSales : ERP.OMS.ViewState_class.VSPage// System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                SalesDetailsGrid.SettingsCookies.CookiesID = "BreeezeErpGridCookiesActivityNewFutureDetailsGrid";
                this.Page.ClientScript.RegisterStartupScript(GetType(), "heightL", "<script>addCookiesKeyOnStorage('BreeezeErpGridCookiesActivityNewFutureDetailsGrid');</script>");
        ...
        void BindGrid()
        {
            ...
            SalesDetailsGridDataSource.SelectParameters.Add("Mode", "GetSalesFutureDetails");
        ...
        public void bindSalesActivityDetailsexport(int Filter)
        {
            ...
            exporter.FileName = "SalesAssign_FutureDetails";

            exporter.PageHeader.Left = "Sales Assign Future Details";

...
{
    public partial class ActivityDocumentsales : ERP.OMS.ViewState_class.VSPage// System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                SalesDetailsGrid.SettingsCookies.CookiesID = "BreeezeErpGridCookiesActivityNewDocumentDetailsGrid";
                this.Page.ClientScript.RegisterStartupScript(GetType(), "heightL", "<script>addCookiesKeyOnStorage('BreeezeErpGridCookiesActivityNewDocumentDetailsGrid');</script>");
        ...
        void BindGrid()
        {
            ...
            SalesDetailsGridDataSource.SelectParameters.Add("Mode", "GetSalesDocumentDetails");
        ...
        public void bindSalesActivityDetailsexport(int Filter)
        {
            ...
            exporter.FileName = "SalesAssign_DocumentDetails";

            exporter.PageHeader.Left = "Sales Assign Document Details";

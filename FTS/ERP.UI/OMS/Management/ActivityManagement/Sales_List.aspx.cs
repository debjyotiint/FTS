...
namespace ERP.OMS.Management.Activities
{
    public partial class Sales_List : ERP.OMS.ViewState_class.VSPage// System.Web.UI.Page
    {
        ...
        void BindGrid(DateTime FromDate, DateTime ToDate)
        {
            ...
            SalesDataSource.SelectParameters.Add("Fromdate", Convert.ToString(FromDate));
            SalesDataSource.SelectParameters.Add("ToDate", Convert.ToString(ToDate));
            SaleGrid.DataBind();
        ...
        public void bindSalesActivityexport(int Filter)
        {
            ...
            SaleGrid.Columns[7].Visible = false;
            switch (Filter)
            {
                case 1:

...
{
    public partial class ActivityClarificationSales : ERP.OMS.ViewState_class.VSPage// System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                SalesDetailsGrid.SettingsCookies.CookiesID = "BreeezeErpGridCookiesActivityNewClarificationDetailsGrid";
                this.Page.ClientScript.RegisterStartupScript(GetType(), "heightL", "<script>addCookiesKeyOnStorage('BreeezeErpGridCookiesActivityNewClarificationDetailsGrid');</script>");
        ...
        void BindGrid()
        {
            ...
            SalesDetailsGridDataSource.SelectParameters.Add("Mode", "GetSalesClarificationRequiredDetails");
        ...
        public void bindSalesActivityDetailsexport(int Filter)
        {
            ...
            exporter.FileName = "SalesAssign_ClarificationRequiredDetails";

            exporter.PageHeader.Left = "Sales Assign Clarification Required Details";

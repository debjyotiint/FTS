...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            if ($('#<%=hdnEditIndustry.ClientID %>').val() != "") {
                ...
                // alert($('#<%=hdnEditProductClassGroup.ClientID %>').val())


                //  BindProductClassGroup($('#<%=hdnEditIndustry.ClientID %>').val());
            ...
            $('#<%=RdnType.ClientID %>').change(function () {
                ...
                //  alert(typeParam);
                //if (typeParam == "1")
                //{ BindLeadOrCustomerOnSelecType(); }
                //else { RemoveLeadOrCustomerOnSelecType(); }
            ...
            $('#taskList').change(function () {
                ...
                //var tsk_desc = $("#taskDescList option[value='" + task_id + "'").text();
                //$('#txtDesc').val(tsk_desc);
            });
        });
    ...
    <script>
        ...
        function RefreshLeadOrCustomer() {
            ...
            // lbClientAvailable.PerformCallback("Clientlist~" + IndustryId + "~" + EntityType);
            if (industryId) {
    ...
    <script src="/assests/pluggins/choosen/choosen.min.js"></script>
     ...
     <script type="text/javascript">
         ...
         $(function () {
             ...
             BindActivityType(null);
             //var IID = document.getElementById("hdnEditIndustry").value;
             //if (IID != "" && IID!=null)
             //BindProductClassGroup(IID);
             //  setWithFromProductClassType();
             //supervisor list and assign list is binded kaushik 21-11-2016
             var firstParam = 'F';
         ...
         function DisableSalesActivity() {
             ...
             //    $('#ListBoxProduct').prop('disabled', true).trigger("chosen:updated");
                 ...
                 success: function (msg) {
                     ...
                     if (list.length > 0) {
                         ...
                         if (hdnEditIndustry != null && hdnEditIndustry != '') {
                             ...
                             // lbAvailable.PerformCallback(hdnEditIndustry);
         ...
         function setWithFromProductClassType(listValue) {
             ...
             // var listValue = document.getElementById("hdnEditProductClassGroup").value;
             // var listValue = $('#<%=hdnEditProductClassGroup.ClientID %>').val();
             // alert(listValue);
             var str_array = listValue.split(',');
    ...
    <style>
      ...
      <script type="text/javascript">
          ...
          $(document).ready(function () {
              ...
              //when product drop down changed kaushik 16-12-2016

              //when ListBoxActivityType Type drop down changed kaushik 27-12-2016
              ...
              <%--    if (classGrpOldVal.length==0)
                  ...
                  else
                  {
                      var newid = Id;
                      if (newid != null) {
                          if (classGrpOldVal.length > newid.length) {
                              //uncheck
                            //console.log(newid);
                            //console.log(classGrpOldVal);
                          ...
                          //alert(classGrpOldVal);
                          $('#<%=hdnOldProductClass.ClientID %>').val(classGrpOldVal); 
                          //console.log('old value', classGrpOldVal);
                      }
                  }--%>
             ...
             <%-- $("#lstItems").chosen().change(function () {
                  var CustomerLeadId = $(this).val();
                  $('#<%=hdnCustomerLead.ClientID %>').val(CustomerLeadId);
              });
          --%>
          ...
          function BindCustomerProductEdit() {
              ...
              // var lstProducts = $('select[id$=ListBoxProduct]');
          ...
          function CheckBoxListProduct_Init(s, e) {
              ...
              // alert($('#<%=hdnProduct.ClientID %>').val());
              // alert(document.getElementById('divprodlist').innerHTML);
              if (($('#<%=hdnbtnexit.ClientID %>').val() != "" && $('#<%=hdnbtnexit.ClientID %>').val() != null) || ($('#<%=hdnbtn.ClientID %>').val() != "" && $('#<%=hdnbtn.ClientID %>').val() != null)) {
          ...
          function GetAllClientValues() {
              ...
              // alert(lbClientAvailable.GetItem(1).value);
              for (var i = 0; i < j; i++) {
                ...
                <div class="col-md-12">
                            ...
                            <asp:HiddenField ID="hdnActivityTypeText" runat="server" />   
                                ...
                                <div class="col-md-4">
                                    <div><label style="padding-bottom:5px;padding-top:10px">Additional Note </label>
                                       <%-- <asp:TextBox ID="txtInstNote" runat="server" Width="100%" Height="50px" TextMode="MultiLine"  >
                                        </asp:TextBox>--%>
                   ...
                   <asp:HiddenField ID="hdnProductClass" runat="server" />
                            ...
                            <asp:HiddenField ID="hdnProductClassText" runat="server" />   
                                   ...
                                   <div class=" relative">
                             <%-- <label >Product(s)</label><span style="color: red">*</span>--%>
   ...
   <asp:HiddenField ID="hdnProduct" runat="server" />
            <asp:HiddenField ID="hdnProductText" runat="server" />   
                ...
                <div class="col-md-12">     
                  ...
                  <%--  <button id="btnSend" type="button" class="btn btn-primary" style="padding: 5px 10px;"><i class="fa fa-save" aria-hidden="true"></i> Save </button> --%>
                </div>

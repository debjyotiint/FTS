<%@ Page Language="C#"  MasterPageFile="~/OMS/MasterPage/ERP.Master" EnableEventValidation="false"  AutoEventWireup="true" CodeBehind="ActivityNewSales.aspx.cs" Inherits="ERP.OMS.Management.ActivityManagement.ActivityNewSales" %>
    ...
    <script type="text/javascript" language="Javascript">
       ...
       BindAssignSupervisor();
        ...
        function BindAssignSupervisor() {
            ...
            $.ajax({
                type: "POST",
                url: 'ActivityNewSales.aspx/GetAllUserListBeforeSelect',
                                            ...
                                            <table width="100%">
                                                ...
                                                <tr>
                                                    ...
                                                    <td id="SaleDetailsListID">
                                                         <dxe:ASPxGridView ID="SalesDetailsGrid"  KeyFieldName="act_id" runat="server" AutoGenerateColumns="False" ClientInstanceName="grid"
                                                       SettingsCookies-Enabled="true" SettingsCookies-StorePaging="true" SettingsCookies-StoreFiltering="true" SettingsCookies-StoreGroupingAndSorting="true" SettingsBehavior-AllowFocusedRow="true"   Width="100%"  DataSourceID="SalesDetailsGridDataSource"  OnHtmlRowCreated="SalesDetailsGrid_HtmlRowCreated" OnCustomCallback="SalesDetailsGrid_CustomCallback">
                                                            <Columns>
                                        ...
                                        NullText="0" Value='<%# Eval("LeadId") %>'>
                                                             ...
                                                             <%--   <dxe:GridViewDataTextColumn FieldName="ProductType" ReadOnly="True" Visible="False"
                                                                ...
                                                                <dxe:GridViewDataTextColumn FieldName="ProductType" VisibleIndex="10"  Caption="Product Type" Visible="false">
                                                                 ...
                                                                 <dxe:GridViewDataTextColumn VisibleIndex="14" Caption="History">
                                                                       <CellStyle HorizontalAlign="Center">
                                                                    </CellStyle>
                                                                ...
                                                                <dxe:GridViewDataTextColumn VisibleIndex="15" Caption="Actions">
                                                                      <CellStyle HorizontalAlign="Center">
                                                                    </CellStyle>
                                                                    <HeaderStyle HorizontalAlign="Center" />
                                                                    <DataItemTemplate>
                                                                  ...
                                                                  <dxe:GridViewDataTextColumn  VisibleIndex="16" Caption="Create Activity" Visible="false">
                                                                    <DataItemTemplate>
                ...
                <dxe:PopupControlContentControl runat="server">
                    ...
                    <div class="Top clearfix">
                        ...
                        <table style="width:94%">
                            <tr>
                                <td>Select User<span style="color: red">*</span>
                                </td>
                                <td class="relative">

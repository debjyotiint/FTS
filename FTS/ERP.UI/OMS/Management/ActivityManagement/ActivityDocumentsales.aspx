<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/OMS/MasterPage/ERP.Master" EnableEventValidation="false"   CodeBehind ="ActivityDocumentsales.aspx.cs" Inherits="ERP.OMS.Management.ActivityManagement.ActivityDocumentsales" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">   
    ...
    <script type="text/javascript">
        ...
        function BindAssignSupervisor() {
            ...
            $.ajax({
                type: "POST",
                url: 'ActivityDocumentsales.aspx/GetAllUserListBeforeSelect',
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <div class="panel-heading">
        <div class="panel-title">
            <h3>Sales Activity Details - Document Collection
            </h3>

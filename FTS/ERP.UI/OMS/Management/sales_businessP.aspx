<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/OMS/MasterPage/ERP.Master" 
    Inherits="ERP.OMS.Management.management_sales_businessP" Codebehind="sales_businessP.aspx.cs" %>
        ...
        <div>
            <table class="TableMain100">
                <tr>  <td class="EHEADER" style="text-align: center;">
                        <strong><span style="color: #000099">Business Processing</span></strong>
                    </td>
                </tr>
                <tr>
                    <td>
                        <dxe:ASPxPageControl ID="ASPxPageControl1" runat="server" ActiveTabIndex="5" ClientInstanceName="page"
                             ...
                             Font-Size="12px">
                            <tabpages>
                    <dxe:TabPage Text="Total Expenses" Name="Total"><ContentCollection>
                            ...
                            <dxe:ContentControl runat="server">
                                <dxe:ASPxGridView ID="gridLodging" ClientInstanceName="grid" DataSourceID="SqlLodging" runat="server" KeyFieldName="expnd_internalId"   Width="100%" AutoGenerateColumns="False" OnInitNewRow="gridLodging_InitNewRow">
                                    <Columns>
                                        ...
                                        <dxe:GridViewDataMemoColumn Caption="Description" FieldName="expnd_BPDescription" VisibleIndex="0"
                                            Width="40%">
                                        ...
                                        <dxe:GridViewDataTextColumn Caption="Amount" FieldName="expnd_BPExpAmount"
                                        ...
                                        <table style="width:100%">
                                          <tr>
                                            <td align="center" style="width:50%">
                                                <span style="color:White;" >Add/Modify Business Processing.</span>
                                            </td>
                                           <%-- <td align="right">
                                              <table >
                                                <tr>                                                 
                            ...
                            <tr>
                                <td align="right" style="width: 843px">
                                    <asp:SqlDataSource ID="SqlLodging" runat="server" 
                                        ...
                                        SelectCommand="SELECT [expnd_internalId], [expnd_empId], [expnd_compId], [expnd_branchId], [expnd_activityId],expnd_dateExpenditure,convert(varchar(11),expnd_dateExpenditure,113) as expnd_dateExpenditure1,  [expnd_currencyType],expnd_BPDescription,expnd_BPExpAmount,[CreateDate],[CreateUser], [LastModifyUser], [LastModifyDate] FROM [tbl_trans_salesExpenditure] where expnd_expenceType='BP' and expnd_empId=@expnd_empId"
                                        DeleteCommand="DELETE FROM [tbl_trans_salesExpenditure] WHERE [expnd_internalId] = @expnd_internalId"
                                        InsertCommand="Expnd_BP_Insert" InsertCommandType="StoredProcedure" UpdateCommand="Expnd_BP_Update"

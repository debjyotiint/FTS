    ...
    public partial class Servicetax : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (HttpContext.Current.Session["EntryProfileType"] != null)
            {
                ...
                {
                    ServiceTaxDataSource.ConnectionString = System.Configuration.ConfigurationSettings.AppSettings["DBReadOnlyConnection"];
                }
                else
                {
                    ServiceTaxDataSource.ConnectionString = System.Configuration.ConfigurationSettings.AppSettings["DBConnectionDefault"];
                }
            }
            ...
            BusinessLogicLayer.DBEngine oDBEngine = new BusinessLogicLayer.DBEngine(System.Configuration.ConfigurationSettings.AppSettings["DBConnectionDefault"]);
            string segid = "0";

...
{
    public partial class management_SettingsOptions_targetSetUpBranch : System.Web.UI.Page, ICallbackEventHandler
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                //string[,] cmbData = oDBEngine.GetFieldValue("tbl_targetschemes", "tgt_id,tgt_descripition", " CAST(tgt_effectivedate AS datetime) < CAST(GETDATE() AS datetime) AND CAST(tgt_enddate AS datetime) > GETDATE() and tgt_enddate is not null", 2, "tgt_descripition");
                ...
                TxtBranchName.Attributes.Add("onkeyup", "ajax_showOptions(this,'SearchByBranchName',event)");

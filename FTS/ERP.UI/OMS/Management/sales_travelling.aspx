<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/OMS/MasterPage/ERP.Master"
    Inherits="ERP.OMS.Management.management_sales_travelling" CodeBehind="sales_travelling.aspx.cs" %>
        ...
        <table class="TableMain100">
            <tr>
                <td class="EHEADER" style="text-align: center;">
                    <strong><span style="color: #000099">Travelling</span></strong>
                </td>
            </tr>
            <tr>
                <td>
                                    ...
                                    <dxe:ContentControl runat="server">
                                        <dxe:ASPxGridView ID="GridConveyence" runat="server" KeyFieldName="expnd_internalId"
                                            ...
                                            <Columns>
                                                ...
                                                <dxe:GridViewDataTextColumn FieldName="expnd_dateTravExpenditure1" Caption="Date"
                                                    VisibleIndex="1">
                                                    <EditFormSettings Visible="False" />
                                                    <CellStyle CssClass="gridcellleft">
                                                    </CellStyle>
                                                ...
                                                <dxe:GridViewDataTextColumn FieldName="expnd_dtTravJourney1" Caption="Start Journing"
                                                    VisibleIndex="4">
                                                    <EditFormSettings Visible="False" />
                                                    <CellStyle CssClass="gridcellleft">
                                                    </CellStyle>
                                                </dxe:GridViewDataTextColumn>
                                                <dxe:GridViewDataDateColumn Caption="Travelling Date" FieldName="expnd_dtTravJourney"
                                                    VisibleIndex="1" Visible="False">
                                                    <PropertiesDateEdit DisplayFormatString="" EditFormat="Custom" EditFormatString="dd-MM-yyyy">
                                                    </PropertiesDateEdit>
                                                ...
                                                <dxe:GridViewDataTextColumn FieldName="expnd_dtTravRetJourney1" Caption="Return Journing"
                                                    VisibleIndex="5">
                                                    <EditFormSettings Visible="False" />
                                                    <CellStyle CssClass="gridcellleft">
                                                    </CellStyle>
                                                    ...
                                                    <table style="width: 100%">
                                                        <tr>
                                                            <td align="center" style="width: 50%">
                                                                <span style="color: White;">Add/Modify Travelling.</span>
                                                            </td>
                                                            <%--  <td align="right">
                                              <table >
                                                <tr>                                                 
                        ...
                        <tr>
                            <td align="right" style="width: 843px">
                                <asp:SqlDataSource ID="SqlConveyence" runat="server"
                                    ...
                                    InsertCommand="Expnd_Travelling_Insert" InsertCommandType="StoredProcedure" SelectCommand="SELECT [expnd_internalId], [expnd_empId], [expnd_compId], [expnd_branchId], [expnd_activityId],  [expnd_currencyType],expnd_dateTravExpenditure, convert(varchar(11),expnd_dateTravExpenditure,113) as expnd_dateTravExpenditure1, expnd_TTravCity1, expnd_TTravArea1,((select city_name from tbl_master_city where city_id=tbl_trans_salesExpenditure.expnd_TTravCity1)+'-'+(select area_name from tbl_master_area where area_id=tbl_trans_salesExpenditure.expnd_TTravArea1)) as Scity,((select city_name from tbl_master_city where city_id=tbl_trans_salesExpenditure.expnd_TTravCity2)+'-'+(select area_name from tbl_master_area where area_id=tbl_trans_salesExpenditure.expnd_TTravArea2)) as Fcity,expnd_TTravCity2, expnd_TTravArea2,expnd_travTravExpence, expnd_TravTravRefNo,expnd_convenceTravMode,expnd_dtTravJourney,convert(varchar(11),expnd_dtTravJourney,113) as expnd_dtTravJourney1,expnd_dtTravRetJourney,convert(varchar(11),expnd_dtTravRetJourney,113) as expnd_dtTravRetJourney1, [CreateDate],[CreateUser], [LastModifyUser], [LastModifyDate] FROM [tbl_trans_salesExpenditure] where expnd_expenceType='Trav' and expnd_empId=@expnd_empId"
                                    UpdateCommand="Expnd_Travelling_Update" UpdateCommandType="StoredProcedure">
                                    <DeleteParameters>

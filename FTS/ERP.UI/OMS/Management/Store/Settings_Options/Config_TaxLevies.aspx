...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="GridViewArea">
        <dxe:ASPxGridView ID="cityGrid" runat="server" AutoGenerateColumns="False" ClientInstanceName="grid"
            KeyFieldName="TaxRates_ID" Width="100%" OnHtmlRowCreated="cityGrid_HtmlRowCreated"
            ...
            <Columns>
                ...
                <dxe:GridViewDataTextColumn Caption="City Name" FieldName="city_name" Width="12%"
                    FixedStyle="Left" Visible="True" VisibleIndex="9">
                    <EditFormSettings Visible="True" />
                    <Settings AutoFilterCondition="Contains" />
                </dxe:GridViewDataTextColumn>
                ...
                <dxe:GridViewDataTextColumn ReadOnly="True" Width="80px"  VisibleIndex="11" HeaderStyle-HorizontalAlign="Center">
                    <HeaderTemplate>

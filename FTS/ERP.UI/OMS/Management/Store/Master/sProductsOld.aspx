...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:SqlDataSource ID="SqlSourceProductClass_Code" runat="server" ConnectionString="<%$ ConnectionStrings:crmConnectionString %>"
        SelectCommand="SELECT ProductClass_ID,ProductClass_Name FROM Master_ProductClass ">
    </asp:SqlDataSource>
    <asp:SqlDataSource ID="SqlSourceProductType" runat="server" ConnectionString="<%$ ConnectionStrings:crmConnectionString %>"
    ...
    <asp:SqlDataSource ID="SqlSourceColorId" runat="server" ConnectionString="<%$ ConnectionStrings:crmConnectionString %>"
    ...
    <asp:SqlDataSource ID="SqlDataSourceSizeId" runat="server" ConnectionString="<%$ ConnectionStrings:crmConnectionString %>"
    ...
    <asp:SqlDataSource ID="markets" runat="server" ConflictDetection="CompareAllValues"
        OldValuesParameterFormatString="original_{0}" ConnectionString="<%$ ConnectionStrings:CRMConnectionString %>"
  ...
  SELECT  [sProducts_ID],[sProducts_Code],[sProducts_Name],[sProducts_Description],[sProducts_Type] 
    ...
    <asp:SqlDataSource ID="SelectUOM" runat="server" ConnectionString="<%$ ConnectionStrings:crmConnectionString %>"
        SelectCommand="select UOM_ID,UOM_Name from Master_UOM"></asp:SqlDataSource>
    <asp:SqlDataSource ID="SelectCurrency" runat="server" ConnectionString="<%$ ConnectionStrings:crmConnectionString %>"

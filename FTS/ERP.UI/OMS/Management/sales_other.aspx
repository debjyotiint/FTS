<%@ Page Title="Sales other" Language="C#" AutoEventWireup="true" MasterPageFile="~/OMS/MasterPage/ERP.Master" Inherits="ERP.OMS.Management.management_sales_other" CodeBehind="sales_other.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
        <table class="TableMain100">
            ...
            <tr>
                <td>
                    <dxe:ASPxPageControl ID="ASPxPageControl1" runat="server" ActiveTabIndex="6" ClientInstanceName="page" Font-Size="12px">
                        <TabPages>
                            ...
                            <dxe:TabPage Name="Others" Text="Others">
                                <ContentCollection>
                                    <dxe:ContentControl runat="server">
                                        <dxe:ASPxGridView ID="gridLodging" ClientInstanceName="grid" DataSourceID="SqlLodging" runat="server" KeyFieldName="expnd_internalId" Width="100%" AutoGenerateColumns="False" OnInitNewRow="gridLodging_InitNewRow">
                                            <Columns>
                                                ...
                                                <dxe:GridViewDataMemoColumn Caption="Description" FieldName="expnd_otherExpnseDescrip" VisibleIndex="0"
                                                    Width="40%">
                                                ...
                                                <dxe:GridViewDataTextColumn Caption="Amount" FieldName="expnd_otherExpnseAmount"
                                            ...
                                            <SettingsText PopupEditFormCaption="Add/Modify Others" ConfirmDelete="Confirm delete?" />
                                                    ...
                                                    <table style="width: 100%">
                                                        <tr>
                                                            <td align="center" style="width: 50%">
                                                                <span style="color: White;">Add/Modify Others.</span>
                                                            </td>
                                                            <%--  <td align="right">
                                              <table >
                                                <tr>                                                 
                        ...
                        <tr>
                            <td align="right" style="width: 843px">
                                <asp:SqlDataSource ID="SqlLodging" runat="server"
                                    SelectCommand="SELECT [expnd_internalId], [expnd_empId], [expnd_compId], [expnd_branchId], [expnd_activityId],expnd_dateExpenditure,convert(varchar(11),expnd_dateExpenditure,113) as expnd_dateExpenditure1,  [expnd_currencyType],expnd_otherExpnseDescrip,expnd_otherExpnseAmount,[CreateDate],[CreateUser], [LastModifyUser], [LastModifyDate] FROM [tbl_trans_salesExpenditure] where expnd_expenceType='other' and expnd_empId=@expnd_empId"
                                    DeleteCommand="DELETE FROM [tbl_trans_salesExpenditure] WHERE [expnd_internalId] = @expnd_internalId"
                                    InsertCommand="Expnd_Other_Insert" InsertCommandType="StoredProcedure"
                                    UpdateCommand="Expnd_other_Update" UpdateCommandType="StoredProcedure">
                                    <SelectParameters>
                                    ...
                                    <InsertParameters>
                                        ...
                                        <asp:Parameter Name="expnd_otherExpnseDescrip" Type="string" />
                                        <asp:Parameter Name="expnd_otherExpnseAmount" Type="decimal" />

        ...
        <div id="DivEdit">
            <dxe:ASPxGridView ID="GvCBSearch" ClientInstanceName="cGvCBSearch" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <dxe:GridViewDataTextColumn VisibleIndex="1" FieldName="CashBank_TransactionType" Caption="Type" >
                    ...
                    <dxe:GridViewDataTextColumn VisibleIndex="14" FieldName="CashBank_CreateUser" 
                        Caption="Entered By">
                    ...
                    <dxe:GridViewDataTextColumn HeaderStyle-HorizontalAlign="Center" CellStyle-HorizontalAlign="center" VisibleIndex="17" Width="130px">
                        <DataItemTemplate>
                            <% if (rights.CanView)
                               { %>

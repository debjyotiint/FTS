    ...
    public partial class JournalVoucherEntry : ERP.OMS.ViewState_class.VSPage
    {
        ...
        protected void GvJvSearch_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            else if (PCBCommandName == "PCB_DeleteBtnOkE")
            {
                ...
                RowUpdated = oDailyTaskOther.Delete_JV(Convert.ToString(IBRef), Convert.ToString(VoucherNumber));
        ...
        protected void grid_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            if (type == "Edit")
            {
                ...
                if (Detailsdt != null && Detailsdt.Rows.Count > 0)
                {
                    ...
                    grid.JSProperties["cpEdit"] = BillNumber + "~" + JvNarration + "~" + BranchId + "~" + Credit + "~" + Debit + "~" + TransactionDate + "~" + PlaceOfSupply + "~" + Taxoption + "~" + IsPartyJournal + "~" + PartyCount;
                }
        ...
        protected void grid_BatchUpdate(object sender, DevExpress.Web.Data.ASPxDataBatchUpdateEventArgs e)
        {
            ...
            else
            {
                ...
                if (ModifyJournal(Action, JournalID, JVNumStr, strFinYear, strCompanyID, strBranchID, JournalDate, strSegmentID, strCurrency, IBRef, MainNarration, strUserID, Journaldt, Supplystate, TaxOption, SupplyStateId) == true)
                {
                    Session["VoucherNumber"] = null;
                    Session["VoucherIBRef"] = null;
        ...
        public bool ModifyJournal(string ActionType, string JournalID, string BillNo, string FinYear, string CompanyID, string BranchID, string JournalDate, string SegmentID,
                                   string CurrencyID, string IBRef, string Narration, string UserID, DataTable JournalDetails, string SupplyState, string TaxOption, string SupplyStateId)
        {
            try
            {

...
{
    public partial class frm_ManualBRSListEntity : System.Web.UI.Page
    {
        ...
        [WebMethod]
        public static int SolveRepeat(string Fromdate, string ToDate, string BankId)
        {
            int vehicle = 0;
            SlaesActivitiesBL objSlaesActivitiesBL = new SlaesActivitiesBL();

            DataTable dt = objSlaesActivitiesBL.SolveRepeatSubAccount(Fromdate,ToDate,BankId);
        ...
        protected void EntityServerModeDataSource_Selecting(object sender, DevExpress.Data.Linq.LinqServerModeDataSourceSelectEventArgs e)
        {
            ...
            string strBranchID = (Convert.ToString(hfBankID.Value) == "") ? "0" : Convert.ToString(hfBankID.Value);
            ...
            if (CheckStatus == "U")
            {
                ...
                if (IsFilter == "Y")
                {
                        ...
                        var q = from d in dc.v_GetManualBRSCleareds
                                where (d.Doc_Date >= Convert.ToDateTime(strFromDate) && d.Doc_Date <= Convert.ToDateTime(strToDate))
                                //&& (d.CashBank_ValueDate == null || d.CashBank_ValueDate == Convert.ToDateTime("1900-01-01 00:00:00.000"))

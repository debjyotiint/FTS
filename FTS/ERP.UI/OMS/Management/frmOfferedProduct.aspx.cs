...
{
    public partial class management_frmOfferedProduct : System.Web.UI.Page
    {
        ...
        public void SaveData()
        {
            ...
            {
                string popupScript = "";
                popupScript = "<script language='javascript'>" + "window.opener.document.getElementById('Button1').disabled=false;window.close();</script>";
            ...
            if (ViewState["product"] != null)
            {
                ...
                foreach (string chr1 in str)
                {
                    ...
                    else
                    {
                        ...
                        {
                            //columns = "ofp_actId,ofp_leadId,ofp_productTypeId,ofp_probableAmount,ofp_productId,ofp_activityid";
                            //DataValue += Session["ActNo"].ToString() + ",";
                            //DataValue += "'" + Session["ContactLeadID"].ToString() + "'" + ",";
                            //DataValue += "'" + temp.GetValue(0) + "'" + ",";
                            //DataValue += "'" + temp.GetValue(1) + "'" + ",";
                            //if (temp.Length == 4)
                            //{
                            ...
                            //    DataValue += "0" + ",";
                            //}
                            //string[,] ActNo1 = oDBEngine.GetFieldValue("tbl_trans_Activies", "act_activityNo", "act_id='" + Session["ActNo"].ToString() + "'", 1);
                            //if (ActNo1[0, 0] != "n")
                            //{
                            //    ActNo = ActNo1[0, 0];
                            //}

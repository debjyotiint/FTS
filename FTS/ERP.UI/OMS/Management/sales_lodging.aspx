<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/OMS/MasterPage/ERP.Master" Inherits="ERP.OMS.Management.management_sales_lodging" CodeBehind="sales_lodging.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
        <table class="TableMain100">
            ...
            <tr>
                <td>
                    <dxe:ASPxPageControl ID="ASPxPageControl1" runat="server" ActiveTabIndex="3" ClientInstanceName="page" Font-Size="12px">
                        <TabPages>
                                    ...
                                    <dxe:ContentControl runat="server">
                                        <dxe:ASPxGridView ID="gridLodging" ClientInstanceName="grid" DataSourceID="SqlLodging" runat="server" KeyFieldName="expnd_internalId" Width="100%" AutoGenerateColumns="False" OnInitNewRow="gridLodging_InitNewRow">
                                            <Columns>
                                                ...
                                                <dxe:GridViewDataDateColumn FieldName="expnd_LodgingDateTo" Visible="False" VisibleIndex="0">
                                                    <PropertiesDateEdit DisplayFormatString="" EditFormat="Custom" EditFormatString="dd-MM-yyyy">
                                                    </PropertiesDateEdit>
                                                ...
                                                <dxe:GridViewDataTextColumn FieldName="expnd_LodgingDateTo1" Caption="To" VisibleIndex="2">
                                                    <EditFormSettings Visible="False" />
                                                    <CellStyle CssClass="gridcellleft">
                                                    </CellStyle>
                                                </dxe:GridViewDataTextColumn>
                                                <dxe:GridViewDataTextColumn FieldName="expnd_LodgingExpnseAmount" Caption="Amount" VisibleIndex="3">
                                                ...
                                                <dxe:GridViewDataTextColumn FieldName="expnd_LodgingRefNo" Caption="Reference No" VisibleIndex="4">
                                                    ...
                                                    <table style="width: 100%">
                                                        <tr>
                                                            <td align="center" style="width: 50%">
                                                                <span style="color: White;">Add/Modify Lodging.</span>
                                                            </td>
                                                            <%-- <td align="right">
                                             <table >
                                                <tr>                                                 

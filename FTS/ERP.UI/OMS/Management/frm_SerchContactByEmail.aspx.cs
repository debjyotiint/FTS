...
{
    public partial class management_frm_SerchContactByEmail : System.Web.UI.Page
    {
        ...
        public void Procedure()
        {
            ...
            //    cmd.Connection = con;
            //    cmd.CommandText = "SEARCH_CONTACT_BYEMAIL";
            //    cmd.CommandType = CommandType.StoredProcedure;
            //    cmd.Parameters.AddWithValue("@SEARCH_ENTITY", cmbDuplicate.SelectedItem.Value);
            //    cmd.Parameters.AddWithValue("@SEARCH_TYPE", cmbType.SelectedItem.Value);
            ...
            ds = oManagement_BL.SEARCH_CONTACT_BYEMAIL(Convert.ToString(cmbDuplicate.SelectedItem.Value), Convert.ToString(cmbType.SelectedItem.Value),
                Convert.ToString(txtClientID.Text.ToString().Trim()));
            ViewState["DatasetMain"] = ds;
            GridBind();
        ...
        protected void GridBind()
        {
            ...
            {
                gridContract.Columns[5].Caption = "Address";
            }
            else
            {

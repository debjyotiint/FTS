    ...
    public partial class management_InterestRateSlab : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (HttpContext.Current.Session["EntryProfileType"] != null)
            {
                ...
                {
                    IntSlabDataSource.ConnectionString = ConfigurationSettings.AppSettings["DBReadOnlyConnection"];
                }
                else
                {
                    IntSlabDataSource.ConnectionString = ConfigurationSettings.AppSettings["DBConnectionDefault"];
                }
            }

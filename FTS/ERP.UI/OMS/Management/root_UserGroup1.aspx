<%@ Page Language="C#" AutoEventWireup="True" MasterPageFile="~/OMS/MasterPage/ERP.Master"
    Inherits="ERP.OMS.Management.management_root_UserGroup1" Codebehind="root_UserGroup1.aspx.cs" %>
...
<head runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function Reload() {
            //alert("2");
            window.location("../reports/root_UserGroup1.aspx");
            //alert("1");
        }
        function OnMoreInfoClick(keyValue) {
            ...
            parent.OnMoreInfoClick(url, "Members Details" + '-' + grp, '940px', '450px', "Y");
...
<body style="margin: 0px 0px 0px 0px; background-color: #DDECFE" onload="clearPreloadPage()">
        ...
        <table class="TableMain100">
            <tr>
                <td class="EHEADER" style="text-align: center">
                    <span style="color: Blue"><strong>User Groups</strong></span>
                </td>
            </tr>
            <tr>
                                ...
                                <dxe:GridViewDataTextColumn VisibleIndex="2" FieldName="segname"
                                    Caption="Segment Name">
                                                        ...
                                                        <%-- <HeaderTemplate>
                                                         ...
                                                         <DataItemTemplate>
                                        <a href="javascript:void(0);" onclick="OnMoreInfoClick('<%# Container.KeyValue %> ,<%# Eval("grp_name") %>')">
                                            Members</a>
	...
	CallHeight(cpHeight);
        ...
        <br />
        <%--<asp:SqlDataSource ID="grp_id" runat="server" ConnectionString="<%$ ConnectionStrings:crmConnectionString %>"

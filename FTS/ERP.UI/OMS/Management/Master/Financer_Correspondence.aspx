<%@ Page Title="Correspondence" Language="C#" AutoEventWireup="true" MasterPageFile="~/OMS/MasterPage/ERP.Master"
    Inherits="ERP.OMS.Management.Master.management_master_Financer_Correspondence" CodeBehind="Financer_Correspondence.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
  <script language="javascript" type="text/javascript">
        ...
        function disp_prompt(name) {
            if (name == "tab0") { 
                document.location.href = "FinancerAddEdit.aspx?id="+ <%=Convert.ToString(Session["KeyVal"])%>+"";
            }
            if (name == "tab2") {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="panel-heading">
        <div class="panel-title">
            <h3 >Financer Correspondence List</h3>

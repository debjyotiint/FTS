...
{
    public partial class management_master_Employee_Registration : ERP.OMS.ViewState_class.VSPage //System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (HttpContext.Current.Session["EntryProfileType"] != null)
            {
                ...
                {
                    Sqlmembership.ConnectionString = ConfigurationSettings.AppSettings["DBReadOnlyConnection"];
                    Sqlstatutory.ConnectionString = ConfigurationSettings.AppSettings["DBReadOnlyConnection"];
                    SqlExchange.ConnectionString = ConfigurationSettings.AppSettings["DBReadOnlyConnection"];

                }
                else
                {
                    Sqlmembership.ConnectionString = ConfigurationSettings.AppSettings["DBConnectionDefault"];
                    Sqlstatutory.ConnectionString = ConfigurationSettings.AppSettings["DBConnectionDefault"];
                    SqlExchange.ConnectionString = ConfigurationSettings.AppSettings["DBConnectionDefault"];
        ...
        {
            Session["check"] = "a";
            string[,] id = oDBEngine.GetFieldValue("tbl_master_contact", "cnt_UCC", "cnt_internalId='" + Session["KeyVal_InternalID"].ToString() + "'", 1);
            if (id[0, 0] != "n")
            {

                                ...
                                <table>
                                    <tr>
                                        <td id="ShowFilter">
                                            <% if (rights.CanAdd)
                                               { %>
                                            <a href="javascript:void(0);" onclick="addNewRecord()" class="btn btn-primary">
                                                <span>Add New</span>
                                            </a>
                                            <%} %>
                                            ...
                                            <% if (rights.CanExport)
                                               { %>
                                             <asp:DropDownList ID="drdExport" runat="server" CssClass="btn btn-sm btn-primary" onChange="if(!showFilter()){return false;}"

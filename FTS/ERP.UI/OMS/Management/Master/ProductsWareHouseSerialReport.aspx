    ...
    <div class="form_main">
        ...
        <dxe:ASPxGridView ID="OpeningGrid" runat="server" KeyFieldName="Stock_ID" AutoGenerateColumns="False" EnableRowsCache="true"
            ...
            <Columns>
                ...
                <dxe:GridViewDataTextColumn Caption="Batch" VisibleIndex="11" Width="15%" FieldName="Batch" CellStyle-VerticalAlign="Top" CellStyle-Wrap="True">
                    <EditFormSettings Visible="False" />
                </dxe:GridViewDataTextColumn>
                <dxe:GridViewDataTextColumn Caption="Serial" VisibleIndex="12" Width="15%" FieldName="Serial" CellStyle-Wrap="True">
                    <EditFormSettings Visible="False" />
                </dxe:GridViewDataTextColumn>
            </Columns>
    ...
    <div style="display: none">
        ...
        <dxe:ASPxGridView ID="openingGridExport" runat="server" AutoGenerateColumns="True"
            ...
            <Columns>
                ...
                <dxe:GridViewDataTextColumn FieldName="Batch" Caption="Batch" VisibleIndex="6">
                </dxe:GridViewDataTextColumn>
                <dxe:GridViewDataTextColumn FieldName="Serial" Caption="Serial" VisibleIndex="7">
                </dxe:GridViewDataTextColumn>
            </Columns>
        </dxe:ASPxGridView>
    </div>

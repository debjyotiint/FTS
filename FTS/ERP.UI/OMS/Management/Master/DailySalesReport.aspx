...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        ...
        var vartype;
        var nxtdate;
        function InsertFeedback(sid, dtid, tid, nxtcall, type) {
            var datearr = [];
            var datearr1 = [];
            //  alert(slsid+' '+tid)
        ...
        function CallFeedback_save() {
            ...
            if (Remarks == "" || Remarks == null) {
                ...
                Grid.PerformCallback('Feedback~' + refeedbackvar + '~' + Remarks + '~' + $("#hdtid").val() + '~' + stid + '~' + vartype + '~' + nxtdate);
                //  Grid.Refresh();
            }
            cNxtactivtyDate.SetEnabled(false);
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <tr>
                ...
                <td colspan="2">
                    ...
                    <dxe:ASPxGridView runat="server" ID="GridSalesReport" ClientInstanceName="Grid" Width="100%"  AutoGenerateColumns="False"
                        ...
                        SettingsBehavior-ColumnResizeMode="Control" Settings-HorizontalScrollBarMode="Auto">
                        <Columns>
                            <dxe:GridViewDataComboBoxColumn FieldName="AssignTo" Caption="Salesmen" GroupIndex="0" Width="150" SortOrder="Descending">
                                <%-- <PropertiesComboBox
                            ...
                            <dxe:GridViewDataTextColumn FieldName="Product" Caption="Product(s)" Width="250" VisibleIndex="5" Visible="false" />

                            <dxe:GridViewDataTextColumn FieldName="ProductClass_Name" Caption="Product Class" Width="120" VisibleIndex="4" />

                            <dxe:GridViewDataTextColumn FieldName="Industry" Caption="Industry" Width="150" VisibleIndex="3" />
                            <dxe:GridViewDataTextColumn FieldName="activitystatus" Caption="Outcome" Width="250" VisibleIndex="7" />
                            <dxe:GridViewDataTextColumn FieldName="Status" Caption="Status" Width="150" VisibleIndex="8" />
                            <dxe:GridViewDataTextColumn FieldName="feed_remarks" Caption="Feedback" Width="250" VisibleIndex="9" />
                            <dxe:GridViewDataTextColumn FieldName="Note" Caption="Activity Note" VisibleIndex="6" />
                            <dxe:GridViewDataTextColumn FieldName="Customer_Lead" Caption="Customer/Lead" Width="250" VisibleIndex="2" />
                            <dxe:GridViewDataTextColumn FieldName="Date" Caption="Activity Done On" Width="130" VisibleIndex="1" />

                            <dxe:GridViewDataTextColumn FieldName="NextCall" Caption="Next Activity Date" Width="130" VisibleIndex="10" />


                            <dxe:GridViewDataTextColumn FieldName="Invoice_Number" Caption="Last Sale Date/Qty" Width="200" VisibleIndex="11" />

                            <dxe:GridViewDataTextColumn FieldName="budget" Caption="Product:Budget Rate/Month" Width="100" VisibleIndex="12" />
                            <dxe:GridViewDataTextColumn VisibleIndex="13" Caption="History" Width="50">
                            ...
                            <dxe:GridViewDataTextColumn VisibleIndex="14" Caption="Actions" Width="50">
                                <CellStyle HorizontalAlign="Center">
                                </CellStyle>
                                <HeaderStyle HorizontalAlign="Center" />
                                <DataItemTemplate>
                                    <a href="javascript:void(0)" onclick="InsertFeedback('<%#Eval("sls_id") %>','<%#Eval("detailsid") %>','<%#Eval("Tid") %>','<%#Eval("NextCall") %>','<%#Eval("Type") %>')" class="pad">
    ...
    <asp:SqlDataSource ID="SMDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:crmConnectionString %>"

<%@ Page Title="Document" Language="C#" AutoEventWireup="true" MasterPageFile="~/OMS/MasterPage/ERP.Master"
    Inherits="ERP.OMS.Management.Master.management_master_rootComp_document" CodeBehind="rootComp_document.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        //}
        function Show() {
            //                var url = "frmAddDocuments.aspx?id=rootComp_document.aspx&id1='<%#Session["requesttype"]%>'&AcType=Add";
        ...
        function ShowEditForm(KeyValue) {
            //           var url = "frmAddDocuments.aspx?id=rootComp_document.aspx&id1='<%#Session["requesttype"]%>'&AcType=Edit&docid="+KeyValue;
                ...
                <td>
                    <dxe:ASPxPageControl ID="ASPxPageControl1" runat="server" ActiveTabIndex="2" ClientInstanceName="page"
                        ...
                        <TabPages>
                            ...
                            <dxe:TabPage Text="UDF" Name="UDF" Visible="false">
                                <ContentCollection>
                                    <dxe:ContentControl runat="server">
                                    </dxe:ContentControl>
                                </ContentCollection>

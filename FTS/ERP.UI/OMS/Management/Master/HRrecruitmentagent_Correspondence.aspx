                                                        ...
                                                        <dxe:ContentControl runat="server">
                                                            ...
                                                            <dxe:ASPxGridView ID="AddressGrid" runat="server" DataSourceID="Address" ClientInstanceName="gridAddress"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <dxe:GridViewDataTextColumn Caption="Address1" FieldName="Address1" VisibleIndex="1">
                                                                        <CellStyle CssClass="gridcellleft">
                                                                        </CellStyle>
                                                                    ...
                                                                    <dxe:GridViewDataTextColumn Caption="Address2" FieldName="Address2" VisibleIndex="2">
                                                                        <CellStyle CssClass="gridcellleft">
                                                                        </CellStyle>
                                                                        <PropertiesTextEdit MaxLength="500"></PropertiesTextEdit>
                                                                        <EditFormCaptionStyle HorizontalAlign="Right" VerticalAlign="Top" Wrap="False">
                                                                    ...
                                                                    <dxe:GridViewDataTextColumn Caption="Address3" FieldName="Address3" VisibleIndex="3">
                                                                        <CellStyle CssClass="gridcellleft">
                                                                        </CellStyle>
                                                                        <PropertiesTextEdit MaxLength="500"></PropertiesTextEdit>
                                                                        <EditFormCaptionStyle HorizontalAlign="Right" VerticalAlign="Top" Wrap="False">
                                                                    ...
                                                                    <dxe:GridViewDataTextColumn Caption="Landmark" FieldName="LandMark" VisibleIndex="4">
                                                                        <CellStyle CssClass="gridcellleft">
                                                                        </CellStyle>
                                                                        <PropertiesTextEdit MaxLength="500"></PropertiesTextEdit>
                                                                        <EditFormCaptionStyle HorizontalAlign="Right" VerticalAlign="Top" Wrap="False">
                                                                    ...
                                                                    <dxe:GridViewDataTextColumn Caption="Country" FieldName="Country1" VisibleIndex="5">
                                                                        <CellStyle CssClass="gridcellleft">
                                                                        </CellStyle>
                                                                        <EditFormCaptionStyle HorizontalAlign="Right" VerticalAlign="Top" Wrap="False">
                                                                        </EditFormCaptionStyle>
                                                                    ...
                                                                    <dxe:GridViewDataTextColumn Caption="State" FieldName="State1" VisibleIndex="6">
                                                                        <CellStyle CssClass="gridcellleft">
                                                                        </CellStyle>
                                                                        <EditFormCaptionStyle HorizontalAlign="Right" VerticalAlign="Top" Wrap="False">
                                                                        </EditFormCaptionStyle>
                                                                    ...
                                                                    <dxe:GridViewDataTextColumn Caption="City" FieldName="City1" VisibleIndex="8">
                                                                        <CellStyle CssClass="gridcellleft">
                                                                        </CellStyle>
                                                                        <EditFormCaptionStyle HorizontalAlign="Right" VerticalAlign="Top" Wrap="False">
                                                                        </EditFormCaptionStyle>
                                                                      ...
                                                                      <dxe:GridViewDataTextColumn Caption="Area" FieldName="area1" VisibleIndex="7">
                                                                        <CellStyle CssClass="gridcellleft">
                                                                        </CellStyle>
                                                                        <EditFormCaptionStyle HorizontalAlign="Right" VerticalAlign="Top" Wrap="False">
                                                                        </EditFormCaptionStyle>
                                                                    ...
                                                                    <dxe:GridViewDataComboBoxColumn Caption="City / District" FieldName="City" Visible="False"
                                                                        VisibleIndex="7">
                                                                    ...
                                                                    <dxe:GridViewDataTextColumn VisibleIndex="10" Caption="Change Status">
                                                                        <DataItemTemplate>
                                                                    ...
                                                                    <dxe:GridViewCommandColumn VisibleIndex="11" ShowDeleteButton="true" ShowNewButton="true" HeaderStyle-HorizontalAlign="Center" ShowEditButton="True">
...
<Style CssClass="pad"></Style>
    ...
    <asp:SqlDataSource ID="Address" runat="server" ConnectionString="<%$ ConnectionStrings:crmConnectionString %>"
        SelectCommand="select DISTINCT  tbl_master_address.add_id AS Id, tbl_master_address.add_addressType AS Type,
                        ...
                        case when IsNull(add_status,'')='N' then 'Deactive' else 'Active' end as status,tbl_master_address.Isdefault as Isdefault, tbl_master_address.contactperson as contactperson             

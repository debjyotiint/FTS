                                    ...
                                    <dxe:ContentControl runat="server">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <div><asp:TextBox ID="txtBranch"  runat="server" TabIndex="2" Width="100%" MaxLength="200"></asp:TextBox></div>
                                            </div>
                                            <div class="col-md-3">
                                                <label>MICR Code </label>
                                                <div> <asp:TextBox ID="txtMICRcode"  runat="server" TabIndex="3" Width="100%" MaxLength="11"></asp:TextBox></div>
                                            </div>
                                            <div class="col-md-3">
                                                <label>IFSC Code</label>
                                                <div><asp:TextBox ID="txtIFSCCode"  runat="server" TabIndex="4" Width="100%" MaxLength="11"></asp:TextBox></div>
                                            </div>
                                            <div class="clear"></div>
                                            <div class="col-md-3">
                                                <label>NEFT Code</label>
                                                <div><asp:TextBox ID="txtNEFTcode"  runat="server" TabIndex="5" Width="100%" MaxLength="11"></asp:TextBox></div>
                                            </div>
                                            <div class="col-md-3">
                                                <label>RTGS Code</label>
                                                <div><asp:TextBox ID="txtRTGScode"  runat="server" TabIndex="6" Width="100%" MaxLength="11"></asp:TextBox></div>
                                            </div>

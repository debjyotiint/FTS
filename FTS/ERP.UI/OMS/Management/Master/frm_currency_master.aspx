<%@ Page Title="Currency Master" Language="C#" AutoEventWireup="true" CodeBehind="frm_currency_master.aspx.cs" ValidateRequest="false" MasterPageFile="~/OMS/MasterPage/ERP.Master" Inherits="ERP.OMS.Management.Master.frm_currency_master" %>
                                            ...
                                            <table>
                                                <tr>
                                                    ...
                                                    <td width="300px" style="position: relative;">
                                                        ...
                                                        <asp:DropDownList ID="DrpCompany" runat="server" Width="100%" OnSelectedIndexChanged="DrpCompany_SelectedIndexChanged1" AutoPostBack="true"></asp:DropDownList>

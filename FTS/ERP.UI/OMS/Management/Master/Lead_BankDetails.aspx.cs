...
{
    public partial class management_Master_Lead_BankDetails : ERP.OMS.ViewState_class.VSPage
    {
        ...
        {
          //  string val = Convert.ToString(Session["KeyVal_InternalID"]);

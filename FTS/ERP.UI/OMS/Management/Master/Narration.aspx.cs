    ...
    public partial class management_Master_Narration : ERP.OMS.ViewState_class.VSPage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (HttpContext.Current.Session["EntryProfileType"] != null)
            {
                ...
                {
                    Narration.ConnectionString = ConfigurationSettings.AppSettings["DBReadOnlyConnection"];
                }
                else
                {
                    Narration.ConnectionString = ConfigurationSettings.AppSettings["DBConnectionDefault"];
                }
            }

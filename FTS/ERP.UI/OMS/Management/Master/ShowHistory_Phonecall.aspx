...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <PropertiesComboBox DataSourceID="AssignedToDataSource"  
                    ValueField="cnt_id" TextField="AssignTo" />
                            ...
                            <dxe:GridViewDataTextColumn FieldName="CallDate" VisibleIndex="8" Caption="Call/Visit Date">
                             ...
                             <dxe:GridViewDataTextColumn FieldName="feed_remarks" VisibleIndex="9" Caption="Feedback Details">
                            </dxe:GridViewDataTextColumn>

                            <dxe:GridViewDataTextColumn VisibleIndex="10" Caption="Actions"  Width="80px">
    ...
    <%--   <asp:SqlDataSource ID="AssignedToDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:CRMConnectionString %>"></asp:SqlDataSource>--%>
    ...
    <asp:SqlDataSource ID="ActivityTypeDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:crmConnectionString %>"

    ...
    public partial class management_master_HRFamilyRelation : ERP.OMS.ViewState_class.VSPage //System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (HttpContext.Current.Session["EntryProfileType"] != null)
            {
                ...
                {
                    FamilySource.ConnectionString = ConfigurationSettings.AppSettings["DBReadOnlyConnection"];
                }
                else
                {
                    FamilySource.ConnectionString = ConfigurationSettings.AppSettings["DBConnectionDefault"];
                }
            }

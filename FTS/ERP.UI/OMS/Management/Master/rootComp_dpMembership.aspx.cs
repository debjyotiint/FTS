...
public partial class management_master_rootComp_dpMembership : ERP.OMS.ViewState_class.VSPage
{
    Int32 ID;
    /* For Tier Structure
    ...
    {
        HiddenField txtCompliance_hidden = (HiddenField)ASPxCallbackPanel1.FindControl("txtCompliance_hidden");
        ...
        if (data[0] == "Edit")
        {
           ...
           // cmbSegName.SelectedValue = DT[0, 2];
            ...
            //string soss = HttpContext.Current.Session["KeyVal_InternalID"].ToString();
            if (DT[0, 7].ToString() != "")
            {
        ...
        else if (data[0] == "SaveNew")
        {
            ...
            dtEXN = oDBEngine.GetDataTable("tbl_master_companyExchange", "*", "exch_membershipType='" + cmbMemberType.SelectedItem.Value + "' and exch_TMCode='" + txtTMCODE.Text + "'");
            ...
            {
                string s = txtCompliance_hidden.Value;
                int NoofRowsAffect = oDBEngine.InsurtFieldValue("[tbl_master_companyExchange]", "exch_compId,exch_exchId,exch_segmentId,exch_membershipType,exch_TMCode,exch_CMCode,exch_cmbpid,exch_sebiNo,exch_sebiexpDate,exch_regnNo,exch_regnexpdate,exch_ComplianceOfficer,CreateDate,CreateUser,exch_GrievanceID,exch_InvestorGrievanceID", "'" + HttpContext.Current.Session["KeyVal_InternalID"] + "','" + string.Empty + "','" + string.Empty + "','" + cmbMemberType.SelectedItem.Value + "','" + txtTMCODE.Text.ToString().Trim() + "','" + txtCMCODE.Text.ToString().Trim() + "','" + txtcmbpid.Text.ToString().Trim() + "','" + txtSEBINO.Text.ToString().Trim() + "','" + dtSEBIEXP.Value + "','" + txtFMCNO.Text.ToString().Trim() + "','" + dtFMCEXP.Value + "','" + txtCompliance_hidden.Value + "','" + oDBEngine.GetDate() + "','" + Session["userid"].ToString() + "','" + txtbroker.Text.ToString().Trim() + "','" + txtexchange.Text.ToString().Trim() + "'");
        ...
        else if (data[0] == "SaveOld")
        {
            ...
            dtEXO = oDBEngine.GetDataTable("tbl_master_companyExchange", "*", "exch_membershipType='" + cmbMemberType.SelectedItem.Value + "' and exch_TMCode='" + txtTMCODE.Text + "' and exch_internalId !=" + data[1]);

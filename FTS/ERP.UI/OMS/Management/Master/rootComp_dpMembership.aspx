<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/OMS/MasterPage/ERP.Master"
    Inherits="management_master_rootComp_dpMembership" Codebehind="rootComp_dpMembership.aspx.cs" %>
                                                    ...
                                                    <td style="width: 907px">
                                                        <dxe:ASPxGridView ID="gridContract" ClientInstanceName="grid" Width="100%" KeyFieldName="exch_internalId"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <dxe:GridViewDataTextColumn VisibleIndex="1" FieldName="exch_membershipType" Caption="Depository">
                                                                    <CellStyle Wrap="True" CssClass="gridcellleft">
                                                                    </CellStyle>
                                                                    <EditFormSettings Visible="False"></EditFormSettings>
                                                                </dxe:GridViewDataTextColumn>
                                                                <dxe:GridViewDataTextColumn VisibleIndex="2" FieldName="exch_TMCode" Caption="DP Id">
                                                                    <CellStyle Wrap="True" CssClass="gridcellleft">
                                                                    </CellStyle>
                                                                    <EditFormSettings Visible="False"></EditFormSettings>
                                                                </dxe:GridViewDataTextColumn>
                                                                <dxe:GridViewDataTextColumn VisibleIndex="2" FieldName="exch_sebiNo" Caption="SEBI Registraton No">
                                                                    <CellStyle Wrap="True" CssClass="gridcellleft">
                                                                    </CellStyle>
                                                                    <EditFormSettings Visible="False"></EditFormSettings>
                                                                </dxe:GridViewDataTextColumn>
                                                                <dxe:GridViewDataTextColumn VisibleIndex="2" FieldName="exch_sebiexpDate" Caption="SEBI Expiry Date">

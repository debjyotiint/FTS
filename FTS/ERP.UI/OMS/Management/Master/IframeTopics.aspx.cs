    ...
    public partial class management_master_IframeTopics : ERP.OMS.ViewState_class.VSPage //SSystem.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (HttpContext.Current.Session["EntryProfileType"] != null)
            {
                ...
                {
                    SqlTopics.ConnectionString = ConfigurationSettings.AppSettings["DBReadOnlyConnection"];
                }
                else
                {
                    SqlTopics.ConnectionString = ConfigurationSettings.AppSettings["DBConnectionDefault"];
                }
            }

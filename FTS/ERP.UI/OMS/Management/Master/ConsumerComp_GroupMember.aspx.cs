...
{
    public partial class management_master_ConsumerComp_GroupMember : ERP.OMS.ViewState_class.VSPage
    {
        string InterNalId;
        ...
        public void GroupMasterBind()
        {
            ...
            for (int i = 0; i < Gtype.Length; i++)
            {
                if (Gtype[i, 0] != null)
                {
                    ...
                    BusinessLogicLayer.DBEngine objEngine1 = new BusinessLogicLayer.DBEngine(ConfigurationManager.AppSettings["DBConnectionDefault"]);
                    clsDropDownList objclsDropDownList = new clsDropDownList();
                    ...
                    if (Description[0, 0] != "n")
                    {
                        ...
                        objclsDropDownList.AddDataToDropDownList(Description, ddl);
        ...
        protected void BtnSave_Click(object sender, EventArgs e)
        {
            ...
            BusinessLogicLayer.DBEngine objEngine2 = new BusinessLogicLayer.DBEngine(ConfigurationManager.AppSettings["DBConnectionDefault"]);

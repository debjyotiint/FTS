<%@ Page Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true"
    Inherits="ERP.OMS.Management.Master.management_master_ConsumerComp_ContactPerson" CodeBehind="ConsumerComp_ContactPerson.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    else
    {
         GridContactPerson.GetEditor(&quot;cp_designation&quot;).SetVisible(false);
                                                            ...
                                                            <dxe:GridViewCommandColumn VisibleIndex="5" Width="10%" ShowClearFilterButton="True" ShowDeleteButton="True" ShowEditButton="True">

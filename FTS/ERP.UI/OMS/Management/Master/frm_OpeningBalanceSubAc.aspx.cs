...
namespace ERP.OMS.Management.Master
{
    ...
    public partial class management_master_frm_OpeningBalanceSubAc : ERP.OMS.ViewState_class.VSPage //System.Web.UI.Page
    {
        ...
        AccountHead obj = new AccountHead();
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                // .............................Code Commented and Added by Sam on 29112016. due to  Session["Segmentname"] is null calling from Custom Type of frm_Subledger.aspx..................................... 
        ...
        private void InsertInTransMainAccount(string strSubAcId, int strSubMainId)
        {
            ...
            int NoOfRowEffected = obj.Insert_TransSubAccount(Session["LastFinYear"].ToString().Trim(), strSubMainId.ToString(),
                strSubAcId.ToString(), Session["LastCompany"].ToString().Trim(), ViewState["Seg"].ToString().Trim(), cmbBranch.Value.ToString(), strOpeningCr.ToString(),
                strOpeningDr.ToString(), Session["ActiveCurrency"].ToString().Split('~')[0]);
        ...
        private void updateTransSubAccount(string strSubAcId, int strSubMainId)
        {
            ...
            int NoOfRowEffected = obj.UpDate_AccountSummary1("UpDateSubAccountSummary", Session["LastFinYear"].ToString().Trim(), strSubMainId.ToString(),
                strSubAcId.ToString(), Session["LastCompany"].ToString().Trim(), ViewState["Seg"].ToString().Trim(), cmbBranch.Value.ToString(), strOpeningCr.ToString(),
                strOpeningDr.ToString(), Session["ActiveCurrency"].ToString().Split('~')[0]);

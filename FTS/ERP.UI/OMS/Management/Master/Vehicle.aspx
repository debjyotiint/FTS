        ...
        <div class="clearfix">
            ...
            <div class="GridViewArea">
                ...
                <dxe:ASPxGridView ID="cityGrid" runat="server" AutoGenerateColumns="False" ClientInstanceName="grid"
                    ...
                    OnHtmlEditFormCreated="cityGrid_HtmlEditFormCreated"
                    OnCustomCallback="cityGrid_CustomCallback"  SettingsBehavior-AllowFocusedRow="true" Settings-HorizontalScrollBarMode="Visible" >
                    ...
                    <columns>
                        ...
                        <dxe:GridViewDataTextColumn Caption="Is Active" FieldName="vehicle_isActive" ReadOnly="True"
                         ...
                         <dxe:GridViewDataTextColumn Caption="By Hand" FieldName="ByHand" ReadOnly="True"
                                ...
                                <dxe:GridViewDataTextColumn ReadOnly="True" Width="100px" CellStyle-HorizontalAlign="Center" VisibleIndex="31"  Visible="True">

...
{
    public partial class management_master_rootComp_Correspondence : ERP.OMS.ViewState_class.VSPage
    {
        /* For Tier Structure
        ...
        */
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            LitCompName.Text = "Company Name :" + "  " + Convert.ToString(Session["CompanyName"]);
            ...
            //..................... Code Commented By Sam on 14112016 to prevent insertion of dummy Address...........................
            ...
            //..................... Code Above Commented By Sam on 14112016 to prevent insertion of dummy Address...........................
        }
        ...
        protected void AddressGrid_CommandButtonInitialize(object sender, ASPxGridViewCommandButtonEventArgs e)
        {
            ...
            //DataTable dt = (DataTable)AddressGrid.DataSource;
        ...
        {
            //DataTable dt = (DataTable)PhoneGrid.DataSource;
            //if (dt != null)
            //{
            //    if (!rights.CanDelete)
            //    {
        ...
        protected void PhoneGrid_RowValidating(object sender, DevExpress.Web.Data.ASPxDataValidationEventArgs e)
        {
            ...
            //object key = e.Keys[0];
            //string keyValue = PhoneGrid.Selection.SelectRowByKey(e.Keys[0]); //Convert.ToString(e.NewValues["phf_id"]);//Convert.ToString(e.Keys[0]);

...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <dxe:ASPxPopupControl ID="Popup_Schema" runat="server"
        ...
        Width="450px" HeaderText="Add/Modify Scheme" Modal="true" AllowResize="true" ResizingMode="Postponed" PopupHorizontalAlign="WindowCenter" PopupVerticalAlign="WindowCenter">
        <contentcollection>
        ...
        <dxe:ASPxGridView ID="SchemaGrid" runat="server" KeyFieldName="schemaID" AutoGenerateColumns="False"
          ...
          <%--  <settingspager numericbuttoncount="10" showseparators="True" alwaysshowpager="True" pagesize="10">
            ...
            <settingsediting mode="PopupEditForm" popupeditformhorizontalalign="Center" popupeditformmodal="True"
                popupeditformverticalalign="WindowCenter" popupeditformwidth="500px" editformcolumncount="1" popupeditformheight="500px" />

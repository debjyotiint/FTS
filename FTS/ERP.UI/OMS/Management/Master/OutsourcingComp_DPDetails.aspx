<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/OMS/MasterPage/ERP.Master"
    Inherits="ERP.OMS.Management.Master.management_master_OutsourcingComp_DPDetails" CodeBehind="OutsourcingComp_DPDetails.aspx.cs" %>
                                ...
                                <ContentCollection>
                                    <dxe:ContentControl runat="server">
                                        <table class="TableMain100">
                                            <tr>
                                                <td id="ShowFilter">
                                                    <a href="javascript:void(0);" onclick="gridDp.AddNewRow();" class="btn btn-success"><span>Add New</span> </a>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="gridcellcenter">
                                                    <dxe:ASPxGridView ID="DpDetailsGrid" runat="server" AutoGenerateColumns="False"
                                                        ...
                                                        <Columns>
                                                          ...
                                                          { %>
                                                        <dxe:ASPxHyperLink ID="ASPxHyperLink1" runat="server" Text="Add New" ClientSideEvents-Click="function(s, e) {gridDp.AddNewRow();}"

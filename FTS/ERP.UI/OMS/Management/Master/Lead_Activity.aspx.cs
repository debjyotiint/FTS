...
namespace ERP.OMS.Management.Master
{
    public partial class management_master_Lead_Activity : ERP.OMS.ViewState_class.VSPage
    {
        ...
        protected void BTNSave_click(object sender, EventArgs e)
        {
                ...
                case 6:
                    ...
                    if (DT.Rows.Count != 0)
                    {
                        ...
                        for (int i = 0; i < DTcategory.Rows.Count; i++)
                        {
                            ...
                            BusinessLogicLayer.DBEngine oDBEngineLocal = new BusinessLogicLayer.DBEngine(ConfigurationSettings.AppSettings["DBConnectionDefault"]);
            ...
            BusinessLogicLayer.DBEngine oDBEngineL = new BusinessLogicLayer.DBEngine(ConfigurationSettings.AppSettings["DBConnectionDefault"]);

...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <td>
                    <dxe:ASPxGridView ID="gridCategory" runat="server" ClientInstanceName="grid" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <dxe:GridViewDataTextColumn FieldName="Variable_Name" Caption="Name" 
                            ...
                            <dxe:GridViewDataTextColumn FieldName="Variable_Description" Caption="Description"
                            ...
                            <dxe:GridViewDataTextColumn FieldName="Variable_Value" Caption="Value"
	...
	LastCall(s.cpHeight);
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server"
             SelectCommand="SELECT [Variable_Name],[Variable_Description],[Variable_Value],[IsActive],[UpdatedOn],[UpdatedBy],[FieldType]  FROM Config_SystemSettings  where IsActive=1">        

        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            rights = BusinessLogicLayer.CommonBLS.CommonBL.GetUserRightSession("/management/master/frm_Subledger.aspx");
                ...
                if (HttpContext.Current.Session["EntryProfileType"] != null)
                {
                    ...
                    {
                        SubAccount.ConnectionString = ConfigurationSettings.AppSettings["DBReadOnlyConnection"];
                        WithoutCustom.ConnectionString = ConfigurationSettings.AppSettings["DBReadOnlyConnection"];
                    }
                    else
                    {
                        SubAccount.ConnectionString = ConfigurationSettings.AppSettings["DBConnectionDefault"];
                        WithoutCustom.ConnectionString = ConfigurationSettings.AppSettings["DBConnectionDefault"];
                    }
                }

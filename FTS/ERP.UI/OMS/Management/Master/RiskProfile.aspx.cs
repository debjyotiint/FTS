    ...
    public partial class management_master_RiskProfile : ERP.OMS.ViewState_class.VSPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (HttpContext.Current.Session["EntryProfileType"] != null)
            {
                ...
                {
                    SqlRiskProfile.ConnectionString = ConfigurationSettings.AppSettings["DBReadOnlyConnection"];
                }
                else
                {
                    SqlRiskProfile.ConnectionString = ConfigurationSettings.AppSettings["DBConnectionDefault"];
                }
            }

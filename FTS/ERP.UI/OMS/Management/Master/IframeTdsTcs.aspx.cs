    ...
    public partial class management_master_IframeTdsTcs : ERP.OMS.ViewState_class.VSPage //SSystem.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (HttpContext.Current.Session["EntryProfileType"] != null)
            {
                ...
                {
                    SqlTdsCts.ConnectionString = ConfigurationSettings.AppSettings["DBReadOnlyConnection"];
                }
                else
                {
                    SqlTdsCts.ConnectionString = ConfigurationSettings.AppSettings["DBConnectionDefault"];
                }
            }

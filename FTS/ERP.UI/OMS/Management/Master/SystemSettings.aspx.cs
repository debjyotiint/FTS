        ...
        protected void gridCategory_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            try
            {
                ...
                else if (lengthIndex[0].ToString() == "EDIT")
                {
                    ...
                    else
                    {
                        ...
                        if (Convert.ToString(lengthIndex[1]) !="")
                        {
                            ...
                            oDBEngine.SetFieldValue("Config_SystemSettings", "Variable_Value='" + valeedit + "',UpdatedOn='" + DateTime.Now + "'", "Variable_Name='" + Convert.ToString(lengthIndex[1]) + "'");
                ...
                else if (lengthIndex[0].ToString() == "BEFORE_EDIT")
                {
                    ...
                    Field_Value = oDBEngine.GetFieldValue("Config_SystemSettings", "Variable_Name,Variable_Description,Variable_Value,IsActive,FieldType", "Variable_Name='" + lengthIndex[1].ToString() + "'", 5);

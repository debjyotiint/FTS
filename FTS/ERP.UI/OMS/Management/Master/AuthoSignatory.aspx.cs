    ...
    public partial class management_master_AuthoSignatory : ERP.OMS.ViewState_class.VSPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (HttpContext.Current.Session["EntryProfileType"] != null)
            {
                ...
                {
                    SqlSignatory.ConnectionString = ConfigurationSettings.AppSettings["DBReadOnlyConnection"];
                }
                else
                {
                    SqlSignatory.ConnectionString = ConfigurationSettings.AppSettings["DBConnectionDefault"];
                }
            }

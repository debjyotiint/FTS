<%@ Page Language="C#" AutoEventWireup="true"
    Inherits="ERP.OMS.Management.Master.management_master_rootComp_Remarks" MasterPageFile="~/OMS/MasterPage/ERP.Master" CodeBehind="rootComp_Remarks.aspx.cs" %>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function disp_prompt(name) {
            ...
            if (name == "tab1") {
                ...
                //alert(name);
                document.location.href = "rootcompany_Remarks.aspx";
            }

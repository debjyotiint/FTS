    ...
    public partial class management_master_OutsourcingComp_Correspondence : ERP.OMS.ViewState_class.VSPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (HttpContext.Current.Session["EntryProfileType"] != null)
            {
                ...
                {
                    Address.ConnectionString = ConfigurationSettings.AppSettings["DBReadOnlyConnection"];
                    Phone.ConnectionString = ConfigurationSettings.AppSettings["DBReadOnlyConnection"];
                    Email.ConnectionString = ConfigurationSettings.AppSettings["DBReadOnlyConnection"];

                }
                else
                {
                    Address.ConnectionString = ConfigurationSettings.AppSettings["DBConnectionDefault"];
                    Phone.ConnectionString = ConfigurationSettings.AppSettings["DBConnectionDefault"];
                    Email.ConnectionString = ConfigurationSettings.AppSettings["DBConnectionDefault"];
                }
            }

    ...
    public partial class management_master_ConsumerFinanceProductDetails : ERP.OMS.ViewState_class.VSPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (HttpContext.Current.Session["EntryProfileType"] != null)
            {
                ...
                {
                    SqlConsumerFinance.ConnectionString = ConfigurationSettings.AppSettings["DBReadOnlyConnection"];
                    SqlproductRequired.ConnectionString = ConfigurationSettings.AppSettings["DBReadOnlyConnection"];
                }
                else
                {
                    SqlConsumerFinance.ConnectionString = ConfigurationSettings.AppSettings["DBConnectionDefault"];
                    SqlproductRequired.ConnectionString = ConfigurationSettings.AppSettings["DBConnectionDefault"];
                }
            }

    ...
    public partial class management_master_indices : ERP.OMS.ViewState_class.VSPage //SSystem.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (HttpContext.Current.Session["EntryProfileType"] != null)
            {
                ...
                {
                    IndicesMaster.ConnectionString = ConfigurationSettings.AppSettings["DBReadOnlyConnection"];
                }
                else
                {
                    IndicesMaster.ConnectionString = ConfigurationSettings.AppSettings["DBConnectionDefault"];
                }
            }

    ...
    public partial class management_master_Other_CallDisposition : ERP.OMS.ViewState_class.VSPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (HttpContext.Current.Session["EntryProfileType"] != null)
            {
                ...
                {
                    CallDisposition.ConnectionString = ConfigurationSettings.AppSettings["DBReadOnlyConnection"];
                }
                else
                {
                    CallDisposition.ConnectionString = ConfigurationSettings.AppSettings["DBConnectionDefault"];
                }
            }

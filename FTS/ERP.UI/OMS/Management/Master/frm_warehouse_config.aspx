            ...
            <%--   SettingsPager-Mode="ShowAllRecords"  Settings-ShowFooter="false"   Settings-VerticalScrollBarMode="Auto"  Settings-VerticalScrollableHeight="360"--%><%-- For off to show all record--%>
                <td style="vertical-align: top; text-align: left" colspan="2">
                    <dxe:ASPxGridView ID="gridWarehouseConfig" ClientInstanceName="grid" Width="100%"    
                        KeyFieldName="sproducts_id" DataSourceID="gridWarehouseConfigDataSource" runat="server" 
                        AutoGenerateColumns="False" OnInitNewRow="gridWarehouseConfig_InitNewRow" SettingsBehavior-AllowFocusedRow="true" OnCellEditorInitialize="gridWarehouseConfig_CellEditorInitialize"   OnCustomCallback="grid_CustomCallback" >
                        ...
                        <%--    <dxe:GridViewDataTextColumn Visible="False" FieldName="cmp_id" Caption="comp_id" VisibleIndex="4">
                          ...
                          <%--   <dxe:GridViewDataTextColumn Visible="True" Caption="Warehouse" VisibleIndex="2">
                            ...
                            <dxe:GridViewDataComboBoxColumn Caption="Warehouse" FieldName="warehouse_id" VisibleIndex="2">
                                  <DataItemTemplate>
                                    <dxe:ASPxComboBox ID="ASPxComboBox2" ClientInstanceName="cASPxComboBox2" runat="server" 
ValueType="System.String" DataSourceID="sqlwarehouse" TextField="bui_name" ValueField="bui_id" Text='<%# Bind("warehouse_name") %>' OnInit="cb_Init" Width="100%" >
        ...
        <asp:SqlDataSource ID="gridWarehouseConfigDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:crmConnectionString %>"
            SelectCommand="select sproducts_id,sProducts_Name,sProducts_Code,warehouse_id,warehouse_name=(
select bui_name from tbl_master_building where bui_id=warehouse_id),Is_active_Batch,Is_active_serialno,Is_stock_Block from Master_sProducts where sProduct_IsInventory=1"> 
        </asp:SqlDataSource>

         <asp:SqlDataSource ID="sqlwarehouse" runat="server" ConnectionString="<%$ ConnectionStrings:crmConnectionString %>"
            SelectCommand="select -1 as bui_id,'none' as bui_name union all select bui_id,bui_name from tbl_master_building">
        </asp:SqlDataSource>

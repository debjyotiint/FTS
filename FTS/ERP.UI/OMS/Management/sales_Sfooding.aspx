<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/OMS/MasterPage/ERP.Master" Inherits="ERP.OMS.Management.management_sales_Sfooding" CodeBehind="sales_Sfooding.aspx.cs" %>
                                            ...
                                            <Columns>
                                                ...
                                                <dxe:GridViewDataComboBoxColumn Caption="Food Type" FieldName="expnd_FoodType"
                                                    ...
                                                    <PropertiesComboBox ValueType="System.String">
                                                        <Items>
                                                            <dxe:ListEditItem Text="Breakfast " Value="Breakfast"></dxe:ListEditItem>
                                                            <dxe:ListEditItem Text="Lunch " Value="Lunch"></dxe:ListEditItem>
                                                            <dxe:ListEditItem Text="Dinner " Value="Dinner"></dxe:ListEditItem>
                                                            <dxe:ListEditItem Text="Refreshment " Value="Refreshment"></dxe:ListEditItem>
                                                            <dxe:ListEditItem Text="Full Day meal" Value="Full Day meal"></dxe:ListEditItem>
                                                        </Items>

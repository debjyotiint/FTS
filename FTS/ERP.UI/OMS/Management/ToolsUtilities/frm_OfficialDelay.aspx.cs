    ...
    public partial class management_utilities_frm_OfficialDelay : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (HttpContext.Current.Session["EntryProfileType"] != null)
            {
                ...
                {
                    DataOD.ConnectionString = ConfigurationSettings.AppSettings["DBReadOnlyConnection"];
                }
                else
                {
                    DataOD.ConnectionString = ConfigurationSettings.AppSettings["DBConnectionDefault"];
                }
            }

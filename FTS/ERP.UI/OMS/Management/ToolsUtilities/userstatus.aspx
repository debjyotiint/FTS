        ...
        <table class="TableMain100">
            ...
            <tr>
                <td>
                        ...
                        <ContentTemplate>
                            ...
                            <dxe:ASPxGridView ID="grdActive2" runat="server" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <dxe:GridViewDataTextColumn FieldName="Since" VisibleIndex="4" Caption="Since">
                                    </dxe:GridViewDataTextColumn>
                                    <dxe:GridViewDataTextColumn FieldName="Duration" VisibleIndex="5" Caption="Duration">
                                    </dxe:GridViewDataTextColumn>
                    ...
                    <br />
                    <asp:Button ID="chkAll" runat="server" Text="Select All For Message" CssClass="btnUpdate btn btn-primary" OnClick="chkAll_Click" />
                    <asp:Button ID="UnChkAll" runat="server" Text="DeSelect All For Message" CssClass="btnUpdate btn btn-primary" OnClick="UnChkAll_Click" />
                </td>
            </tr>
            <tr id="trMessage">
                <td>

    ...
    public partial class management_utilities_frm_LeaveApplication : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (HttpContext.Current.Session["EntryProfileType"] != null)
            {
                ...
                {
                    DataSourceLeaveApplication.ConnectionString = ConfigurationSettings.AppSettings["DBReadOnlyConnection"];
                }
                else
                {
                    DataSourceLeaveApplication.ConnectionString = ConfigurationSettings.AppSettings["DBConnectionDefault"];
                }
            }

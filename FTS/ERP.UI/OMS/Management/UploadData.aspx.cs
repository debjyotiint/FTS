...
namespace ERP.OMS.Management
{
    ...
    {
        string str = ConfigurationManager.AppSettings["DBConnectionDefault"].ToString();
        ...
        protected void Button3_Click(object sender, EventArgs e)
        {
            ...
            if (strExt.Trim() == ".xml")
            {
                ...
                using (SqlConnection lConn = new SqlConnection(ConfigurationSettings.AppSettings["DBConnectionDefault"]))
                {
                    SqlCommand cmd = null;

...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function OnMoreInfoClick(keyValue) {
            var url = 'PurchaseChallan.aspx?key=' + keyValue + '&type=PC';
            window.location.href = url;
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        <dxe:ASPxGridView ID="Grid_PurchaseChallan" runat="server" AutoGenerateColumns="False" KeyFieldName="PurchaseChallan_Id" OnCustomCallback="Grid_PurchaseChallan_CustomCallback"
            ...
            OnSummaryDisplayText="Grid_PurchaseChallan_SummaryDisplayText" DataSourceID="EntityServerModeDataSource">
            ...
            <Columns>
                ...
                <dxe:GridViewDataTextColumn VisibleIndex="1" Caption="GRN No." FieldName="PurchaseChallan_Number" Width="180px" FixedStyle="Left">
                    <CellStyle Wrap="False" CssClass="gridcellleft"></CellStyle>
                </dxe:GridViewDataTextColumn>
                <dxe:GridViewDataTextColumn VisibleIndex="2" Caption="Date" FieldName="TransDate">
                    <CellStyle Wrap="False" CssClass="gridcellleft"></CellStyle>
                </dxe:GridViewDataTextColumn>

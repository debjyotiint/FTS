...
{
    public partial class PurchaseChallanForCustomer : ERP.OMS.ViewState_class.VSPage//ERP.OMS.ViewState_class.VSPage//System.Web.UI.Page//PersistViewStateToFileSystem
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                else
                {
                    ...
                    lblHeading.Text = "Modify Purchase GRN for Customer";
        ...
        public void GetFinacialYear()
        {
            ...
            if (Session["LastFinYear"] != null)
            {
                ...
                if (dtFinYear != null && dtFinYear.Rows.Count > 0)
                {
                    ...
                    dt_PartyDate.Value = null;
                    dt_PartyDate.MinDate = MinDate;
                    dt_PartyDate.MaxDate = MaxDate;
                                            ...
                                            ref int strIsComplete, ref int strChallanID)
        {
            try
            {
                ...
                cmd.Parameters.AddWithValue("@Entitytype", "CL");

...
{
    public partial class SalesInvoiceforVendor : ERP.OMS.ViewState_class.VSPage// System.Web.UI.Page
    {
            ...
            if (!IsPostBack)
            {
                ...
                if (Request.QueryString["key"] != null)
                {
                    if (Convert.ToString(Request.QueryString["key"]) != "ADD")
                    {
                        ...
                        lblHeadTitle.Text = "Modify Sales Invoice for Vendor";
                        ...
                        {
                            lblHeadTitle.Text = "View Sales Invoice for Vendor";
                    ...
                    else
                    {
                        ...
                        Session["SI_TaxDetails"] = null;
                        CreateDataTaxTable();
                        lblHeadTitle.Text = "Add Sales Invoice for Vendor";

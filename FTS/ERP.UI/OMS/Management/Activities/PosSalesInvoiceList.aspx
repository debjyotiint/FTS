        ...
        function IconChange() {
            $(function () {
                ...
                $tr.each(function (index, value) {
                    ...
                    var $a_Assignment = $(this).find("td").eq(16).find("#a_Assignment");
                    var $Cancel_Assignment = $(this).find("td").eq(16).find("#Cancel_Assignment");
                    var $a_editInvoice = $(this).find("td").eq(16).find("#a_editInvoice"); 
                    var $a_delete = $(this).find("td").eq(16).find("#a_delete");
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="form_main">
        <div class="clearfix">
            <% if (rights.CanAdd)
               { %>
            <a href="javascript:void(0);" onclick="OnAddInvoiceButtonClick('Cash')" class="btn btn-success btn-xs"><span>Add <u>C</u>ash Invoice</span> </a>
            <a href="javascript:void(0);" onclick="OnAddInvoiceButtonClick('Crd')" class="btn btn-success btn-xs"><span>Add Cre<u>d</u>it Invoice</span> </a>
            <a href="javascript:void(0);" onclick="OnAddInvoiceButtonClick('Fin')" class="btn btn-success btn-xs"><span>Add <u>F</u>inance Invoice</span> </a>
            <a href="javascript:void(0);" onclick="OnAddInvoiceButtonClick('IST')" class="btn btn-success btn-xs"><span>Interstate <u>S</u>tock Transfer</span> </a>

            <a href="javascript:void(0);" onclick="ShowReceiptPayment()" class="btn btn-success btn-xs"><span>Add <u>R</u>eceipt/Payment</span> </a>
            ...
            <% if (rights.CanAssignbranch)
               { %>
            <a href="javascript:void(0);" onclick="MassBranchAssign()" class="btn btn-primary btn-xs"><span><u>M</u>ass Branch Assign</span> </a>
            <%} %>
            <%--<a href="javascript:void(0);" class="btn btn-danger"><span>Delete</span> </a>--%>


            <a href="javascript:void(0);" onclick="InvoiceWatingClick()" class="btn btn-primary btn-xs hide"><span><u>I</u>nvoice Waiting </span>
                                ...
                                <Columns>
                                    ...
                                    <dxe:GridViewDataTextColumn HeaderStyle-HorizontalAlign="Center" CellStyle-HorizontalAlign="center" VisibleIndex="17" Width="170">
                                        <DataItemTemplate>
                                            <% if (rights.CanEdit)
                                               { %>
                                            <a href="javascript:void(0);" onclick="OnMoreInfoClick('<%# Container.KeyValue %>')" id="a_editInvoice" class="pad" title="Edit">
                                            ...
                                            <% if (rights.CanAssignbranch)
                                               { %>
                                            <a href="javascript:void(0);" class="pad" title="Branch Assignment" id="a_Assignment" onclick="onViewBranchAssignment('<%# Container.KeyValue %>')" style="display: none;">
                                            ...
                                            <% if (rights.Cancancelassignmnt)
                                               { %>
                                            <a href="javascript:void(0);" class="pad" title="Cancel Branch Assignment" id="Cancel_Assignment" onclick="onCancelBranchAssignment('<%# Container.KeyValue %>')" style="display: none;">
                            ...
                            <dxe:ASPxGridView ID="CustomerReceiptGrid" runat="server" KeyFieldName="ReceiptPayment_ID" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    <dxe:GridViewDataTextColumn Caption="Sl No." FieldName="SlNo" Width="50"
                                      ...
                                      <dxe:GridViewDataTextColumn Caption="Voucher Type" FieldName="ReceiptPayment_TransactionType" Width="200"
                                        VisibleIndex="0" FixedStyle="Left">
                                        <CellStyle CssClass="gridcellleft" Wrap="true">
                                        </CellStyle>
                                        <Settings AutoFilterCondition="Contains" />
                                    ...
                                    <dxe:GridViewDataTextColumn Caption="Voucher No." FieldName="ReceiptPayment_VoucherNumber" Width="200"
                                        VisibleIndex="0" FixedStyle="Left">
                                        <CellStyle CssClass="gridcellleft" Wrap="true">
                                        </CellStyle>
                                        <Settings AutoFilterCondition="Contains" />
                                    ...
                                    <dxe:GridViewDataTextColumn Caption="Transaction Date" FieldName="ReceiptPayment_TransactionDate" Width="200"
                                        VisibleIndex="0">
                                        <CellStyle CssClass="gridcellleft" Wrap="true">
                                        </CellStyle>
                                        <Settings AutoFilterCondition="Contains" />
                                    ...
                                    <dxe:GridViewDataTextColumn Caption="Currency" FieldName="ReceiptPayment_Currency" Width="200"
                                        VisibleIndex="0">
                                        <CellStyle CssClass="gridcellleft" Wrap="true">
                                        </CellStyle>
                                        <Settings AutoFilterCondition="Contains" />
                                    ...
                                    <dxe:GridViewDataTextColumn Caption="Amount" FieldName="Amount" Width="200"
                                        VisibleIndex="0">
                                        <PropertiesTextEdit DisplayFormatString="0.00"></PropertiesTextEdit>
                                        <CellStyle CssClass="gridcellleft" Wrap="true">
                                        </CellStyle>
                    ...
                    <dxe:ContentControl runat="server">
                        ...
                        <div class="GridViewArea">
                            <dxe:ASPxGridView ID="IstGrid" runat="server" KeyFieldName="Invoice_Id" AutoGenerateColumns="False"
                                ...
                                SettingsBehavior-AllowSelectSingleRowOnly="false" SettingsBehavior-AllowSelectByRowClick="true" OnDataBinding="IstGrid_DataBinding" Settings-HorizontalScrollBarMode="Auto"
                                SettingsCookies-Enabled="true" SettingsCookies-StorePaging="true" SettingsCookies-StoreFiltering="true" SettingsCookies-StoreGroupingAndSorting="true" SettingsBehavior-ColumnResizeMode="Control"
                                OnSummaryDisplayText="ShowGrid_SummaryDisplayText">

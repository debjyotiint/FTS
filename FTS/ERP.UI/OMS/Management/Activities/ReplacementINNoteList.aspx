<%@ Page Title="Replacement Stock IN" Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" CodeBehind="ReplacementINNoteList.aspx.cs" Inherits="ERP.OMS.Management.Activities.ReplacementINNoteList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function OnMoreInfoClick(ChallanID, keyValue, ReplacementStkID, InvoiceID, ReplacementStkOutID) {
            ...
            $('#<%=hdfOutStkID.ClientID %>').val(ReplacementStkOutID);
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
        ...
        <div class="GridViewArea">
            <dxe:ASPxGridView ID="GrdReplacement" runat="server" KeyFieldName="ReplacementID" AutoGenerateColumns="False"
                ...
                <Columns>
                    <dxe:GridViewDataTextColumn Caption="Stock Out Number" FieldName="StockInNumber"
                        VisibleIndex="0" FixedStyle="Left" Width="10%">
                        <CellStyle CssClass="gridcellleft" Wrap="true">
                        </CellStyle>
                        <Settings AutoFilterCondition="Contains" />
                    </dxe:GridViewDataTextColumn>
                    <dxe:GridViewDataTextColumn Caption="Date" FieldName="ReplacementDate"
                        VisibleIndex="0" FixedStyle="Left" Width="10%">
                        <CellStyle CssClass="gridcellleft" Wrap="true">
                        </CellStyle>
                        <Settings AutoFilterCondition="Contains" />
                    ...
                    <dxe:GridViewDataTextColumn HeaderStyle-HorizontalAlign="Center" CellStyle-HorizontalAlign="center" VisibleIndex="5" Width="150">
                        <DataItemTemplate>
                            <a href="javascript:void(0);" onclick="OnMoreInfoClick('<%#Eval("ChallanID")%>','<%# Container.KeyValue %>','<%#Eval("StockInID")%>','<%#Eval("InvoiceID")%>','<%#Eval("StockOutID")%>')" class="pad" title="Edit">
                ...
                <div class="Top clearfix">
                    ...
                    <div class="clearfix col-md-12" style="background: #f5f4f3; padding: 8px 0; margin-bottom: 15px; border-radius: 4px; border: 1px solid #ccc;">
                        ...
                        <div class="col-md-3">
                            ...
                            <dxe:ASPxTextBox ID="txt_PLQuoteNo" runat="server" ClientInstanceName="ctxt_PLQuoteNo" TabIndex="2" Width="100%" ClientEnabled="false">
    ...
    <%--Hidden Field--%>
    <asp:HiddenField ID="hdfOutStkID" runat="server" />

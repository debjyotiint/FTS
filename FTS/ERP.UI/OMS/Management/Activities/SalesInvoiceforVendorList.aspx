<%@ Page Title="Sales Invoice for Vendor" Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" 
    AutoEventWireup="true" CodeBehind="SalesInvoiceforVendorList.aspx.cs" Inherits="ERP.OMS.Management.Activities.SalesInvoiceforVendorList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        ...
        function OnGetApprovedRowValues(obj) {
            uri = "SalesInvoiceforVendor.aspx?key=" + obj + "&status=2" + '&type=SI';
        ...
        function OnGetRejectedRowValues(obj) {
            uri = "SalesInvoiceforVendor.aspx?key=" + obj + "&status=3" + '&type=SI';
            popup.SetContentUrl(uri);
            popup.Show();
        }
        ...
        function OnApprovalEndCall(s, e) {
            $.ajax({
                type: "POST",
                url: "SalesInvoiceforVendorList.aspx/GetPendingCase",
    ...
    <script>
        ...
        function OnAddButtonClick() {
            var url = 'SalesInvoiceforVendor.aspx?key=' + 'ADD';
            window.location.href = url;
        }
        function OnMoreInfoClick(keyValue) {
            ...
            if (ActiveUser != null) {
                $.ajax({
                    type: "POST",
                    url: "SalesInvoiceforVendorList.aspx/GetEditablePermission",
                    data: "{'ActiveUser':'" + ActiveUser + "'}",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (msg) {
                        var status = msg.d;
                        var url = 'SalesInvoiceforVendor.aspx?key=' + keyValue + '&Permission=' + status + '&type=SI';
                        window.location.href = url;
                    }
                });
            }
        ...
        function OnViewClick(keyValue) {
            var url = 'SalesInvoiceforVendor.aspx?key=' + keyValue + '&req=V' + '&type=SI';
            window.location.href = url;
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="panel-heading">
        <div class="panel-title clearfix">
            <h3 class="pull-left">Sales Invoice for Vendor</h3>
    ...
    <div class="GridViewArea">
        <dxe:ASPxGridView ID="GrdQuotation" runat="server" KeyFieldName="Invoice_Id" AutoGenerateColumns="False" SettingsBehavior-AllowFocusedRow="true"
            ...
            <Columns>
                ...
                <dxe:GridViewDataTextColumn Caption="Vendor" FieldName="CustomerName"  Width="150px"
                    VisibleIndex="7">
                    <CellStyle CssClass="gridcellleft" Wrap="true">
                    </CellStyle>
                    <Settings AutoFilterCondition="Contains" />

...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        ...
        function OnGetApprovedRowValues(obj) {
            uri = "PurchaseChallan_OD.aspx?key=" + obj + "&status=2" + '&type=PC';
        ...
        function OnGetRejectedRowValues(obj) {
            uri = "PurchaseChallan_OD.aspx?key=" + obj + "&status=3" + '&type=PC';
            popup.SetContentUrl(uri);
            popup.Show();
        }
    ...
    <script type="text/javascript">
        ...
        function AddButtonClick() {
            var url = 'PurchaseChallan_OD.aspx?key=' + 'ADD';
            window.location.href = url;
        }
        function OnMoreInfoClick(keyValue) {
            var url = 'PurchaseChallan_OD.aspx?key=' + keyValue + '&type=PC';
            window.location.href = url;
        }
        ...
        function OnViewClick(keyValue) {
            var url = 'PurchaseChallan_OD.aspx?key=' + keyValue + '&req=V' + '&type=PC';
            window.location.href = url;
        }
    ...
    <script>
        ...
        function AllControlInitilize() {
            if (isFirstTime) {
                if (localStorage.getItem('TransferList_FromDate')) {
                    var fromdatearray = localStorage.getItem('TransferList_FromDate').split('-');
                    var fromdate = new Date(fromdatearray[0], parseFloat(fromdatearray[1]) - 1, fromdatearray[2], 0, 0, 0, 0);
                    cFormDate.SetDate(fromdate);
                }

                if (localStorage.getItem('TransferList_ToDate')) {
                    var todatearray = localStorage.getItem('TransferList_ToDate').split('-');
                    var todate = new Date(todatearray[0], parseFloat(todatearray[1]) - 1, todatearray[2], 0, 0, 0, 0);
                    ctoDate.SetDate(todate);
                }

                if (localStorage.getItem('TransferList_Branch')) {
                    if (ccmbBranchfilter.FindItemByValue(localStorage.getItem('TransferList_Branch'))) {
                        ccmbBranchfilter.SetValue(localStorage.getItem('TransferList_Branch'));
                    }
        ...
        function updateGridByDate() {
            if (cFormDate.GetDate() == null) {
                ...
                localStorage.setItem("TransferList_FromDate", cFormDate.GetDate().format('yyyy-MM-dd'));
                localStorage.setItem("TransferList_ToDate", ctoDate.GetDate().format('yyyy-MM-dd'));
                localStorage.setItem("TransferList_Branch", ccmbBranchfilter.GetValue());
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        <dxe:ASPxGridView ID="Grid_PurchaseChallan" runat="server" AutoGenerateColumns="False" KeyFieldName="PurchaseChallan_Id" OnCustomCallback="Grid_PurchaseChallan_CustomCallback"
            ClientInstanceName="CgvPurchaseOrder" Width="100%" DataSourceID="EntityServerModeDataSource">
            ...
            <Columns>
                ...
                <dxe:GridViewDataTextColumn VisibleIndex="1" Caption="GRN No." FieldName="PurchaseChallan_Number">
                    <CellStyle Wrap="False" CssClass="gridcellleft"></CellStyle>
                </dxe:GridViewDataTextColumn>
                <dxe:GridViewDataTextColumn VisibleIndex="2" Caption="Date" FieldName="Challan_Date">
                    <CellStyle Wrap="False" CssClass="gridcellleft"></CellStyle>

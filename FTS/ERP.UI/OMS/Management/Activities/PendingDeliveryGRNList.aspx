...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="GridViewArea">
        <dxe:ASPxGridView ID="GrdOrder" runat="server" KeyFieldName="PCId" AutoGenerateColumns="False"
            ...
            <columns>
                <dxe:GridViewDataTextColumn Caption="GRN No." FieldName="PCNo"
                    VisibleIndex="0" FixedStyle="Left">
                    <CellStyle CssClass="gridcellleft" Wrap="true">
                    </CellStyle>
                </dxe:GridViewDataTextColumn>
                <dxe:GridViewDataTextColumn Caption="Date" FieldName="PCDate"
                ...
                <dxe:GridViewDataTextColumn Caption="Branch" FieldName="MBBranchDesc"

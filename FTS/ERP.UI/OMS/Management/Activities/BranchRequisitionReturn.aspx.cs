...
namespace ERP.OMS.Management.Activities
{
    public partial class BranchRequisitionReturn : ERP.OMS.ViewState_class.VSPage// System.Web.UI.Page
    {
        ...
        BusinessLogicLayer.DBEngine oDbEngine = new DBEngine(ConfigurationManager.AppSettings["DBConnectionDefault"]);
        string strCon;
        ...
        protected void gridBatch_BatchUpdate(object sender, DevExpress.Web.Data.ASPxDataBatchUpdateEventArgs e)
        {
            ...
            if (IsDeleteFrom != "D" && IsDeleteFrom != "C")
            {
                ...
                string strPartyID = Convert.ToString(VendorComboBox.Value);
        ...
        protected string checkNMakeJVCodeBR(string manual_str, int sel_schema_Id)
        {
            ...
            if (sel_schema_Id > 0)
            {
                dtSchema = oDBEngineBR.GetDataTable("tbl_master_idschema", "prefix, suffix, digit, startno, schema_type", "id=" + sel_schema_Id);

...
{
    public partial class PurchaseReturnManual : ERP.OMS.ViewState_class.VSPage// System.Web.UI.Page
    {
        ...
        {
            rights = BusinessLogicLayer.CommonBLS.CommonBL.GetUserRightSession("/management/Activities/PurchaseReturnManual.aspx");
            ...
            if (!IsPostBack)
            {
                ...
                this.Session["LastCompanyPRMWS"] = Session["LastCompany"];
                this.Session["LastFinYearPRMWS"] = Session["LastFinYear"];
                //////  GetProductData();//24-8
                ...
                Session["PRMWS_BillingAddressLookup"] = null;
                Session["PRMWS_ShippingAddressLookup"] = null;
                ...
                Session["PRMWS_ReturnID"] = "";
                Session["PRMWS_CustomerDetail"] = null;
                Session["PRMWS_QuotationDetails"] = null;
                Session["PRMWS_WarehouseData"] = null;
                Session["PRMWS_QuotationTaxDetails"] = null;
                Session["LoopPRMWSWarehouse"] = 1;
                Session["PRMWS_TaxDetails"] = null;
                Session["PRMWS_FinalTaxRecord"] = null;
                Session["PRMWS_ActionType"] = "";
                Session["PRMWS_ComponentData"] = null;
                Session["TaggingPurchaseInviceWithSTK"] = "";

                Session["PRMWSwarehousedetailstemp"] = null;
                Session["PRMIwarehousedetailstempUpdate"] = null;
                Session["PRMWSwarehousedetailstempDelete"] = null;
                Session["PurchaseReturnManualWithStkAddressDtl"] = null;
                ...
                Session["PRMWS_QuotationAddressDtl"] = null;
                ...
                Task PopulatePRTrialDataTask = new Task(() => BindAllControlDataOnPageLoad(userbranch));
                PopulatePRTrialDataTask.RunSynchronously();
                ...
                if (Request.QueryString["key"] != null)
                {
                    if (Convert.ToString(Request.QueryString["key"]) != "ADD")
                    {
                        ...
                        lblHeadTitle.Text = "Modify Purchase Return Manual";
                        hdnPageStatus.Value = "update";
                        divScheme.Style.Add("display", "none");
                        strPurchaseReturnId = Convert.ToString(Request.QueryString["key"]);
                        Session["PRMWS_KeyVal_InternalID"] = "SRQUOTE" + strPurchaseReturnId;


                        Keyval_internalId.Value = "PurchaseReturnManual" + strPurchaseReturnId;
                        #region Subhra Section
                        Session["PRMWS_key_QutId"] = strPurchaseReturnId;
                        ...
                        Session["PRMWS_ReturnID"] = strPurchaseReturnId;
                        Session["PRMWS_ActionType"] = "Edit";
                        SetPurchaseReturnDetails(strPurchaseReturnId);
                        //  DateTime quoteDate = Convert.ToDateTime(dt_PLQuote.Date.ToString("dd/MM/yyyy"));
                        Session["PRMWS_TaxDetails"] = GetTaxDataWithGST(GetTaxData(dt_PLQuote.Date.ToString("yyyy-MM-dd")));
                        ...
                        Session["PRMWS_QuotationDetails"] = Productdt;
                        grid.DataSource = GetQuotation(Productdt);
                        grid.DataBind();

                        DataTable dt = GetQuotationWarehouseData();
                        Session["PRMWS_WarehouseData"] = dt;

                        Session["PRMWS_QuotationAddressDtl"] = objPurchaseReturnBL.GetPurchaseReturnBillingAddress(strPurchaseReturnId); ;
                        ...
                        if (GetQuotationTaxData().Tables[0] != null)
                            Session["PRMWS_QuotationTaxDetails"] = GetQuotationTaxData().Tables[0];
                        ...
                        if (GetQuotationEditedTaxData().Tables[0] != null)
                        {
                            ...
                            {
                                Session["PRMWS_FinalTaxRecord"] = quotetable;
                            }
                        }
                        ...
                        {
                            lblHeadTitle.Text = "View Purchase Return Manual";
                    ...
                    else
                    {
                        ...
                        if (Session["PRMWS_SaveMode"] != null)  // it has been removed from coding side of Quotation list 
                        {
                            if (Session["PRMWS_schemavalue"] != null)  // it has been removed from coding side of Quotation list 
                            {
                                ddl_numberingScheme.SelectedValue = Convert.ToString(Session["PRMWS_schemavalue"]); // it has been removed from coding side of Quotation list 
                            }
                            if (Convert.ToString(Session["PRMWS_SaveMode"]) == "A")
                            {
                                dt_PLQuote.Focus();
                                txt_PLQuoteNo.Enabled = false;
                                txt_PLQuoteNo.Text = "Auto";
                            }
                            else if (Convert.ToString(Session["PRMWS_SaveMode"]) == "M")
                            {
                        ...
                        Session["PRMWS_ActionType"] = "Add";
                        //ASPxButton2.Enabled = false;
                        Session["PRMWS_TaxDetails"] = null;
                        CreateDataTaxTable();   //kaushik  24-8-2017
                        lblHeadTitle.Text = "Add Purchase Return  Manual";
        ...
        public void BindAllControlDataOnPageLoad(string userbranch)
        {
            /// GetEditablePermission();
            SetFinYearCurrentDate();
            GetFinacialYearBasedQouteDate();
        ...
        {
            DataTable udfCount = oDBEngine.GetDataTable("select 1 from tbl_master_remarksCategory rc where cat_applicablefor='PRM'  and ( exists (select * from tbl_master_udfGroup where id=rc.cat_group_id and grp_isVisible=1) or rc.cat_group_id=0)");
        ...
        public DataTable GetInvoiceWarehouse(string strInvoiceList)
        {
            try
            {
                ...
                Session["LoopPRMWSWarehouse"] = Convert.ToString(Convert.ToInt32(strNewVal) + 1);
                return tempdt;
            }
            catch
            {
        ...
        protected void BindLookUp(string Customer, string SalesReturnDate, string branchId)
        {
            ...
            string strReturnID = Convert.ToString(Session["PRMWS_ReturnID"]);
            string RequestNo = Convert.ToString(cmbRequest.Value);
            ...
            Session["PRMWS_ComponentData"] = ComponentTable;
        ...
        protected void acbpCrpUdf_Callback(object source, DevExpress.Web.CallbackEventArgsBase e)
        {
            ...
            {
                if (reCat.isAllMandetoryDone((DataTable)Session["UdfDataOnAdd"], "PRM") == false)
                {
        ...
        public bool CheckrefCreditNoteNo(string vendorid, string RefCreditNoteno)
        {
            ...
            if (vendorid != "" && Convert.ToString(RefCreditNoteno).Trim() != "")
            {
                ...
                else if (hdnADDEditMode.Value == "Edit")
                {
                    ...
                    PurchaseReturnID = Convert.ToString(Session["PRMWS_ReturnID"]);
                }
        ...
        {
            Boolean inUse = false;
            DataTable taxTable = (DataTable)Session["PRMWS_FinalTaxRecord"];
            ...
            Session["PRMWS_FinalTaxRecord"] = taxTable;
        ...
        public IEnumerable GetInvoiceInfo(DataTable SalesInvoicedt1, string Order_Id)
        {
            ...
            for (int i = 0; i < SalesInvoicedt1.Rows.Count; i++)
            {
                ...
                if (eachPurchaseChallan.Length == 1)
                {
                    ...
                    {
                        Session["PRMWS_TaxDetails"] = tempMainTax;

                    }

                }
                else { Session["PRMWS_TaxDetails"] = null; }
                ...
                //    Session["PRMWS_WarehouseData"] = tempWarehouse;
        ...
        public IEnumerable GetQuotation(DataTable Quotationdt)
        {
            ...
            if (Quotationdt != null && Quotationdt.Rows.Count > 0)
            {
                for (int i = 0; i < Quotationdt.Rows.Count; i++)
                {
                    ...
                    Quotations.PurchaseInvoiceDetail_ComponentDetailID = "0";
        ...
        public DataSet GetQuotationData()
        {
            ...
            proc.AddVarcharPara("@QuotationID", 500, Convert.ToString(Session["PRMWS_ReturnID"]));
            ds = proc.GetDataSet();
            return ds;
        }
        ...
        protected void grid_BatchUpdate(object sender, DevExpress.Web.Data.ASPxDataBatchUpdateEventArgs e)
        {
            ...
            if (Session["PRMWS_QuotationDetails"] != null)
            {
                Quotationdt = (DataTable)Session["PRMWS_QuotationDetails"];
            }
            else
            {
            ...
            foreach (var args in e.InsertValues)
            {
                ...
                if (ProductDetails != "" && ProductDetails != "0")
                {
                    ...
                    string PurchaseInvoiceDetail_ComponentDetailID = "0";
                    ...
                    Quotationdt.Rows.Add(SrlNo, "0", ProductDetails, Description, Quantity, UOM, Warehouse, StockQuantity, StockUOM, SalePrice, Discount, Amount, TaxAmount, TotalAmount, "I", ProductName, ComponentID, PurchaseInvoiceDetail_ComponentDetailID, ComponentNumber, TotalQty, BalanceQty, IsComponentProduct, ProductDisID, Product);
                }
            }
            ...
            Session["PRMWS_QuotationDetails"] = Quotationdt;
            ...
            if (IsDeleteFrom != "D")
            {
                ...
                string ActionType = Convert.ToString(Session["PRMWS_ActionType"]);
                string MainInvoiceID = Convert.ToString(Session["PRMWS_ReturnID"]);
                ...
                if (Session["PRMWS_FinalTaxRecord"] != null)
                {
                    TaxDetailTable = (DataTable)Session["PRMWS_FinalTaxRecord"];
                }
                ...
                //kaushik 29_6_2017
                if (Session["PRMWS_WarehouseData"] != null)
                {
                    DataTable Warehousedt = (DataTable)Session["PRMWS_WarehouseData"];
                ...
                if (Session["PRMWS_TaxDetails"] != null)
                {
                    TaxDetailsdt = (DataTable)Session["PRMWS_TaxDetails"];
                }
                else
                {
                ...
                ////DataTable tempBillAddress = new DataTable();
                ////if (Session["PRMWS_QuotationAddressDtl"] != null)
                ////{
                ////    tempBillAddress = (DataTable)Session["PRMWS_QuotationAddressDtl"];
                ////}
                ////else
                ////{
               ...
               .Select(g => g.Key);
                ...
                if (validate == "outrange" || validate == "duplicate" || validate == "checkWarehouse" || validate == "nullAmount" || validate == "nullQuantity" || validate == "transporteMandatory")
                {
                ...
                else
                {
                    ...
                    #region To Show By Default Cursor after SAVE AND NEW
                    if (Convert.ToString(Session["PRMWS_ActionType"]) == "Add") // session has been removed from quotation list page working good
                    {
                        string[] schemaid = new string[] { };
                        string schemavalue = ddl_numberingScheme.SelectedValue;
                        Session["PRMWS_schemavalue"] = schemavalue;        // session has been removed from quotation list page working good
                        ...
                        if (hdnRefreshType.Value == "N")
                        {
                            if (schematype == "1")
                            {
                                Session["PRMWS_SaveMode"] = "A";
                            }
                            else
                            {
                                Session["PRMWS_SaveMode"] = "M";
                            }
                        }
                    }
                    ...
                    TaxDetailTable = gstTaxDetails.SetTaxTableDataWithProductSerialForPurchaseRoundOff(ref tempQuotation, "SrlNo", "ProductID", "Amount", "TaxAmount", "TotalAmount", TaxDetailTable, "P", dt_PLQuote.Date.ToString("yyyy-MM-dd"), strBranch, ShippingState, TaxType, Convert.ToString(CustomerComboBox.Value));
                    ...
                    if (udfTable != null)
                        Session["UdfDataOnAdd"] = reCat.insertRemarksCategoryAddMode("PRM", "PurchaseReturnManual" + Convert.ToString(strQuoteID), udfTable, Convert.ToString(Session["userid"]));
        ...
        public void GetQuantityBaseOnProduct(string strProductSrlNo, ref decimal WarehouseQty)
        {
            ...
            if (Session["PRMWS_WarehouseData"] != null)
            {
                Warehousedt = (DataTable)Session["PRMWS_WarehouseData"];
        ...
        protected void grid_DataBinding(object sender, EventArgs e)
        {
            ...
            if (Session["PRMWS_QuotationDetails"] != null)
            {
                DataTable Quotationdt = (DataTable)Session["PRMWS_QuotationDetails"];
        ...
        protected void grid_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            else if (strSplitCommand == "RemoveDisplay")
            {
                ...
                if (Session["PRMWS_QuotationDetails"] != null)
                {
                    purchaseReturndt = (DataTable)Session["PRMWS_QuotationDetails"];
                }
                ...
                Session["PRMWS_QuotationDetails"] = purchaseReturndt;
                grid.DataBind();
            ...
            else if (strSplitCommand == "BindGridOnQuotation")
            {
                ...
                if (Quote_Nos != "$")
                {
                    ...
                    if (RequestNo != "")
                    {
                        dt_QuotationDetails = objPurchaseReturnBL.GetIndentDetailsForPSGridBindByRequest(InvoiceDetails_Id, "", Product_id1, companyId, fin_year, RequestNo);
                    ...
                    else
                    {
                        ...
                        if (!string.IsNullOrEmpty(IdKey))
                        {
                            if (IdKey != "ADD")
                            {
                                dt_QuotationDetails = objPurchaseReturnBL.GetIndentDetailsForPOGridBind(QuoComponent1, IdKey, Product_id1, companyId, fin_year);
                            }
                            else
                            {
                                dt_QuotationDetails = objPurchaseReturnBL.GetIndentDetailsForPOGridBind(QuoComponent1, IdKey, Product_id1, companyId, fin_year);
                ...
                //Session["PRMWS_QuotationAddressDtl"] = GetComponentEditedAddressData(InvoiceDetails_Id, "PC");
                //if (Session["PRMWS_QuotationAddressDtl"] != null)
                //{
                //    DataTable dt = (DataTable)Session["PRMWS_QuotationAddressDtl"];
                //    if (dt != null && dt.Rows.Count > 0)
                //    {
                //        if (dt.Rows.Count == 2)
                //        {
                                    ...
                                    ref int strIsComplete, ref int strInvoiceID, string ReasonforReturn, string refCreditNoteNo, string refCreditNoteDate)
        {
            try
            {
                ...
                cmd.Parameters.AddWithValue("@ComponentType", "PRM");
                ...
                if (Session["PRMWSwarehousedetailstemp"] != null)
                {
                    DataTable temtable = new DataTable();
                    DataTable Warehousedtssss = (DataTable)Session["PRMWSwarehousedetailstemp"];
        ...
        public DataTable GetTaxData(string quoteDate)
        {
            ...
            proc.AddVarcharPara("@PurchaseReturnID", 500, Convert.ToString(Session["PRMWS_ReturnID"]));
            proc.AddVarcharPara("@FinYear", 500, Convert.ToString(Session["LastFinYear"]));
            //proc.AddVarcharPara("@branchId", 500, Convert.ToString(Session["userbranchID"]));
        ...
        protected void gridTax_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            if (strSplitCommand == "Display")
            {
                ...
                if (Session["PRMWS_TaxDetails"] == null)
                {
                    Session["PRMWS_TaxDetails"] = GetTaxData(dt_PLQuote.Date.ToString("yyyy-MM-dd"));
                }
            ...
            else if (strSplitCommand == "SaveGst")
            {
                ...
                else
                {
                    ...
                    Session["PRMWS_TaxDetails"] = TaxDetailsdt;
                }
            }
        }
        ...
        protected void gridTax_DataBinding(object sender, EventArgs e)
        {
            if (Session["PRMWS_TaxDetails"] != null)
            {
                DataTable TaxDetailsdt = (DataTable)Session["PRMWS_TaxDetails"];
        ...
        public DataTable GetWarehouseData()
        {
            DataTable dt = new DataTable();
            ProcedureExecute proc = new ProcedureExecute("prc_PurchaseReturn_Details");
            proc.AddVarcharPara("@Action", 500, "GetWareHouseDtlPurchaseReturnManualByProductID");
            proc.AddVarcharPara("@Order_Id", 500, Convert.ToString(Session["PRMWS_ReturnID"]));
            proc.AddVarcharPara("@Product_Id", 500, Convert.ToString(hdfProductID.Value));
            proc.AddVarcharPara("@FinYear", 500, Convert.ToString(Session["LastFinYear"]));
        ...
        public DataTable GetBatchData(string WarehouseID)
        {
            DataTable dt = new DataTable();
            ProcedureExecute proc = new ProcedureExecute("prc_PurchaseReturn_Details");
            proc.AddVarcharPara("@Action", 500, "GetBatchByProductIDPurchaseReturnManualWarehouse");
            proc.AddVarcharPara("@Order_Id", 500, Convert.ToString(Session["PRMWS_ReturnID"]));
            proc.AddVarcharPara("@Product_Id", 500, Convert.ToString(hdfProductID.Value));
            proc.AddVarcharPara("@WarehouseID", 500, WarehouseID);
            proc.AddVarcharPara("@FinYear", 500, Convert.ToString(Session["LastFinYear"]));
        ...
        public DataTable GetSerialata(string WarehouseID, string BatchID, string BranchSerialNumber)
        {
            DataTable dt = new DataTable();
            ProcedureExecute proc = new ProcedureExecute("prc_PurchaseReturn_Details");
            proc.AddVarcharPara("@Action", 500, "GetSerialByPRMProductIDWarehouseBatch");
        ...
        //    proc.AddVarcharPara("@PurchaseReturnID", 20, Convert.ToString(Session["PRMWS_ReturnID"]));
        //    proc.AddVarcharPara("@PID", 500, Convert.ToString(hdfProductID.Value));
        //    proc.AddVarcharPara("@BatchID", 500, BatchID);
        //    proc.AddVarcharPara("@WarehouseID", 500, WarehouseID);
        //    proc.AddVarcharPara("@Stock_BranchSerialNumber", 50, BranchSerialNumber);
        ...
        public DataTable GetQuotationWarehouseData()
        {
            try
            {
                DataTable dt = new DataTable();
                ProcedureExecute proc = new ProcedureExecute("prc_PurchaseReturn_Details");
                proc.AddVarcharPara("@Action", 500, "PurchaseReturnManualWarehouse");
                proc.AddVarcharPara("@PurchaseReturnID", 500, Convert.ToString(Session["PRMWS_ReturnID"]));
                dt = proc.GetTable();

                if (Session["PRMWS_QuotationDetails"] != null)
                {
                    DataTable SalesInvoicedt1 = (DataTable)Session["PRMWS_QuotationDetails"];
        ...
        public DataTable GetSerialataNew(string WarehouseID, string BatchID)
        {
            DataTable dt = new DataTable();
            ProcedureExecute proc = new ProcedureExecute("prc_PurchaseReturn_Details");
            proc.AddVarcharPara("@Action", 500, "GetSerialByProductIDPurchaseReturnManualWarehouseBatch");
            //proc.AddVarcharPara("@Action", 500, "GetSerialOnFIFOBasis");
            proc.AddVarcharPara("@Order_Id", 500, Convert.ToString(Session["PRMWS_ReturnID"]));
            proc.AddVarcharPara("@Product_Id", 500, Convert.ToString(hdfProductID.Value));
            proc.AddVarcharPara("@BatchID", 500, BatchID);
        ...
        protected void GrdWarehouse_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            {
                int loopId = Convert.ToInt32(Session["LoopPRMWSWarehouse"]);
                ...
                Session["PRMWS_WarehouseData"] = Warehousedt;
                changeGridOrder();

                GrdWarehouse.DataSource = Warehousedt.DefaultView;
                GrdWarehouse.DataBind();

                Session["LoopPRMWSWarehouse"] = loopId + 1;
        ...
        protected void taxUpdatePanel_Callback(object source, DevExpress.Web.CallbackEventArgsBase e)
        {
            ...
            {
                DataTable MainTaxDataTable = (DataTable)Session["PRMWS_FinalTaxRecord"];
                ...
                Session["PRMWS_FinalTaxRecord"] = MainTaxDataTable;
                GetStock(Convert.ToString(performpara.Split('~')[1]));
                // DeleteWarehouse(Convert.ToString(performpara.Split('~')[1]));
                DataTable taxDetails = (DataTable)Session["PRMWS_TaxDetails"];
                if (taxDetails != null)
                {
                    ...
                    Session["PRMWS_TaxDetails"] = taxDetails;
                }
            }
        ...
        public void CreateDataTaxTable()
        {
            ...
            Session["PRMWS_FinalTaxRecord"] = TaxRecord;
        }
        ...
        protected void cgridTax_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            {
                DataTable TaxRecord = (DataTable)Session["PRMWS_FinalTaxRecord"];
            ...
            else
            {
                ...
                DataTable MainTaxDataTable = (DataTable)Session["PRMWS_FinalTaxRecord"];
                DataTable databaseReturnTable = (DataTable)Session["PRMWS_QuotationTaxDetails"];
                ...
                //kaushik 10-7-2017  new added
                proc.AddVarcharPara("@ProductsID", 20, Convert.ToString(setCurrentProdCode.Value));
        ...
        public void DeleteTaxDetails(string SrlNo)
        {
            ...
            if (Session["PRMWS_FinalTaxRecord"] != null)
            {
                ...
                Session["PRMWS_FinalTaxRecord"] = TaxDetailTable;
            }
        }
        ...
        public void GetAllDropDownDetailForSalesQuotation(string userbranch)
        {
            ...
            SlaesActivitiesBL objSlaesActivitiesBL = new SlaesActivitiesBL();
            DataTable Schemadt = objSlaesActivitiesBL.GetNumberingSchema(strCompanyID, userbranchHierarchy, strYear, "54", "Y");
            if (Schemadt != null && Schemadt.Rows.Count > 0)
            {
                ddl_numberingScheme.DataTextField = "SchemaName";
                ddl_numberingScheme.DataValueField = "Id";
        ...
        //{
        //    if (Session["PRMWS_CustomerDetail"] == null)
        //    {
        ...
        //            Session["PRMWS_CustomerDetail"] = dtCustomer;
        //        }
        //    }
        //    else
        //    {
        //        lookup_Customer.DataSource = (DataTable)Session["PRMWS_CustomerDetail"];
        //        lookup_Customer.DataBind();
        //    }
        ...
        public static bool CheckUniqueCode(string ReturnNo)
        {
            ...
            try
            {
                ...
                flag = objShortNameChecking.CheckUnique(ReturnNo, "0", "PurchaseReturnManual");
            }
            catch (Exception ex)
            {
        ...
        //{
        //    if (Session["PRMWSwarehousedetailstempUpdate"] != null)
        //    {
        //        DataTable dt = new DataTable();
        //        DataTable Warehousedtups = (DataTable)Session["PRMWSwarehousedetailstempUpdate"];
        ...
        protected void ComponentQuotation_Callback(object source, DevExpress.Web.CallbackEventArgsBase e)
        {
            ...
            if (e.Parameter.Split('~')[0] == "BindComponentGrid")
            {
                ...
                string strPurchaseReturnID = Convert.ToString(Session["PRMWS_ReturnID"]);
                ...
                if (RequestNo != "")
                {
                    ...
                    if (StockOutTable != null && StockOutTable.Rows.Count > 0)
                    {
                        ...
                        stockoutbranchId = Convert.ToString(StockOutTable.Rows[0]["BR_BranchIdFor"]);
        ...
        {
            if (Session["PRMWS_ComponentData"] != null)
            {
                lookup_quotation.DataSource = (DataTable)Session["PRMWS_ComponentData"];
            }
        }
        ...
        public bool BindSessionByDatatable(DataTable dt)
        {
            ...
            Session["PRMWS_QuotationDetails"] = SlsOreturnDT;
        ...
        public static bool CheckUniqueRefCreditNoteNo(string vendorid, string creditNoteno, string mode, string pID)
        {
            ...
            PurchaseReturnBL obj = new PurchaseReturnBL();
            // strPurchaseReturnId = Convert.ToString(Session["PRMWS_ReturnID"]);
        ...
        protected void ASPxComboBox_OnItemsRequestedByFilterCondition_SQL(object source, ListEditItemsRequestedByFilterConditionEventArgs e)
        {
            ...
            {
                ASPxComboBox comboBox = (ASPxComboBox)source;
                VendorDataSource.SelectCommand = @"select cnt_internalid,shortname,Name,Type from(select cnt_internalid ,shortname , Name ,Type , row_number()over(order by t.Name) as [rn]  from v_PBVendorDetail  as t where (([shortname] + ' ' + [Name] ) LIKE @filter)) as st where st.[rn] between @startIndex and @endIndex  AND cnt_internalId in(Select Ven_InternalId from tbl_master_VendorBranch_map  Where branch_id in('" + Convert.ToString(ddl_Branch.SelectedItem.Value) + "','0'))";

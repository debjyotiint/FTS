...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        <dxe:ASPxGridView ID="Grid_PurchaseChallan" runat="server" AutoGenerateColumns="False" KeyFieldName="PurchaseChallan_Id" OnCustomCallback="Grid_PurchaseChallan_CustomCallback"
            ClientInstanceName="CgvPurchaseOrder" Width="100%" OnDataBinding="Grid_PurchaseChallan_DataBinding" Settings-HorizontalScrollBarMode="Visible">
            ...
            <Columns>
                ...
                <dxe:GridViewDataTextColumn VisibleIndex="1" Caption="GRN No." FieldName="PurchaseChallan_Number" Width="180px">
                    <CellStyle Wrap="False" CssClass="gridcellleft"></CellStyle>
                </dxe:GridViewDataTextColumn>
                ...
                <dxe:GridViewDataTextColumn VisibleIndex="4" Caption="Party Invoice No." FieldName="PartyInvoiceNo" CellStyle-Wrap="True">
                    <CellStyle Wrap="False" CssClass="gridcellleft"></CellStyle>
                </dxe:GridViewDataTextColumn>
                <dxe:GridViewDataTextColumn VisibleIndex="5" Caption="Party Invoice Date" FieldName="PartyInvoiceDate" CellStyle-Wrap="True">
                    <CellStyle Wrap="False" CssClass="gridcellleft"></CellStyle>
                </dxe:GridViewDataTextColumn>

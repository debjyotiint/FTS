<%@ Page Title="" Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" CodeBehind="PurchaseChallanDocument.aspx.cs" Inherits="ERP.OMS.Management.Activities.PurchaseChallanDocument" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function disp_prompt(name) {
            ...
            if (name == "tab0") {
                //alert(name);
                document.location.href = "PurchaseChallan.aspx?key=<%=Session["key_QutId"]%>";
            }
            if (name == "tab1") {
                //alert(name);
             ...
             <%--   PopupOpen('<%=Session["key_QutId"]%>')--%>
                ...
                document.location.href = "PurchaseChallan.aspx?key=<%=Session["key_QutId"]%>&tab=billship";
            }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="panel-heading">
        ...
        <div class="panel-title">
            ...
            <div class="crossBtn"><a href="/OMS/management/Activities/PurchaseChallanList.aspx"><i class="fa fa-times"></i></a></div>

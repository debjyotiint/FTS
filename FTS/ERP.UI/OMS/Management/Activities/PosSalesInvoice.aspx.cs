...
{
    public partial class PosSalesInvoice : VSPage  
    {
        ...
        protected void grid_BatchUpdate(object sender, DevExpress.Web.Data.ASPxDataBatchUpdateEventArgs e)
        {
            ...
            if (IsDeleteFrom != "D" && IsDeleteFrom != "C")
            {
               ...
               .Select(g => g.Key);
                ...
                if (Challanvalidate == "outrange" || Challanvalidate == "duplicate" || validate == "outrange" || validate == "duplicate" || validate == "checkWarehouse" || validate == "duplicateProduct" || validate == "nullAmount" || validate == "nullQuantity" || validate == "minSalePriceMust" || validate == "MRPLess" || validate == "InValidReceipt" || validate == "MoreThanStock" || validate == "BillingSHippingRequired")
                {
            ...
            if (strSplitCommand == "Display")
            {
                ...
                if (Session["SI_TaxDetails" + Convert.ToString(uniqueId.Value)] != null)
                {
                    ...
                    string ShippingState = "";
                            ...
                            ShippingState = lblShippingStateText.Value;// lblShippingState.Text;

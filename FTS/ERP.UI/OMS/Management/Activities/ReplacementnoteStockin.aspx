<%@ Page Title="" Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" EnableEventValidation="false"
    CodeBehind="ReplacementnoteStockin.aspx.cs" Inherits="ERP.OMS.Management.Activities.ReplacementnoteStockin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="ApprovalCross" runat="server" class="crossBtn"><a href="ReplacementstocksList.aspx"><i class="fa fa-times"></i></a></div>
    <div class="form_main">

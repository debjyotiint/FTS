    ...
    public partial class OldUnitReceivedFromServiceCenter : ERP.OMS.ViewState_class.VSPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Request.QueryString["key"] != null && Request.QueryString["key"] != "ADD")
            {
                ...
                DataTable DT = objEngine.GetDataTable("tbl_trans_SalesInvoice", " Invoice_Number ", " Invoice_Id = " + Convert.ToInt32(strOrderId1) + "");
        ...
        public void GetAllDropDownDetailForSalesOrder(string UserBranch)
        {
            ...
            DataTable CNSchemadt = objSlaesActivitiesBL.GetNumberingSchema(strCompanyID, userbranchHierarchy, FinYear, "25", "Y");

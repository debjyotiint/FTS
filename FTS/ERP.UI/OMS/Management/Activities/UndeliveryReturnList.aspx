...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="GridViewArea">
        <dxe:ASPxGridView ID="GrdSalesReturn" ClientInstanceName="cGrdSalesReturn" runat="server" KeyFieldName="SrlNo"
           ...
           Setting-HorizontalScrollBarMode="Auto"  DataSourceID="EntityServerModeDataSource">
            <Columns>
                <dxe:GridViewDataTextColumn Caption="Undelivery Return Number" FieldName="SalesReturnNo"
                ...
                <dxe:GridViewDataTextColumn VisibleIndex="7" Caption="Assigned To Branch" FieldName="branchToBranch" Width="130px" Visible="false">
                    <CellStyle Wrap="False" CssClass="gridcellleft"></CellStyle>
                </dxe:GridViewDataTextColumn>

<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/OMS/MasterPage/ERP.Master" 
    Inherits="ERP.OMS.Management.Activities.management_Activities_sales_Sconveyence" Codebehind="sales_Sconveyence.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        <div>
            <table class="TableMain100">
                ...
                <tr>
                    <td>
                        <dxe:ASPxPageControl ID="ASPxPageControl1" runat="server" ActiveTabIndex="1" ClientInstanceName="page" Font-Size="12px">
                            <tabpages>
                    ...
                    <dxe:TabPage Text="Conveyence" Name="Conveyence">
                        <ContentCollection>
                            <dxe:ContentControl runat="server">
                                <dxe:ASPxGridView ID="GridConveyence" runat="server" KeyFieldName="expnd_internalId" ClientInstanceName="grid" DataSourceID="SqlConveyence"  Width="100%" AutoGenerateColumns="False" OnCellEditorInitialize="GridConveyence_CellEditorInitialize" OnInitNewRow="GridConveyence_InitNewRow">
                                    <Columns>
                                        ...
                                        <dxe:GridViewDataTextColumn Caption="Amount" FieldName="expnd_travExpence" VisibleIndex="6">
                                        ...
                                        <dxe:GridViewDataTextColumn Caption="Start Journey" Visible="false" FieldName="expnd_dtJourney1" VisibleIndex="4">
                                            <EditFormSettings Visible="False" />
                                            <CellStyle CssClass="gridcellleft">
                                            </CellStyle>
                                        </dxe:GridViewDataTextColumn>
                                        <dxe:GridViewDataDateColumn Caption="Start Date" FieldName="expnd_dtJourney"
                                        ...
                                        <dxe:GridViewDataTextColumn Caption="Return Journey" FieldName="expnd_dtRetJourney1" Visible="false" VisibleIndex="5">
                                            <EditFormSettings Visible="False" />
                                            <CellStyle CssClass="gridcellleft">
                                            </CellStyle>
                                        </dxe:GridViewDataTextColumn>

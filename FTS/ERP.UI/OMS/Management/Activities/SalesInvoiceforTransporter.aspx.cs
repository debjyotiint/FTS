...
{
    public partial class SalesInvoiceforTransporter : ERP.OMS.ViewState_class.VSPage// System.Web.UI.Page
    {
        ...
        #region Sam Section for Vendor Population Section start on 19092017
        protected void lookup_Customer_DataBinding(object sender, EventArgs e)
        {
            lookup_Customer.DataSource = (DataTable)Session["VendorList_SI"];
        }
        ...
        #endregion Sam Section for Vendor Population Section start on 19092017
            ...
            if (!IsPostBack)
            {
                ...
                if (Request.QueryString["key"] != null)
                {
                    if (Convert.ToString(Request.QueryString["key"]) != "ADD")
                    {
                        ...
                        lblHeadTitle.Text = "Modify Sales Invoice for Transporter";
                        ...
                        {
                            lblHeadTitle.Text = "View Sales Invoice for Transporter";
                    ...
                    else
                    {
                        ...
                        Session["SI_TaxDetails"] = null;
                        CreateDataTaxTable();
                        lblHeadTitle.Text = "Add Sales Invoice for Transporter";
        ...
        public void SetInvoiceDetails(string strInvoiceId)
        {
            ...
            if (QuotationEditdt != null && QuotationEditdt.Rows.Count > 0)
            {
                ...
                //if (Session["VendorList_SI"] == null)
                //{
                Session["VendorList_SI"] = vendordt;
                //}
            ...
            if (IsDeleteFrom != "D" && IsDeleteFrom != "C")
            {
               ...
               .Select(g => g.Key);
                ...
                if (validate == "outrange" || validate == "duplicate" || validate == "checkWarehouse" || validate == "duplicateProduct" || validate == "nullAmount" || validate == "nullQuantity" || validate == "transporteMandatory" || validate == "TCMandatory" || validate == "minSalePriceMust" || validate == "MRPLess"
                    || validate == "DueDateLess" || validate == "BillingShippingNotLoaded")
                {
                                    ...
                                    ref int strIsComplete, ref int strInvoiceID)
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("prc_CRMSalesInvoice", con);

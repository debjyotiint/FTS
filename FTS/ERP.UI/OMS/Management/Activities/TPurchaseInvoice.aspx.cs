...
namespace ERP.OMS.Management.Activities
{
    public partial class TPurchaseInvoice : VSPage //: System.Web.UI.Page
    {
        ...
        protected void grid_BatchUpdate(object sender, DevExpress.Web.Data.ASPxDataBatchUpdateEventArgs e)
        {
            ...
            if (IsDeleteFrom != "D" && IsCompFrom != "C")
            {
               ...
               .Where(gr => gr.Count() > 1)
                ...
                if (validate == "outrange" || validate == "nullQuantity" || validate == "duplicateProduct" || validate == "duplicate" || validate == "transporteMandatory" || validate == "TCMandatory")
                {
                ...
                else
                {
                    ...
                    if (!chk_reversemechenism.Checked)
                    {
                        ...
                        TaxDetailTable = gstTaxDetails.SetTaxTableDataWithProductSerialForPurchaseRoundOff(ref tempPurchaseInvoice, "SrlNo", "ProductID", "Amount", "TaxAmount", "TotalAmount", TaxDetailTable, "P", dt_PLQuote.Date.ToString("yyyy-MM-dd"), strBranch, ShippingState, incluexclutype, Convert.ToString(lookup_Customer.Value));
                    }
                    else
                    {
                    ...
                    if (ModifyQuatation(MainPurchaseInvoiceID, strSchemeType, UniquePurchaseInvoice, strQuoteDate, IndentRequisitionDate,
                        ...
                        inventorytype, productcharges, partyInvNo, partyInvDate, ReverseTaxtable) == true)
                    {
        ...
        public bool ModifyQuatation(string PurchaseInvoiceID, string strSchemeType, string strQuoteNo, string strQuoteDate, string strQuoteExpiry, string strCustomer, string strContactName,
            ...
            string partyInvNo, string partyInvDate, DataTable ReverseTaxtable)
        {
            try
            {
        ...
        //    {
        //        DataTable TaxRecord = (DataTable)Session["TPBNonInvProChg"];
        //        int slNo = Convert.ToInt32(HdSerialNo.Value);
        //        //For GST/CST/VAT
        //        if (cmbGstCstVat.Value != null)
        //        {

...
{
    public partial class IssueToServiceCenterList : ERP.OMS.ViewState_class.VSPage
    {
        ...
        {
            rights = BusinessLogicLayer.CommonBLS.CommonBL.GetUserRightSession("/management/Activities/IssueToServiceCenterList.aspx");
            if (!IsPostBack)
            {
        ...
        protected void EntityServerModeDataSource_Selecting(object sender, DevExpress.Data.Linq.LinqServerModeDataSourceSelectEventArgs e)
        {
            ...
            var q = from d in dc.V_IssueToServiceCenterLists
                    where d.Service_Company == lastCompany &&
                          branchidlist.Contains(Convert.ToInt32(d.Service_TransferFormBranch))
                    orderby d.Service_Date descending
                    select d;
            e.QueryableSource = q;
        }
        public void FillGrid()
        {
            ...
            if (HttpContext.Current.Session["LastCompany"] != null)
            {
                ...
                if (HttpContext.Current.Session["userbranchHierarchy"] != null)
                {
                    ...
                    dtdata = objCRMSalesOrderDtlBL.GetIssueToServiceCenterListGridData(userbranch, lastCompany);
                }
            }
        ...
        public static string GetChallanIdIsExistInSalesInvoice(string keyValue)
        {
            ...
            int ispermission = 0;
            ispermission = objCRMSalesOrderDtlBL.GetIdFromSalesInvoiceExistsInOrder(keyValue);
        ...
        protected void GrdOrder_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            if (WhichCall == "Delete")
            {
                ...
                deletecnt = objCRMSalesOrderDtlBL.DeleteIssueToService(WhichType,Company,Finyear);
                if (deletecnt == 1)
                {
                    //FillGrid();

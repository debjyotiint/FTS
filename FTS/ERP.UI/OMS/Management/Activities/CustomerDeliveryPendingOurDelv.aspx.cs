...
{
    public partial class CustomerDeliveryPendingOurDelv :ERP.OMS.ViewState_class.VSPage //System.Web.UI.Page 
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Request.QueryString.AllKeys.Contains("Flag"))
            {
                dtInvoiceData = GetInvoiceDateData();
                hdnCustomerId.Value = Convert.ToString(dtInvoiceData.Rows[0]["Customer_Id"]);
            }
            ...
            if (!string.IsNullOrEmpty(Request.QueryString["DlvTyeId"]) && !Request.QueryString.AllKeys.Contains("Flag"))
            {
            ...
            if (!IsPostBack)
            {
                ...
                GetAllDropDownDetailForSalesOrder(userbranch);
                Session["CDPDetails"] = null;
            }

            if (!IsPostBack)
            {
                //Subhabrata
                if (!string.IsNullOrEmpty(Request.QueryString["Flag"]) && hddnIsODSDFirstTime.Value == "0")
                {
                    //Tax button hide
                    ...
                    BindSalesChallanDirect(Convert.ToString(Request.QueryString["key"]), Convert.ToString(hdnCustomerId.Value));

                    //hdnCustomerId.Value = Convert.ToString(Request.QueryString["CustID"]);

                    //DataTable dt_Date = GetInvoiceDateData();
                    DataTable dt_Date = dtInvoiceData.Copy();
                    ...
                    if (!string.IsNullOrEmpty(Convert.ToString(dt_InvoiceHeader.Rows[0]["salesmancnt_id"])))
                    {
                        PopulateSalesManAgent(Convert.ToString(dt_InvoiceHeader.Rows[0]["salesmancnt_id"]));
                        ddl_SalesAgent.SelectedValue = Convert.ToString(dt_InvoiceHeader.Rows[0]["salesmancnt_id"]);
                    ...
                    PopulateBranchOnOD(strBranchID);
            ...
            if (!IsPostBack)
            {
                ...
                //kaushik 24-2-2017
                Session["CDPBillingAddressLookup"] = null;
                Session["CDPShippingAddressLookup"] = null;
                Session["CDPChallanAddressDtl"] = null;
                //kaushik 24-2-2017
                Session["CDPCustomerDetail"] = null;
                Session["CDP_WarehouseData"] = null;
                Session["CDP_LoopWarehouse"] = 1;
                Session["CDPTaxDetails"] = null;
                Session["WarehouseBindQtyCDP"] = null;
                //Purpose : Binding Batch Edit Grid
                //Name : SuBHABRATA 
                // Dated : 21-01-2017
                string strOrderId = "";
                grid.AddNewRow();
                if (Request.QueryString["key"] != null && string.IsNullOrEmpty(Request.QueryString["Flag"]))
                {
                    if (Convert.ToString(Request.QueryString["key"]) != "ADD")
                    {
                        ...
                        Session["ChallanIDCDP"] = strOrderId;
                        Session["ActionType"] = "Edit";
                        Session["CDP_WarehouseData"] = GetChallanWarehouseData();
                        ...
                        Session["CDPTaxDetails"] = GetTaxDataWithGST(GetTaxData(dt_PLSales.Date.ToString("yyyy-MM-dd")));
                        ...
                        {
                            Session["CDPFinalTaxRecord"] = quotetable;
                        }

                        #endregion Debjyoti Get Tax Details in Edit Mode

                        Session["CDPDetails"] = GetOrderData().Tables[0];
            ...
            if (Request.QueryString["key"] != null && Request.QueryString["key"] != "ADD" && string.IsNullOrEmpty(Request.QueryString["Flag"]))
            {
                //SetOrderDetails();
                ...
                Session["ChallanIDCDP"] = strOrderId1;
        ...
        public void BindSalesChallanDirect(string Bill_No, string Cust_Id)
        {
            ...
            DataTable InvoiceInfo = dtInvoiceData.Copy();
            ...
            {
                txt_Customer.Text = Convert.ToString(InvoiceInfo.Rows[0]["Customer"]);
                //txt_Customer.ForeColor = System.Drawing.Color.White;
                //txt_Customer.BackColor = System.Drawing.Color.Blue;



                txtInvoiceNo.Text = Convert.ToString(InvoiceInfo.Rows[0]["Invoice_Number"]);
                //txtInvoiceNo.ForeColor = System.Drawing.Color.White;
                //txtInvoiceNo.BackColor = System.Drawing.Color.Blue;

                txt_Customer.Enabled = false;
                txtInvoiceNo.Enabled = false;


                hdfLookupCustomer.Value=Convert.ToString(InvoiceInfo.Rows[0]["Customer_Id"]);
                hddnPosBillId.Value = Convert.ToString(InvoiceInfo.Rows[0]["Invoice_Id"]);
            ...
            {
                dt = Convert.ToString(dtInvoiceData.Rows[0]["Invoice_Dt"]);
            }
        ...
        public IEnumerable GetSalesOrderLinesDirect(string Bill_No)
        {
            ...
            if (tempProductTax != null)
            {
                ...
                Session["CDPFinalTaxRecord"] = tempProductTax;
            }
            else { Session["CDPFinalTaxRecord"] = null; }
        ...
        protected void PopulateSalesManAgent(string InternalId)
        {
            string ContactPerson = "";
            DataTable dtContactPerson = new DataTable();
            SlaesActivitiesBL objSlaesActivitiesBL = new SlaesActivitiesBL();
            dtContactPerson = objSlaesActivitiesBL.PopulateSalesManAgent(InternalId);
            if (dtContactPerson != null && dtContactPerson.Rows.Count > 0)
            {
                ddl_SalesAgent.DataTextField = "Name";
                ddl_SalesAgent.DataValueField = "cnt_id";
                ddl_SalesAgent.DataSource = dtContactPerson;
                ddl_SalesAgent.DataBind();
        ...
        protected void PopulateBranchOnOD(string BranchId)
        {
            string ContactPerson = "";
            DataTable dtBranch = new DataTable();
            SlaesActivitiesBL objSlaesActivitiesBL = new SlaesActivitiesBL();
            dtBranch = objSlaesActivitiesBL.PopulateBranchOnOD(BranchId);
        ...
        public DataTable GetTaxData(string quoteDate)
        {
            ...
            proc.AddVarcharPara("@Challan_Id", 500, Convert.ToString(Session["ChallanIDCDP"]) == "ADD" ? "" : Convert.ToString(Session["ChallanIDCDP"]));
        ...
        public IEnumerable GetSalesOrderInfo(DataTable SalesOrderdt1, string Order_Id)
        {
            ...
            if (tempWarehouse != null && tempWarehouse.Rows.Count > 0)
            {
                ...
                Session["CDP_WarehouseData"] = tempWarehouse;
            }
            else { Session["CDP_WarehouseData"] = null; }
        ...
        public bool BindSessionByDatatable(DataTable dt)
        {
            ...
            Session["CDPDetails"] = SalesChalladt;
        ...
        protected void grid_BatchUpdate(object sender, DevExpress.Web.Data.ASPxDataBatchUpdateEventArgs e)
        {
            ...
            if (Session["CDPDetails"] != null)
            {
                //subhabrata: foreach@deleted extra column 
                DataTable dt = new DataTable();
                DataTable dtTemp = new DataTable();

                dtTemp = (DataTable)Session["CDPDetails"];
                dt = dtTemp.Copy();
            ...
            foreach (var args in e.InsertValues)
            {
                ...
                if (ProductDetails != "" && ProductDetails != "0")
                {
                    ...
                    string QuotationNumber = Convert.ToString(args.NewValues["Doc_Number"]);
            ...
            if (IsDeleteFrom != "D")
            {
                try
                {
                        ...
                        string.IsNullOrEmpty(Request.QueryString["Flag"]))
                    {
                        ...
                        Session["ChallanIDCDP"] = Convert.ToString(Request.QueryString["key"]);
                        if (!string.IsNullOrEmpty(Convert.ToString(Session["ChallanIDCDP"])))
                        {

                            MainOrderID = Convert.ToString(Session["ChallanIDCDP"]);
                        }
                        else
                        {
                            MainOrderID = "";
                    ...
                    String QuoComponent = "";
                    QuoComponent = Convert.ToString(hddnPosBillId.Value);
                    ...
                    if (Session["CDPFinalTaxRecord"] != null)
                    {
                        TaxDetailTable = (DataTable)Session["CDPFinalTaxRecord"];
                    }
                    else
                    {
                    ...
                    if (Session["CDPTaxDetails"] != null)
                    {
                        TaxDetailsdt = (DataTable)Session["CDPTaxDetails"];
                    }
                    else
                    {
                    ...
                    if (Session["CDP_WarehouseData"] != null)
                    {
                        DataTable Warehousedt = (DataTable)Session["CDP_WarehouseData"];
                        ...
                        else
                        {
                            ...
                            if (isQtyExists == true)
                            {
                                ...
                                int id = ModifySalesChallan(MainOrderID, strSchemeType, UniqueQuotation, strQuoteDate, strQuoteExpiry, strCustomer, strContactName,
                                                   ...
                                                   , tempTaxDetailsdt, Doc_Type, approveStatus, strCustomerDueDays, strEwayBillNo);
        ...
        protected void grid_DataBinding(object sender, EventArgs e)
        {
            if (Session["CDPDetails"] != null)
            {
                DataTable Quotationdt = (DataTable)Session["CDPDetails"];
        ...
        protected void grid_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            if (strSplitCommand == "BindGridOnQuotation")
            {
                ...
                //            {
                //                dt_QuotationDetails = objSlaesActivitiesBL.GetSalesInvoiceFromSalesChallan(QuoComponent1, QuoteDetails_Id, Product_id1, "Edit");
                //            }
                ...
                //            else if (e.Parameters.Split('~')[2] == "SI")
                //            {
                //                dt_QuotationDetails = objSlaesActivitiesBL.GetSalesInvoiceFromSalesChallan(QuoComponent1, QuoteDetails_Id, Product_id1, "Add");
                //            }
                //        }
        ...
        [WebMethod]
        public static String GetContactSalesManReference(string KeyVal)
        {

            SlaesActivitiesBL objSlaesActivitiesBL = new SlaesActivitiesBL();
            DataTable dt = objSlaesActivitiesBL.GetConatctReferenceSalesManInfo(KeyVal);
            string ResultString = "";
            if (dt.Rows.Count > 0)
            {
        ...
        public int ModifySalesChallan(string ChallanID, string strSchemeType, string strOrderNo, string strOrderDate, string strOrderExpiry, string strCustomer, string strContactName,
                                    ...
                                    DataTable tempTaxDetailsdt, string Doc_type, string approveStatus, string CustomerDueDate, string EwayBillNo)
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("prc_CRMSalesChallan", con);
        ...
        protected void gridTax_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            if (strSplitCommand == "Display")
            {
                ...
                if (Session["CDPTaxDetails"] == null)
                {
                    Session["CDPTaxDetails"] = GetTaxData(dt_PLSales.Date.ToString("yyyy-MM-dd"));
                }
            ...
            else if (strSplitCommand == "SaveGst")
            {
                ...
                else
                {
                    ...
                    Session["CDPTaxDetails"] = TaxDetailsdt;
                }
            }
        }
        ...
        protected DataTable GetTaxDataWithGST(DataTable existing)
        {
            ...
            proc.AddVarcharPara("@Challan_Id", 500, Convert.ToString(Session["ChallanIDCDP"]));
            dt = proc.GetTable();
            if (dt.Rows.Count > 0)
            {
        ...
        protected void gridTax_DataBinding(object sender, EventArgs e)
        {
            if (Session["CDPTaxDetails"] != null)
            {
                DataTable TaxDetailsdt = (DataTable)Session["CDPTaxDetails"];
        ...
        protected void taxUpdatePanel_Callback(object source, DevExpress.Web.CallbackEventArgsBase e)
        {
            ...
            {
                DataTable MainTaxDataTable = (DataTable)Session["CDPFinalTaxRecord"];
                ...
                if (taxDetails != null)
                {
                    ...
                    Session["CDPTaxDetails"] = taxDetails;
                }
            }
        ...
        public void CreateDataTaxTable()
        {
            ...
            Session["CDPFinalTaxRecord"] = TaxRecord;
        }
        ...
        protected void cgridTax_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            {
                DataTable TaxRecord = (DataTable)Session["CDPFinalTaxRecord"];
        ...
        public void DeleteTaxDetails(string SrlNo)
        {
            ...
            if (Session["CDPFinalTaxRecord"] != null)
            {
                ...
                Session["CDPFinalTaxRecord"] = TaxDetailTable;
            }
        }
        ...
        public void DeleteWarehouse(string SrlNo)
        {
            ...
            if (Session["CDP_WarehouseData"] != null)
            {
                Warehousedt = (DataTable)Session["CDP_WarehouseData"];
                ...
                Session["CDP_WarehouseData"] = Warehousedt;
            }
        }
        ...
        public DataTable GetOrderWarehouseData()
        {
            try
            {
                ...
                proc.AddVarcharPara("@PCNumber", 500, Convert.ToString(Session["ChallanIDCDP"]));
                proc.AddVarcharPara("@Finyear", 500, Convert.ToString(Session["LastFinYear"]));
                proc.AddVarcharPara("@ProductID", 500, Convert.ToString(hdfProductID.Value));
                proc.AddVarcharPara("@branchID", 500, Convert.ToString(ddl_Branch.SelectedValue));
                ...
                Session["CDP_LoopWarehouse"] = Convert.ToString(Convert.ToInt32(strNewVal) + 1);
        ...
        protected void CmbSerial_Callback(object sender, CallbackEventArgsBase e)
        {
            ...
            if (WhichCall == "BindSerial")
            {
                ...
                //string WarehouseID = Convert.ToString(e.Parameter.Split('~')[1]);
                if (!string.IsNullOrEmpty(Convert.ToString(e.Parameter.Split('~')[1])))
                {
                    WarehouseID = Convert.ToString(e.Parameter.Split('~')[1]);
                }
                else
                {
                    WarehouseID = "0";
                ...
                {
                    BatchID = Convert.ToString(e.Parameter.Split('~')[2]);
                }
                else
                {
                    BatchID = "0";
                ...
                string strQuoteDate = Convert.ToString(dt_PLSales.Date);
                DataTable dt = null;
                if (string.IsNullOrEmpty(Qty) && !string.IsNullOrEmpty(Convert.ToString(e.Parameter.Split('~')[1])))
                {
                    Qty = "0";
                ...
                else if (!string.IsNullOrEmpty(Convert.ToString(e.Parameter.Split('~')[1])))
                {
                    dt = GetSerialataForFifo(WarehouseID, BatchID, Qty);
                }
        ...
        protected void GrdWarehouse_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            {
                int loopId = Convert.ToInt32(Session["CDP_LoopWarehouse"]);
                ...
                Session["CDP_LoopWarehouse"] = loopId + 1;

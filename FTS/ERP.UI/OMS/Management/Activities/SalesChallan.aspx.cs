...
{
    public partial class SalesChallan : ERP.OMS.ViewState_class.VSPage
    {
        ...
        {
            rights = BusinessLogicLayer.CommonBLS.CommonBL.GetUserRightSession("/management/Activities/SalesChallan.aspx");
            if (!IsPostBack)
            {

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SalesOrderEntityList.aspx.cs" MasterPageFile="~/OMS/MasterPage/ERP.Master"
    Inherits="ERP.OMS.Management.Activities.SalesOrderEntityList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="GridViewArea">
        <dxe:ASPxGridView ID="GrdOrder" runat="server" KeyFieldName="SlNo" AutoGenerateColumns="False" DataSourceID="EntityServerModeDataSource"
               ...
               <%-- <dxe:GridViewDataTextColumn Caption="Updated By" FieldName="UpdatedBy"
                ...
                <dxe:GridViewDataTextColumn HeaderStyle-HorizontalAlign="Center" CellStyle-HorizontalAlign="center" VisibleIndex="17" Width="150px">
                    <DataItemTemplate>
                        ...
                        <% if (rights.CanEdit)
                                        { %>
                        <a href="javascript:void(0);" onclick="OnMoreInfoClick('<%#Eval("Order_Id")%>')" class="pad" title="Modify">
                            
                            <img src="../../../assests/images/info.png" /></a>  <% } %>
                          <% if (rights.CanDelete)
                                       { %>
                        <a href="javascript:void(0);" onclick="OnClickDelete('<%#Eval("Order_Id")%>')" class="pad" title="Delete">

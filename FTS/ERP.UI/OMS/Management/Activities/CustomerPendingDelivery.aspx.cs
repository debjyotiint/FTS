...
{
    public partial class CustomerPendingDelivery : ERP.OMS.ViewState_class.VSPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (!string.IsNullOrEmpty(Request.QueryString["Flag"]) && hddnIsODSDFirstTime.Value == "0")
                {
                    ...
                    string strBranchID = Convert.ToString(dt_InvoiceHeader.Rows[0]["Invoice_BranchId"]);
        ...
        public void BindSalesChallanDirect(string Bill_No, string Cust_Id)
        {
            ...
            dtCustomer = objSlaesActivitiesBL.PopulateCustomerDetailOD(hdnCustomerId.Value);
            if (dtCustomer != null && dtCustomer.Rows.Count > 0)
            {
                lookup_Customer.DataSource = dtCustomer;
                lookup_Customer.DataBind();
                Session["CDPCustomerDetail"] = dtCustomer;
        ...
        {
            if (Session["CDPCustomerDetail"] == null)
            {
                DataTable dtCustomer = new DataTable();
                //dtCustomer = objSlaesActivitiesBL.PopulateCustomerDetail();
                dtCustomer = objSlaesActivitiesBL.PopulateCustomerDetailOD(hdnCustomerId.Value);
            ...
            {
                lookup_Customer.DataSource = (DataTable)Session["CDPCustomerDetail"];
                lookup_Customer.DataBind();
            }
                            ...
                            if (isQtyExists == true)
                            {
                                ...
                                else
                                {
                                    ...
                                    if (!string.IsNullOrEmpty(hfTermsConditionData.Value))
                                    {
                                        ...
                                        TermsConditionsControl.SaveTC(hfTermsConditionData.Value, Convert.ToString(id), "SC");
                                    }
        ...
        {
            if (Session["CDPData"] != null)
            {
                lookup_order.DataSource = (DataTable)Session["CDPData"];
            }
        }

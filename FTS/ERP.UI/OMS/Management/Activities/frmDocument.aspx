<%@ Page Title="Document Collection" Language="C#" AutoEventWireup="true" MasterPageFile="~/OMS/MasterPage/ERP.Master" Inherits="ERP.OMS.Management.Activities.management_Activities_frmDocument" CodeBehind="frmDocument.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        //    var stract = LeadId + "&frmdate=" + frmdate + "&todate=" + todate;

        // //   alert(stract)
        //    window.open("ShowHistory_Phonecall.aspx?id1=" + stract, 'welcome', 'width=' + width + ',height=' + height + ',top=' + x + ',left=' + y + ',menubar=no,status=no,location=no,toolbar=no,scrollbars=yes');
        //}
        ...
        function callback() {
            document.getElementById("ASPxPageControl1_ShowDetails").contentWindow.ClosingDHTML();
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel-heading">
        <div class="panel-title">
            <h3>Sales Activity - Document Collection
            </h3>
            ...
            <div class="clearfix">
                <div style="padding-right: 5px;">
                    ...
                    <table class="pull-left">
                      <%--  <tr>
<td>   <asp:Button ID="btn_PendingTask" Style="padding: 4px 10px;"  Text="My Pending Task" runat="server" CssClass="btn btn-primary" OnClick="btMyPendingTask_Click" /></td>
                            ...
                            <td>
                                <span id="spanBudget" >
                                   ...
                                   <span id="spanMyactivities" visible="false">
                                    <asp:Button ID="btn_myactivity" Style="padding: 4px 10px;"  Text="My Activities" runat="server" CssClass="btn btn-primary" OnClick="btMyactivities_Click" />
                                </span>
                            </td>
                            <td>
                     ...
                     <% if (rights.CanExport)
                           { %>
                      <asp:DropDownList ID="drdSalesActivityDetails" runat="server" Height="34px" CssClass="btn btn-sm btn-primary  expad pull-right" OnSelectedIndexChanged="drdSalesActivityDetails_SelectedIndexChanged" AutoPostBack="true">
                                    ...
                                    <dxe:ContentControl runat="server">
                                        <div id="GridDiv">
                                            <table width="100%">
                                                ...
                                                <tr>
                                                    <td>
                                                        <dxe:ASPxGridView ID="SalesDetailsGrid" runat="server" KeyFieldName="sls_id" AutoGenerateColumns="False" ClientInstanceName="grid"
                                                            Width="100%" DataSourceID="SalesDetailsGridDataSource" OnHtmlRowCreated="SalesDetailsGrid_HtmlRowCreated"   SettingsCookies-Enabled="true" SettingsCookies-StorePaging="true" SettingsCookies-StoreFiltering="true" SettingsCookies-StoreGroupingAndSorting="true" 
	...
	LastActivityDetailsCall(s.cpHeight);
        ...
        <%--  <asp:SqlDataSource ID="DocumentDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:CRMConnectionString %>">
            </asp:SqlDataSource>--%>

    ...
    public partial class PurchaseInvoiceListForTransporter : ERP.OMS.ViewState_class.VSPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                Session.Remove("TRSaveModePB");  // Use this session to remove default cursor from manual oe auto schema type
                Session.Remove("TRschemavaluePB"); // Use this session to remove default cursor from manual oe auto schema type

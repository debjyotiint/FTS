<%@ Page Title="" Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" CodeBehind="BranchRequisitionReturn.aspx.cs" Inherits="ERP.OMS.Management.Activities.BranchRequisitionReturn" %>
    ...
    <div id="DivEntry">
        <div style="background: #f5f4f3; padding: 8px 0; margin-bottom: 15px; border-radius: 4px; border: 1px solid #ccc;" class="clearfix">
            ...
            <div class="col-md-2 lblmTop8">
                <label>Return Request No.<span style="color: red;">*</span></label>
                <div>

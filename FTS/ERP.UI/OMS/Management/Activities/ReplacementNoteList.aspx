    ...
    <div class="GridViewArea">
        <dxe:ASPxGridView ID="GrdReplacement" runat="server" KeyFieldName="Replacement_Id" AutoGenerateColumns="False"
            ...
            <Columns>
                ...
                <dxe:GridViewDataTextColumn FixedStyle="Left"  VisibleIndex="11" Width="50%">
                        <CellStyle CssClass="gridcellleft" Wrap="true">
                    </CellStyle>
                    <DataItemTemplate>
                        ...
                        <a href="javascript:void(0);" onclick="OnMoreInfoClick('<%# Container.KeyValue %>')"  title="Edit">
                        ...
                        <% if (rights.CanAssignbranch)
                           { %>
                        <a href="javascript:void(0);" onclick="OnEditButtonClick('<%# Container.KeyValue %>', '<%# Eval("current_status") %>', '<%# Eval("assign_to_branch") %>', '<%# Eval("receiver_remark") %>', '<%# Eval("assignee_remark") %>')" title="Assigned Branch" >

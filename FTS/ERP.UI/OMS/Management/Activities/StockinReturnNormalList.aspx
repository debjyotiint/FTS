            ...
            if (ActiveUser != null) {
                $.ajax({
                    ...
                    success: function (msg) {
                        var status = msg.d;
                        var url = 'StockinReturnNormal.aspx?key=' + keyValue + '&Permission=' + status + '&type=SRN';
                        window.location.href = url;
                    }
                });
            }
        ...
        <dxe:ASPxGridView ID="GrdSalesReturn" runat="server" KeyFieldName="SrlNo" AutoGenerateColumns="False" 
         ...
         DataSourceID="EntityServerModeDataSource"   Setting-HorizontalScrollBarMode="Auto" >
            <Columns>
                ...
                <dxe:GridViewDataTextColumn Caption="Return Normal Number" FieldName="SalesReturnNo"
                ...
                <dxe:GridViewDataTextColumn Caption="Amount" FieldName="Amount"
                 ...
                 <dxe:GridViewDataTextColumn VisibleIndex="8" Caption="Assigned To Branch" FieldName="branchToBranch" Width="130px">
                <CellStyle Wrap="False" CssClass="gridcellleft"></CellStyle>
            </dxe:GridViewDataTextColumn> 

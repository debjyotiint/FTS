<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucPaymentDetails.ascx.cs" Inherits="ERP.OMS.Management.Activities.UserControls.ucPaymentDetails" %>
    ...
    function GetHtml5(type) {
        ...
        if (type == "Card") {
            ...
            for (var i = 0; i < JsonMainAccount.length; i++) {
                if (JsonMainAccount[i].MainAccount_BankCashType == "Card" && ($('#HdSelectedBranch').val() == JsonMainAccount[i].BranchId || JsonMainAccount[i].BranchId == "0")) {
                    
                    if (JsonMainAccount[i].BranchId != "0")
                        optionsHtml += '<option value="' + JsonMainAccount[i].MainAccount_AccountCode + '">' + JsonMainAccount[i].MainAccount_Name + '</option>'
                    else {
                        MainAccountCount = $.grep(JsonBranchmainAct, function (e) { return e.MainAccount_Code == JsonMainAccount[i].MainAccount_AccountCode; })

                        if (MainAccountCount.length > 0) {

                            BranchLedgerObj = $.grep(JsonBranchmainAct, function (e) { return e.BranchId == $('#HdSelectedBranch').val() && e.MainAccount_Code == JsonMainAccount[i].MainAccount_AccountCode; })
                            if (BranchLedgerObj.length > 0) {
                                optionsHtml += '<option value="' + JsonMainAccount[i].MainAccount_AccountCode + '">' + JsonMainAccount[i].MainAccount_Name + '</option>';
                            }
                        } else {
                            optionsHtml += '<option value="' + JsonMainAccount[i].MainAccount_AccountCode + '">' + JsonMainAccount[i].MainAccount_Name + '</option>';
            ...
            var optionsHtml = ''
            for (var i = 0; i < JsonMainAccount.length; i++) {
                if (JsonMainAccount[i].MainAccount_BankCashType == "None" && ($('#HdSelectedBranch').val() == JsonMainAccount[i].BranchId || JsonMainAccount[i].BranchId=="0")) {
                    if (JsonMainAccount[i].BranchId != "0")
                        optionsHtml += '<option value="' + JsonMainAccount[i].MainAccount_AccountCode + '">' + JsonMainAccount[i].MainAccount_Name + '</option>'
                    else {
                        MainAccountCount = $.grep(JsonBranchmainAct, function (e) { return e.MainAccount_Code == JsonMainAccount[i].MainAccount_AccountCode; })
            ...
            var optionsHtml = ''
            for (var i = 0; i < JsonMainAccount.length; i++) {
                if (JsonMainAccount[i].MainAccount_BankCashType == "Etransfer" && ($('#HdSelectedBranch').val() == JsonMainAccount[i].BranchId || JsonMainAccount[i].BranchId == "0")) {
                    if (JsonMainAccount[i].BranchId != "0")
                        optionsHtml += '<option value="' + JsonMainAccount[i].MainAccount_AccountCode + '">' + JsonMainAccount[i].MainAccount_Name + '</option>'
                    else {
                        MainAccountCount = $.grep(JsonBranchmainAct, function (e) { return e.MainAccount_Code == JsonMainAccount[i].MainAccount_AccountCode; })
            ...
            var optionsHtml = ''
            for (var i = 0; i < JsonMainAccount.length; i++) {
                if (JsonMainAccount[i].MainAccount_BankCashType == "Coupon" && ($('#HdSelectedBranch').val() == JsonMainAccount[i].BranchId ||  JsonMainAccount[i].BranchId=="0")) {
                    if (JsonMainAccount[i].BranchId != "0")
                        optionsHtml += '<option value="' + JsonMainAccount[i].MainAccount_AccountCode + '">' + JsonMainAccount[i].MainAccount_Name + '</option>'
                    else {
                        MainAccountCount = $.grep(JsonBranchmainAct, function (e) { return e.MainAccount_Code == JsonMainAccount[i].MainAccount_AccountCode; })
                             ...
                             <tbody><tr>
                                 ...
                                 <td>
                                      <dxe:ASPxComboBox ID="cmbUcpaymentCashLedger" runat="server" ClientIDMode="Static" ClientInstanceName="ccmbUcpaymentCashLedger" SelectedIndex="0"  Width="100%">
                                                  <ClientSideEvents SelectedIndexChanged="cmbUcpaymentCashLedgerChanged" />
                                       </dxe:ASPxComboBox>
                                 </td>

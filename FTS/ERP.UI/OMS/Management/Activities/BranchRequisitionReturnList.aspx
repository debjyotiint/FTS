...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function OnViewClick(keyValue) {
            var url = 'BranchRequisitionReturn.aspx?key=' + keyValue + '&req=V';
            window.location.href = url;
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        <dxe:ASPxGridView ID="GridPurchaseReturnREquest" runat="server" AutoGenerateColumns="False" KeyFieldName="BR_Id"
            ...
            DataSourceID="EntityServerModeDataSource" OnDataBinding="GridPurchaseReturnREquest_DataBinding">
            ...
            <Columns>
                ...
                <dxe:GridViewDataTextColumn VisibleIndex="1" Caption="Purchase Return Request Number" FieldName="BR_RequisitionNumber">
                    <CellStyle Wrap="False" CssClass="gridcellleft"></CellStyle>
                </dxe:GridViewDataTextColumn>
                <dxe:GridViewDataTextColumn VisibleIndex="2" Caption="Date" FieldName="BR_RequisitionDt" PropertiesTextEdit-DisplayFormatString="dd-MM-yyyy">
                    <CellStyle Wrap="False" CssClass="gridcellleft"></CellStyle>
                </dxe:GridViewDataTextColumn>
                <dxe:GridViewDataTextColumn VisibleIndex="3" Caption="Requisition sent From" FieldName="BR_BranchIdFor">
                    <CellStyle Wrap="False" CssClass="gridcellleft"></CellStyle>
                </dxe:GridViewDataTextColumn>
                <dxe:GridViewDataTextColumn VisibleIndex="4" Caption="Requested to Branch" FieldName="BR_BranchIdTo">
                    <CellStyle Wrap="False" CssClass="gridcellleft"></CellStyle>
                </dxe:GridViewDataTextColumn>

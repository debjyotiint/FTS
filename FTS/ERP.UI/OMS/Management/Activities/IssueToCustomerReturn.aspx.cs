...
{
    public partial class IssueToCustomerReturn : ERP.OMS.ViewState_class.VSPage// System.Web.UI.Page
    {
        ...
        {
            DataTable udfCount = oDBEngine.GetDataTable("select 1 from tbl_master_remarksCategory rc where cat_applicablefor='CRI'  and ( exists (select * from tbl_master_udfGroup where id=rc.cat_group_id and grp_isVisible=1) or rc.cat_group_id=0)");
            return udfCount.Rows.Count;
        }
        protected void Page_Load(object sender, EventArgs e)
        {
            rights = BusinessLogicLayer.CommonBLS.CommonBL.GetUserRightSession("/management/Activities/CustomerReturn.aspx");
            ...
            if (!IsPostBack)
            {
                ...
                Session["CRI_BillingAddressLookup"] = null;
                Session["CRI_ShippingAddressLookup"] = null;
                ...
                Session["CRI_ReturnID"] = "";
                Session["CRI_CustomerDetail"] = null;
                Session["CRI_QuotationDetails"] = null;
                Session["CRI_WarehouseData"] = null;
                Session["CRI_QuotationTaxDetails"] = null;
                Session["LoopCRIWarehouse"] = 1;
                Session["CRI_TaxDetails"] = null;
                Session["CRI_ActionType"] = "";
                Session["CRI_ComponentData"] = null;
                Session["TaggingCustomerReturn"] = "";

                Session["CRIwarehousedetailstemp"] = null;
                Session["CRIwarehousedetailstempUpdate"] = null;
                Session["CRIwarehousedetailstempDelete"] = null;
                Session["CustomerReturnIssueAddressDtl"] = null;
                ...
                //LoadGSTCSTVATCombo();
                //   Session["CRQuotationAddressDtl"] = null;
                Session["CRI_QuotationAddressDtl"] = null;
                ...
                if (Request.QueryString["key"] != null)
                {
                    ...
                    {
                        lblHeadTitle.Text = "Modify Issue To Customer";
                        hdnPageStatus.Value = "update";
                        divScheme.Style.Add("display", "none");
                        strSalesReturnId = Convert.ToString(Request.QueryString["key"]);
                        Session["CRI_KeyVal_InternalID"] = "SRQUOTE" + strSalesReturnId;


                        Keyval_internalId.Value = "IssueCustomerReturn" + strSalesReturnId;
                        #region Subhra Section
                        Session["CRI_key_QutId"] = strSalesReturnId;
                        ...
                        Session["CRI_ReturnID"] = strSalesReturnId;
                        Session["CRI_ActionType"] = "Edit";
                        SetSalesReturnDetails(strSalesReturnId);
                        //  DateTime quoteDate = Convert.ToDateTime(dt_PLQuote.Date.ToString("dd/MM/yyyy"));
                        Session["CRI_TaxDetails"] = GetTaxDataWithGST(GetTaxData(dt_PLQuote.Date.ToString("yyyy-MM-dd")));

                        //  Session["CRI_WarehouseData"] = GetQuotationWarehouseData();

                        DataTable Productdt = new DataTable();
                        if (Session["TaggingCustomerReturn"] == "1")
                        {

                            Productdt = objSalesReturnBL.GetCustomerReturnTaggingProductData(strSalesReturnId, Convert.ToString(Session["LastFinYear"]), Convert.ToString(Session["LastCompany"])).Tables[0];
                        }
                        else
                        {
                            Productdt = objSalesReturnBL.GetCustomerReturnProductData(strSalesReturnId, Convert.ToString(Session["LastFinYear"]), Convert.ToString(Session["LastCompany"])).Tables[0];
                        }

                        Session["CRI_QuotationDetails"] = Productdt;
                        ...
                        Session["CRI_WarehouseData"] = dt;
                        Session["CRI_QuotationAddressDtl"] = objSalesReturnBL.GetSalesReturnBillingAddress(strSalesReturnId); ;
                        ...
                        if (GetQuotationTaxData().Tables[0] != null)
                            Session["CRI_QuotationTaxDetails"] = GetQuotationTaxData().Tables[0];
                        ...
                        if (GetQuotationEditedTaxData().Tables[0] != null)
                        {
                            ...
                            {
                                Session["CRI_FinalTaxRecord"] = quotetable;
                            }
                        }
                        ...
                        {
                            lblHeadTitle.Text = "View Issue To Customer";
                    ...
                    else
                    {
                        ...
                        if (Session["CRI_SaveMode"] != null)  // it has been removed from coding side of Quotation list 
                        {
                            if (Session["CRI_schemavalue"] != null)  // it has been removed from coding side of Quotation list 
                            {
                                ddl_numberingScheme.SelectedValue = Convert.ToString(Session["CRI_schemavalue"]); // it has been removed from coding side of Quotation list 
                            }
                            if (Convert.ToString(Session["CRI_SaveMode"]) == "A")
                            {
                                dt_PLQuote.Focus();
                                txt_PLQuoteNo.Enabled = false;
                                txt_PLQuoteNo.Text = "Auto";
                            }
                            else if (Convert.ToString(Session["CRI_SaveMode"]) == "M")
                            {
                        ...
                        Session["CRI_ActionType"] = "Add";
                        //ASPxButton2.Enabled = false;
                        Session["CRI_TaxDetails"] = null;
                        CreateDataTaxTable();
                        lblHeadTitle.Text = "Add Issue To Customer";
        ...
        public void GetCustomerReturnSchemaLength()
        {
            DataTable Dt = new DataTable();
            Dt = objSalesReturnBL.GetSchemaLengthCustomerReturn();
            if (Dt != null && Dt.Rows.Count > 0)
            {
                hdnSchemaLength.Value = Convert.ToString(Dt.Rows[0]["length"]);
        ...
        public DataSet GetQuotationData()
        {
            ...
            proc.AddVarcharPara("@QuotationID", 500, Convert.ToString(Session["CRI_ReturnID"]));
            ds = proc.GetDataSet();
            return ds;
        }
        ...
        protected void grid_BatchUpdate(object sender, DevExpress.Web.Data.ASPxDataBatchUpdateEventArgs e)
        {
            ...
            if (Session["CRI_QuotationDetails"] != null)
            {
                Quotationdt = (DataTable)Session["CRI_QuotationDetails"];
            }
            else
            {
            ...
            Session["CRI_QuotationDetails"] = Quotationdt;
            ...
            if (IsDeleteFrom != "D")
            {
                ...
                string ActionType = Convert.ToString(Session["CRI_ActionType"]);
                string MainInvoiceID = Convert.ToString(Session["CRI_ReturnID"]);
                ...
                if (Session["CRI_FinalTaxRecord"] != null)
                {
                    TaxDetailTable = (DataTable)Session["CRI_FinalTaxRecord"];
                }

                // DataTable of Warehouse

                DataTable tempWarehousedt = new DataTable();
                if (Session["CRI_WarehouseData"] != null)
                {
                    DataTable Warehousedt = (DataTable)Session["CRI_WarehouseData"];
                   ...
                   Convert.ToString(Warehousedt.Rows[i]["SrlNo"]),
                   Convert.ToString(Warehousedt.Rows[i]["WarehouseID"]),
                   Convert.ToString(Warehousedt.Rows[i]["Quantity"]),
                ...
                if (Session["CRI_TaxDetails"] != null)
                {
                    TaxDetailsdt = (DataTable)Session["CRI_TaxDetails"];
                }
                else
                {
                ...
                #region #### Old_Process ####
                ////DataTable tempBillAddress = new DataTable();
                ////if (Session["CRI_QuotationAddressDtl"] != null)
                ////{
                ////    tempBillAddress = (DataTable)Session["CRI_QuotationAddressDtl"];
                ////}
                ////else
                ////{
               ...
               .Select(g => g.Key);
                ...
                BusinessLogicLayer.DBEngine objEngine = new BusinessLogicLayer.DBEngine(ConfigurationManager.AppSettings["DBConnectionDefault"]);
                DataTable DT = objEngine.GetDataTable("Config_SystemSettings", " Variable_Value ", " Variable_Name='Transporter_CRMandatory' AND IsActive=1");
                if (DT != null && DT.Rows.Count > 0)
                {
                ...
                else
                {
                    ...
                    #region To Show By Default Cursor after SAVE AND NEW
                    if (Convert.ToString(Session["CRI_ActionType"]) == "Add") // session has been removed from quotation list page working good
                    {
                        string[] schemaid = new string[] { };
                        string schemavalue = ddl_numberingScheme.SelectedValue;
                        Session["CRI_schemavalue"] = schemavalue;        // session has been removed from quotation list page working good
                        ...
                        if (hdnRefreshType.Value == "N")
                        {
                            if (schematype == "1")
                            {
                                Session["CRI_SaveMode"] = "A";
                            }
                            else
                            {
                                Session["CRI_SaveMode"] = "M";
                            }
                        }
                    }
                    ...
                    if (!string.IsNullOrEmpty(hfControlData.Value))
                    {
                        ...
                        objCommonBL.InsertTransporterControlDetails(Convert.ToInt32(strQuoteID), "CRI", hfControlData.Value, Convert.ToString(HttpContext.Current.Session["userid"]));
                    }
                    //Udf Add mode
                    DataTable udfTable = (DataTable)Session["UdfDataOnAdd"];
                    if (udfTable != null)
                        Session["UdfDataOnAdd"] = reCat.insertRemarksCategoryAddMode("CRI", "IssueCustomerReturn" + Convert.ToString(strQuoteID), udfTable, Convert.ToString(Session["userid"]));
        ...
        public void GetQuantityBaseOnProduct(string strProductSrlNo, ref decimal WarehouseQty)
        {
            ...
            if (Session["CRI_WarehouseData"] != null)
            {
                Warehousedt = (DataTable)Session["CRI_WarehouseData"];
                for (int i = 0; i < Warehousedt.Rows.Count; i++)
                {
        ...
        protected void grid_DataBinding(object sender, EventArgs e)
        {
            ...
            if (Session["CRI_QuotationDetails"] != null)
            {
                DataTable Quotationdt = (DataTable)Session["CRI_QuotationDetails"];
        ...
        protected void grid_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            else if (strSplitCommand == "RemoveDisplay")
            {
                ...
                if (Session["CRI_QuotationDetails"] != null)
                {
                    salesReturndt = (DataTable)Session["CRI_QuotationDetails"];
                }
                ...
                Session["CRI_QuotationDetails"] = salesReturndt;
                grid.DataBind();
            ...
            else if (strSplitCommand == "BindGridOnQuotation")
            {
                ...
                //    ChallanDetails_Id += "," + Convert.ToString(grid_Products.GetSelectedFieldValues("ComponentDetailsID")[i]);
                //}

                //  Product_id1 = Product_id1.TrimStart(',');
                string Quote_Nos = Convert.ToString(e.Parameters.Split('~')[1]);
                string companyId = Convert.ToString(HttpContext.Current.Session["LastCompany"]);
                Session["CustomerReturnInvoiceIds"] = QuoComponent;
                ...
                if (Quote_Nos != "$")
                {
                    ...
                    if (!string.IsNullOrEmpty(IdKey))
                    {
                        ...
                        dt_QuotationDetails = objSalesReturnBL.GetReturnforCRI(QuoComponent, companyId, fin_year);
                        //if (IdKey != "ADD")
                        //{
                        //    dt_QuotationDetails = objSalesReturnBL.GetIndentDetailsForCRGridBind(QuoComponent1, IdKey, Product_id1, companyId, fin_year);
                        //}
                        //else
                        //{
                        //    dt_QuotationDetails = objSalesReturnBL.GetIndentDetailsForCRGridBind(QuoComponent1, IdKey, Product_id1, companyId, fin_year);
                ...
                //Session["CRI_QuotationAddressDtl"] = GetComponentEditedAddressData(ChallanDetails_Id, "SC");
                //if (Session["CRI_QuotationAddressDtl"] != null)
                //{
                //    DataTable dt = (DataTable)Session["CRI_QuotationAddressDtl"];
                //    if (dt != null && dt.Rows.Count > 0)
                //    {
                //        if (dt.Rows.Count == 2)
                //        {
                                    ...
                                    ref int strIsComplete, ref int strInvoiceID, string ReasonforReturn)
        {
            try
            {
                ...
                else { cmd.Parameters.AddWithValue("@ComponentType", "CR"); }
        ...
        public DataTable GetTaxData(string quoteDate)
        {
            ...
            proc.AddVarcharPara("@SalesReturnID", 500, Convert.ToString(Session["CRI_ReturnID"]));
            proc.AddVarcharPara("@FinYear", 500, Convert.ToString(Session["LastFinYear"]));
            // proc.AddVarcharPara("@branchId", 500, Convert.ToString(Session["userbranchID"]));
        ...
        protected void gridTax_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            if (strSplitCommand == "Display")
            {
                ...
                if (Session["CRI_TaxDetails"] == null)
                {
                    Session["CRI_TaxDetails"] = GetTaxData(dt_PLQuote.Date.ToString("yyyy-MM-dd"));
                }
            ...
            else if (strSplitCommand == "SaveGst")
            {
                ...
                else
                {
                    ...
                    Session["CRI_TaxDetails"] = TaxDetailsdt;
                }
            }
        }
        ...
        protected void gridTax_DataBinding(object sender, EventArgs e)
        {
            if (Session["CRI_TaxDetails"] != null)
            {
                DataTable TaxDetailsdt = (DataTable)Session["CRI_TaxDetails"];
        ...
        protected void taxUpdatePanel_Callback(object source, DevExpress.Web.CallbackEventArgsBase e)
        {
            ...
            {
                DataTable MainTaxDataTable = (DataTable)Session["CRI_FinalTaxRecord"];
                ...
                if (taxDetails != null)
                {
                    ...
                    Session["CRI_TaxDetails"] = taxDetails;
                }
            }
        ...
        public void CreateDataTaxTable()
        {
            ...
            Session["CRI_FinalTaxRecord"] = TaxRecord;
        }
        ...
        protected void cgridTax_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            {
                DataTable TaxRecord = (DataTable)Session["CRI_FinalTaxRecord"];
            ...
            else
            {
                ...
                DataTable MainTaxDataTable = (DataTable)Session["CRI_FinalTaxRecord"];
                DataTable databaseReturnTable = (DataTable)Session["CRI_QuotationTaxDetails"];
        ...
        public void DeleteTaxDetails(string SrlNo)
        {
            ...
            if (Session["CRI_FinalTaxRecord"] != null)
            {
                ...
                Session["CRI_FinalTaxRecord"] = TaxDetailTable;
            }
        }
        ...
        public static bool CheckUniqueCode(string ReturnNo)
        {
            ...
            try
            {
                ...
                flag = objShortNameChecking.CheckUnique(ReturnNo, "0", "CustomerReturn");
            }
            catch (Exception ex)
            {
        ...
        public void GetAllDropDownDetailForSalesQuotation(string userbranch)
        {
            ...
            dst = objSalesReturnBL.GetAllDropDownDetailForSalesChallan(userbranchHierarchy, strCompanyID, strBranchID, FinYear);
            ...
            SlaesActivitiesBL objSlaesActivitiesBL = new SlaesActivitiesBL();
            DataTable Schemadt = objSlaesActivitiesBL.GetNumberingSchema(strCompanyID, userbranchHierarchy, FinYear, "45", "Y");
        ...
        //{
        //    if (Session["CRI_CustomerDetail"] == null)
        //    {
        ...
        //            Session["CRI_CustomerDetail"] = dtCustomer;
        //        }
        //    }
        //    else
        //    {
        //        lookup_Customer.DataSource = (DataTable)Session["CRI_CustomerDetail"];
        //        lookup_Customer.DataBind();
        //    }
            ...
            if (SalesReturnEditdt != null && SalesReturnEditdt.Rows.Count > 0)
            {
                ...
                if (!String.IsNullOrEmpty(InvoiceCreatedFromDoc_Ids))
                {
                    ...
                    if (eachQuo.Length > 1)//More tha one quotation
                    {
                        ...
                        Session["TaggingCustomerReturn"] = "1";
                    }
                    ...
                    {
                        BindLookUp(Customer_Id, Convert.ToDateTime(Quote_Date).ToString("yyyy-MM-dd"), Branch_Id);
                        Session["TaggingCustomerReturn"] = "0";
                    }
                }
        ...
        protected void ComponentQuotation_Callback(object source, DevExpress.Web.CallbackEventArgsBase e)
        {
            ...
            if (e.Parameter.Split('~')[0] == "BindComponentGrid")
            {
                ...
                string strReturnID = Convert.ToString(Session["CRI_ReturnID"]);
                ...
                DataTable ComponentTable = objSalesReturnBL.GetCustomerReturnComponent(Customer, SalesReturnDate, strReturnID, branchId);
                lookup_quotation.GridView.Selection.CancelSelection();
                lookup_quotation.DataSource = ComponentTable;
                lookup_quotation.DataBind();

                Session["CRI_ComponentData"] = ComponentTable;
            ...
            else if (e.Parameter.Split('~')[0] == "BindComponentGridOnSelection")//Subhabrata for binding quotation
            {
                if (grid_Products.GetSelectedFieldValues("ComponentDetailsID").Count != 0)
                {
                    ...
                    if (!String.IsNullOrEmpty(InvoiceIds))
                    {
                        ...
                        if (eachQuo.Length > 1)//More tha one quotation
                        {
                            txt_InvoiceDate.Text = "Multiple Select Customer Return Dates";
        ...
        {
            if (Session["CRI_ComponentData"] != null)
            {
                lookup_quotation.DataSource = (DataTable)Session["CRI_ComponentData"];
            }
        }
        ...
        protected void ComponentDatePanel_Callback(object sender, CallbackEventArgsBase e)
        {
            ...
            if (strSplitCommand == "BindComponentDate")
            {
                ...
                DataTable dt_QuotationDetails = objSalesReturnBL.GetCustomerReturnDate(Invoice_No);
                if (dt_QuotationDetails != null && dt_QuotationDetails.Rows.Count > 0)
                {
                    string quotationdate = Convert.ToString(dt_QuotationDetails.Rows[0]["Challan_Date"]);
            ...
            if (strSplitCommand == "BindProductsDetails")
            {
                ...
                if (Quote_Nos != "$")
                {
                    ...
                    if (!string.IsNullOrEmpty(IdKey))
                    {
                        if (IdKey != "ADD")
                        {
                            dt_QuotationDetails = objSalesReturnBL.GetChallanDetailsOnly(QuoComponent, "Edit");
                            // dt_QuotationDetails = objPurchaseChallanBL.GetInvoiceDetailsOnly(QuoComponent, IdKey, "");
                        }
                        else
                        {
                            dt_QuotationDetails = objSalesReturnBL.GetChallanDetailsOnly(QuoComponent, "Add");
                        }
        ...
        {
            Boolean inUse = false;
            DataTable taxTable = (DataTable)Session["CRI_FinalTaxRecord"];
            ProcedureExecute proc = new ProcedureExecute("prc_taxReturnTable");
            proc.AddVarcharPara("@Module", 20, "IssueCustomerReturn");
            ...
            Session["CRI_FinalTaxRecord"] = taxTable;
        ...
        public IEnumerable GetInvoiceInfo(DataTable SalesInvoicedt1, string Order_Id)
        {
            ...
            string commaSeparatedString = Convert.ToString(Session["CustomerReturnInvoiceIds"]);
            ...
            for (int i = 0; i < SalesInvoicedt1.Rows.Count; i++)
            {
                ...
                QuoComponent = QuoComponent.TrimStart(',');
                string[] eachCustomerReturn = QuoComponent.Split(',');
                ...
                //// main tax integrate with respect to first tag  challan
                if (eachCustomerReturn.Length == 1)
                {
                    DataTable tempMainTax = objSalesReturnBL.GetTaxDetailsSR(QuoComponent);
                    if (tempMainTax != null && tempMainTax.Rows.Count > 0)
                    {
                        Session["CRI_TaxDetails"] = tempMainTax;

                    }

                }
                else { Session["CRI_TaxDetails"] = null; }
                //  main tax integrate with respect to first tag  challan
                //warehouse
                ...
                //    Session["CRI_WarehouseData"] = tempWarehouse;
        ...
        public bool BindSessionByDatatable(DataTable dt)
        {
            ...
            Session["CRI_QuotationDetails"] = SlsOreturnDT;
        ...
        //        DataTable dt = new DataTable();
        //        ProcedureExecute proc = new ProcedureExecute("prc_CRMSalesReturn_Details");
        //        proc.AddVarcharPara("@Action", 500, "ChallanWarehouseByReturn");
        ...
        //        Session["LoopCRIWarehouse"] = Convert.ToString(Convert.ToInt32(strNewVal) + 1);
        ...
        protected void acbpCrpUdf_Callback(object source, DevExpress.Web.CallbackEventArgsBase e)
        {
            ...
            {
                if (reCat.isAllMandetoryDone((DataTable)Session["UdfDataOnAdd"], "CRI") == false)
                {
        ...
        public DataTable GetQuotationWarehouseData()
        {
            try
            {
                DataTable dt = new DataTable();
                ProcedureExecute proc = new ProcedureExecute("prc_CRMSalesReturn_Details");
                proc.AddVarcharPara("@Action", 500, "CustomerIssueReturnWarehouse");
                proc.AddVarcharPara("@SalesReturnID", 500, Convert.ToString(Session["CRI_ReturnID"]));

                proc.AddVarcharPara("@Type", 100, "CRI");
                dt = proc.GetTable();

                if (Session["CRI_QuotationDetails"] != null)
                {
                    DataTable SalesInvoicedt1 = (DataTable)Session["CRI_QuotationDetails"];
        ...
        protected void GrdWarehouse_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            {
                int loopId = Convert.ToInt32(Session["LoopCRIWarehouse"]);
                ...
                Session["CRI_WarehouseData"] = Warehousedt;
                changeGridOrder();

                GrdWarehouse.DataSource = Warehousedt.DefaultView;
                GrdWarehouse.DataBind();

                Session["LoopCRIWarehouse"] = loopId + 1;
        ...
        public DataTable GetWarehouseData()
        {
            ...
            DataTable dt = new DataTable();
            ProcedureExecute proc = new ProcedureExecute("prc_CRMSalesReturn_Details");
            proc.AddVarcharPara("@Action", 500, "GetWareHouseDtlByProductID_From_CSC");
        ...
        public DataTable GetInvoiceWarehouse(string strInvoiceList)
        {
            try
            {
                ...
                DataTable dt = new DataTable();
                ProcedureExecute proc = new ProcedureExecute("prc_CRMSalesReturn_Details");
                proc.AddVarcharPara("@Action", 500, "CustomerReturnWarehouseByIssueCustomerReturn");
                proc.AddVarcharPara("@InvoiceList", 3000, strInvoiceList);

...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="GridViewArea">
        <dxe:ASPxGridView ID="GrdOrder" runat="server" KeyFieldName="SlNo" AutoGenerateColumns="False"
            Width="100%" ClientInstanceName="cGrdOrder" DataSourceID="EntityServerModeDataSource" OnCustomCallback="GrdOrder_CustomCallback" OnHtmlRowPrepared="AvailableStockgrid_HtmlRowPrepared"
            ...
            <columns>
                ...
                <dxe:GridViewDataTextColumn HeaderStyle-HorizontalAlign="Center" CellStyle-HorizontalAlign="center" VisibleIndex="15" Width="100px">
                    <DataItemTemplate>
                        <% if (rights.CanAdd)
                           { %>
                        <a href="javascript:void(0);" onclick="OnMoreInfoClickOur('<%#Eval("Bill_Id")%>',<%# Container.VisibleIndex %>)" class="pad" title="Make Delivery">
                       ...
                       <%-- <a href="javascript:void(0);" onclick="OnclickViewAttachment('<%# Container.KeyValue %>')" style="display:none" class="pad" title="View Attachment">
                         ...
                         <% if (rights.CanPrint)
                            { %>
                               <a href="javascript:void(0);" onclick="onPrintJv('<%#Eval("Bill_Id")%>', '<%# Eval("Bill_Id") %>', '<%# Eval("ChallanDocNo") %>')" class="pad" title="print">

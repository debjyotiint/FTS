    ...
    public partial class ReturnManual : ERP.OMS.ViewState_class.VSPage// System.Web.UI.Page
    {
        ...
        protected void grid_BatchUpdate(object sender, DevExpress.Web.Data.ASPxDataBatchUpdateEventArgs e)
        {
            ...
            if (IsDeleteFrom != "D")
            {
                ...
                //{
                //    tempBillAddress = (DataTable)Session["SRM_QuotationAddressDtl"];
                //}
                //else
                //{
               ...
               .Select(g => g.Key);
                ...
                if (validate == "outrange" || validate == "duplicate" || validate == "checkWarehouse" || validate == "duplicateProduct" || validate == "nullAmount")
                {
       ...
       DataTable CustomerStateCodeDT = new DataTable();
               ...
               // string CustomerStateCode = Convert.ToString(hdnCustomerStateCodeId.Value);
                ...
                if (VendorState.Trim() != "")
                {
                    VendorState = VendorState.Substring(VendorState.IndexOf("(State Code:")).Replace("(State Code:", "").Replace(")", "");
                }

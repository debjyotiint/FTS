...
{
    public partial class CRMOtherActivities : ERP.OMS.ViewState_class.VSPage// System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                rightsSalesOrder = BusinessLogicLayer.CommonBLS.CommonBL.GetUserRightSession("/management/Activities/SalesOrderList.aspx");
                ...
                if (!IsPostBack)
                {
                    ...
                    string ActivityTypeId = Convert.ToString(Request.QueryString["TypId"]);
                    if (ActivityTypeId == "2")
                    {
                        lblOtherActivity.Text = "Email Activity";

                        Label1.Text = "Last Email";
                        Label2.Text = "Email Status";
                        Label3.Text = "Next Email";
                        lblNextDate1.Text = "Next Email Date:";
                        Label21.Text = "Email Status";
                        Page.Title = "Email Activity";
                    }
                    else if (ActivityTypeId == "3")
                    {
                        lblOtherActivity.Text = "Sms Activity";
                        Label1.Text = "Last Sms";
                        Label2.Text = "Sms Status";
                        Label3.Text = "Next Sms";
                        lblNextDate1.Text = "Next Sms Date:";
                        Label21.Text = "Sms Status";
                        Page.Title = "Sms Activity";
                    }
                    else
                    {
                        lblOtherActivity.Text = "Meeting Activity";
                        Label1.Text = "Last Meeting";
                        Label2.Text = "Meeting Status";
                        Label3.Text = "Next Meeting";
                        lblNextDate1.Text = "Next Meeting Date:";
                        Label21.Text = "Meeting Status";
                        Page.Title = "Meeting Activity";
                    }
                    ...
                    if (Convert.ToString(Request.QueryString["TransSale"]) != null)
                    {
                        ...
                        AId = Convert.ToInt32(ActivityTypeId);
                        CallDetailShow(transSaleId, AId);
                ...
                //    ASPxNextDate.Value = Convert.ToDateTime(oDBEngine.GetDate().ToString());
                  //  ASPxNextDate.EditFormatString = objConverter.GetDateFormat("DateTime");
                    ...
                    {
                        if(Convert.ToString(Session["ContactType"]) != "Lead")
                        {  
        ...
        #region Other Activities Status
        public void OtherActivitiesBind()
        {
                ...
                if (!string.IsNullOrEmpty(Request.QueryString["Assigned"]))
                {
                 ...
                 //   ddl_activitystatus.Items.Add(new ListItem("Document Collection", "1", true));
                   ...
                   // ddl_activitystatus.Items.Add(new ListItem("Future Sales", "3"));
                    ...
                    RdActivityList.Items.Add(new ListItem("Future Sales", "3", true));

                    RdActivityList.Items.Add(new ListItem("Clarification Required", "5", true));
                }
        ...
        public void BindActivityTypeList()
        {
            ...
            dtbl = objbl.GetActivityTypeListBySalesActivity(Convert.ToString(Request.QueryString["TransSale"]));
            ...
            if (dtbl != null && dtbl.Rows.Count > 0)
            {
                ...
                li.Text = "Select";
                li.Value = "0";
                drpActType.Items.Insert(0, li);
                drpActType.SelectedIndex = 0;
            }
            }
            catch (Exception ex)
            {
        ...
        public void CallDetailShow(int transSaleId,int ActivityTypeId)
        {
            try
            {
                SlaesActivitiesBL objSlaesActivitiesBL = new SlaesActivitiesBL();
                ...
                string id = "";
                DataTable OtherActivitiesDt = new DataTable();
                OtherActivitiesDt = objSlaesActivitiesBL.GetOtherActivityIdToShowDetail(transSaleId, ActivityTypeId);
                if (OtherActivitiesDt != null && OtherActivitiesDt.Rows.Count > 0)
                {
                    id = Convert.ToString(OtherActivitiesDt.Rows[0]["othActivity_id"]);
                }
        ...
        public void ShowCallDetails(string id)
        {
            ...
            try
            {
                ...
                dt = objBL.GetOtherInfo(id, cntId, transSaleId);
               // dt = oDBEngine.GetDataTable("tbl_trans_OtherActivity INNER JOIN tbl_trans_Activies ON tbl_trans_OtherActivity.othActivity_activityId = tbl_trans_Activies.act_id", "tbl_trans_OtherActivity.othActivity_leadcotactId as othActivity_leadcotactId,tbl_trans_Activies.act_id as act_id,tbl_trans_Activies.act_assignedBy as act_assignedBy,(convert(varchar(11),tbl_trans_Activies.act_createDate,113)+ ' '+ LTRIM(SUBSTRING(CONVERT(VARCHAR(20), tbl_trans_Activies.act_createDate, 22), 10, 5)+ RIGHT(CONVERT(VARCHAR(20), tbl_trans_Activies.act_createDate, 22), 3))) as act_createDate,(convert(varchar(11),tbl_trans_Activies.act_actualStartDate,113)+ ' '+ LTRIM(SUBSTRING(CONVERT(VARCHAR(20), tbl_trans_Activies.act_actualStartDate, 22), 10, 5)+ RIGHT(CONVERT(VARCHAR(20), tbl_trans_Activies.act_actualStartDate, 22), 3))) as act_actualStartDate,tbl_trans_Activies.act_priority as act_priority,convert(varchar(11),tbl_trans_Activies.act_scheduledDate,113)+ LTRIM(SUBSTRING(CONVERT(VARCHAR(20), tbl_trans_Activies.act_scheduledDate, 22), 10, 5))+RIGHT(CONVERT(VARCHAR(20), tbl_trans_Activies.act_scheduledDate, 22), 3)as act_scheduledDate ,tbl_trans_Activies.act_scheduledTime as act_scheduledTime,(convert(varchar(11),tbl_trans_Activies.act_expectedDate,113)+ ' '+ LTRIM(SUBSTRING(CONVERT(VARCHAR(20), tbl_trans_Activies.act_expectedDate, 22), 10, 5)+ RIGHT(CONVERT(VARCHAR(20), tbl_trans_Activies.act_expectedDate, 22), 3)))as act_expectedDate,tbl_trans_Activies.act_expectedTime as act_expectedTime,tbl_trans_Activies.act_instruction as act_instruction", " tbl_trans_OtherActivity.othActivity_id = '" + id + "'");
                if (dt!=null && dt.Rows.Count != 0)
                {
                    ViewState["OthActivityLeadContactId"] = Convert.ToString(dt.Rows[0]["othActivity_leadcotactId"]);
                    Session["LeadId"] = Convert.ToString(ViewState["OthActivityLeadContactId"]);
                    if (Convert.ToString(dt.Rows[0]["othActivity_leadcotactId"]).Substring(0, 2) == "LD")
                    {
                        Session["ContactType"] = "Lead";
                        Session["KeyVal_InternalID"] = Convert.ToString(dt.Rows[0]["othActivity_leadcotactId"]);
                        chkStage.Visible = true;
                    }
                    else if (Convert.ToString(dt.Rows[0]["othActivity_leadcotactId"]).Substring(0, 2) == "CL")
                    {
        ...
        public string getTotalNoOfCalls(string actid)
        {
            ...
            string str = "";
            DataTable dt = new DataTable();
            dt = oDBEngine.GetDataTable("tbl_trans_OtherActivity", "count(othActivity_id)", "othActivity_activityId='" + actid + "'");
            if (dt.Rows.Count != 0)
            {
        ...
        public void JavaScr()
        {
         ...
         //   string today = objConverter.DateConverter(oDBEngine.GetDate().ToString(), "dd/mm/yyyy hh:mm");
          ...
          //  ASPxNextDate.EditFormatString = objConverter.GetDateFormat("DateTime");
         //   ASPxNextDate.Value = Convert.ToDateTime(oDBEngine.GetDate().ToString("yyyy-MM-dd"));
            }
            catch (Exception ex)
            {
                ScriptManager.RegisterStartupScript(this, this.GetType(), "Notify", "alert('Server Internal Error.Please try again');", true);
        ...
        public void LeadInformation(string phcid)
        {
            try
            {
                ...
                Session["otherdetailscallid"] = phcid;
                ...
                dt = oDBEngine.GetDataTable("tbl_trans_OtherActivity INNER JOIN tbl_master_calldispositions ON tbl_trans_OtherActivity.othActivity_callDispose = tbl_master_calldispositions.call_id", "tbl_master_calldispositions.call_dispositions, (convert(varchar(11),tbl_trans_OtherActivity.othActivity_nextCall,113)+ ' '+ LTRIM(SUBSTRING(CONVERT(VARCHAR(20), tbl_trans_OtherActivity.othActivity_nextCall, 22), 10, 5)+ RIGHT(CONVERT(VARCHAR(20), tbl_trans_OtherActivity.othActivity_nextCall, 22), 3))) as othActivity_nextCall, (convert(varchar(11),tbl_trans_OtherActivity.othActivity_callDate,113)+ ' '+ LTRIM(SUBSTRING(CONVERT(VARCHAR(20), tbl_trans_OtherActivity.othActivity_callDate, 22), 10, 5)+ RIGHT(CONVERT(VARCHAR(20) , tbl_trans_OtherActivity.othActivity_callDate, 22), 3))) as othActivity_callDate,othActivity_leadcotactId,othActivity_note,(SELECT tbl_Master_DispositionCategory.Int_id FROM tbl_Master_DispositionCategory INNER JOIN tbl_master_calldispositions ON tbl_Master_DispositionCategory.Int_id = tbl_master_calldispositions.Call_Category WHERE (tbl_master_calldispositions.call_id = othActivity_callDispose)) as Category,othActivity_callDispose", " tbl_trans_OtherActivity.othActivity_id ='" + phcid + "'");
                if (dt.Rows.Count != 0)
                {
                    ...
                    if (Convert.ToString(dt.Rows[0][0]) != "")
                    {
                        ...
                        string callDispose = Convert.ToString(dt.Rows[0]["othActivity_callDispose"]) + "|" + Convert.ToString(dt.Rows[0]["Category"]);
                    }
        ...
        public void filldrpdownlistUserAddress()
        {
            try
            { 
            if (Session["otherdetailscallid"] != null)
            {
                string id = Convert.ToString(Session["otherdetailscallid"]);
                DataTable dt = new DataTable();
                dt = oDBEngine.GetDataTable("tbl_trans_OtherActivity INNER JOIN tbl_master_address ON tbl_trans_OtherActivity.othActivity_leadcotactId = tbl_master_address.add_cntId", "tbl_master_address.add_address1 as Address, tbl_master_address.add_id as Id", " tbl_trans_OtherActivity.othActivity_id='" + id + "'");
                if (dt.Rows.Count != 0)
                {
        ...
        protected void BtnService_Click(object sender, EventArgs e)
        {
            ...
            if (id != "")
            {
                ...
                oDBEngine.SetFieldValue("tbl_trans_OtherActivity", "othActivity_callDate='" + oDBEngine.GetDate().ToString() + "',othActivity_lastCallDuration='0', othActivity_callDispose=6,othActivity_nextCall='" + nextcall + "',LastModifyDate='" + oDBEngine.GetDate().ToString() + "',LastModifyUser='" + Convert.ToString(Session["userid"]) + "'", " othActivity_id='" + id + "'");
                oDBEngine.InsurtFieldValue("tbl_trans_OtherActivityDetails", "otherActivitydtl_othActivity_id, otherActivitydtl_branchId, otherActivitydtl_callDate, otherActivitydtl_callStart, otherActivitydtl_callEnd, otherActivitydtl_callDispose,otherActivitydtl_callduration, otherActivitydtl_note, otherActivitydtl_nextCall,CreateDate,CreateUser", "'" + id + "','" + Convert.ToString(HttpContext.Current.Session["userbranchID"]) + "','" + oDBEngine.GetDate().ToString() + "','" + oDBEngine.GetDate().ToString() + "','" + oDBEngine.GetDate().ToString() + "',6,0,'','" + nextcall + "','" + oDBEngine.GetDate().ToString() + "','" + Convert.ToString(Session["userid"]) + "'");
                oDBEngine.messageTableUpdate(Convert.ToString(Session["userid"]), Convert.ToString(Session["userid"]), "Phone Calls", oDBEngine.GetDate().ToString("yyyy-MM-dd"), nextcall, txtPriority.Text, txtNotes.Text, "0", "message");
                ShowCallDetails(id);
                FillGridUserInfo();
                ...
                if (dt.Rows.Count != 0)
                {
                    ...
                    else
                    {
                        ...
                        {
                            DataTable temp = new DataTable();
                            temp = oDBEngine.GetDataTable("tbl_trans_OtherActivity", "COUNT(othActivity_id)", "othActivity_callDate IS NULL AND othActivity_activityId ='" + Convert.ToString(Session["newactivityid"]) + "'");
        ...
        protected void BtnReachable_Click(object sender, EventArgs e)
        {
            ...
            if (id != "")
            {
                ...
                oDBEngine.SetFieldValue("tbl_trans_OtherActivity", "othActivity_callDate='" + oDBEngine.GetDate().ToString() + "',othActivity_lastCallDuration='0', othActivity_callDispose=2,othActivity_nextCall='" + nextcall + "',LastModifyDate='" + oDBEngine.GetDate().ToString() + "',LastModifyUser='" + Convert.ToString(Session["userid"]) + "'", "othActivity_id='" + id + "'");
                oDBEngine.InsurtFieldValue("tbl_trans_OtherActivityDetails", "otherActivitydtl_othActivity_id,otherActivitydtl_branchId,otherActivitydtl_callDate,otherActivitydtl_callStart,otherActivitydtl_callEnd,otherActivitydtl_callDispose,otherActivitydtl_callduration,otherActivitydtl_note,otherActivitydtl_nextCall,CreateDate,CreateUser", "'" + id + "','" + Convert.ToString(HttpContext.Current.Session["userbranchID"]) + "','" + oDBEngine.GetDate().ToString() + "','" + oDBEngine.GetDate().ToString() + "','" + oDBEngine.GetDate().ToString() + "',2,0,'','" + nextcall + "','" + oDBEngine.GetDate().ToString() + "','" + Convert.ToString(Session["userid"]) + "'");
        ...
        protected void BtnResponse_Click(object sender, EventArgs e)
        {
            ...
            if (id != "")
            {
                ...
                oDBEngine.SetFieldValue("tbl_trans_OtherActivity", "othActivity_callDate='" + oDBEngine.GetDate().ToString() + "',othActivity_lastCallDuration='0',othActivity_callDispose=3,phc_nextCall='" + nextcall + "',LastModifyDate='" + oDBEngine.GetDate().ToString() + "',LastModifyUser='" + Convert.ToString(Session["userid"]) + "'", "othActivity_id='" + id + "'");
                oDBEngine.InsurtFieldValue("tbl_trans_OtherActivityDetails", "otherActivitydtl_othActivity_id, phd_branchId, phd_callDate, phd_callStart, phd_callEnd, phd_callDispose, phd_callduration, phd_note, phd_nextCall,CreateDate,CreateUser", "'" + id + "','" + Convert.ToString(HttpContext.Current.Session["userbranchID"]) + "','" + oDBEngine.GetDate().ToString() + "','" + oDBEngine.GetDate().ToString() + "','" + oDBEngine.GetDate().ToString() + "',3,0,'','" + nextcall + "','" + oDBEngine.GetDate().ToString() + "','" + Convert.ToString(Session["userid"]) + "'");
                oDBEngine.messageTableUpdate(Convert.ToString(Session["userid"]), Convert.ToString(Session["userid"]), "Phone Calls", oDBEngine.GetDate().ToString(), nextcall, txtPriority.Text, txtNotes.Text, "0", "message");
                ShowCallDetails(id);
                FillGridUserInfo();
                LeadInformation(id);
        ...
        protected void BtnExist_Click(object sender, EventArgs e)
        {
            ...
            if (id != "")
            {
                ...
                txtCallDispose.Text = "";
                txtNotes.Text = "";
                oDBEngine.SetFieldValue("tbl_trans_OtherActivity", "othActivity_callDate='" + oDBEngine.GetDate().ToString() + "',othActivity_lastCallDuration='0',othActivity_callDispose=3,othActivity_nextCall='',LastModifyDate='" + oDBEngine.GetDate().ToString() + "',LastModifyUser='" + Convert.ToString(Session["userid"]) + "'", "othActivity_id='" + id + "'");
                oDBEngine.InsurtFieldValue("tbl_trans_OtherActivityDetails", "otherActivitydtl_othActivity_id,otherActivitydtl_branchId,otherActivitydtl_callDate,otherActivitydtl_callStart,otherActivitydtl_callEnd,otherActivitydtl_callDispose,otherActivitydtl_callduration,otherActivitydtl_note,otherActivitydtl_nextCall,CreateDate,CreateUser", "'" + id + "','" + Convert.ToString(HttpContext.Current.Session["userbranchID"]) + "','" + oDBEngine.GetDate().ToString() + "','" + oDBEngine.GetDate().ToString() + "','" + oDBEngine.GetDate().ToString() + "',3,0,'','','" + oDBEngine.GetDate().ToString() + "','" + Convert.ToString(Session["userid"]) + "'");
        ...
        protected void btnSavePhoneCallDetails_Click(object sender, EventArgs e)
        {
            try
            { 
            int AId = Convert.ToInt32(Request.QueryString["TypId"]);
           int transSaleId= Convert.ToInt32(Request.QueryString["TransSale"]);
            SlaesActivitiesBL objSlaesActivitiesBL = new SlaesActivitiesBL();
            string date = oDBEngine.GetDate().ToString("yyyy-MM-dd HH:mm:ss");
            ViewState["callstart"] = date.ToString();
            //TxtNext.Visible = false;
            ...
            DataTable OtherActivitiesDt = new DataTable();
            OtherActivitiesDt = objSlaesActivitiesBL.GetOtherActivityIdToShowDetail(transSaleId, AId);
            if (OtherActivitiesDt != null && OtherActivitiesDt.Rows.Count > 0)
            {
                Cid1 = Convert.ToString(OtherActivitiesDt.Rows[0]["othActivity_leadcotactId"]);
            }


            //string str = objConverter.DateConverter(ASPxNextDate.Text, "mm/dd/yyyy hh:mm");
           // string str = Convert.ToDateTime(ASPxNextDate.Value).ToString("yyyy-MM-dd");

            var curr = DateTime.Now;
            String s = curr.ToString("HH:mm:ss");

          
            DateTime dtOther = Convert.ToDateTime(ASPxNextDate.Value);

            if (Convert.ToDateTime(curr).ToString("yyyy-MM-dd") == Convert.ToDateTime(dtOther).ToString("yyyy-MM-dd") && (Request.QueryString["Pid"] == "3"))
            {
                ScriptManager.RegisterStartupScript(this, this.GetType(), "redirect", "SameDate();", true);

            }
            DateTime time = Convert.ToDateTime(s);
            DateTime dtCOMPLTDTTM = new DateTime(dtOther.Year, dtOther.Month, dtOther.Day, time.Hour, time.Minute, time.Second);
            ...
            if (Session["otherdetailscallid"] != null)
            {
                phonecallid = Convert.ToString(Session["otherdetailscallid"]);
            }
            else
            {
                phonecallid = "0";
            }
            flag = Convert.ToBoolean(oDBEngine.InsurtFieldValue("tbl_trans_OtherActivityDetails", "otherActivitydtl_othActivity_id,otherActivitydtl_branchId,otherActivitydtl_callDate,otherActivitydtl_callStart,otherActivitydtl_callEnd,otherActivitydtl_callDispose,otherActivitydtl_note,otherActivitydtl_nextCall,otherActivitydtl_callduration,CreateDate,CreateUser", "'" + phonecallid + "','" + branchid + "','" + calldate + "','" + CallStart + "','" + call + "','" + calldispose + "','" + txtNotes.Text + "','" + str + "','" + Callduration + "','" + oDBEngine.GetDate().ToString("yyyy-MM-dd HH:mm:ss") + "','" + Convert.ToString(Session["userid"]) + "'"));
            if (flag)
            {
                ...
                flag = Convert.ToBoolean(oDBEngine.SetFieldValue("tbl_trans_OtherActivity", "othActivity_callDate='" + calldate + "',othActivity_callDispose='" + calldispose + "',othActivity_nextCall='" + str + "',othActivity_note='" + txtNotes.Text + "',othActivity_lastCallDuration='" + Callduration + "',othActivity_addId='" + Convert.ToString(drpVisitPlace.SelectedValue) + "',LastModifyDate='" + oDBEngine.GetDate().ToString() + "',LastModifyUser='" + Convert.ToString(Session["userid"]) + "'", "othActivity_id='" + Convert.ToString(Session["otherdetailscallid"]) + "'"));
                ...
                DataTable dt = new DataTable();
                oDBEngine.messageTableUpdate(Convert.ToString(Session["otherdetailscallid"]), Convert.ToString(Session["userid"]), "Phone Calls", oDBEngine.GetDate().ToString(), str, txtPriority.Text, txtNotes.Text, "0", "message");
            ...
            {
                string val = "";
                string[,] val1 = oDBEngine.GetFieldValue("tbl_master_address", "add_id", " add_cntId='" + Convert.ToString(ViewState["OthActivityLeadContactId"]) + "'", 1);
                if (val1[0, 0] != "n")
                {
                    val = val1[0, 0];
                }
                DataTable address = new DataTable();
                string id123 = "0";
                address = oDBEngine.GetDataTable("tbl_master_address", "*", " add_cntId='" + Convert.ToString(ViewState["OthActivityLeadContactId"]) + "'");
                bool fi = false;
                try
                {
            ...
            //{
            //    oDBEngine.SetFieldValue("tbl_trans_sales", "sls_nextvisitdate='" + str + "',sls_sales_status='" + ddl_activitystatus.SelectedValue + "',sls_dateTime='" + oDBEngine.GetDate().ToString() + "', LastModifyDate='" + oDBEngine.GetDate().ToString() + "',LastModifyUser='" + Session["userid"].ToString() + "'", " sls_id='" + Request.QueryString["TransSale"].ToString() + "'");
            //}
            ...
            if (chkMail.Checked)
            {
                ...
                string typeId = Convert.ToString(Request.QueryString["TypId"]);
                ...
                if (!string.IsNullOrEmpty(RecvEmail))
                {
                    if(typeId=="5")//Meeting
                    {
                        ...
                        MeetingMailStatus = ExceptionLogging.SendEmailToAssigneeByUser(RecvEmail, "", replacements, dt_EmailConfig, ActvName, 11);
                        if (MeetingMailStatus == 1)
                        {
                            ScriptManager.RegisterStartupScript(this, this.GetType(), "Notify", "jAlert('Mail Send');", true);
                            return;
                        }
                        else if (MeetingMailStatus == -1)
                        {
                    ...
                    {
                        int SmsMailStatus;
                        SmsMailStatus = ExceptionLogging.SendEmailToAssigneeByUser(RecvEmail, "", replacements, dt_EmailConfig, ActvName, 9);
                    ...
                    {
                        int EmailMailStatus;
                        EmailMailStatus = ExceptionLogging.SendEmailToAssigneeByUser(RecvEmail, "", replacements, dt_EmailConfig, ActvName, 8);
                        if (EmailMailStatus == 1)
                        {
                            ScriptManager.RegisterStartupScript(this, this.GetType(), "Notify", "jAlert('Mail Send');", true);
                            return;
                        }
                        else if (EmailMailStatus == -1)
                        {
                            ScriptManager.RegisterStartupScript(this, this.GetType(), "Notify", "jAlert('Mail Not Send.Please try again');", true);
                            return;
                        }
            ...
            // .............................Code Commented and Added by Sam on 29122016. ..................................... 
            ///ScriptManager.RegisterStartupScript(this, this.GetType(), "Message", "jAlert('Saved sucessfully');window.location ='crm_sales.aspx';", true);
          ...
          //  ScriptManager.RegisterStartupScript(this, this.GetType(), "redirect", "popUpRedirect('" + ConfigurationManager.AppSettings["SiteURL"].ToString() + "OMS/Management/Activities/crm_sales.aspx');", true);
        ...
        protected void BtnExist_Click1(object sender, EventArgs e)
        {
            ...
            if (id != "")
            {
                ...
                txtCallDispose.Text = "";
                txtNotes.Text = "";
                oDBEngine.SetFieldValue("tbl_trans_OtherActivity", "othActivity_callDate='" + oDBEngine.GetDate().ToString() + "',othActivity_lastCallDuration='0',othActivity_callDispose=5,othActivity_nextCall='',LastModifyDate='" + oDBEngine.GetDate().ToString() + "',LastModifyUser='" + Convert.ToString(Session["userid"]) + "'", "othActivity_id='" + id + "'");
                oDBEngine.InsurtFieldValue("tbl_trans_OtherActivityDetails", "otherActivitydtl_othActivity_id,otherActivitydtl_branchId,otherActivitydtl_callDate,otherActivitydtl_callStart,otherActivitydtl_callEnd,otherActivitydtl_callDispose,otherActivitydtl_callduration, otherActivitydtl_note,otherActivitydtl_nextCall,CreateDate,CreateUser", "'" + id + "','" + Convert.ToString(HttpContext.Current.Session["userbranchID"]) + "','" + oDBEngine.GetDate().ToString() + "','" + oDBEngine.GetDate().ToString() + "','" + oDBEngine.GetDate().ToString() + "',5,0,'','','" + oDBEngine.GetDate().ToString() + "','" + Convert.ToString(Session["userid"]) + "'");
                ShowCallDetails(id);
                FillGridUserInfo();
                LeadInformation(id);
                DataTable dt = oDBEngine.GetDataTable("tbl_trans_Activies", "act_actualStartDate,act_actualEndDate", " act_id='" + Convert.ToString(Session["newactivityid"]) + "'");
        ...
        public void bindClassandCustomer()
        {
            if (!string.IsNullOrEmpty(Request.QueryString["TransSale"]) && !string.IsNullOrEmpty(Request.QueryString["type"]))
            {
                ...
                {
                    lblcustomer1.Text = Convert.ToString(ds.Rows[0]["CustomerName"]);

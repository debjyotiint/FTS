...
{
    public partial class UndeliveryReturnList : ERP.OMS.ViewState_class.VSPage// System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (Session["LastCompany"] != null && Session["LastCompany"] != null)
                {
                    ...
                    GrdSalesReturn.SettingsCookies.CookiesID = "BreeezeErpGridCookiesSalesReturnUndeliveryNormalListDetailsGrid";
                    this.Page.ClientScript.RegisterStartupScript(GetType(), "heightL", "<script>addCookiesKeyOnStorage('BreeezeErpGridCookiesSalesReturnUndeliveryNormalListDetailsGrid');</script>");
        ...
        public void bindexport(int Filter)
        {
            ...
            string filename = "Undelivery Return";
            ...
            exporter.PageHeader.Left = "Undelivery Return";
        ...
        protected void GrdSalesReturn_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            if (Command == "Delete")
            {
                ...
                int deletecnt = 0;
                deletecnt = objSalesReturnBL.DeleteSalesReturn(SalesReturnID, Convert.ToString(HttpContext.Current.Session["LastCompany"]), Convert.ToString(Session["LastFinYear"]), "USR", Convert.ToString(Session["userbranchID"]));
                if (deletecnt == 1)
                {
        ...
        protected void EntityServerModeDataSource_Selecting(object sender, DevExpress.Data.Linq.LinqServerModeDataSourceSelectEventArgs e)
        {
            ...
            if (IsFilter == "Y")
            {
                if (strBranchID == "0")
                {
                    ...
                    var q = from d in dc.v_UndeliveryReturnLists

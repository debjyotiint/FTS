...
namespace ERP.OMS.Management.Activities
{
    public partial class TSalesInvoiceList : VSPage //: System.Web.UI.Page
    {
        ...
        protected void GrdQuotation_PageIndexChanged(object sender, EventArgs e)
        {
            //if (Session["TSBList"] != null)
            //{
            //    DataTable TPBdt = (DataTable)Session["TSBList"];
            //    GrdQuotation.DataSource = TPBdt;
            //    GrdQuotation.DataBind();
            //}
            //else
            //{
            //    GetQuotationListGridData(Convert.ToString(HttpContext.Current.Session["userbranchHierarchy"]), Convert.ToString(HttpContext.Current.Session["LastCompany"]), Convert.ToString(HttpContext.Current.Session["LastFinYear"]));

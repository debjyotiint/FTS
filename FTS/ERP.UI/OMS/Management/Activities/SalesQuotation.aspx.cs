...
namespace ERP.OMS.Management.Activities
{
    public partial class SalesQuotation : ERP.OMS.ViewState_class.VSPage
    {
        ...
        protected void grid_BatchUpdate(object sender, DevExpress.Web.Data.ASPxDataBatchUpdateEventArgs e)
        {
            ...
            if (IsDeleteFrom != "D")
            {
               ...
               .Select(g => g.Key);
                ...
                if (Convert.ToString(BillingShippingControl.GetShippingStateCode()).Trim()=="")
                {
                    validate = "nullStateCode";
                }

                if (validate == "outrange" || validate == "duplicate" || validate == "checkWarehouse" || validate == "duplicateProduct" || validate == "nullAmount" || validate == "nullQuantity" || validate == "errorUdf" || validate == "transporteMandatory" || validate == "nullStateCode" || validate == "TCMandatory" || validate == "BillingShippingNull")
                {
        ...
        public void ModifyQuatation(string QuotationID, string strSchemeType, string strQuoteNo, string strQuoteDate, string strQuoteExpiry, string strCustomer, string strContactName,
                                    ...
                                    ref int strIsComplete, ref int strQuoteID, string strIsInventory)
        {
            try
            {

...
{
    public partial class Replacementnotestockout : ERP.OMS.ViewState_class.VSPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (Request.QueryString["keyM"] != null)
                {
                    rights.CanEdit = true;
                    GridReplacementBind(Request.QueryString["keyM"]);
        ...
        protected void NumberingScheme()
        {
            ...
            DataTable Schemadt = objreplacement1.GetNumberingSchema(strCompanyID, strBranchID, FinYear, "38", "Y");
        ...
        public void GridReplacementBind(string ReplacementId)
        {
            ...
            if (ds.Tables.Count > 0)
            {
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    DataTable ComponentTable = objreplacement1.GetComponentInvoice(lookup_Customer.Value.ToString(), dt_date.Value.ToString(), FinYear, ddl_Branch.SelectedValue);
        ...
        protected void gridReplacement_BatchUpdate(object sender, DevExpress.Web.Data.ASPxDataBatchUpdateEventArgs e)
        {
            ...
            if (replacementList != null)
            {
                ...
                if (Request.QueryString["keyM"] != null)
                {
                    model.ReplacementId = Convert.ToInt32(Request.QueryString["keyM"]);
        ...
        protected void ComponentQuotation_Callback(object source, DevExpress.Web.CallbackEventArgsBase e)
        {
            ...
            if (e.Parameter.Split('~')[0] == "BindComponentGrid")
            {
                ...
                DataTable ComponentTable = objreplacement1.GetComponentInvoice(Customer, InvoicecreatedDate, FinYear, BranchId);
                if (ComponentTable.Rows.Count > 0)
                {
        ...
        protected void GrdWarehouse_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            else if (strSplitCommand == "SaveDisplay")
            {
                ...
                string ReplacementId = Convert.ToString(Request.QueryString["keyM"]);

...
<asp:content id="Content2" contentplaceholderid="ContentPlaceHolder1" runat="server">
    ...
    <div class="GridViewArea">
        <dxe:ASPxGridView ID="GrdOrder" runat="server" KeyFieldName="Service_Id" AutoGenerateColumns="False"
            Width="100%" ClientInstanceName="cGrdOrder" OnCustomCallback="GrdOrder_CustomCallback" DataSourceID="EntityServerModeDataSource">
            <Columns>
               <dxe:GridViewDataTextColumn Visible="False" FieldName="Service_Id" Caption="Service_Id" SortOrder="Descending">
                ...
                <dxe:GridViewDataTextColumn Caption="Issue No." FieldName="Service_No"
                    VisibleIndex="0" FixedStyle="Left">
                    <CellStyle CssClass="gridcellleft" Wrap="true">
                    </CellStyle>
                </dxe:GridViewDataTextColumn>
                 <dxe:GridViewDataTextColumn Caption="Date" FieldName="Service_Date"  
                    VisibleIndex="0" FixedStyle="Left">
                    <CellStyle CssClass="gridcellleft" Wrap="true">
                    </CellStyle>

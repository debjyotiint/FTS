<%@ Page Title="Purchase Invoice For Transporter" Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" 
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel-heading clearfix">
        <div class="panel-title pull-left">
            <h3>Purchase Invoice For Transporter</h3>
        </div>
           ...
           DataSourceID="EntityServerModeDataSource"  >
            <Columns>
                <dxe:GridViewDataTextColumn Caption="Purchase Invoice No" FieldName="InvoiceNumber" VisibleIndex="0"  Width="130px">
                 ...
                 <dxe:GridViewDataTextColumn Caption="Date" FieldName="InvoiceDate" VisibleIndex="1" Width="85px">
                    <CellStyle CssClass="gridcellleft" Wrap="true">
                    </CellStyle>
                    <Settings AutoFilterCondition="Contains" />
                </dxe:GridViewDataTextColumn>
                ...
                <dxe:GridViewDataTextColumn HeaderStyle-HorizontalAlign="Center" CellStyle-HorizontalAlign="center" VisibleIndex="13" width="130px">
                    <DataItemTemplate>
                        ...
                        <% if (rights.CanEdit)
                                       { %>
                        <a href="javascript:void(0);" onclick="OnEditClick('<%# Container.KeyValue %>')" class="pad" title="Edit">

...
{
    public partial class StockinReturnNormal : ERP.OMS.ViewState_class.VSPage// System.Web.UI.Page
    {
        ...
        {
            rights = BusinessLogicLayer.CommonBLS.CommonBL.GetUserRightSession("/management/Activities/StockinReturnNormal.aspx");
            ...
            if (!IsPostBack)
            {
                this.Session["LastCompanySISRN"] = Session["LastCompany"];
                this.Session["LastFinYearSISRN"] = Session["LastFinYear"];
                ...
                Session["SISRN_BillingAddressLookup"] = null;
                Session["SISRN_ShippingAddressLookup"] = null;
                ...
                Session["SISRN_ReturnID"] = "";
                Session["SISRN_CustomerDetail"] = null;
                Session["SISRN_QuotationDetails"] = null;
                Session["SISRN_WarehouseData"] = null;
                Session["SISRN_QuotationTaxDetails"] = null;
                Session["LoopSRNWarehouse"] = 1;
                Session["SISRN_TaxDetails"] = null;
                Session["SISRN_ActionType"] = "";

                Session["TaggingNInvoce"] = "";
                Session["SISRN_ComponentData"] = null;
                Session["SRNwarehousedetailstemp"] = null;
                Session["SRNwarehousedetailstempUpdate"] = null;
                Session["SRNwarehousedetailstempDelete"] = null;
                ...
                Session["SISRN_QuotationAddressDtl"] = null;
                ...
                if (Request.QueryString["key"] != null)
                {
                    if (Convert.ToString(Request.QueryString["key"]) != "ADD")
                    {
                        ...
                        Session["SISRN_ReturnID"] = strSalesReturnId;
                        Session["SISRN_ActionType"] = "Edit";
                        SetSalesReturnDetails(strSalesReturnId);
                        //  DateTime quoteDate = Convert.ToDateTime(dt_PLQuote.Date.ToString("dd/MM/yyyy"));
                        Session["SISRN_TaxDetails"] = GetTaxDataWithGST(GetTaxData(dt_PLQuote.Date.ToString("yyyy-MM-dd")));

                        //  Session["SISRN_WarehouseData"] = GetQuotationWarehouseData();
                        ...
                        Session["SISRN_QuotationDetails"] = Productdt;
                        ...
                        {
                            Session["SISRN_WarehouseData"] = dt;
                        }

                        //if (dt == null || dt.Rows.Count == 0)
                        //{

                        //    string commaSeparatedString = Convert.ToString(Session["InvoiceIds"]);
                        //    dt = GetInvoiceWarehouse(commaSeparatedString);
                        //}
                        //Session["SISRN_WarehouseData"] = dt;

                        Session["SISRN_QuotationAddressDtl"] = objSalesReturnBL.GetSalesReturnBillingAddress(strSalesReturnId); ;
                        ...
                        if (GetQuotationTaxData().Tables[0] != null)
                            Session["SISRN_QuotationTaxDetails"] = GetQuotationTaxData().Tables[0];
                        ...
                        if (GetQuotationEditedTaxData().Tables[0] != null)
                        {
                            ...
                            {
                                Session["SISRN_FinalTaxRecord"] = quotetable;
                            }
                        }
                        ...
                        {
                            lblHeadTitle.Text = "View  Receive Against Normal Return";
                        ...
                        //Billing/Shipping Address can not be modified in for this module only.
                    ...
                    else
                    {
                        ...
                        if (Session["SISRN_SaveMode"] != null)  // it has been removed from coding side of Quotation list 
                        {
                            if (Session["SISRN_schemavalue"] != null)  // it has been removed from coding side of Quotation list 
                            {
                                ddl_numberingScheme.SelectedValue = Convert.ToString(Session["SISRN_schemavalue"]); // it has been removed from coding side of Quotation list 
                            }
                            if (Convert.ToString(Session["SISRN_SaveMode"]) == "A")
                            {
                                dt_PLQuote.Focus();
                                txt_PLQuoteNo.ClientEnabled = false;
                                txt_PLQuoteNo.Text = "Auto";
                            }
                            else if (Convert.ToString(Session["SISRN_SaveMode"]) == "M")
                            {
                        ...
                        Session["SISRN_ActionType"] = "Add";
                        //ASPxButton2.Enabled = false;
                        Session["SISRN_TaxDetails"] = null;
                        CreateDataTaxTable();
                        lblHeadTitle.Text = "Add Receive Against Normal Return";
        ...
        public DataSet GetQuotationData()
        {
            ...
            proc.AddVarcharPara("@QuotationID", 500, Convert.ToString(Session["SISRN_ReturnID"]));
            ds = proc.GetDataSet();
            return ds;
        }
        ...
        protected void grid_BatchUpdate(object sender, DevExpress.Web.Data.ASPxDataBatchUpdateEventArgs e)
        {
            ...
            if (Session["SISRN_QuotationDetails"] != null)
            {
                Quotationdt = (DataTable)Session["SISRN_QuotationDetails"];
            }
            else
            {
            ...
            Session["SISRN_QuotationDetails"] = Quotationdt;
            ...
            if (IsDeleteFrom != "D")
            {
                ...
                string ActionType = Convert.ToString(Session["SISRN_ActionType"]);
                string MainInvoiceID = Convert.ToString(Session["SISRN_ReturnID"]);
                ...
                if (Session["SISRN_FinalTaxRecord"] != null)
                {
                    TaxDetailTable = (DataTable)Session["SISRN_FinalTaxRecord"];
                }

                // DataTable of Warehouse

                DataTable tempWarehousedt = new DataTable();
                if (Session["SISRN_WarehouseData"] != null)
                {
                    DataTable Warehousedt = (DataTable)Session["SISRN_WarehouseData"];
                ...
                if (Session["SISRN_TaxDetails"] != null)
                {
                    TaxDetailsdt = (DataTable)Session["SISRN_TaxDetails"];
                }
                else
                {
                ...
                //Old Code
                //if (Session["SISRN_QuotationAddressDtl"] != null)
                //{
                //    tempBillAddress = (DataTable)Session["SISRN_QuotationAddressDtl"];
                //}
                //else
                //{
                ...
                foreach (DataRow dr in tempQuotation.Rows)
                {
                    ...
                    string strSalesReturnId = Convert.ToString(Request.QueryString["key"]);
                    //check warehouse exist
                    DataTable DTWH = new DataTable();

                    DTWH = objSalesReturnBL.GetStkWHDetails("SISRN", strSalesReturnId);
               ...
               .Select(g => g.Key);
                ...
                if (validate == "outrange" || validate == "duplicate" || validate == "checkWarehouse" || validate == "duplicateProduct" || validate == "nullAmount" || validate == "nullQuantity")
                {
                ...
                else
                {
                    ...
                    #region To Show By Default Cursor after SAVE AND NEW
                    if (Convert.ToString(Session["SISRN_ActionType"]) == "Add") // session has been removed from quotation list page working good
                    {
                        string[] schemaid = new string[] { };
                        string schemavalue = ddl_numberingScheme.SelectedValue;
                        Session["SISRN_schemavalue"] = schemavalue;        // session has been removed from quotation list page working good
                        ...
                        if (hdnRefreshType.Value == "N")
                        {
                            if (schematype == "1")
                            {
                                Session["SISRN_SaveMode"] = "A";
                            }
                            else
                            {
                                Session["SISRN_SaveMode"] = "M";
                            }
                        }
                    }
        ...
        protected void grid_DataBinding(object sender, EventArgs e)
        {
            ...
            if (Session["SISRN_QuotationDetails"] != null)
            {
                DataTable Quotationdt = (DataTable)Session["SISRN_QuotationDetails"];
        ...
        protected void grid_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            else if (strSplitCommand == "RemoveDisplay")
            {
                ...
                if (Session["SISRN_QuotationDetails"] != null)
                {
                    salesReturndt = (DataTable)Session["SISRN_QuotationDetails"];
                }
                ...
                Session["SISRN_QuotationDetails"] = salesReturndt;
                grid.DataBind();
            ...
            else if (strSplitCommand == "BindGridOnQuotation")
            {
                ...
                //   Session["SISRN_QuotationAddressDtl"]


                //Session["SISRN_QuotationAddressDtl"] = GetComponentEditedAddressData(InvoiceDetails_Id, "SI");
                //if (Session["SISRN_QuotationAddressDtl"] != null)
                //{
                //    DataTable dt = (DataTable)Session["SISRN_QuotationAddressDtl"];
                //    if (dt != null && dt.Rows.Count > 0)
                //    {
                //        if (dt.Rows.Count == 2)
                //        {
                                    ...
                                    ref int strIsComplete, ref int strInvoiceID, string ReasonforReturn)
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("prc_CRMSalesReturn", con);
                ...
                cmd.Parameters.AddWithValue("@ComponentType", "SISRN");
                ...
                DataTable Quotationdt = new DataTable();
                //  DataTable Warehousedtssss = Warehousedt;
                ...
                Billdt.Columns.Add("AddressType", typeof(string));
                Billdt.Columns.Add("Address1", typeof(string));
                Billdt.Columns.Add("Address2", typeof(string));
                Billdt.Columns.Add("Address3", typeof(string));
                Billdt.Columns.Add("LandMark", typeof(string));
                Billdt.Columns.Add("CountryID", typeof(int));
                Billdt.Columns.Add("StateID ", typeof(int));
                Billdt.Columns.Add("CityID", typeof(int));
                Billdt.Columns.Add("Pincode", typeof(string));
                Billdt.Columns.Add("Area", typeof(string));
                Billdt.Columns.Add("GSTIN", typeof(string));
                Billdt.Columns.Add("ShipToParty", typeof(string));

                cmd.Parameters.AddWithValue("@BillAddress", Billdt);
        ...
        public DataTable GetTaxData(string quoteDate)
        {
            ...
            proc.AddVarcharPara("@SalesReturnID", 500, Convert.ToString(Session["SISRN_ReturnID"]));
            proc.AddVarcharPara("@FinYear", 500, Convert.ToString(Session["LastFinYear"]));
            proc.AddVarcharPara("@branchId", 500, Convert.ToString(Session["userbranchID"]));
            proc.AddVarcharPara("@companyId", 500, Convert.ToString(Session["LastCompany"]));
        ...
        protected void gridTax_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            if (strSplitCommand == "Display")
            {
                ...
                if (Session["SISRN_TaxDetails"] == null)
                {
                    Session["SISRN_TaxDetails"] = GetTaxData(dt_PLQuote.Date.ToString("yyyy-MM-dd"));
                }
            ...
            else if (strSplitCommand == "SaveGst")
            {
                ...
                else
                {
                    ...
                    Session["SISRN_TaxDetails"] = TaxDetailsdt;
                }
            }
        }
        ...
        protected void gridTax_DataBinding(object sender, EventArgs e)
        {
            if (Session["SISRN_TaxDetails"] != null)
            {
                DataTable TaxDetailsdt = (DataTable)Session["SISRN_TaxDetails"];
        ...
        //            if (Session["SISRN_WarehouseData"] != null)
        //            {
        //                Warehousedt = (DataTable)Session["SISRN_WarehouseData"];
        //            }
        //            else
        //            {
        ...
        //            if (Session["SISRN_WarehouseData"] != null)
        //            {
        //                DataTable Warehousedts = (DataTable)Session["SISRN_WarehouseData"];
        ...
        //                    Session["SISRN_WarehouseData"] = Warehousedt;
        ...
        //    {
        //        if (Session["SISRN_WarehouseData"] == null && hdnisolddeleted.Value == "false")
        //        {
        ...
        //        }
        //        else if (Session["SISRN_WarehouseData"] == null && hdnisolddeleted.Value == "true")
        //        {
        ...
        //            if (newrowcount != 0 || updaterows != 0 || Session["SISRNWarehouseDataDelete"] != null)
        //            {
        //                decimal inputqnty = 0;
        //                decimal totalopeining = Convert.ToDecimal(hdfopeningstockPC.Value);
        //                decimal oldtotalopeining = Convert.ToDecimal(oldopeningqntity.Value);
        ...
        //        Session["SISRNWarehouseUpdatedData"] = null;
        //        Session["SISRNWarehouseDataDelete"] = null;
        ...
        //            Session["SISRNWarehouseUpdatedData"] = Warehousedt;
        ...
        //            if (drs.Count() != 0)
        //            {
        //                if (Session["SISRNWarehouseDataDelete"] != null)
        //                {
        //                    setdeletedate = drs.CopyToDataTable();
        //                    DataTable dtmp = (DataTable)Session["SISRNWarehouseDataDelete"];
        //                    dtmp.Merge(setdeletedate);
        //                    Session["SISRNWarehouseDataDelete"] = dtmp;
        //                }
        //                else
        //                {
        //                    setdeletedate = drs.CopyToDataTable();
        //                    Session["SISRNWarehouseDataDelete"] = setdeletedate;
        //                }
        ...
        //                GrdWarehousePC.DataSource = Session["SISRN_WarehouseData"];
        //                GrdWarehousePC.DataBind();
        //            }
        //            else
        //            {
        ...
        //        {
        //            //if (!string.IsNullOrEmpty(Convert.ToString(dts.Rows[i]["BatchWarehouseID"])) && Convert.ToString(dts.Rows[i]["BatchWarehouseID"]) != "0" && Convert.ToString(Session["SISRN_ActionType"]) == "Edit")
        //            //
        //            if (!string.IsNullOrEmpty(Convert.ToString(dts.Rows[i]["BatchWarehouseID"])) && Convert.ToString(dts.Rows[i]["BatchWarehouseID"]) != "0" && isExist == "1")
        //            {
        //                isoldornew = "old";
        //            }
        //            else
        ...
        //        if (Session["SRNwarehousedetailstemp"] != null)
        //        {
        //            temtable23 = (DataTable)Session["SRNwarehousedetailstemp"];
        //            DataRow[] rows;
        ...
        //            Session["SRNwarehousedetailstemp"] = temtable23;
        //        }
        //        else
        //        {
        //            Session["SRNwarehousedetailstemp"] = temtable;
        //        }
        ...
        //    {
        //        DataTable dt = new DataTable();
        //        DataTable Warehousedtups = (DataTable)Session["SISRN_WarehouseData"];
        //        DataRow[] dr = Warehousedtups.Select("isnew = 'Updated'");
        //        if (dr.Count() != 0)
        //        {
        //            dt = dr.CopyToDataTable();
        //            if (Session["SRNwarehousedetailstempUpdate"] != null)
        //            {
        //                temtable23 = (DataTable)Session["SRNwarehousedetailstempUpdate"];
        //                DataRow[] rows;
        //                rows = temtable23.Select("pcslno = '" + hdnpcslno.Value + "'");  //'UserName' is ColumnName
        //                foreach (DataRow row in rows)
        //                    temtable23.Rows.Remove(row);
        ...
        //                temtable23.Merge(dt);
        //                Session["SRNwarehousedetailstempUpdate"] = temtable23;
        //            }
        //            else
        //            {
        //                Session["SRNwarehousedetailstempUpdate"] = dt;
        //            }
        ...
        //    {
        //        DataTable dt = new DataTable();
        //        DataTable Warehousedtups = (DataTable)Session["SISRNWarehouseDataDelete"];
        ...
        //        {
        //            dt = dr.CopyToDataTable();
        //            if (Session["SRNwarehousedetailstempDelete"] != null)
        //            {
        //                temtable23 = (DataTable)Session["SRNwarehousedetailstempDelete"];
        //                DataRow[] rows;
        //                rows = temtable23.Select("pcslno = '" + hdnpcslno.Value + "'");  //'UserName' is ColumnName
        //                foreach (DataRow row in rows)
        //                    temtable23.Rows.Remove(row);
        ...
        //                temtable23.Merge(dt);
        //                Session["SRNwarehousedetailstempDelete"] = temtable23;
        //            }
        //            else
        //            {
        //                Session["SRNwarehousedetailstempDelete"] = dt;
        //            }
        ...
        //        cmd.Parameters.AddWithValue("@Finyear", Convert.ToString(Session["LastFinYear"]));
        //        cmd.Parameters.AddWithValue("@PCNumber", Convert.ToString(Session["SISRN_ReturnID"]));
        //        cmd.Parameters.AddWithValue("@PCType", "SISRN");
        ...
        //            if (Session["SRNwarehousedetailstemp"] != null)
        //            {
        //                DataTable Warehousedtss = (DataTable)Session["SRNwarehousedetailstemp"];
        ...
        //                    Session["SRWNarehouseDatabyslno"] = Warehousedtss;

        //                    dt2 = (DataTable)Session["SRWNarehouseDatabyslno"];
        ...
        //   else if (DTWH == null || DTWH.Rows.Count == 0)
        //    {
        //        DataSet dsInst = new DataSet();
        //        SqlConnection con = new SqlConnection(ConfigurationManager.AppSettings["DBConnectionDefault"]);
        //        SqlCommand cmd = new SqlCommand("prc_StockGetPCwarehousentry", con);
        ...
        //        }
        //    }
        //    else if (Session["SRNwarehousedetailstemp"] != null)
        //    {
        //        DataTable Warehousedtss = (DataTable)Session["SRNwarehousedetailstemp"];
        ...
        //            dt = (DataTable)Session["SRWNarehouseDatabyslno"];
        ...
        //        DataTable Warehousedtups = (DataTable)Session["SRNwarehousedetailstempDelete"];
        ...
        //    if (Session["SISRNWarehouseDataDelete"] != null)
        //    {
        //        DataTable Warehousedts = (DataTable)Session["SISRNWarehouseDataDelete"];
        ...
        protected void taxUpdatePanel_Callback(object source, DevExpress.Web.CallbackEventArgsBase e)
        {
            ...
            {
                DataTable MainTaxDataTable = (DataTable)Session["SISRN_FinalTaxRecord"];
                ...
                Session["SISRN_FinalTaxRecord"] = MainTaxDataTable;
                GetStock(Convert.ToString(performpara.Split('~')[1]));
                // DeleteWarehouse(Convert.ToString(performpara.Split('~')[1]));
                DataTable taxDetails = (DataTable)Session["SISRN_TaxDetails"];
                if (taxDetails != null)
                {
                    ...
                    Session["SISRN_TaxDetails"] = taxDetails;
                }
            }
        ...
        public void CreateDataTaxTable()
        {
            ...
            Session["SISRN_FinalTaxRecord"] = TaxRecord;
        }
        ...
        protected void cgridTax_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            {
                DataTable TaxRecord = (DataTable)Session["SISRN_FinalTaxRecord"];
            ...
            else
            {
                ...
                DataTable MainTaxDataTable = (DataTable)Session["SISRN_FinalTaxRecord"];
                DataTable databaseReturnTable = (DataTable)Session["SISRN_QuotationTaxDetails"];
        ...
        public void DeleteTaxDetails(string SrlNo)
        {
            ...
            if (Session["SISRN_FinalTaxRecord"] != null)
            {
                ...
                Session["SISRN_FinalTaxRecord"] = TaxDetailTable;
            }
        }
        ...
        //    {
        //        Session["SISRN_BillingAddressLookup"] = dst.Tables[0];
        //    }
        //    shippingAddress.DataSource = dst.Tables[1];
        //    shippingAddress.DataBind();
        //    if (dst.Tables[1].Rows.Count > 0)
        //    {
        //        Session["SISRN_ShippingAddressLookup"] = dst.Tables[1];
        //    }
        ...
        //        else if (Session["SISRN_QuotationAddressDtl"] != null)
        //        {
        //            DataTable dt = (DataTable)Session["SISRN_QuotationAddressDtl"];
        //            if (dt.Rows.Count > 0)
        //            {
        ...
        //        CmbPin.Enabled = false;
        //        CmbArea.Enabled = false;
        //        chkBilling.Enabled = false;
        //        txtsAddress1.Enabled = false;
        //        txtsAddress2.Enabled = false;
        //        txtsAddress3.Enabled = false;
        //        txtslandmark.Enabled = false;
        //        CmbCountry1.Enabled = false;

        //        CmbState1.Enabled = false;
        //        CmbCity1.Enabled = false;
        //        CmbPin1.Enabled = false;
        //        CmbArea1.Enabled = false;

        //        chkShipping.Enabled = false;

        //        btnSave_citys.Enabled = false;
        //    }
        ...
        //            Session["SISRN_QuotationAddressDtl"] = dt;
       ...
       */
        ...
        */
        ...
        {
            if (Session["SISRN_CustomerDetail"] == null)
            {
                ...
                if (dtCustomer != null && dtCustomer.Rows.Count > 0)
                {
                    ...
                    Session["SISRN_CustomerDetail"] = dtCustomer;
                }
            }
            else
            {
                lookup_Customer.DataSource = (DataTable)Session["SISRN_CustomerDetail"];
                lookup_Customer.DataBind();
            }
        ...
        //        DataTable Warehousedtups = (DataTable)Session["SRNwarehousedetailstempUpdate"];
        //        DataRow[] dr = Warehousedtups.Select("isnew = 'Updated'");
        //        if (dr.Count() != 0)
        //        {
        //            //dt = dr.CopyToDataTable();
        ...
        protected void ComponentQuotation_Callback(object source, DevExpress.Web.CallbackEventArgsBase e)
        {
            ...
            if (e.Parameter.Split('~')[0] == "BindComponentGrid")
            {
                ...
                string strReturnID = Convert.ToString(Session["SISRN_ReturnID"]);
                ...
                Session["SISRN_ComponentData"] = ComponentTable;
        ...
        {
            if (Session["SISRN_ComponentData"] != null)
            {
                lookup_quotation.DataSource = (DataTable)Session["SISRN_ComponentData"];
            }
        }
        ...
        {
            DataTable SalesReturnEditdt = objSalesReturnBL.GetSalesReturnNormalStockEditData(strSalesReturnId);
            if (SalesReturnEditdt != null && SalesReturnEditdt.Rows.Count > 0)
            {
                ...
                Session["InvoiceIds"] = InvoiceCreatedFromDoc_Ids;
                //gstn
        ...
        {
            Boolean inUse = false;
            DataTable taxTable = (DataTable)Session["SISRN_FinalTaxRecord"];
            ...
            Session["SISRN_FinalTaxRecord"] = taxTable;
        ...
        public IEnumerable GetInvoiceInfo(DataTable SalesInvoicedt1, string Order_Id)
        {
            ...
            for (int i = 0; i < SalesInvoicedt1.Rows.Count; i++)
            {
                ...
                if (eachInvoice.Length == 1)
                {
                    ...
                    {
                        Session["SISRN_TaxDetails"] = tempMainTax;

                    }

                }
                else { Session["SISRN_TaxDetails"] = null; }
                //  main tax integrate with respect to first tag  invoice
                // warehouse
                ...
                //    Session["SISRN_WarehouseData"] = tempWarehouse;
        ...
        public bool BindSessionByDatatable(DataTable dt)
        {
            ...
            Session["SISRN_QuotationDetails"] = SlsOreturnDT;
        ...
        //                Session["LoopSRNWarehouse"] = Convert.ToString(Convert.ToInt32(strNewVal) + 1);
        ...
        public DataTable GetQuotationWarehouseData()
        {
            try
            {
                ...
                proc.AddVarcharPara("@SalesReturnID", 500, Convert.ToString(Session["SISRN_ReturnID"]));
                proc.AddVarcharPara("@Type", 100, "SISRN");
                dt = proc.GetTable();

                if (Session["SISRN_QuotationDetails"] != null)
                {
                    DataTable SalesInvoicedt1 = (DataTable)Session["SISRN_QuotationDetails"];
        ...
        public DataTable GetBranchWarehouseData()
        {
            ...
            DataTable dt = new DataTable();
            dt = oDBEngine.GetDataTable("select top 1 bui_id as WarehouseID,bui_Name as WarehouseName from tbl_master_building Where IsNull(bui_BranchId,0) in ('" + strBranch + "') order by bui_Name");
            return dt;
        }
        ...
        protected void GrdWarehouse_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            {
                int loopId = Convert.ToInt32(Session["LoopSRNWarehouse"]);
                ...
                Session["LoopSRNWarehouse"] = loopId + 1;
        ...
        //    //proc.AddVarcharPara("@ReturnID", 500, Convert.ToString(Session["SISRN_ReturnID"]));
        ...
        //    proc.AddVarcharPara("@Action", 500, "GetwarehouseData");
        ...
        public DataTable GetInvoiceWarehouse(string strInvoiceList)
        {
            try
            {
                DataTable dt = new DataTable();
                ProcedureExecute proc = new ProcedureExecute("prc_CRMSalesReturn_Details");
                proc.AddVarcharPara("@Action", 500, "SalesChallanWarehouseByReturnNormal");
                proc.AddVarcharPara("@InvoiceList", 3000, strInvoiceList);
                dt = proc.GetTable();
        ...
        public DataTable GetWarehouseData()
        {
            DataTable dt = new DataTable();
            ProcedureExecute proc = new ProcedureExecute("prc_CRMSalesReturn_Details");
            proc.AddVarcharPara("@Action", 500, "GetWareHouseDtlByProductID_From_SC");
            proc.AddVarcharPara("@PID", 500, Convert.ToString(hdfProductID.Value));
            proc.AddVarcharPara("@branchId", 500, Convert.ToString(ddl_Branch.SelectedValue));
            proc.AddVarcharPara("@Component_ID", 500, Convert.ToString(hdfComponentID.Value));
            dt = proc.GetTable();

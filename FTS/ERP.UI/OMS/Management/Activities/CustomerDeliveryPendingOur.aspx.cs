...
{
    public partial class CustomerDeliveryPendingOur : ERP.OMS.ViewState_class.VSPage//System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (!string.IsNullOrEmpty(Request.QueryString["Flag"]) && hddnIsODSDFirstTime.Value == "0")
                {
                    ...
                    {
                        PopulateSalesManAgent(Convert.ToString(dt_InvoiceHeader.Rows[0].Field<Int32>("salesmancnt_id")));

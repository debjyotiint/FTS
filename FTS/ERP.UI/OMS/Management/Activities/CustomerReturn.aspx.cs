...
{
    public partial class CustomerReturn : ERP.OMS.ViewState_class.VSPage// System.Web.UI.Page
    {
        ...
        {
            DataTable udfCount = oDBEngine.GetDataTable("select 1 from tbl_master_remarksCategory rc where cat_applicablefor='CR'  and ( exists (select * from tbl_master_udfGroup where id=rc.cat_group_id and grp_isVisible=1) or rc.cat_group_id=0)");
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                Session["CR_BillingAddressLookup"] = null;
                Session["CR_ShippingAddressLookup"] = null;
                ...
                Session["CR_ReturnID"] = "";
                Session["CR_CustomerDetail"] = null;
                Session["CR_QuotationDetails"] = null;
                Session["CR_WarehouseData"] = null;
                Session["CR_QuotationTaxDetails"] = null;
                Session["LoopCRWarehouse"] = 1;
                Session["CR_TaxDetails"] = null;
                Session["CR_ActionType"] = "";

                Session["TaggingChallan"] = "";
                Session["CR_ComponentData"] = null;
                Session["CRwarehousedetailstemp"] = null;
                Session["CRwarehousedetailstempUpdate"] = null;
                Session["CRwarehousedetailstempDelete"] = null;
                Session["CustomerReturnAddressDtl"] = null;
                ...
                Session["CR_QuotationAddressDtl"] = null;
                ...
                if (Request.QueryString["key"] != null)
                {
                    if (Convert.ToString(Request.QueryString["key"]) != "ADD")
                    {
                        ...
                        lblHeadTitle.Text = "Modify Customer Return";
                        hdnPageStatus.Value = "update";
                        divScheme.Style.Add("display", "none");
                        strSalesReturnId = Convert.ToString(Request.QueryString["key"]);
                        Session["CR_KeyVal_InternalID"] = "SRQUOTE" + strSalesReturnId;


                        Keyval_internalId.Value = "CustomerReturn" + strSalesReturnId;
                        #region Subhra Section
                        Session["CR_key_QutId"] = strSalesReturnId;
                        ...
                        Session["CR_ReturnID"] = strSalesReturnId;
                        Session["CR_ActionType"] = "Edit";
                        SetSalesReturnDetails(strSalesReturnId);
                        //  DateTime quoteDate = Convert.ToDateTime(dt_PLQuote.Date.ToString("dd/MM/yyyy"));
                        Session["CR_TaxDetails"] = GetTaxDataWithGST(GetTaxData(dt_PLQuote.Date.ToString("yyyy-MM-dd")));

                        //  Session["CR_WarehouseData"] = GetQuotationWarehouseData();

                        DataTable Productdt = new DataTable();
                        if (Session["TaggingChallan"] == "1")
                        {
                        ...
                        Session["CR_QuotationDetails"] = Productdt;
                        ...
                        Session["CR_QuotationAddressDtl"] = objSalesReturnBL.GetSalesReturnBillingAddress(strSalesReturnId); ;
                        ...
                        if (GetQuotationTaxData().Tables[0] != null)
                            Session["CR_QuotationTaxDetails"] = GetQuotationTaxData().Tables[0];
                        ...
                        if (GetQuotationEditedTaxData().Tables[0] != null)
                        {
                            ...
                            {
                                Session["CR_FinalTaxRecord"] = quotetable;
                            }
                        }
                        ...
                        {
                            lblHeadTitle.Text = "View Customer Return";
                    ...
                    else
                    {
                        ...
                        if (Session["CR_SaveMode"] != null)  // it has been removed from coding side of Quotation list 
                        {
                            if (Session["CR_schemavalue"] != null)  // it has been removed from coding side of Quotation list 
                            {
                                ddl_numberingScheme.SelectedValue = Convert.ToString(Session["CR_schemavalue"]); // it has been removed from coding side of Quotation list 
                            }
                            if (Convert.ToString(Session["CR_SaveMode"]) == "A")
                            {
                                dt_PLQuote.Focus();
                                txt_PLQuoteNo.Enabled = false;
                                txt_PLQuoteNo.Text = "Auto";
                            }
                            else if (Convert.ToString(Session["CR_SaveMode"]) == "M")
                            {
                        ...
                        Session["CR_ActionType"] = "Add";
                        //ASPxButton2.Enabled = false;
                        Session["CR_TaxDetails"] = null;
                        CreateDataTaxTable();
                        lblHeadTitle.Text = "Add Customer Return";
        ...
        public DataTable GetBatchData(string WarehouseID)
        {
            ...
            proc.AddVarcharPara("@Action", 500, "GetCustomerReturnBatchByProductIDWarehouse");
        ...
        public DataTable GetSerialata(string WarehouseID, string BatchID, string BranchSerialNumber)
        {
            DataTable dt = new DataTable();
            ProcedureExecute proc = new ProcedureExecute("prc_CRMSalesReturn_Details");
            proc.AddVarcharPara("@Action", 500, "GetCustomerReturnSerialByProductIDWarehouseBatch");
        ...
        public DataSet GetQuotationData()
        {
            ...
            proc.AddVarcharPara("@QuotationID", 500, Convert.ToString(Session["CR_ReturnID"]));
            ds = proc.GetDataSet();
            return ds;
        }
        ...
        protected void grid_BatchUpdate(object sender, DevExpress.Web.Data.ASPxDataBatchUpdateEventArgs e)
        {
            ...
            if (Session["CR_QuotationDetails"] != null)
            {
                Quotationdt = (DataTable)Session["CR_QuotationDetails"];
            }
            else
            {
            ...
            Session["CR_QuotationDetails"] = Quotationdt;
            ...
            if (IsDeleteFrom != "D")
            {
                ...
                string ActionType = Convert.ToString(Session["CR_ActionType"]);
                string MainInvoiceID = Convert.ToString(Session["CR_ReturnID"]);
                ...
                if (Session["CR_FinalTaxRecord"] != null)
                {
                    TaxDetailTable = (DataTable)Session["CR_FinalTaxRecord"];
                }

                // DataTable of Warehouse

                DataTable tempWarehousedt = new DataTable();
                if (Session["CR_WarehouseData"] != null)
                {
                    DataTable Warehousedt = (DataTable)Session["CR_WarehouseData"];
                ...
                if (Session["CR_TaxDetails"] != null)
                {
                    TaxDetailsdt = (DataTable)Session["CR_TaxDetails"];
                }
                else
                {
                ...
                #region #### Old_Process ####
                ////DataTable tempBillAddress = new DataTable();
                ////if (Session["CR_QuotationAddressDtl"] != null)
                ////{
                ////    tempBillAddress = (DataTable)Session["CR_QuotationAddressDtl"];
                ////}
                ////else
                ////{
               ...
               .Select(g => g.Key);
                ...
                else
                {
                    ...
                    #region To Show By Default Cursor after SAVE AND NEW
                    if (Convert.ToString(Session["CR_ActionType"]) == "Add") // session has been removed from quotation list page working good
                    {
                        string[] schemaid = new string[] { };
                        string schemavalue = ddl_numberingScheme.SelectedValue;
                        Session["CR_schemavalue"] = schemavalue;        // session has been removed from quotation list page working good
                        ...
                        if (hdnRefreshType.Value == "N")
                        {
                            if (schematype == "1")
                            {
                                Session["CR_SaveMode"] = "A";
                            }
                            else
                            {
                                Session["CR_SaveMode"] = "M";
                            }
                        }
                    }
                    ...
                    if (!string.IsNullOrEmpty(hfControlData.Value))
                    {
                        ...
                        objCommonBL.InsertTransporterControlDetails(Convert.ToInt32(strQuoteID), "CR", hfControlData.Value, Convert.ToString(HttpContext.Current.Session["userid"]));
                    }
                    //Udf Add mode
                    DataTable udfTable = (DataTable)Session["UdfDataOnAdd"];
                    if (udfTable != null)
                        Session["UdfDataOnAdd"] = reCat.insertRemarksCategoryAddMode("CR", "CustomerReturn" + Convert.ToString(strQuoteID), udfTable, Convert.ToString(Session["userid"]));
        ...
        public void GetQuantityBaseOnProduct(string strProductSrlNo, ref decimal WarehouseQty)
        {
            ...
            if (Session["CR_WarehouseData"] != null)
            {
                Warehousedt = (DataTable)Session["CR_WarehouseData"];
                for (int i = 0; i < Warehousedt.Rows.Count; i++)
                {
        ...
        protected void grid_DataBinding(object sender, EventArgs e)
        {
            ...
            if (Session["CR_QuotationDetails"] != null)
            {
                DataTable Quotationdt = (DataTable)Session["CR_QuotationDetails"];
        ...
        protected void grid_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            else if (strSplitCommand == "RemoveDisplay")
            {
                ...
                if (Session["CR_QuotationDetails"] != null)
                {
                    salesReturndt = (DataTable)Session["CR_QuotationDetails"];
                }
                ...
                Session["CR_QuotationDetails"] = salesReturndt;
                grid.DataBind();
            ...
            else if (strSplitCommand == "BindGridOnQuotation")
            {
                ...
                Session["CustomerReturnInvoiceIds"] = QuoComponent1;
                ...
                //Session["CR_QuotationAddressDtl"] = GetComponentEditedAddressData(ChallanDetails_Id, "SC");
                //if (Session["CR_QuotationAddressDtl"] != null)
                //{
                //    DataTable dt = (DataTable)Session["CR_QuotationAddressDtl"];
                //    if (dt != null && dt.Rows.Count > 0)
                //    {
                //        if (dt.Rows.Count == 2)
                //        {
                                    ...
                                    ref int strIsComplete, ref int strInvoiceID, string ReasonforReturn)
        {
            try
            {
                ...
                else { cmd.Parameters.AddWithValue("@ComponentType", "SC"); }
        ...
        public DataTable GetTaxData(string quoteDate)
        {
            ...
            proc.AddVarcharPara("@SalesReturnID", 500, Convert.ToString(Session["CR_ReturnID"]));
            proc.AddVarcharPara("@FinYear", 500, Convert.ToString(Session["LastFinYear"]));
            // proc.AddVarcharPara("@branchId", 500, Convert.ToString(Session["userbranchID"]));
            proc.AddVarcharPara("@branchId", 500, Convert.ToString(ddl_Branch.SelectedValue));
            proc.AddVarcharPara("@companyId", 500, Convert.ToString(Session["LastCompany"]));
        ...
        protected void gridTax_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            if (strSplitCommand == "Display")
            {
                ...
                if (Session["CR_TaxDetails"] == null)
                {
                    Session["CR_TaxDetails"] = GetTaxData(dt_PLQuote.Date.ToString("yyyy-MM-dd"));
                }
            ...
            else if (strSplitCommand == "SaveGst")
            {
                ...
                else
                {
                    ...
                    Session["CR_TaxDetails"] = TaxDetailsdt;
                }
            }
        }
        ...
        protected void gridTax_DataBinding(object sender, EventArgs e)
        {
            if (Session["CR_TaxDetails"] != null)
            {
                DataTable TaxDetailsdt = (DataTable)Session["CR_TaxDetails"];
        ...
        protected void taxUpdatePanel_Callback(object source, DevExpress.Web.CallbackEventArgsBase e)
        {
            ...
            {
                DataTable MainTaxDataTable = (DataTable)Session["CR_FinalTaxRecord"];
                ...
                if (taxDetails != null)
                {
                    ...
                    Session["CR_TaxDetails"] = taxDetails;
                }
            }
        ...
        public void CreateDataTaxTable()
        {
            ...
            Session["CR_FinalTaxRecord"] = TaxRecord;
        }
        ...
        protected void cgridTax_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            {
                DataTable TaxRecord = (DataTable)Session["CR_FinalTaxRecord"];
            ...
            else
            {
                ...
                DataTable MainTaxDataTable = (DataTable)Session["CR_FinalTaxRecord"];
                DataTable databaseReturnTable = (DataTable)Session["CR_QuotationTaxDetails"];
                ...
                if (ShippingState.Trim() != "" && compGstin[0].Trim() != "")
                {
                    ...
                    if (compGstin.Length > 0)
                    {
                        if (compGstin[0].Substring(0, 2) == ShippingState)
                        {
                            ...
                            if (ShippingState == "4" || ShippingState == "35" || ShippingState == "26" || ShippingState == "25" || ShippingState == "7" || ShippingState == "31" || ShippingState == "34")
                            {
        ...
        public void DeleteTaxDetails(string SrlNo)
        {
            ...
            if (Session["CR_FinalTaxRecord"] != null)
            {
                ...
                Session["CR_FinalTaxRecord"] = TaxDetailTable;
            }
        }
        ...
        public void GetAllDropDownDetailForSalesQuotation(string userbranch)
        {
            ...
            SlaesActivitiesBL objSlaesActivitiesBL = new SlaesActivitiesBL();
            DataTable Schemadt = objSlaesActivitiesBL.GetNumberingSchema(strCompanyID, userbranchHierarchy, FinYear, "29", "Y");
        ...
        //{
        //    if (Session["CR_CustomerDetail"] == null)
        //    {
        ...
        //            Session["CR_CustomerDetail"] = dtCustomer;
        //        }
        //    }
        //    else
        //    {
        //        lookup_Customer.DataSource = (DataTable)Session["CR_CustomerDetail"];
        //        lookup_Customer.DataBind();
        //    }
        ...
        protected void ComponentQuotation_Callback(object source, DevExpress.Web.CallbackEventArgsBase e)
        {
            ...
            if (e.Parameter.Split('~')[0] == "BindComponentGrid")
            {
                ...
                string strReturnID = Convert.ToString(Session["CR_ReturnID"]);
                ...
                DataTable ComponentTable = objSalesReturnBL.GetChallanComponent(Customer, SalesReturnDate, strReturnID, branchId);
                lookup_quotation.GridView.Selection.CancelSelection();
                lookup_quotation.DataSource = ComponentTable;
                lookup_quotation.DataBind();

                Session["CR_ComponentData"] = ComponentTable;
            ...
            else if (e.Parameter.Split('~')[0] == "BindComponentGridOnSelection")//Subhabrata for binding quotation
            {
                if (grid_Products.GetSelectedFieldValues("ComponentDetailsID").Count != 0)
                {
                    ...
                    if (!String.IsNullOrEmpty(InvoiceIds))
                    {
                        ...
                        if (eachQuo.Length > 1)//More tha one quotation
                        {
                            txt_InvoiceDate.Text = "Multiple Select Challan Dates";
        ...
        {
            if (Session["CR_ComponentData"] != null)
            {
                lookup_quotation.DataSource = (DataTable)Session["CR_ComponentData"];
            }
        }
        ...
        protected void ComponentDatePanel_Callback(object sender, CallbackEventArgsBase e)
        {
            ...
            if (strSplitCommand == "BindComponentDate")
            {
                ...
                DataTable dt_QuotationDetails = objSalesReturnBL.GetChallanDate(Invoice_No);
        ...
        {
            Boolean inUse = false;
            DataTable taxTable = (DataTable)Session["CR_FinalTaxRecord"];
            ProcedureExecute proc = new ProcedureExecute("prc_taxReturnTable");
            proc.AddVarcharPara("@Module", 20, "CustomerReturn");
            ...
            Session["CR_FinalTaxRecord"] = taxTable;
        ...
        public IEnumerable GetInvoiceInfo(DataTable SalesInvoicedt1, string Order_Id)
        {
            ...
            for (int i = 0; i < SalesInvoicedt1.Rows.Count; i++)
            {
                ...
                QuoComponent = QuoComponent.TrimStart(',');
                string[] eachChallan = QuoComponent.Split(',');
                ...
                if (eachChallan.Length == 1)
                {
                    DataTable tempMainTax = objSalesReturnBL.GetTaxDetailsSC(QuoComponent);
                    if (tempMainTax != null && tempMainTax.Rows.Count > 0)
                    {
                        Session["CR_TaxDetails"] = tempMainTax;

                    }

                }
                else { Session["CR_TaxDetails"] = null; }
                //  main tax integrate with respect to first tag  challan
                //warehouse
                ...
                //    Session["CR_WarehouseData"] = tempWarehouse;
        ...
        public bool BindSessionByDatatable(DataTable dt)
        {
            ...
            Session["CR_QuotationDetails"] = SlsOreturnDT;
        ...
        //        Session["LoopCRWarehouse"] = Convert.ToString(Convert.ToInt32(strNewVal) + 1);
        ...
        protected void acbpCrpUdf_Callback(object source, DevExpress.Web.CallbackEventArgsBase e)
        {
            ...
            {
                if (reCat.isAllMandetoryDone((DataTable)Session["UdfDataOnAdd"], "CR") == false)
                {
        ...
        public DataTable GetQuotationWarehouseData()
        {
            try
            {
                ...
                proc.AddVarcharPara("@Type", 100, "CR");
                dt = proc.GetTable();

                if (Session["CR_QuotationDetails"] != null)
                {
                    DataTable SalesInvoicedt1 = (DataTable)Session["CR_QuotationDetails"];
        ...
        protected void GrdWarehouse_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            {
                int loopId = Convert.ToInt32(Session["LoopCRWarehouse"]);
                ...
                Session["CR_WarehouseData"] = Warehousedt;
                changeGridOrder();

                GrdWarehouse.DataSource = Warehousedt.DefaultView;
                GrdWarehouse.DataBind();

                Session["LoopCRWarehouse"] = loopId + 1;
        ...
        public DataTable GetInvoiceWarehouse(string strInvoiceList)
        {
            try
            {
                ...
                DataTable dt = new DataTable();
                ProcedureExecute proc = new ProcedureExecute("prc_CRMSalesReturn_Details");
                proc.AddVarcharPara("@Action", 500, "SalesChallanWarehouseByCustomerReturn");
                proc.AddVarcharPara("@InvoiceList", 3000, strInvoiceList);

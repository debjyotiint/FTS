...
//        }
        ...
        protected void gridBatch_BatchUpdate(object sender, DevExpress.Web.Data.ASPxDataBatchUpdateEventArgs e)
        {
            ...
            if (IsDeleteFrom != "D")
            {
                ...
                if (validate == "outrange" || validate == "duplicate" || validate == "nullQuantity" || validate == "ProductMandatory" || validate == "BSMandatory" || validate == "nullReceiptPayment" || validate == "NotMatchVoucherAmount" || validate == "duplicateDocument" || validate == "nullType")
                {

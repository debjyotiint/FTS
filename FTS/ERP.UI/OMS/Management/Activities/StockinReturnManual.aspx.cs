...
{
    public partial class StockinReturnManual : ERP.OMS.ViewState_class.VSPage// System.Web.UI.Page
    {
        ...
        {
            rights = BusinessLogicLayer.CommonBLS.CommonBL.GetUserRightSession("/management/Activities/StockinReturnManual.aspx");
            ...
            if (!IsPostBack)
            {
                this.Session["LastCompanySISRM"] = Session["LastCompany"];
                this.Session["LastFinYearSISRM"] = Session["LastFinYear"];
                //18-10-2017
                //   GetProductData();
                //18-10-2017
                ...
                Session["SISRM_BillingAddressLookup"] = null;
                Session["SISRM_ShippingAddressLookup"] = null;
                ...
                Session["SISRM_ReturnID"] = "";
                Session["SISRM_CustomerDetail"] = null;
                Session["SISRM_QuotationDetails"] = null;
                Session["SISRM_WarehouseData"] = null;
                Session["SISRM_QuotationTaxDetails"] = null;
                Session["LoopSRWarehouse"] = 1;
                Session["SISRM_TaxDetails"] = null;
                Session["SISRM_ActionType"] = "";

                Session["TaggingMInvoce"] = "";
                Session["SISRM_ComponentData"] = null;
                Session["SRMwarehousedetailstemp"] = null;
                Session["SRMwarehousedetailstempUpdate"] = null;
                Session["SRMwarehousedetailstempDelete"] = null;
                ...
                Session["SISRM_QuotationAddressDtl"] = null;
                ...
                if (Request.QueryString["key"] != null)
                {
                    if (Convert.ToString(Request.QueryString["key"]) != "ADD")
                    {
                        ...
                        Session["SISRM_ReturnID"] = strSalesReturnId;
                        Session["SISRM_ActionType"] = "Edit";
                        SetSalesReturnDetails(strSalesReturnId);
                        //  DateTime quoteDate = Convert.ToDateTime(dt_PLQuote.Date.ToString("dd/MM/yyyy"));
                        Session["SISRM_TaxDetails"] = GetTaxDataWithGST(GetTaxData(dt_PLQuote.Date.ToString("yyyy-MM-dd")));


                        //kaushik 30-11-2017
                    //   Session["SISRM_WarehouseData"] = GetReturnWarehouseData();

                        //kaushik 30-11-2017
                       Session["SRMwarehousedetailstemp"] = GetReturnWarehouseData();
                        ...
                        Session["SISRM_QuotationDetails"] = Productdt;
                        grid.DataSource = GetQuotation(Productdt);
                        grid.DataBind();

                        Session["SISRM_QuotationAddressDtl"] = objSalesReturnBL.GetSalesReturnBillingAddress(strSalesReturnId); ;
                        ...
                        if (GetQuotationTaxData().Tables[0] != null)
                            Session["SISRM_QuotationTaxDetails"] = GetQuotationTaxData().Tables[0];
                        ...
                        if (GetQuotationEditedTaxData().Tables[0] != null)
                        {
                            ...
                            {
                                Session["SISRM_FinalTaxRecord"] = quotetable;
                            }
                        }
                        ...
                        {
                            lblHeadTitle.Text = "View Receive Against Manual Return";
                    ...
                    else
                    {
                        ...
                        if (Session["SISRM_SaveMode"] != null)  // it has been removed from coding side of Quotation list 
                        {
                            if (Session["SISRM_schemavalue"] != null)  // it has been removed from coding side of Quotation list 
                            {
                                ddl_numberingScheme.SelectedValue = Convert.ToString(Session["SISRM_schemavalue"]); // it has been removed from coding side of Quotation list 
                            }
                            if (Convert.ToString(Session["SISRM_SaveMode"]) == "A")
                            {
                                dt_PLQuote.Focus();
                                txt_PLQuoteNo.ClientEnabled = false;
                                txt_PLQuoteNo.Text = "Auto";
                            }
                            else if (Convert.ToString(Session["SISRM_SaveMode"]) == "M")
                            {
                        ...
                        Session["SISRM_ActionType"] = "Add";
                        //ASPxButton2.Enabled = false;
                        Session["SISRM_TaxDetails"] = null;
                        CreateDataTaxTable();
                        lblHeadTitle.Text = "Add Receive Against Manual Return";
        ...
        public DataTable GetReturnWarehouseData()
        {
            try
            {
                DataTable dt = new DataTable();
                ProcedureExecute proc = new ProcedureExecute("prc_CRMSalesReturn_Details");
                proc.AddVarcharPara("@Action", 500, "GetSalesReturnWarehouse");
                proc.AddVarcharPara("@SalesReturnID", 500, Convert.ToString(Session["SISRM_ReturnID"]));
                dt = proc.GetTable();
        ...
        public void SetQuotationDetails()
        {
            ...
            if (QuotationEditdt != null && QuotationEditdt.Rows.Count > 0)
            {
                ...
                txtReasonforChange.ClientEnabled = false;
        ...
        public DataSet GetQuotationData()
        {
            ...
            proc.AddVarcharPara("@QuotationID", 500, Convert.ToString(Session["SISRM_ReturnID"]));
            ds = proc.GetDataSet();
            return ds;
        }
        ...
        protected void grid_BatchUpdate(object sender, DevExpress.Web.Data.ASPxDataBatchUpdateEventArgs e)
        {
            ...
            if (Session["SISRM_QuotationDetails"] != null)
            {
                Quotationdt = (DataTable)Session["SISRM_QuotationDetails"];
            }
            else
            {
            ...
            Session["SISRM_QuotationDetails"] = Quotationdt;
            ...
            if (IsDeleteFrom != "D")
            {
                ...
                string ActionType = Convert.ToString(Session["SISRM_ActionType"]);
                string MainInvoiceID = Convert.ToString(Session["SISRM_ReturnID"]);
                ...
                if (Session["SISRM_FinalTaxRecord"] != null)
                {
                    TaxDetailTable = (DataTable)Session["SISRM_FinalTaxRecord"];
                }

                // DataTable of Warehouse

                DataTable tempWarehousedt = new DataTable();
                if (Session["SISRM_WarehouseData"] != null)
                {
                    DataTable Warehousedt = (DataTable)Session["SISRM_WarehouseData"];
                ...
                if (Session["SISRM_TaxDetails"] != null)
                {
                    TaxDetailsdt = (DataTable)Session["SISRM_TaxDetails"];
                }
                else
                {
                ...
                ////DataTable tempBillAddress = new DataTable();
                ////if (Session["SISRM_QuotationAddressDtl"] != null)
                ////{
                ////    tempBillAddress = (DataTable)Session["SISRM_QuotationAddressDtl"];
                ////}
                ////else
                ////{
                ...
                foreach (DataRow dr in tempQuotation.Rows)
                {
                    ...
                    DTWH = objSalesReturnBL.GetStkWHDetails("SISRM", strSalesReturnId);
               ...
               .Select(g => g.Key);
                ...
                else
                {
                    ...
                    #region To Show By Default Cursor after SAVE AND NEW
                    if (Convert.ToString(Session["SISRM_ActionType"]) == "Add") // session has been removed from quotation list page working good
                    {
                        string[] schemaid = new string[] { };
                        string schemavalue = ddl_numberingScheme.SelectedValue;
                        Session["SISRM_schemavalue"] = schemavalue;        // session has been removed from quotation list page working good
                        ...
                        if (hdnRefreshType.Value == "N")
                        {
                            if (schematype == "1")
                            {
                                Session["SISRM_SaveMode"] = "A";
                            }
                            else
                            {
                                Session["SISRM_SaveMode"] = "M";
                            }
                        }
                    }
        ...
        protected void grid_DataBinding(object sender, EventArgs e)
        {
            ...
            if (Session["SISRM_QuotationDetails"] != null)
            {
                DataTable Quotationdt = (DataTable)Session["SISRM_QuotationDetails"];
        ...
        protected void grid_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            else if (strSplitCommand == "RemoveDisplay")
            {
                ...
                if (Session["SISRM_QuotationDetails"] != null)
                {
                    salesReturndt = (DataTable)Session["SISRM_QuotationDetails"];
                }
                ...
                Session["SISRM_QuotationDetails"] = salesReturndt;
                grid.DataBind();
            ...
            else if (strSplitCommand == "BindGridOnQuotation")
            {
                ...
                //Session["SISRM_QuotationAddressDtl"] = GetComponentEditedAddressData(InvoiceDetails_Id, "SI");
                //if (Session["SISRM_QuotationAddressDtl"] != null)
                //{
                //    DataTable dt = (DataTable)Session["SISRM_QuotationAddressDtl"];
                //    if (dt != null && dt.Rows.Count > 0)
                //    {
                //        if (dt.Rows.Count == 2)
                //        {
                                    ...
                                    ref int strIsComplete, ref int strInvoiceID, string ReasonforReturn)
        {
            try
            {
                ...
                cmd.Parameters.AddWithValue("@ComponentType", "SISRM");
                ...
                if (Session["SRMwarehousedetailstemp"] != null)
                {
                    DataTable temtable = new DataTable();
                    DataTable Warehousedtssss = (DataTable)Session["SRMwarehousedetailstemp"];
        ...
        protected void gridTax_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            if (strSplitCommand == "Display")
            {
                ...
                if (Session["SISRM_TaxDetails"] == null)
                {
                    Session["SISRM_TaxDetails"] = GetTaxData(dt_PLQuote.Date.ToString("yyyy-MM-dd"));
                }
            ...
            else if (strSplitCommand == "SaveGst")
            {
                ...
                else
                {
                    ...
                    Session["SISRM_TaxDetails"] = TaxDetailsdt;
                }
            }
        }
        ...
        protected void gridTax_DataBinding(object sender, EventArgs e)
        {
            if (Session["SISRM_TaxDetails"] != null)
            {
                DataTable TaxDetailsdt = (DataTable)Session["SISRM_TaxDetails"];
        ...
        protected void GrdWarehousePC_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            if (strSplitCommand == "Display")
            {
                ...
                else
                {
                    ...
                    if (Session["SISRM_WarehouseData"] != null)
                    {
                        Warehousedt = (DataTable)Session["SISRM_WarehouseData"];
                    }
                    else
                    {
                    ...
                    if (Session["SISRM_WarehouseData"] != null)
                    {
                        DataTable Warehousedts = (DataTable)Session["SISRM_WarehouseData"];
                    ...
                    else
                    {
                        ...
                        if (inputqnty <= totalopeining || isedited == "true")
                        {
                            ...
                            Session["SISRM_WarehouseData"] = Warehousedt;
            ...
            {
                if (Session["SISRM_WarehouseData"] == null && hdnisolddeleted.Value == "false")
                {
                ...
                else if (Session["SISRM_WarehouseData"] == null && hdnisolddeleted.Value == "true")
                {
                ...
                else
                {
                    ...
                    if (newrowcount != 0 || updaterows != 0 || Session["SISRMWarehouseDataDelete"] != null)
                    {
                        decimal inputqnty = 0;
                        decimal totalopeining = Convert.ToDecimal(hdfopeningstockPC.Value);
                        decimal oldtotalopeining = Convert.ToDecimal(oldopeningqntity.Value);
            ...
            if (strSplitCommand == "checkdataexist")
            {
               Session["SISRM_WarehouseData"] = null;
                ...
                Session["SISRMWarehouseUpdatedData"] = null;
                Session["SISRMWarehouseDataDelete"] = null;
            ...
            if (strSplitCommand == "Updatedata")
            {
                ...
                if (Session["SISRM_WarehouseData"] != null)
                {
                    ...
                    Session["SISRMWarehouseUpdatedData"] = Warehousedt;
            ...
            if (strSplitCommand == "Delete")
            {
                ...
                if (Session["SISRM_WarehouseData"] != null)
                {
                    ...
                    if (drs.Count() != 0)
                    {
                        if (Session["SISRMWarehouseDataDelete"] != null)
                        {
                            setdeletedate = drs.CopyToDataTable();
                            DataTable dtmp = (DataTable)Session["SISRMWarehouseDataDelete"];
                            dtmp.Merge(setdeletedate);
                            Session["SISRMWarehouseDataDelete"] = dtmp;
                        }
                        else
                        {
                            setdeletedate = drs.CopyToDataTable();
                            Session["SISRMWarehouseDataDelete"] = setdeletedate;
                        }
                    ...
                    if (dr.Count() > 0)
                    {
                        ...
                        GrdWarehousePC.DataSource = Session["SISRM_WarehouseData"];
                        GrdWarehousePC.DataBind();
                    }
                    else
                    {
        ...
        public DataTable GetRecord(string stockids)
        {
            ...
            DataTable Warehousedt = new DataTable();
            //DataTable Warehousedt1 = new DataTable();

            //if (Session["SISRM_WarehouseData"] != null)
            //{
            //    Warehousedt1 = (DataTable)Session["SISRM_WarehouseData"];
            //}

            //if (Warehousedt1.Rows.Count<1)
            //{
            //    Session["SISRM_WarehouseData"] = null;
        ...
        private int Insertupdatedata(string ProductID, string stockid, string branchid)
        {
            ...
            if (Session["SISRM_WarehouseData"] != null)
            {
                ...
                DataTable dtcHECK = (DataTable)Session["SRMwarehousedetailstemp"];
                if (dtcHECK!=null && dtcHECK.Rows.Count > 0)//Session["SRMwarehousedetailstemp"] != null)
                {
                    temtable23 = (DataTable)Session["SRMwarehousedetailstemp"];
                    DataRow[] rows;
                    ...
                    Session["SRMwarehousedetailstemp"] = temtable23;
                }
                else
                {
                    Session["SRMwarehousedetailstemp"] = temtable;
                }
            ...
            {
                DataTable dt = new DataTable();
                DataTable Warehousedtups = (DataTable)Session["SISRM_WarehouseData"];
                DataRow[] dr = Warehousedtups.Select("isnew = 'Updated'");
                if (dr.Count() != 0)
                {
                    dt = dr.CopyToDataTable();
                    if (Session["SRMwarehousedetailstempUpdate"] != null)
                    {
                        temtable23 = (DataTable)Session["SRMwarehousedetailstempUpdate"];
                        DataRow[] rows;
                        rows = temtable23.Select("pcslno = '" + hdnpcslno.Value + "'");  //'UserName' is ColumnName
                        foreach (DataRow row in rows)
                            temtable23.Rows.Remove(row);
                        ...
                        temtable23.Merge(dt);
                        Session["SRMwarehousedetailstempUpdate"] = temtable23;
                    }
                    else
                    {
                        Session["SRMwarehousedetailstempUpdate"] = dt;
                    }
            ...
            {
                DataTable dt = new DataTable();
                DataTable Warehousedtups = (DataTable)Session["SISRMWarehouseDataDelete"];
                ...
                {
                    dt = dr.CopyToDataTable();
                    if (Session["SRMwarehousedetailstempDelete"] != null)
                    {
                        temtable23 = (DataTable)Session["SRMwarehousedetailstempDelete"];
                        DataRow[] rows;
                        rows = temtable23.Select("pcslno = '" + hdnpcslno.Value + "'");  //'UserName' is ColumnName
                        foreach (DataRow row in rows)
                            temtable23.Rows.Remove(row);
                        ...
                        temtable23.Merge(dt);
                        Session["SRMwarehousedetailstempDelete"] = temtable23;
                    }
                    else
                    {
                        Session["SRMwarehousedetailstempDelete"] = dt;
                    }
        ...
        protected void CmbWarehouse_Callback(object sender, CallbackEventArgsBase e)
        {
            ...
            if (WhichCall == "BindWarehouse")
            {
                ...
                if (dtW.Rows.Count > 0)
                {
                    CmbWarehouse.JSProperties["cpwarehouseid"] = Convert.ToString(dtW.Rows[0]["WarehouseID"]);
                }
            }
        ...
        public void GetQuantityBaseOnProduct(string strProductSrlNo, ref decimal WarehouseQty)
        {
            ...
            if (Session["SRMwarehousedetailstemp"] != null)
            {
                Warehousedt = (DataTable)Session["SRMwarehousedetailstemp"];
                for (int i = 0; i < Warehousedt.Rows.Count; i++)
                {
                    ...
                    {
                        string strQuantity = (Convert.ToString(dr["viewQuantity"]) != "") ? Convert.ToString(dr["viewQuantity"]) : "0";
        ...
        public DataTable GetStockWarehouseData(string stockid)
        {
            ...
            if (DTWH != null && DTWH.Rows.Count > 0)
            {
                ...
                cmd.Parameters.AddWithValue("@Finyear", Convert.ToString(Session["LastFinYear"]));
                cmd.Parameters.AddWithValue("@PCNumber", Convert.ToString(Session["SISRM_ReturnID"]));
                cmd.Parameters.AddWithValue("@PCType", "SISRM");
                ...
                if (dsInst.Tables != null)
                {
                    ...
                    if (Session["SRMwarehousedetailstemp"] != null)
                    {
                        DataTable Warehousedtss = (DataTable)Session["SRMwarehousedetailstemp"];
                        ...
                        if (dr.Count() > 0)
                        {
                            ...
                            Session["SRWMarehouseDatabyslno"] = Warehousedtss;

                            dt2 = (DataTable)Session["SRWMarehouseDatabyslno"];
            ...
            else if (Session["SRMwarehousedetailstemp"] != null)
            {
                DataTable Warehousedtss = (DataTable)Session["SRMwarehousedetailstemp"];
                ...
                if (dr.Count() > 0)
                {
                    ...
                    dt = (DataTable)Session["SRWMarehouseDatabyslno"];
        ...
        public void deleteALL()
        {
            ...
            if (Session["SRMwarehousedetailstempDelete"] != null)
            {
                ...
                DataTable Warehousedtups = (DataTable)Session["SRMwarehousedetailstempDelete"];
        ...
        private int Insertwaredataalldata(string ProductID, string stockid, string branchid)
        {
            ...
            if (Session["SISRMWarehouseDataDelete"] != null)
            {
                DataTable Warehousedts = (DataTable)Session["SISRMWarehouseDataDelete"];
        ...
        protected void taxUpdatePanel_Callback(object source, DevExpress.Web.CallbackEventArgsBase e)
        {
            ...
            {
                DataTable MainTaxDataTable = (DataTable)Session["SISRM_FinalTaxRecord"];
                ...
                Session["SISRM_FinalTaxRecord"] = MainTaxDataTable;
                GetStock(Convert.ToString(performpara.Split('~')[1]));
                // DeleteWarehouse(Convert.ToString(performpara.Split('~')[1]));
                DataTable taxDetails = (DataTable)Session["SISRM_TaxDetails"];
                if (taxDetails != null)
                {
                    ...
                    Session["SISRM_TaxDetails"] = taxDetails;
                }
            }
        ...
        public void CreateDataTaxTable()
        {
            ...
            Session["SISRM_FinalTaxRecord"] = TaxRecord;
        }
        ...
        protected void cgridTax_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            {
                DataTable TaxRecord = (DataTable)Session["SISRM_FinalTaxRecord"];
            ...
            else
            {
                ...
                DataTable MainTaxDataTable = (DataTable)Session["SISRM_FinalTaxRecord"];
                DataTable databaseReturnTable = (DataTable)Session["SISRM_QuotationTaxDetails"];
        ...
        public void DeleteTaxDetails(string SrlNo)
        {
            ...
            if (Session["SISRM_FinalTaxRecord"] != null)
            {
                ...
                Session["SISRM_FinalTaxRecord"] = TaxDetailTable;
            }
        }
        ...
        public static bool CheckUniqueCode(string ReturnNo)
        {
            ...
            try
            {
                ...
                flag = objShortNameChecking.CheckUnique(ReturnNo, "0", "StockinSalesReturnManual");
            }
            catch (Exception ex)
            {
        ...
        {
            if (Session["SISRM_CustomerDetail"] == null)
            {
                ...
                if (dtCustomer != null && dtCustomer.Rows.Count > 0)
                {
                    ...
                    Session["SISRM_CustomerDetail"] = dtCustomer;
                }
            }
            else
            {
                lookup_Customer.DataSource = (DataTable)Session["SISRM_CustomerDetail"];
                lookup_Customer.DataBind();
            }
        ...
        private int updatewarehouse()
        {
            if (Session["SRMwarehousedetailstempUpdate"] != null)
            {
                ...
                DataTable Warehousedtups = (DataTable)Session["SRMwarehousedetailstempUpdate"];
                DataRow[] dr = Warehousedtups.Select("isnew = 'Updated'");
                if (dr.Count() != 0)
                {
                    //dt = dr.CopyToDataTable();
        ...
        protected void ComponentQuotation_Callback(object source, DevExpress.Web.CallbackEventArgsBase e)
        {
            ...
            if (e.Parameter.Split('~')[0] == "BindComponentGrid")
            {
                ...
                string strReturnID = Convert.ToString(Session["SISRM_ReturnID"]);
                ...
                Session["SISRM_ComponentData"] = ComponentTable;
        ...
        {
            if (Session["SISRM_ComponentData"] != null)
            {
                lookup_quotation.DataSource = (DataTable)Session["SISRM_ComponentData"];
            }
        }
        ...
        {
            Boolean inUse = false;
            DataTable taxTable = (DataTable)Session["SISRM_FinalTaxRecord"];
            ...
            Session["SISRM_FinalTaxRecord"] = taxTable;
        ...
        public IEnumerable GetInvoiceInfo(DataTable SalesInvoicedt1, string Order_Id)
        {
            ...
            for (int i = 0; i < SalesInvoicedt1.Rows.Count; i++)
            {
                ...
                if (eachInvoice.Length == 1)
                {
                    ...
                    {
                        Session["SISRM_TaxDetails"] = tempMainTax;

                    }

                }
                else { Session["SISRM_TaxDetails"] = null; }
                //  main tax integrate with respect to first tag  invoice
                // warehouse
                ...
                if (tempWarehouse != null && tempWarehouse.Rows.Count > 0)
                {
                    ...
                    Session["SISRM_WarehouseData"] = tempWarehouse;
        ...
        public bool BindSessionByDatatable(DataTable dt)
        {
            ...
            Session["SISRM_QuotationDetails"] = SlsOreturnDT;

...
{
    public partial class ReplacementNote : ERP.OMS.ViewState_class.VSPage
    {
        ...
        protected void NumberingScheme()
        {
            ...
            DataTable Schemadt = objreplacement1.GetNumberingSchema(strCompanyID, userbranchHierarchy, FinYear, "38", "Y");

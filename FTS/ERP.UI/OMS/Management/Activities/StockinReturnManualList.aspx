...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        ...
        function OnAddButtonClick() {
            var url = 'StockinReturnManual.aspx?key=' + 'ADD';
            window.location.href = url;
        }
            ...
            if (ActiveUser != null) {
                $.ajax({
                    ...
                    success: function (msg) {
                        var status = msg.d;
                        var url = 'StockinReturnManual.aspx?key=' + keyValue + '&Permission=' + status + '&type=SRM';
                        window.location.href = url;
                    }
                });
            }
        ...
        function OnViewClick(keyValue) {
            var url = 'StockinReturnManual.aspx?key=' + keyValue + '&req=V' + '&type=SRM';
            window.location.href = url;
        }
        ...
        function OnEndCallback(s, e) {
            ...
            if (cGrdSalesReturn.cpDelete != null) {
                ...
                window.location.href = "StockinReturnManualList.aspx";
            }
        }
        //function OnClickDelete(keyValue) {
        //    jConfirm('Confirm delete?', 'Confirmation Dialog', function (r) {
    ...
    <div class="form_main">
     ...
     <div class="GridViewArea">
        <dxe:ASPxGridView ID="GrdSalesReturn" runat="server" KeyFieldName="SrlNo" AutoGenerateColumns="False"  
           ...
           DataSourceID="EntityServerModeDataSource" Setting-HorizontalScrollBarMode="Auto"  >
            <Columns>
                ...
                <dxe:GridViewDataTextColumn Caption="Return Manual Number" FieldName="SalesReturnNo"
              ...
              <%--   <dxe:GridViewDataTextColumn Caption="Date" FieldName="Return_Date"
                  ...
                  <dxe:GridViewDataTextColumn VisibleIndex="2" FieldName="Return_Date" Caption="Date" SortOrder="Descending">
                ...
                <dxe:GridViewDataTextColumn Caption="Branch" FieldName="Branch"
                 ...
                 <dxe:GridViewDataTextColumn VisibleIndex="6" Caption="Assigned To Branch" FieldName="branchToBranch">
                <CellStyle Wrap="False" CssClass="gridcellleft"></CellStyle>
            </dxe:GridViewDataTextColumn>
                ...
                <dxe:GridViewDataTextColumn HeaderStyle-HorizontalAlign="Center" CellStyle-HorizontalAlign="center" VisibleIndex="17" Width="14%">
                    <DataItemTemplate>
                        ...
                        <% if (rights.CanEdit)
                                       { %>
                        <a href="javascript:void(0);" onclick="OnMoreInfoClick('<%#Eval("Return_Id")%>')" class="pad" title="StockIn">
                            ...
                            <dxe:PanelContent runat="server">
                                <div style="background: #f5f4f3; padding: 5px 0 5px 0; margin-bottom: 10px; border-radius: 4px; border: 1px solid #ccc;">
                                    <div class="Top clearfix">
                                        <div class="col-md-6">
                                            <label>Assigned To Branch<span style="color: red">*</span></label>
                                            <div>

<%@ Page Title="Transit Purchase Invoice" Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" 
    CodeBehind="TPurchaseInvoiceList.aspx.cs" Inherits="ERP.OMS.Management.Activities.TPurchaseInvoicelist" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
                    ...
                    for (var i = 0; i < TotDocument.length; i++) {
                        if (TotDocument[i] != "") {
                            if (cCmbDesignName.GetValue() == 1) {
                                window.open("../../reports/XtraReports/Viewer/TPurchaseInvoiceReportViewer.aspx?id=" + PInvoice_id + '&PrintOption=' + TotDocument[i], '_blank')
                            }
                        }
                    }
                }
        ...
        function OnViewClick(keyValue) {
            var url = 'TPurchaseInvoice.aspx?key=' + keyValue + '&req=V' + '&type=TPB';
            window.location.href = url;
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel-heading">
        <div class="panel-title">
            <h3>Transit Purchase Invoice</h3>
        </div>
    </div>
            ...
            Width="100%" ClientInstanceName="cgrid" OnCustomCallback="GrdQuotation_CustomCallback" Settings-VerticalScrollableHeight="300"
             ...
             <Columns>
                <dxe:GridViewDataTextColumn Caption="Purchase Invoice No" FieldName="InvoiceNumber" VisibleIndex="0"  Width="130px">
                 ...
                 <dxe:GridViewDataTextColumn Caption="Date" FieldName="InvoiceDt" VisibleIndex="1" Width="90px" PropertiesTextEdit-DisplayFormatString="dd-MM-yyyy">
                    <CellStyle CssClass="gridcellleft" Wrap="true">
                    </CellStyle>
                    <Settings AutoFilterCondition="Contains" />
                </dxe:GridViewDataTextColumn>
                <dxe:GridViewDataTextColumn Caption="Vendor" FieldName="VendorName" VisibleIndex="2" Width="300px" >
                    <CellStyle CssClass="gridcellleft" Wrap="true">
                    </CellStyle>
                    <Settings AutoFilterCondition="Contains" />
                </dxe:GridViewDataTextColumn>
                <dxe:GridViewDataTextColumn Caption="Branch" FieldName="branch" VisibleIndex="3" Width="170px">
                    <CellStyle CssClass="gridcellleft" Wrap="true">
                    </CellStyle>
                    <Settings AutoFilterCondition="Contains" />
                </dxe:GridViewDataTextColumn>

                 <dxe:GridViewDataTextColumn Caption="Purchase Order No" FieldName="ChallanNumber" VisibleIndex="4"  Width="130px">
                    <CellStyle CssClass="gridcellleft" Wrap="true">
                    </CellStyle>
                    <Settings AutoFilterCondition="Contains" />
                </dxe:GridViewDataTextColumn>
                 <dxe:GridViewDataTextColumn Caption="Purchase Order Date" FieldName="ChallanDate" VisibleIndex="5"  Width="130px" PropertiesTextEdit-DisplayFormatString="dd-MM-yyyy">
                    <CellStyle CssClass="gridcellleft" Wrap="true">
                    </CellStyle>
                    <Settings AutoFilterCondition="Contains" />
                </dxe:GridViewDataTextColumn>

                <dxe:GridViewDataTextColumn Caption="Party Invoice No" FieldName="PartyInvoiceNo" VisibleIndex="6"  Width="110px">
                    <CellStyle CssClass="gridcellleft" Wrap="true">
                    </CellStyle>
                    <Settings AutoFilterCondition="Contains" />
                </dxe:GridViewDataTextColumn>
                 <dxe:GridViewDataTextColumn Caption="Party Invoice Date" FieldName="PartyInvoiceDate" VisibleIndex="7"  Width="120px" PropertiesTextEdit-DisplayFormatString="dd-MM-yyyy">
                    <CellStyle CssClass="gridcellleft" Wrap="true">
                    </CellStyle>
                    <Settings AutoFilterCondition="Contains" />
                </dxe:GridViewDataTextColumn>

...
{
    public partial class BranchTransferIn : ERP.OMS.ViewState_class.VSPage //System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                //kaushik 24-2-2017
                Session["BTInBillingAddressLookup"] = null;
                Session["BTInShippingAddressLookup"] = null;
                Session["BTInAddressDtl"] = null;
                //kaushik 24-2-2017
                Session["CustomerDetail"] = null;
                Session["BTIn_WarehouseData"] = null;
                Session["BTIn_LoopWarehouse"] = 1;
                Session["BTInTaxDetails"] = null;
                Session["BTInDetails"] = null;
                ...
                if (Request.QueryString["key"] != null)
                {
                    if (Convert.ToString(Request.QueryString["key"]) != "ADD")
                    {
                        ...
                        ltrTitle.Text = "Modify Branch Transfer In";
                        strOrderId = Convert.ToString(Request.QueryString["key"]);
                        Session["BTInID"] = strOrderId;
                        Session["ActionType"] = "Edit";
                        Session["BTIn_WarehouseData"] = GetOrderWarehouseData();
                        Session["BTInDetails"] = GetOrderData().Tables[0];
                        #region Subhabrata Get Tax Details in Edit Mode

                        //  Session["SalesChallanTaxDetails"] = GetQuotationTaxData().Tables[0];
                        //from quotation
                        Session["BTInTaxDetails"] = GetTaxDataWithGST(GetTaxData(dt_BTOut.Date.ToString("yyyy-MM-dd")));
                        ...
                        {
                            Session["BTInFinalTaxRecord"] = quotetable;
                        }
                        ...
                        //kaushik 24-2-2017
                        Session["BTInAddressDtl"] = GetBillingAddress();
                        //kaushik 24-2-2017
                        ...
                        {
                            ltrTitle.Text = "View Branch Transfer In";
                    ...
                    else
                    {
                        ...
                        //lookup_quotation.DataBind();
                        // bindLookUP("NOT-DONE");
                        ltrTitle.Text = "Add Branch Transfer In";
            ...
            if (Request.QueryString["key"] != null && Request.QueryString["key"] != "ADD")
            {
                ...
                if (OrderEditdt != null && OrderEditdt.Rows.Count > 0)
                {
                    ...
                    string Order_Date = Convert.ToString(OrderEditdt.Rows[0]["Requisition_Date"]);
        ...
        public void GetAllDropDownDetailForSalesOrder(string UserBranch)
        {
            ...
            DataTable Schemadt = objSlaesActivitiesBL1.GetNumberingSchema(strCompanyID, UserBranch, FinYear, "30", "Y");
        ...
        public DataTable GetTaxData(string quoteDate)
        {
            ...
            proc.AddVarcharPara("@Challan_Id", 500, Convert.ToString(Session["BTInID"]) == "ADD" ? "" : Convert.ToString(Session["BTInID"]));
        ...
        public IEnumerable GetSalesOrder()
        {
            ...
            for (int i = 0; i < Orderdt.Rows.Count; i++)
            {
                ...
                if (!string.IsNullOrEmpty(Convert.ToString(Orderdt.Rows[i]["Stk_Id"])))//Added on 15-02-2017
                { Orders.Stk_Id = Convert.ToInt64(Orderdt.Rows[i]["Stk_Id"]); }
                else
                { Orders.Stk_Id = 0; }
        ...
        public IEnumerable GetSalesOrder(DataTable SalesOrderdt)
        {
            ...
            for (int i = 0; i < SalesOrderdt.Rows.Count; i++)
            {
                ...
                Orders.TaxAmount = "0";
                Orders.TotalAmount = Convert.ToString(SalesOrderdt.Rows[i]["Amount"]);
                if (!string.IsNullOrEmpty(Convert.ToString(SalesOrderdt.Rows[i]["Stk_Id"])))//Added on 15-02-2017
                { Orders.Stk_Id = Convert.ToInt64(SalesOrderdt.Rows[i]["Stk_Id"]); }
                else
                { Orders.Stk_Id = 0; }
                if (dtC.Contains("Indent"))
                {
        ...
        public IEnumerable GetSalesOrderInfo(DataTable SalesOrderdt1, string Order_Id)
        {
            ...
            for (int i = 0; i < SalesOrderdt1.Rows.Count; i++)
            {
                ...
                { Orders.Stk_Id = Convert.ToInt64(SalesOrderdt1.Rows[i]["Stk_Id"]); }
                else
                { Orders.Stk_Id = 0; }
                if (dtC.Contains("Indent"))
                {
                ...
                //{
                //    var rows = tempWarehouse.Select("StkDetails_Id ='" + strQuoteDetails_Id + "'");
            ...
            //if (tempWarehouse != null && tempWarehouse.Rows.Count > 0)
            //{
            //    tempWarehouse.Columns.Remove("StkDetails_Id");
            //    Session["BTIn_WarehouseData"] = tempWarehouse;
            //}
            //else { Session["BTIn_WarehouseData"] = null; }
        ...
        public DataTable GetOrderWarehouse(string strOrderList)
        {
            try
            {
                ...
                proc.AddVarcharPara("@Action", 500, "WareHouseBindFromBOFroBranchIn");
        ...
        public bool BindSessionByDatatable(DataTable dt)
        {
            ...
            SalesChalladt.Columns.Add("Stk_Id", typeof(string));
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                ...
                SalesChalladt.Rows.Add(Convert.ToString(i + 1), Convert.ToString(i + 1), Convert.ToString(dt.Rows[i]["QuoteDetails_ProductId"]), Convert.ToString(dt.Rows[i]["QuoteDetails_ProductDescription"]),
                    Convert.ToString(dt.Rows[i]["QuoteDetails_Quantity"]), Convert.ToString(dt.Rows[i]["UOM_ShortName"]), "", Convert.ToString(dt.Rows[i]["QuoteDetails_StockQty"]), Convert.ToString(dt.Rows[i]["UOM_ShortName"]),
                               SalePrice, Discount, Amount, TaxAmount, TotalAmount, "U", Convert.ToInt64(dt.Rows[i]["Stk_Id"]), Order_Num1, ProductName);
            }

            Session["BTInDetails"] = SalesChalladt;
        ...
        public bool BindSessionByDatatableForgridBind(DataTable dt)
        {
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                ...
                if (!string.IsNullOrEmpty(Convert.ToString(dt.Rows[i]["Stk_Id"])))
                {
                    stk_Id = Convert.ToInt64(dt.Rows[i]["Stk_Id"]);
                }
                else
                {
                    stk_Id = 0;
                ...
                SalesChalladt.Rows.Add(Convert.ToString(i + 1), Convert.ToString(i + 1), Convert.ToString(dt.Rows[i]["ProductID"]), Convert.ToString(dt.Rows[i]["Description"]),
                    Convert.ToString(dt.Rows[i]["Quantity"]), Convert.ToString(dt.Rows[i]["UOM"]), "", Convert.ToString(dt.Rows[i]["StockQuantity"]), Convert.ToString(dt.Rows[i]["UOM"]),
                               SalePrice, Discount, Amount, TaxAmount, TotalAmount, "U", stk_Id, Order_Num1, ProductName);
            }
        ...
        public DataSet GetOrderData()
        {
            DataSet ds = new DataSet();
            ProcedureExecute proc = new ProcedureExecute("prc_SalesChallan_Details");
            proc.AddVarcharPara("@Action", 500, "StockInProductData");
            proc.AddVarcharPara("@Order_Id", 500, Convert.ToString(Session["BTInID"]));
            ds = proc.GetDataSet();
            return ds;
        }
        ...
        protected void grid_BatchUpdate(object sender, DevExpress.Web.Data.ASPxDataBatchUpdateEventArgs e)
        {
            ...
            if (Session["BTInDetails"] != null)
            {
                //subhabrata: foreach@deleted extra column 
                DataTable dt = new DataTable();
                DataTable dtTemp = new DataTable();
                dtTemp = (DataTable)Session["BTInDetails"];
                dt = dtTemp.Copy();
            ...
            foreach (var args in e.UpdateValues)
            {
                ...
                if (isDeleted == false)
                {
                    if (ProductDetails != "" && ProductDetails != "0")
                    {
                        ...
                        string TaxAmount = (Convert.ToString(args.NewValues["TaxAmount"]) != "") ? Convert.ToString(args.NewValues["TaxAmount"]) : "0";
                        string TotalAmount = (Convert.ToString(args.NewValues["TotalAmount"]) != "") ? Convert.ToString(args.NewValues["TotalAmount"]) : "0";
                        string QuotationNumber = Convert.ToString(args.NewValues["Stk_Id"]);
                        //string Quotation = Convert.ToString(args.NewValues["Quotation_Num"]);//Added By:Subhabrata on 21-02-2017
            ...
            DataTable dtDupliData = SalesOrderdt.Copy();
            Session["BTInDetails"] = dtDupliData;
            //////////////////////
            ...
            if (IsDeleteFrom != "D")
            {
                try
                {
                    ...
                    if (Convert.ToString(Request.QueryString["key"]) != null && Convert.ToString(Request.QueryString["key"]) != "")
                    {
                        ...
                        Session["BTInID"] = Convert.ToString(Request.QueryString["key"]);
                        if (!string.IsNullOrEmpty(Convert.ToString(Session["BTInID"])))
                        {

                            MainOrderID = Convert.ToString(Session["BTInID"]);
                        }
                        else
                        {
                            MainOrderID = "";
                    ...
                    if (Session["BTInFinalTaxRecord"] != null)
                    {
                        TaxDetailTable = (DataTable)Session["BTInFinalTaxRecord"];
                    }

                    DataTable TaxDetailsdt = new DataTable();
                    if (Session["BTInTaxDetails"] != null)
                    {
                        TaxDetailsdt = (DataTable)Session["BTInTaxDetails"];
                    }
                    else
                    {
                    ...
                    if (Session["BTIn_WarehouseData"] != null)
                    {
                        DataTable Warehousedt = (DataTable)Session["BTIn_WarehouseData"];
                    ...
                    if (Session["BTInAddressDtl"] != null)
                    {
                        tempBillAddress = (DataTable)Session["BTInAddressDtl"];
                    }
                    else
                    {
                    ...
                    #region checkWareHouseStockSerial
                    //foreach (DataRow dr in duplicatedt.Rows)
                    //{
                    ...
                    BusinessLogicLayer.DBEngine objEngine = new BusinessLogicLayer.DBEngine(ConfigurationManager.AppSettings["DBConnectionDefault"]);
                    DataTable DT = objEngine.GetDataTable("Config_SystemSettings", " Variable_Value ", " Variable_Name='Transporter_BIMandatory' AND IsActive=1");
                    if (DT != null && DT.Rows.Count > 0)
                    {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            if (!string.IsNullOrEmpty(hfControlData.Value))
                            {
                                ...
                                objCommonBL.InsertTransporterControlDetails(id, "BI", hfControlData.Value, Convert.ToString(HttpContext.Current.Session["userid"]));
                            }
        ...
        protected void grid_DataBinding(object sender, EventArgs e)
        {
            if (Session["BTInDetails"] != null)
            {
                DataTable Quotationdt = (DataTable)Session["BTInDetails"];
        ...
        protected void grid_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            if (strSplitCommand == "BindGridOnQuotation")
            {
                ...
                QuoComponent1 = Convert.ToString(grid_Products.GetSelectedFieldValues("Stk_Id")[0]);
                ...
                if (Quote_Nos != "$")
                {
                    ...
                    if (!string.IsNullOrEmpty(IdKey))
                    {
                        if (IdKey != "ADD")
                        {
                            dt_QuotationDetails = objSlaesActivitiesBL.GetTransferOutDetailsToBindCGrid(QuoComponent1, QuoteDetails_Id, Product_id1, "Edit");
                        }
                        else
                        {
                            dt_QuotationDetails = objSlaesActivitiesBL.GetTransferOutDetailsToBindCGrid(QuoComponent1, QuoteDetails_Id, Product_id1, "Add");
                        }

                    }
                    else
                    {
                        dt_QuotationDetails = objSlaesActivitiesBL.GetTransferOutDetailsToBindCGrid(QuoComponent1, QuoteDetails_Id, Product_id1, "");
                    }
                    Session["BTInDetails"] = null;
        ...
        [WebMethod]
        public static String GetBranchDetailsOFBranchOut(string BranchOutNo)
        {
            SlaesActivitiesBL objSlaesActivitiesBL = new SlaesActivitiesBL();
            DataTable dt = objSlaesActivitiesBL.GetBranchDetailsOFBranchOut(BranchOutNo);
            string SalesRate = "";
            if (dt.Rows.Count > 0)
            {
                SalesRate = Convert.ToString(dt.Rows[0]["Stk_TransferFormBranch"]) + "~" + Convert.ToString(dt.Rows[0]["Stk_TransferToBranch"]) + "~" +
                    Convert.ToString(dt.Rows[0]["Stk_VechileNo"]) + "~" + Convert.ToString(dt.Rows[0]["Stk_DriverName"]) + "~" + Convert.ToString(dt.Rows[0]["Stk_DriverMobile"]);
            }
        ...
        public int ModifySalesChallan(string BTInID, string strSchemeType, string strOrderNo, string strOrderDate, string strOrderExpiry, string strCustomer, string strContactName,
                                    ...
                                    DataTable tempTaxDetailsdt, string TransferFrom, string TransferTo, string VehicleNo, string DriverName, string PhoneNoDr)
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("prc_CRMBranchStockIn", con);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@Action", ActionType);
                cmd.Parameters.AddWithValue("@Challan_Id", BTInID);
        ...
        protected void gridTax_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            if (strSplitCommand == "Display")
            {
                ...
                if (Session["BTInTaxDetails"] == null)
                {
                    Session["BTInTaxDetails"] = GetTaxData(dt_BTOut.Date.ToString("yyyy-MM-dd"));
                }
            ...
            else if (strSplitCommand == "SaveGst")
            {
                ...
                else
                {
                    ...
                    Session["BTInTaxDetails"] = TaxDetailsdt;
                }
            }
        }
        ...
        protected void cgridProducts_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            if (strSplitCommand == "BindProductsDetails")
            {
                ...
                List<object> QuoList = lookup_order.GridView.GetSelectedFieldValues("Stk_Id");
                foreach (object Quo in QuoList)
                {
                    OrderComponent += "," + Quo;
                }
                ...
                if (Quote_Nos != "$")
                {
                    ...
                    if (!string.IsNullOrEmpty(IdKey))
                    {
                        if (IdKey != "ADD")
                        {
                            dt_OrderDetails = objSlaesActivitiesBL.GetStockOutToBindCGridProductPopUp(OrderComponent, IdKey, "");
                        }
                        else
                        {
                            dt_OrderDetails = objSlaesActivitiesBL.GetStockOutToBindCGridProductPopUp(OrderComponent, "", "");
                        }
        ...
        protected void ComponentTransferFromBranch_Callback(object sender, CallbackEventArgsBase e)
        {
            ...
            if (strSplitCommand == "TransferBranchFrom")
            {
                ...
                dt_BranchTransferFrom = objSlaesActivitiesBL.GetStockOutDate(Stk_Id);
                ddl_transferFrom_Branch.SelectedValue =Convert.ToString(dt_BranchTransferFrom.Rows[0]["Stk_TransferToBranch"]);
            }
        }
        ...
        public DataTable GetSerialDataForBo(string WarehouseID, string BatchID, int BTOUtNo)
        {
            DataTable dt = new DataTable();
            ProcedureExecute proc = new ProcedureExecute("prc_SalesOrder_Details");
            proc.AddVarcharPara("@Action", 500, "GetSerialByProductIDWarehouseBatchForBO");
            proc.AddVarcharPara("@Order_Id", 500, Convert.ToString(Session["BTInID"]));
            proc.AddVarcharPara("@ProductID", 500, Convert.ToString(hdfProductID.Value));
            proc.AddVarcharPara("@BatchID", 500, BatchID);
            proc.AddVarcharPara("@WarehouseID", 500, WarehouseID);
            ...
            proc.AddVarcharPara("@companyId", 500, Convert.ToString(Session["LastCompany"]));
            proc.AddBigIntegerPara("@BTOut_No", BTOUtNo);
            proc.AddVarcharPara("@Doc_Type", 10, "BO");
            dt = proc.GetTable();
            return dt;
        }
        ...
        public DataTable GetBatchDataOnBind(string WarehouseID,int BTOUtNo)
        {
            DataTable dt = new DataTable();
            ProcedureExecute proc = new ProcedureExecute("prc_SalesOrder_Details");
            proc.AddVarcharPara("@Action", 500, "GetBatchByProductIDWarehouseForBO");
            proc.AddVarcharPara("@Order_Id", 500, Convert.ToString(Session["QuotationID"]));
            proc.AddVarcharPara("@ProductID", 500, Convert.ToString(hdfProductID.Value));
            proc.AddVarcharPara("@WarehouseID", 500, WarehouseID);
            proc.AddVarcharPara("@FinYear", 500, Convert.ToString(Session["LastFinYear"]));
        ...
        public DataTable GetWarehouseData()
        {
            DataTable dt = new DataTable();
            ProcedureExecute proc = new ProcedureExecute("prc_SalesOrder_Details");
            proc.AddVarcharPara("@Action", 500, "GetWareHouseDtlByProductIDForBO");
            proc.AddVarcharPara("@Order_Id", 500, Convert.ToString(Session["BTInID"]));
            proc.AddVarcharPara("@ProductID", 500, Convert.ToString(hdfProductID.Value));
            proc.AddVarcharPara("@FinYear", 500, Convert.ToString(Session["LastFinYear"]));
            //proc.AddVarcharPara("@branchId", 500, Convert.ToString(Session["userbranchID"]));
        ...
        public string checkNMakeJVCode(string manual_str, int sel_schema_Id)
        {
            ...
            if (sel_schema_Id > 0)
            {
                ...
                if (scheme_type != 0)
                {
                    ...
                    sqlQuery = "SELECT max(tjv.Stk_TransferNumber) FROM tbl_trans_BranchStockIn tjv WHERE dbo.RegexMatch('";
                    if (prefLen > 0)
                ...
                {
                    sqlQuery = "SELECT Stk_TransferNumber FROM tbl_trans_BranchStockIn WHERE Stk_TransferNumber LIKE '" + manual_str.Trim() + "'";
                    dtC = oDBEngine.GetDataTable(sqlQuery);
        ...
        protected DataTable GetTaxDataWithGST(DataTable existing)
        {
            ...
            proc.AddVarcharPara("@Challan_Id", 500, Convert.ToString(Session["BTInID"]));
            dt = proc.GetTable();
            if (dt.Rows.Count > 0)
            {
        ...
        protected void gridTax_DataBinding(object sender, EventArgs e)
        {
            if (Session["BTInTaxDetails"] != null)
            {
                DataTable TaxDetailsdt = (DataTable)Session["BTInTaxDetails"];
        ...
        protected void taxUpdatePanel_Callback(object source, DevExpress.Web.CallbackEventArgsBase e)
        {
            ...
            {
                DataTable MainTaxDataTable = (DataTable)Session["BTInFinalTaxRecord"];
                ...
                Session["BTInFinalTaxRecord"] = MainTaxDataTable;
        ...
        public void CreateDataTaxTable()
        {
            ...
            Session["BTInFinalTaxRecord"] = TaxRecord;
        }
        ...
        protected void cgridTax_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            {
                DataTable TaxRecord = (DataTable)Session["BTInFinalTaxRecord"];
        ...
        public void DeleteTaxDetails(string SrlNo)
        {
            ...
            if (Session["BTInFinalTaxRecord"] != null)
            {
                ...
                Session["BTInFinalTaxRecord"] = TaxDetailTable;
            }
        }
        ...
        public void DeleteWarehouse(string SrlNo)
        {
            ...
            if (Session["BTIn_WarehouseData"] != null)
            {
                Warehousedt = (DataTable)Session["BTIn_WarehouseData"];
                ...
                Session["BTIn_WarehouseData"] = Warehousedt;
            }
        }
        ...
        protected void ComponentPanel_Callback(object sender, CallbackEventArgsBase e)
        {
            ...
            {
                Session["BTInBillingAddressLookup"] = dst.Tables[0];
            }
            shippingAddress.DataSource = dst.Tables[1];
            shippingAddress.DataBind();
            if (dst.Tables[1].Rows.Count > 0)
            {
                Session["BTInShippingAddressLookup"] = dst.Tables[1];
            }
            ...
            if (WhichCall == "Edit")
            {
                ...
                else if (Session["BTInAddressDtl"] != null)
                {
                    DataTable dt = (DataTable)Session["BTInAddressDtl"];
                    if (dt.Rows.Count > 0)
                    {
        ...
        public DataTable GetOrderEditData()
        {
            ...
            proc.AddVarcharPara("@Action", 500, "StockIntDetails");
            proc.AddVarcharPara("@Order_Id", 500, Convert.ToString(Session["BTInID"]));
            //proc.AddVarcharPara("@FinYear", 500, Convert.ToString(Session["LastFinYear"]));
            //proc.AddVarcharPara("@branchId", 500, Convert.ToString(Session["userbranchID"]));
            //proc.AddVarcharPara("@companyId", 500, Convert.ToString(Session["LastCompany"]));
        ...
        public DataTable GetOrderEditDataForBinding()
        {
            DataTable dt = new DataTable();
            ProcedureExecute proc = new ProcedureExecute("prc_GetChallanInvoiceDetails");
            proc.AddVarcharPara("@Action", 500, "StockInDetailsForLookupBind");
            proc.AddVarcharPara("@Order_Id", 500, Convert.ToString(Session["BTInID"]));
            //proc.AddVarcharPara("@FinYear", 500, Convert.ToString(Session["LastFinYear"]));
            //proc.AddVarcharPara("@branchId", 500, Convert.ToString(Session["userbranchID"]));
            //proc.AddVarcharPara("@companyId", 500, Convert.ToString(Session["LastCompany"]));
        ...
        public void SetOrderDetails()
        {
            ...
            { 
                ...
                string Requisition_Date = Convert.ToString(OrderEditdt.Rows[0]["StkOut_Date"]);
                ...
                string Order_Date = Convert.ToString(BindLookup.Rows[0]["Requisition_Date"]);
                if (!String.IsNullOrEmpty(Quoids))
                {
                    string[] eachQuo = Quoids.Split(',');
        ...
        protected void ComponentDatePanel_Callback(object sender, CallbackEventArgsBase e)
        {
            ...
            if (strSplitCommand == "BindQuotationDate")
            {
                ...
                if (Stk_Id != "0")
                {
                    DataTable dt_QuotationDetails = objSlaesActivitiesBL.GetStockOutDate(Stk_Id);
                    if (dt_QuotationDetails != null && dt_QuotationDetails.Rows.Count > 0)
                    {
                        string quotationdate = Convert.ToString(dt_QuotationDetails.Rows[0]["BTOut_Date"]);
                        if (!string.IsNullOrEmpty(quotationdate))
                        {
        ...
        {
            if (Session["BTIData"] != null)
            {
                lookup_order.DataSource = (DataTable)Session["BTIData"];
            }
        }
        protected void BindLookUp(string OrderDate)
        {
            ...
            string ResultantBranch = string.Empty;
            //Subhabrata
            if (Convert.ToString(Request.QueryString["key"]) != "ADD")
            {
                status = "DONE";
            ...
            //if (Convert.ToString(Request.QueryString["key"]) == "ADD")
            //{
            //    strBranchId = Convert.ToString(NumberingScheme.Split('~')[3]);
            //}
            
            if (!string.IsNullOrEmpty(NumberingScheme))
            {
                strBranchId = Convert.ToString(NumberingScheme.Split('~')[3]);
            ...
            if (Convert.ToString(Request.QueryString["key"]) != "ADD")
            {
               strBranchId = Convert.ToString(ddl_transferTo_Branch.SelectedValue);
                //strBranchId = Convert.ToString(Session["userbranchHierarchy"]);
            }

            DataTable dtTemp = new DataTable();
            if (strBranchId != "0")
            {
                dtTemp = objSlaesActivitiesBL.GetUserBranchHeirarchy(strBranchId);
            }

            for (int i = 0; i < dtTemp.Rows.Count; i++)
            {
                ResultantBranch += "," + Convert.ToString(dtTemp.Rows[i]["BranchId"]);
            }

            ResultantBranch = ResultantBranch.TrimStart(',');
            ResultantBranch = ResultantBranch.Insert(0, strBranchId + ",");
            DataTable SalesOrderTable = null;


            if (!string.IsNullOrEmpty(ResultantBranch))
            {
                SalesOrderTable = objBL.GetStockOutDetails(OrderDate, status, ResultantBranch);
            }
            else if (!string.IsNullOrEmpty(strBranchId))
            {
                SalesOrderTable = objBL.GetStockOutDetails(OrderDate, status, strBranchId);
            }
            ...
            Session["BTIData"] = SalesOrderTable;
        }
        protected void ComponentSalesOrder_Callback(object source, DevExpress.Web.CallbackEventArgsBase e)
        {
            ...
            string OrderDate = string.Empty;
            string strBranchId = string.Empty;
            string NumberingScheme = string.Empty;//Commanded by:Pijush da on 30-05-2017
            string ResultantBranch = string.Empty;
            if (e.Parameter.Split('~')[0] == "BindSalesOrderGrid")
            {
                ...
                //Commanded by:Pijush da on 30-05-2017
                //Done By:Subhabrata
                if (Convert.ToString(Request.QueryString["key"]) == "ADD")
                {
                    NumberingScheme = Convert.ToString(ddl_numberingScheme.SelectedValue);
        ...
        public DataTable GetBillingAddress()
        {
            ...
            proc.AddVarcharPara("@Challan_Id", 20, Convert.ToString(Session["BTInID"]));
            dt = proc.GetTable();
            return dt;
        }
        ...
        public DataTable GetOrderWarehouseData()
        {
            try
            {
                DataTable dt = new DataTable();
                ProcedureExecute proc = new ProcedureExecute("prc_SalesOrder_Details");
                proc.AddVarcharPara("@Action", 500, "BranchTransferInWarehouse");
                proc.AddVarcharPara("@Order_Id", 500, Convert.ToString(Session["BTInID"]));
                dt = proc.GetTable();
                //ProcedureExecute proc = new ProcedureExecute("prc_StockGetSCwarehousentry");
                //proc.AddVarcharPara("@Action", 500, "OrderWarehouse");
                //proc.AddVarcharPara("@PCNumber", 500, Convert.ToString(Session["BTInID"]));
                //proc.AddVarcharPara("@Finyear", 500, Convert.ToString(Session["LastFinYear"]));
                //proc.AddVarcharPara("@ProductID", 500, Convert.ToString(hdfProductID.Value));
                //proc.AddVarcharPara("@branchID", 500, Convert.ToString(ddl_transferTo_Branch.SelectedValue));
                ...
                foreach (DataRow drr in tempdt.Rows)
                {
                    strNewVal = Convert.ToString(drr["BranchInWarehouse_Id"]);
                ...
                Session["BTIn_LoopWarehouse"] = Convert.ToString(Convert.ToInt32(strNewVal) + 1);
                tempdt.Columns.Remove("BranchInWarehouse_Id");
                return tempdt;
            }
            catch
            {
        ...
        protected void CmbBatch_Callback(object sender, CallbackEventArgsBase e)
        {
            ...
            {
                if (!string.IsNullOrEmpty(Convert.ToString(e.Parameter.Split('~')[2])))
                {
                    string WarehouseID = Convert.ToString(e.Parameter.Split('~')[1]);
                    int BtOutNo = Convert.ToInt32(e.Parameter.Split('~')[2]);
                    Session["BTOutNo"] = BtOutNo;
                    //DataTable dt = GetBatchData(WarehouseID);GetBatchDataOnBind
                    DataTable dt = GetBatchDataOnBind(WarehouseID, BtOutNo);
        ...
        public static string GetSerialId(string id, string wareHouseStr, string BatchID, string ProducttId)
        {
            ...
            {
                dt = objCRMSalesOrderDtlBL.GetSerialataOnFIFOBasisForBTIn(wareHouseStr, BatchID, Serial, ProducttId, id, LastSerial);
            }
            else
            {
                dt = objCRMSalesOrderDtlBL.GetSerialataOnFIFOBasisForBTIn(wareHouseStr, BatchID, Serial, ProducttId, id, Serial);
            }
        ...
        protected void CmbSerial_Callback(object sender, CallbackEventArgsBase e)
        {
            ...
            {
                if(!string.IsNullOrEmpty(e.Parameter.Split('~')[3]))
                {
                    string WarehouseID = Convert.ToString(e.Parameter.Split('~')[1]);
                    string BatchID = Convert.ToString(e.Parameter.Split('~')[2]);
                    int BTOutNo = Convert.ToInt32(e.Parameter.Split('~')[3]);


                    //DataTable dt = GetSerialata(WarehouseID, BatchID);
                    DataTable dt = GetSerialDataForBo(WarehouseID, BatchID, BTOutNo);
                    if (Session["BTIn_WarehouseData"] != null)
                    {
                        DataTable Warehousedt = (DataTable)Session["BTIn_WarehouseData"];
        ...
        protected void GrdWarehouse_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            {
                int loopId = Convert.ToInt32(Session["BTIn_LoopWarehouse"]);
                ...
                Session["BTIn_LoopWarehouse"] = loopId + 1;

...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="form_main clearfix">
        <% if (rights.CanAdd)
           { %>
        <a href="javascript:void(0);" onclick="AddnewFinance()" class="btn btn-primary"><span><u>A</u>dd New</span> </a>
        <% } %>
        <% if (rights.CanExport)
           { %>
    ...
    <div>
        <dxe:ASPxGridView ID="downpaygrid" runat="server" KeyFieldName="SrlNo" AutoGenerateColumns="False"
            ...
            DataSourceID="EntityServerModeDataSource" OnCustomCallback="downpaygrid_CustomCallback" OnSummaryDisplayText="downpaygrid_SummaryDisplayText">
            <Columns>
                <%-- <dxe:GridViewDataTextColumn FieldName="SrlNo"></dxe:GridViewDataTextColumn>--%>
                <dxe:GridViewDataTextColumn FieldName="SrlNo" SortOrder="Ascending" VisibleIndex="0" Visible="false"></dxe:GridViewDataTextColumn>
                ...
                <dxe:GridViewDataTextColumn Caption="Bill Number" FieldName="BillNumber" Width="150px"
                    VisibleIndex="2">
                    <CellStyle CssClass="gridcellleft" Wrap="true">
                    </CellStyle>
                    <Settings AutoFilterCondition="Contains" />
                </dxe:GridViewDataTextColumn>
                <dxe:GridViewDataTextColumn Caption="Bill Date" FieldName="BillDate" Width="100px"
                    VisibleIndex="3">
                    <CellStyle CssClass="gridcellleft" Wrap="true">
                    </CellStyle>
                ...
                <dxe:GridViewDataTextColumn HeaderStyle-HorizontalAlign="Center" CellStyle-HorizontalAlign="center" VisibleIndex="12" Width="100px">
                    <DataItemTemplate>
                        <% if (rights.CanEdit)
                           { %>
                        <a href="javascript:void(0);" onclick="OnMoreInfoClick('<%#Container.VisibleIndex %>')" class="pad" title="Edit">
                            <img src="../../../assests/images/info.png" /></a>
                        <% } %>

                        <% if (rights.CanDelete)
                           { %>
                        <a href="javascript:void(0);" onclick="OnClickDelete('<%#Eval("ID")%>')" class="pad" title="Delete" style='<%#Eval("Status")%>'>
    ...
    <asp:SqlDataSource runat="server" ID="dsProduct" ConnectionString="<%$ ConnectionStrings:crmConnectionString %>"

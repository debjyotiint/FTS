<%@ Page Title="Clarification Required" Language="C#" AutoEventWireup="true"  MasterPageFile="~/OMS/MasterPage/ERP.Master"  CodeBehind="ClarificationSales.aspx.cs" Inherits="ERP.OMS.Management.Activities.ClarificationSales" %>
    ...
    <script type="text/javascript">
        ...
        function Call_save() {
            ...
            if (Remarks == "" || Remarks == null) {
                ...
                grid.PerformCallback('ClosedStatus~' + Closevar+ '~' + Remarks);
            }
            return flag;
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <div class="panel-heading">
        <div class="panel-title">
            <h3>Sales Activity - Clarification Required
            </h3>
                    ...
                    <td>
                        <dxe:ASPxPageControl ID="ASPxPageControl1" runat="server" ActiveTabIndex="3" ClientInstanceName="page"
                            ...
                            <TabPages>
                                ...
                                <dxe:TabPage Text="Clarification Required" Name="Clarification Required">
                                    <ContentCollection>
                                        <dxe:ContentControl runat="server">
                                            <div id="GridDiv">
                                                <table width="100%">
                                                    ...
                                                    <tr>
                                                        <td>
                                                             <dxe:ASPxGridView ID="SalesDetailsGrid" runat="server"  KeyFieldName="sls_id"  SettingsCookies-Enabled="true" SettingsCookies-StorePaging="true" SettingsCookies-StoreFiltering="true" SettingsCookies-StoreGroupingAndSorting="true" SettingsBehavior-AllowFocusedRow="true" AutoGenerateColumns="False" ClientInstanceName="grid"
                                                       ...
                                                       <%--           <dxe:GridViewDataTextColumn FieldName="Address" Caption="Address" VisibleIndex="1" Width="18%">
                                                             ...
                                                             <%--   <dxe:GridViewDataTextColumn FieldName="Address" ReadOnly="True" VisibleIndex="7"
                                                                    Width="18%" Visible="false">
                                                                </dxe:GridViewDataTextColumn>--%>
                                                                <dxe:GridViewDataTextColumn FieldName="Phone" ReadOnly="True" VisibleIndex="8"
                                                                    Width="8%" Visible="false">
                                                                </dxe:GridViewDataTextColumn>
                                                                <%--   <dxe:GridViewDataTextColumn FieldName="ProductType" ReadOnly="True" Visible="False"
                                                                    VisibleIndex="4"  Width="18%">
                                                                </dxe:GridViewDataTextColumn>--%>
                                                                <dxe:GridViewDataTextColumn FieldName="Id" ReadOnly="True" Visible="False" VisibleIndex="9">
                                                                    <EditFormSettings Visible="False" />
                                                                </dxe:GridViewDataTextColumn>
                                                                <dxe:GridViewDataTextColumn FieldName="Amount" Visible="False" VisibleIndex="10">
                                                                </dxe:GridViewDataTextColumn>
                                                                <dxe:GridViewDataTextColumn FieldName="Product" ReadOnly="True" Visible="False"
                                                                    VisibleIndex="9">
                                                                </dxe:GridViewDataTextColumn>

                                                                <dxe:GridViewDataTextColumn FieldName="ProductType" VisibleIndex="11" Caption="Product Type" Visible="false">
                                                                </dxe:GridViewDataTextColumn>
                                                                ...
                                                                <dxe:GridViewDataTextColumn VisibleIndex="18" Caption="History" Width="100px">
                                                                  ...
                                                                  <dxe:GridViewDataTextColumn VisibleIndex="19" Caption="Actions"  Width="160px">
                                                                    ...
                                                                    <DataItemTemplate>
                                                                           <% if (rights.CanClose)
                                                                            { %>
                                                                        <a href="javascript:void(0)" onclick="ShowClosed('<%#Eval("sls_id") %>')">
	...
	LastActivityDetailsCall(s.cpHeight);
            ...
            <HeaderStyle BackColor="LightGray" ForeColor="Black" />
               ...
               <dxe:ASPxPopupControl ID="Popup_Close" runat="server" ClientInstanceName="cPopup_Close"
            Width="400px" HeaderText="Closed Sales" PopupHorizontalAlign="WindowCenter"
            BackColor="white" Height="100px" PopupVerticalAlign="WindowCenter" CloseAction="CloseButton"
            Modal="True" ContentStyle-VerticalAlign="Top" EnableHierarchyRecreation="True">
            <ContentCollection>
                <dxe:PopupControlContentControl runat="server">
                    ...
                    <div class="Top clearfix">
                        ...
                        <table style="width:94%">
                            ...
                            <tr><td>Remarks<span style="color: red">*</span></td>
                                <td class="relative">
                            ...
                            <tr >
                                <td colspan="3" style="padding-left: 121px;padding-top:10px">
                                    <input id="btnSave" class="btn btn-primary" onclick="Call_save()" type="button" value="Save" />
                                    <input id="btnCancel" class="btn btn-danger" onclick="CancelClose_save()" type="button" value="Cancel" />
                                </td>

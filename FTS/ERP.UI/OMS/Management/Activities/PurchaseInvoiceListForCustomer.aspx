<%@ Page Title="Purchase Invoice For Customer" Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" 
    CodeBehind="PurchaseInvoiceListForCustomer.aspx.cs" Inherits="ERP.OMS.Management.Activities.PurchaseInvoiceListForCustomer" %>
    ...
    <script>
        ...
        updatePBCLGridByDate = function () {
            if (cFormDate.GetDate() == null) {
                ...
                localStorage.setItem("PBCLFromDate", cFormDate.GetDate().format('yyyy-MM-dd'));
                localStorage.setItem("PBCLToDate", ctoDate.GetDate().format('yyyy-MM-dd'));
                localStorage.setItem("PBCLBranch", ccmbBranchfilter.GetValue());
        ...
        AllControlInitilize = function (s, e) {
            if (isFirstTime) {
                if (localStorage.getItem('PBCLFromDate')) {
                    var fromdatearray = localStorage.getItem('PBCLFromDate').split('-');
                    var fromdate = new Date(fromdatearray[0], parseFloat(fromdatearray[1]) - 1, fromdatearray[2], 0, 0, 0, 0);
                    cFormDate.SetDate(fromdate);
                }

                if (localStorage.getItem('PBCLToDate')) {
                    var todatearray = localStorage.getItem('PBCLToDate').split('-');
                    var todate = new Date(todatearray[0], parseFloat(todatearray[1]) - 1, todatearray[2], 0, 0, 0, 0);
                    ctoDate.SetDate(todate);
                }

                if (localStorage.getItem('PBCLBranch')) {
                    if (ccmbBranchfilter.FindItemByValue(localStorage.getItem('PBCLBranch'))) {
                        ccmbBranchfilter.SetValue(localStorage.getItem('PBCLBranch'));
                    }
                }
            }
        }
    ...
    <script>
        ...
        function OnMoreInfoClick(keyValue) {
            ...
            if (ActiveUser != null) {
                $.ajax({
                    type: "POST",
                    url: "PurchaseInvoiceListForCustomer.aspx/GetEditablePermission",
                    data: "{'ActiveUser':'" + ActiveUser + "'}",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (msg) {
                        var status = msg.d;
                        var url = 'PurchaseInvoiceForCustomer.aspx?key=' + keyValue + '&Permission=' + status + '&type=PB';
        ...
        function OnViewClick(keyValue) {
            var url = 'PurchaseInvoiceForCustomer.aspx ?key=' + keyValue + '&req=V' + '&type=PB';
            window.location.href = url;
        }
        ...
        function OnAddButtonClick() {
            var url = 'PurchaseInvoiceForCustomer.aspx?key=' + 'ADD';
            window.location.href = url;
        }
        var keyval;
        ...
        function OnGetApprovedRowValues(obj) { 
            uri = "PurchaseInvoiceForCustomer.aspx ?key=" + obj + "&status=2" + '&type=PB';
        ...
        function OnGetRejectedRowValues(obj) {
            uri = "PurchaseInvoiceForCustomer.aspx ?key=" + obj + "&status=3" + '&type=PB';
            popup.SetContentUrl(uri);
            popup.Show();
        }
        ...
        function OnApprovalEndCall(s, e) {
            $.ajax({
                type: "POST",
                url: "PurchaseInvoiceListForCustomer.aspx/GetPendingCase",
                contentType: "application/json; charset=utf-8",
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel-heading clearfix">
        <div class="panel-title pull-left">
            <h3>Purchase Invoice For Customer</h3>
        </div>
         <table class="padTab pull-right">
            <tr>
                ...
                <td>
                    <input type="button" value="Show" class="btn btn-primary" onclick="updatePBCLGridByDate()" />
    ...
    <div class="GridViewArea">
         <dxe:ASPxGridView ID="GrdQuotation" runat="server" KeyFieldName="Invoice_Id" AutoGenerateColumns="False" Settings-HorizontalScrollBarMode="Visible"
            Width="100%" ClientInstanceName="cgrid" OnCustomCallback="GrdQuotation_CustomCallback" Settings-VerticalScrollableHeight="300"
             ...
             DataSourceID="EntityServerModeDataSource" SettingsCookies-Enabled="true" SettingsCookies-StorePaging="true" SettingsCookies-StoreFiltering="true" SettingsCookies-StoreGroupingAndSorting="true" SettingsBehavior-AllowFocusedRow="true" 
             >
            <Columns>
                <dxe:GridViewDataTextColumn Caption="Purchase Invoice No" FieldName="InvoiceNumber" VisibleIndex="0"  Width="130px">
                    <CellStyle CssClass="gridcellleft" Wrap="true">
                    </CellStyle>
                    <Settings AutoFilterCondition="Contains" />
                </dxe:GridViewDataTextColumn>

                 <dxe:GridViewDataTextColumn Caption="Date" FieldName="InvoiceDate" VisibleIndex="1" Width="85px" PropertiesTextEdit-DisplayFormatString="dd-MM-yyyy">
                    <CellStyle CssClass="gridcellleft" Wrap="true">
                    </CellStyle>
                    <Settings AutoFilterCondition="Contains" />
                </dxe:GridViewDataTextColumn>
                <dxe:GridViewDataTextColumn Caption="Customer" FieldName="VendorName" VisibleIndex="2" Width="180px" >
                    <CellStyle CssClass="gridcellleft" Wrap="true">
                    </CellStyle>
                    <Settings AutoFilterCondition="Contains" />
                </dxe:GridViewDataTextColumn>
                <dxe:GridViewDataTextColumn Caption="Branch" FieldName="branch" VisibleIndex="3" Width="150px">
                    <CellStyle CssClass="gridcellleft" Wrap="true">
                    </CellStyle>
                    <Settings AutoFilterCondition="Contains" />
                </dxe:GridViewDataTextColumn>
                ...
                <dxe:GridViewDataTextColumn Caption="Party Invoice No" FieldName="PartyInvoiceNo" VisibleIndex="4"  Width="100px">
                 ...
                 <dxe:GridViewDataTextColumn Caption="Party Invoice Date" FieldName="PartyInvoiceDate" VisibleIndex="5"  Width="120px" PropertiesTextEdit-DisplayFormatString="dd-MM-yyyy">
                    <CellStyle CssClass="gridcellleft" Wrap="true">
                    </CellStyle>
                    <Settings AutoFilterCondition="Contains" />
                </dxe:GridViewDataTextColumn>
                ...
                <dxe:GridViewDataTextColumn Caption="GRN No" FieldName="ChallanNumber" VisibleIndex="6" Width="130px">
                 ...
                 <dxe:GridViewDataTextColumn Caption="GRN Date" FieldName="ChallanDate" VisibleIndex="7"  Width="78px" PropertiesTextEdit-DisplayFormatString="dd-MM-yyyy">
                    <CellStyle CssClass="gridcellleft" Wrap="true">
                    </CellStyle>
                    <Settings AutoFilterCondition="Contains" />
                </dxe:GridViewDataTextColumn>
                ...
                <dxe:GridViewDataTextColumn Caption="Created BY" FieldName="CreatedBY" VisibleIndex="8"  Width="80px">
                    <CellStyle CssClass="gridcellleft" Wrap="true">
                    </CellStyle>
                    <Settings AutoFilterCondition="Contains" />
                </dxe:GridViewDataTextColumn>
                ...
                <dxe:GridViewDataTextColumn Caption="Updated On" FieldName="updatedOn" Width="80px"  VisibleIndex="10" PropertiesTextEdit-DisplayFormatString="dd-MM-yyyy">
                    <CellStyle CssClass="gridcellleft" Wrap="true">
                    </CellStyle>
                    <Settings AutoFilterCondition="Contains" />
                </dxe:GridViewDataTextColumn>
                ...
                <dxe:GridViewDataTextColumn HeaderStyle-HorizontalAlign="Center" CellStyle-HorizontalAlign="center" VisibleIndex="13" width="130px">
                    <DataItemTemplate>
                         <% if (rights.CanView)
                            { %>

...
{
    public partial class BranchTransferOut : ERP.OMS.ViewState_class.VSPage//System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                //kaushik 24-2-2017
                Session["BTOutBillingAddressLookup"] = null;
                Session["BTOutShippingAddressLookup"] = null;
                Session["BTOutAddressDtl"] = null;
                //kaushik 24-2-2017
                Session["CustomerDetail"] = null;
                Session["BTOut_WarehouseData"] = null;
                Session["BTOut_LoopWarehouse"] = 1;
                Session["BTOutTaxDetails"] = null;
                Session["BTOutDetails"] = null;
                ...
                if (Request.QueryString["key"] != null)
                {
                    if (Convert.ToString(Request.QueryString["key"]) != "ADD")
                    {
                        ...
                        Session["BTOutID"] = strOrderId;
                        string ExistsRef = GetBOIsExistInBI(strOrderId);
                        if (ExistsRef == "1")
                        {
                            ...
                            ltrTitle.Text = "View Branch Transfer Out";
                        }
                        else
                        { ltrTitle.Text = "Modify Branch Transfer Out"; }
                        Session["ActionType"] = "Edit";
                        Session["BTOut_WarehouseData"] = GetOrderWarehouseData();
                        Session["BTOutDetails"] = GetOrderData().Tables[0];
                        #region Subhabrata Get Tax Details in Edit Mode

                        //  Session["SalesChallanTaxDetails"] = GetQuotationTaxData().Tables[0];
                        //from quotation
                        Session["BTOutTaxDetails"] = GetTaxDataWithGST(GetTaxData(dt_BTOut.Date.ToString("yyyy-MM-dd")));
                        ...
                        {
                            Session["BTOutFinalTaxRecord"] = quotetable;
                        }
                        ...
                        //kaushik 24-2-2017
                        Session["BTOutAddressDtl"] = GetBillingAddress();
                        //kaushik 24-2-2017
                        hdnmodeId.Value = "BranchStockOut" + strOrderId;
                    ...
                    else
                    {
                        ...
                        //lookup_quotation.DataBind();
                        // bindLookUP("NOT-DONE");
                        ltrTitle.Text = "Add Branch Transfer Out";
            ...
            if (Request.QueryString["key"] != null && Request.QueryString["key"] != "ADD")
            {
                ...
                Session["BTOutID"] = strOrderId1;
                DataTable OrderEditdt = GetOrderEditData();
                if (OrderEditdt != null && OrderEditdt.Rows.Count > 0)
                {
                    string Quoids = Convert.ToString(OrderEditdt.Rows[0]["Stk_BranchRequisitionsIds"]);
                    //Session["Lookup_QuotationIds"] = Quoids;
                    string Order_Date = Convert.ToString(OrderEditdt.Rows[0]["Stk_TransferDate"]);
        ...
        public void GetAllDropDownDetailForSalesOrder(string UserBranch)
        {
            ...
            DataTable Schemadt = objSlaesActivitiesBL1.GetNumberingSchema(strCompanyID, UserBranch, FinYear, "31", "Y");
            ...
            {
                ddl_VehicleNo.DataValueField = "cnt_id";
                ddl_VehicleNo.DataTextField = "cnt_UCC";
                ddl_VehicleNo.DataSource = dst.Tables[10];
        ...
        public class SalesOrder
        {
            ...
            public Int64 Indent_No { get; set; }
        ...
        public DataTable GetTaxData(string quoteDate)
        {
            ...
            proc.AddVarcharPara("@Challan_Id", 500, Convert.ToString(Session["BTOutID"]) == "ADD" ? "" : Convert.ToString(Session["BTOutID"]));
        ...
        public IEnumerable GetSalesOrder()
        {
            ...
            for (int i = 0; i < Orderdt.Rows.Count; i++)
            {
                ...
                if (!string.IsNullOrEmpty(Convert.ToString(Orderdt.Rows[i]["Indent_No"])))//Added on 15-02-2017
                { Orders.Indent_No = Convert.ToInt64(Orderdt.Rows[i]["Indent_No"]); }
                else
                { Orders.Indent_No = 0; }
                OrderList.Add(Orders);
                if (dtC.Contains("Indent"))
                {
                    Orders.Quotation_Num = Convert.ToString(Orderdt.Rows[i]["Indent"]);//subhabrata on 21-02-2017
                }
        ...
        public IEnumerable GetSalesOrder(DataTable SalesOrderdt)
        {
            ...
            for (int i = 0; i < SalesOrderdt.Rows.Count; i++)
            {
                ...
                if (!string.IsNullOrEmpty(Convert.ToString(SalesOrderdt.Rows[i]["SalePrice"])))
                ...
                if (!string.IsNullOrEmpty(Convert.ToString(SalesOrderdt.Rows[i]["Indent_No"])))//Added on 15-02-2017
                { Orders.Indent_No = Convert.ToInt64(SalesOrderdt.Rows[i]["Indent_No"]); }
                else
                { Orders.Indent_No = 0; }
                if (dtC.Contains("Indent"))
                {
        ...
        public IEnumerable GetSalesOrderInfo(DataTable SalesOrderdt1, string Order_Id)
        {
            ...
            string Amount_Res = string.Empty;
            for (int i = 0; i < SalesOrderdt1.Rows.Count; i++)
            {
                SalesOrder Orders = new SalesOrder();
                string ProductId = Convert.ToString(SalesOrderdt1.Rows[i]["QuoteDetails_ProductId"]);
                int Pro_Id = Convert.ToInt32(ProductId.Split('|')[0]);
                DataTable dtFiFoVal = objCRMSalesOrderDtlBL.GetProductFifoValuation(Pro_Id);
                string Valuation_sign = Convert.ToString(dtFiFoVal.Rows[0]["Stockvaluation"]);
                if (dtFiFoVal != null && dtFiFoVal.Rows.Count > 0)
                {
                    DataTable dtFiFoAmount = objCRMSalesOrderDtlBL.GetValueForProductFifoValuation(Pro_Id,
                                                Convert.ToDecimal(SalesOrderdt1.Rows[i]["QuoteDetails_Quantity"]), Valuation_sign, dt_BTOut.Date.ToString("yyyy-MM-dd"),
                                                dt_BTOut.Date.ToString("yyyy-MM-dd"), Convert.ToString(ddl_transferFrom_Branch.SelectedValue));
                    if (dtFiFoAmount!=null && dtFiFoAmount.Rows.Count>0)
                    {
                        Amount_Res = Convert.ToString(dtFiFoAmount.Rows[0]["VALUE"]);
                    }
                ...
                //else { Orders.Amount = ""; }
                if (!string.IsNullOrEmpty(Amount_Res))
                { Orders.Amount = Convert.ToString(Amount_Res); }
                else { Orders.Amount = ""; }
                ...
                if (!string.IsNullOrEmpty(Convert.ToString(Amount_Res)))
                { Orders.TotalAmount = Convert.ToString(Amount_Res); }
                else { Orders.TotalAmount = ""; }

                if (!string.IsNullOrEmpty(Convert.ToString(SalesOrderdt1.Rows[i]["Indent_No"])))//Added on 15-02-2017
                { Orders.Indent_No = Convert.ToInt64(SalesOrderdt1.Rows[i]["Indent_No"]); }
                else
                { Orders.Indent_No = 0; }
                if (dtC.Contains("Indent"))
                {
        ...
        public bool BindSessionByDatatable(DataTable dt)
        {
            ...
            SalesChalladt.Columns.Add("Indent_No", typeof(string));
            SalesChalladt.Columns.Add("Indent", typeof(string));
            SalesChalladt.Columns.Add("ProductName", typeof(string));

            for (int i = 0; i < dt.Rows.Count; i++)
            {
                string ProductId = Convert.ToString(dt.Rows[i]["QuoteDetails_ProductId"]);
                int Pro_Id = Convert.ToInt32(ProductId.Split('|')[0]);
                DataTable dtFiFoVal = objCRMSalesOrderDtlBL.GetProductFifoValuation(Pro_Id);
                string Valuation_sign = Convert.ToString(dtFiFoVal.Rows[0]["Stockvaluation"]);
                ...
                {
                    DataTable dtFiFoAmount = objCRMSalesOrderDtlBL.GetValueForProductFifoValuation(Pro_Id,
                                                Convert.ToDecimal(dt.Rows[i]["QuoteDetails_Quantity"]), Valuation_sign, dt_BTOut.Date.ToString("yyyy-MM-dd"),
                                                dt_BTOut.Date.ToString("yyyy-MM-dd"), Convert.ToString(ddl_transferFrom_Branch.SelectedValue));
                    if (dtFiFoAmount != null && dtFiFoAmount.Rows.Count > 0)
                    {
                        Amount_Res = Convert.ToString(dtFiFoAmount.Rows[0]["VALUE"]);
                ...
                if (!string.IsNullOrEmpty(Convert.ToString(Amount_Res)))
                { Amount = Convert.ToString(Amount_Res); }
                else { Amount = ""; }
                ...
                if (!string.IsNullOrEmpty(Convert.ToString(Amount_Res)))
                { TotalAmount = Convert.ToString(Amount_Res); }
                else { TotalAmount = ""; }
            ...
            Session["BTOutDetails"] = SalesChalladt;
        ...
        public DataSet GetOrderData()
        {
            DataSet ds = new DataSet();
            ProcedureExecute proc = new ProcedureExecute("prc_SalesChallan_Details");
            proc.AddVarcharPara("@Action", 500, "StockOutData");
            proc.AddVarcharPara("@Order_Id", 500, Convert.ToString(Session["BTOutID"]));
            ds = proc.GetDataSet();
            return ds;
        }
        ...
        protected void grid_BatchUpdate(object sender, DevExpress.Web.Data.ASPxDataBatchUpdateEventArgs e)
        {
            ...
            if (Session["BTOutDetails"] != null)
            {
                //subhabrata: foreach@deleted extra column 
                DataTable tempDt = new DataTable();
                DataTable dt = new DataTable();
                tempDt = (DataTable)Session["BTOutDetails"];
                dt = tempDt.Copy();
            ...
            else
            {
                ...
                SalesOrderdt.Columns.Add("Indent_No", typeof(string));
            ...
            foreach (var args in e.UpdateValues)
            {
                ...
                if (isDeleted == false)
                {
                    if (ProductDetails != "" && ProductDetails != "0")
                    {
                        ...
                        string TaxAmount = (Convert.ToString(args.NewValues["TaxAmount"]) != "") ? Convert.ToString(args.NewValues["TaxAmount"]) : "0";
                        string TotalAmount = (Convert.ToString(args.NewValues["TotalAmount"]) != "") ? Convert.ToString(args.NewValues["TotalAmount"]) : "0";
                        string QuotationNumber = Convert.ToString(args.NewValues["Quotation_No"]);
                        //string Quotation = Convert.ToString(args.NewValues["Quotation_Num"]);//Added By:Subhabrata on 21-02-2017
            ...
            DataTable tempDtDetails = SalesOrderdt.Copy();
            Session["BTOutDetails"] = tempDtDetails;
            //////////////////////
            ...
            if (IsDeleteFrom != "D")
            {
                try
                {
                    ...
                    if (Convert.ToString(Request.QueryString["key"]) != null && Convert.ToString(Request.QueryString["key"]) != "")
                    {
                        ...
                        Session["BTOutID"] = Convert.ToString(Request.QueryString["key"]);
                        if (!string.IsNullOrEmpty(Convert.ToString(Session["BTOutID"])))
                        {

                            MainOrderID = Convert.ToString(Session["BTOutID"]);
                        }
                        else
                        {
                            MainOrderID = "";
                    ...
                    //string vehicleNo = ddl_VehicleNo.SelectedValue;
                    string vehicleNo = hddnddlVehicle.Value;
                    string DriverName = txtDriverName.Text;
                    string PhoneNoDr = txtPhoneNo.Text;
                    //End
                    ...
                    String QuoComponent = "";
                    //List<object> QuoList = lookup_order.GridView.GetSelectedFieldValues("Indent_Id");
                    ...
                    if (Session["BTOutFinalTaxRecord"] != null)
                    {
                        TaxDetailTable = (DataTable)Session["BTOutFinalTaxRecord"];
                    }

                    DataTable TaxDetailsdt = new DataTable();
                    if (Session["BTOutTaxDetails"] != null)
                    {
                        TaxDetailsdt = (DataTable)Session["BTOutTaxDetails"];
                    }
                    else
                    {
                    ...
                    if (Session["BTOut_WarehouseData"] != null)
                    {
                        DataTable Warehousedt = (DataTable)Session["BTOut_WarehouseData"];
                    ...
                    if (Session["BTOutAddressDtl"] != null)
                    {
                        tempBillAddress = (DataTable)Session["BTOutAddressDtl"];
                    }
                    else
                    {
                    ...
                    if (ActionType != "Add")
                    {
                        BTOutID = Convert.ToInt32(Session["BTOutID"]);
                    }
                    
                    //Commented by :Subhabrata on 23-06-2017
                    //StockCheckMsg = objBL.GetAvailableStockCheckForOutModulesBO(duplicatedt, Convert.ToString(Session["userbranchID"]), Convert.ToString(strQuoteDate), ActionType, BTOutID);
                    if (Convert.ToString(Request.QueryString["key"]) != "ADD")
                    {
                        StockCheckMsg = objBL.GetAvailableStockCheckForOutModulesBO(duplicatedt, Convert.ToString(ddl_transferFrom_Branch.SelectedValue), Convert.ToString(strQuoteDate), ActionType, BTOutID);
                    }
                    else
                    {
                        StockCheckMsg = objBL.GetAvailableStockCheckForOutModulesBO(duplicatedt, Convert.ToString(hddnBranchNumberingSchemeWise.Value), Convert.ToString(strQuoteDate), ActionType, BTOutID);
                    }
                    
                    //End

                    //StockCheckMsg = objBL.GetAvailableStockCheckForOutModules(duplicatedt, Convert.ToString(Session["userbranchID"]), Convert.ToString(strQuoteDate));
                    //End

                    //// ############# Added By : Samrat Roy -- 02/05/2017 -- To check Transporter Mandatory Control 
                    BusinessLogicLayer.DBEngine objEngine = new BusinessLogicLayer.DBEngine(ConfigurationManager.AppSettings["DBConnectionDefault"]);
                    DataTable DT = objEngine.GetDataTable("Config_SystemSettings", " Variable_Value ", " Variable_Name='Transporter_BOMandatory' AND IsActive=1");
                    if (DT != null && DT.Rows.Count > 0)
                    {
                    ...
                    if (validate == "outrange" || validate == "duplicateProduct" || validate == "transporteMandatory" || validate == "checkWarehouse" || validate == "checkWarehouseQty")
                    {
                    ...
                    else if (StockCheckMsg == "MoreThanStock")
                    {
                        grid.JSProperties["cpProductMoreThanStock"] = StockCheckMsg;
                    }
                    else
                    {
                        int id = ModifySalesChallan(MainOrderID, strSchemeType, UniqueQuotation, strQuoteDate, strQuoteExpiry, strCustomer, strContactName,
                                                ...
                                                , tempTaxDetailsdt, strBranchTrasferFrom, strBranchTransferTo, vehicleNo, DriverName, PhoneNoDr);
                        ...
                        else
                        {
                            ...
                            if (!string.IsNullOrEmpty(hfControlData.Value))
                            {
                                ...
                                objCommonBL.InsertTransporterControlDetails(id, "BO", hfControlData.Value, Convert.ToString(HttpContext.Current.Session["userid"]));
                            }
                            ...
                            grid.JSProperties["cpDocumentNo"] = Convert.ToString(id);
        ...
        protected void grid_DataBinding(object sender, EventArgs e)
        {
            if (Session["BTOutDetails"] != null)
            {
                DataTable Quotationdt = (DataTable)Session["BTOutDetails"];
        ...
        protected void acbpCrpUdf_Callback(object source, DevExpress.Web.CallbackEventArgsBase e)
        {
            ...
            {
                if (reCat.isAllMandetoryDone((DataTable)Session["UdfDataOnAdd"], "BO") == false)
                {
            ...
            if (strSplitCommand == "BindGridOnQuotation")
            {
                ...
                if (Quote_Nos != "$")
                {
                    ...
                    if (!string.IsNullOrEmpty(IdKey))
                    {
                        if (IdKey != "ADD")
                        {
                            dt_QuotationDetails = objSlaesActivitiesBL.GetIndentRequisitionToBindCGrid(QuoComponent1, QuoteDetails_Id, Product_id1, "Edit");
                        }
                        else
                        {
                            dt_QuotationDetails = objSlaesActivitiesBL.GetIndentRequisitionToBindCGrid(QuoComponent1, QuoteDetails_Id, Product_id1, "Add");
                        }

                    }
                    else
                    {
                        dt_QuotationDetails = objSlaesActivitiesBL.GetIndentRequisitionToBindCGrid(QuoComponent1, QuoteDetails_Id, Product_id1, "");
                    }
                    Session["BTOutDetails"] = null;
        ...
        [WebMethod]
        public static List<VehicleMaster> GetVehicles(string BranchId)
        {

            SlaesActivitiesBL objSlaesActivitiesBL = new SlaesActivitiesBL();
            List<VehicleMaster> vehicles = new List<VehicleMaster>();
            DataTable dt = objSlaesActivitiesBL.GetVehicleMasterNumber(BranchId);
            ...
            if (dt != null && dt.Rows.Count > 0)
            {
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    {
                        Id = Convert.ToInt32(dt.Rows[i]["cnt_id"]),
                        Name = Convert.ToString(dt.Rows[i]["cnt_UCC"])
                    });
                }
            }
        ...
        [WebMethod]
        public static String GetReqNoBranchDetails(string BranchReqNo)
        {
            SlaesActivitiesBL objSlaesActivitiesBL = new SlaesActivitiesBL();
            DataTable dt = objSlaesActivitiesBL.GetBranchDetailsOFReq(BranchReqNo);
            string SalesRate = "";
            if (dt.Rows.Count > 0)
            {
                SalesRate = Convert.ToString(dt.Rows[0]["Indent_BranchIdFor"]) + "~" + Convert.ToString(dt.Rows[0]["Indent_BranchIdTo"]);
            }
        ...
        [WebMethod]
        public static String GetSameBranchId(string BranchReqNo)
        {
            SlaesActivitiesBL objSlaesActivitiesBL = new SlaesActivitiesBL();
            string BranchId = "";
            if(!string.IsNullOrEmpty(BranchReqNo))
            {
                DataTable dt = objSlaesActivitiesBL.GetSameBranchIds(BranchReqNo.TrimStart(','));
                
                if (dt.Rows.Count > 0)
                {
                    BranchId = Convert.ToString(dt.Rows[0]["Indent_BranchIdTo"]);
                }
                else
                {
                    BranchId = "";
        ...
        public int ModifySalesChallan(string BTOutID, string strSchemeType, string strOrderNo, string strOrderDate, string strOrderExpiry, string strCustomer, string strContactName,
                                    ...
                                    DataTable tempTaxDetailsdt,string TransferFrom,string TransferTo,string VehicleNo,string DriverName,string PhoneNoDr)
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("prc_CRMBranchStockOut", con);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@Action", ActionType);
                cmd.Parameters.AddWithValue("@Challan_Id", BTOutID);
                ...
                cmd.Parameters.AddWithValue("@PhoneNo", PhoneNoDr);
                //End
                //kaushik 24-2-2017
        ...
        protected void gridTax_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            if (strSplitCommand == "Display")
            {
                ...
                if (Session["BTOutTaxDetails"] == null)
                {
                    Session["BTOutTaxDetails"] = GetTaxData(dt_BTOut.Date.ToString("yyyy-MM-dd"));
                }
            ...
            else if (strSplitCommand == "SaveGst")
            {
                ...
                else
                {
                    ...
                    Session["BTOutTaxDetails"] = TaxDetailsdt;
                }
            }
        }
        ...
        protected void cgridProducts_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            if (strSplitCommand == "BindProductsDetails")
            {
                ...
                if (Quote_Nos != "$")
                {
                    ...
                    if (!string.IsNullOrEmpty(IdKey))
                    {
                        if (IdKey.ToUpper() != "ADD")
                        {
                            dt_OrderDetails = objSlaesActivitiesBL.GetIndentRequisitionToBindCGridProductPopUp(KeyVal, IdKey, "", "Edit");
                        }
                        else
                        {
                            dt_OrderDetails = objSlaesActivitiesBL.GetIndentRequisitionToBindCGridProductPopUp(KeyVal, "", "", "Add");
                        }
                    ...
                    {
                        for (int j = 0; j < dt_OrderDetails.Rows.Count; j++)
                        {
                            if (Convert.ToString(dt_OrderDetails.Rows[j]["QuoteDetails_Quantity"]) == "0.00")
                            {
        ...
        public DataTable GetSerialata(string WarehouseID, string BatchID)
        {
            ...
            proc.AddVarcharPara("@FinYear", 500, Convert.ToString(Session["LastFinYear"]));
            //proc.AddVarcharPara("@branchId", 500, Convert.ToString(Session["userbranchID"]));
            //proc.AddVarcharPara("@branchId", 500, Convert.ToString(hddnBranchNumberingSchemeWise.Value));
            if (Convert.ToString(Request.QueryString["key"]) != "ADD")
            {
                proc.AddVarcharPara("@branchId", 500, Convert.ToString(ddl_transferFrom_Branch.SelectedValue));
            }
            else
            {
                proc.AddVarcharPara("@branchId", 500, Convert.ToString(hddnBranchNumberingSchemeWise.Value));
            ...
            proc.AddVarcharPara("@companyId", 500, Convert.ToString(Session["LastCompany"]));
            proc.AddVarcharPara("@Doc_Type", 500, "BO");
            dt = proc.GetTable();
            return dt;
        }
        ...
        public DataTable GetSerialataNew(string WarehouseID, string BatchID)
        {
            ...
            proc.AddVarcharPara("@companyId", 500, Convert.ToString(Session["LastCompany"]));
            proc.AddVarcharPara("@Doc_Type", 500, "BO");
            proc.AddVarcharPara("@SC_Date", 10, Convert.ToDateTime(dt_BTOut.Value).ToString("yyyy-MM-dd"));
            dt = proc.GetTable();
            return dt;
        }
        ...
        public DataTable GetSerialataForFifo(string WarehouseID, string BatchID, string Qty)
        {
            ...
            proc.AddVarcharPara("@FinYear", 500, Convert.ToString(Session["LastFinYear"]));
            //proc.AddVarcharPara("@branchId", 2000, Convert.ToString(Session["userbranchID"]));
            //proc.AddVarcharPara("@branchId", 2000, Convert.ToString(hddnBranchNumberingSchemeWise.Value));
            if (Convert.ToString(Request.QueryString["key"]) != "ADD")
            {
                proc.AddVarcharPara("@branchId", 500, Convert.ToString(ddl_transferFrom_Branch.SelectedValue));
            }
        ...
        public string checkNMakeJVCode(string manual_str, int sel_schema_Id)
        {
            ...
            if (sel_schema_Id > 0)
            {
                ...
                if (scheme_type != 0)
                {
                    ...
                    sqlQuery = "SELECT max(tjv.Stk_TransferNumber) FROM tbl_trans_StockOut tjv WHERE dbo.RegexMatch('";
                    if (prefLen > 0)
                    ...
                    //sqlQuery += "?$', LTRIM(RTRIM(tjv.Stk_TransferNumber))) = 1";
                    sqlQuery += "?$', LTRIM(RTRIM(tjv.Stk_TransferNumber))) = 1 and Stk_TransferNumber like '" + prefCompCode + "%'";
                ...
                {
                    sqlQuery = "SELECT Stk_TransferNumber FROM tbl_trans_StockOut WHERE Stk_TransferNumber LIKE '" + manual_str.Trim() + "'";
                    dtC = oDBEngine.GetDataTable(sqlQuery);
        ...
        protected DataTable GetTaxDataWithGST(DataTable existing)
        {
            ...
            proc.AddVarcharPara("@Challan_Id", 500, Convert.ToString(Session["BTOutID"]));
            dt = proc.GetTable();
            if (dt.Rows.Count > 0)
            {
        ...
        protected void gridTax_DataBinding(object sender, EventArgs e)
        {
            if (Session["BTOutTaxDetails"] != null)
            {
                DataTable TaxDetailsdt = (DataTable)Session["BTOutTaxDetails"];
        ...
        protected void taxUpdatePanel_Callback(object source, DevExpress.Web.CallbackEventArgsBase e)
        {
            ...
            {
                DataTable MainTaxDataTable = (DataTable)Session["BTOutFinalTaxRecord"];
                ...
                Session["BTOutFinalTaxRecord"] = MainTaxDataTable;
        ...
        public void CreateDataTaxTable()
        {
            ...
            Session["BTOutFinalTaxRecord"] = TaxRecord;
        }
        ...
        protected void cgridTax_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            {
                DataTable TaxRecord = (DataTable)Session["BTOutFinalTaxRecord"];
        ...
        public void DeleteTaxDetails(string SrlNo)
        {
            ...
            if (Session["BTOutFinalTaxRecord"] != null)
            {
                ...
                Session["BTOutFinalTaxRecord"] = TaxDetailTable;
            }
        }
        ...
        public void DeleteWarehouse(string SrlNo)
        {
            ...
            if (Session["BTOut_WarehouseData"] != null)
            {
                Warehousedt = (DataTable)Session["BTOut_WarehouseData"];
                ...
                Session["BTOut_WarehouseData"] = Warehousedt;
            }
        }
        ...
        protected void ComponentPanel_Callback(object sender, CallbackEventArgsBase e)
        {
            ...
            {
                Session["BTOutBillingAddressLookup"] = dst.Tables[0];
            }
            shippingAddress.DataSource = dst.Tables[1];
            shippingAddress.DataBind();
            if (dst.Tables[1].Rows.Count > 0)
            {
                Session["BTOutShippingAddressLookup"] = dst.Tables[1];
            }
            ...
            if (WhichCall == "Edit")
            {
                ...
                else if (Session["BTOutAddressDtl"] != null)
                {
                    DataTable dt = (DataTable)Session["BTOutAddressDtl"];
                    if (dt.Rows.Count > 0)
                    {
        ...
        public DataTable GetOrderEditData()
        {
            ...
            proc.AddVarcharPara("@Action", 500, "StockOutDetails");
            proc.AddVarcharPara("@Order_Id", 500, Convert.ToString(Session["BTOutID"]));
            //proc.AddVarcharPara("@FinYear", 500, Convert.ToString(Session["LastFinYear"]));
            //proc.AddVarcharPara("@branchId", 500, Convert.ToString(Session["userbranchID"]));
            //proc.AddVarcharPara("@companyId", 500, Convert.ToString(Session["LastCompany"]));
        ...
        public void SetOrderDetails()
        {
            ...
            if (OrderEditdt != null && OrderEditdt.Rows.Count > 0)
            {
                string Branch_From = Convert.ToString(OrderEditdt.Rows[0]["Stk_TransferFormBranch"]);
                string Branch_To = Convert.ToString(OrderEditdt.Rows[0]["Stk_TransferToBranch"]);
                string StkOut_Number = Convert.ToString(OrderEditdt.Rows[0]["Stk_TransferNumber"]);
                string StkOut_Date = Convert.ToString(OrderEditdt.Rows[0]["Stk_TransferDate"]);

                string vehicleNo = Convert.ToString(OrderEditdt.Rows[0]["Stk_VechileNo"]);
                string DriverName = Convert.ToString(OrderEditdt.Rows[0]["Stk_DriverName"]);
                string PhoneNo = Convert.ToString(OrderEditdt.Rows[0]["Stk_DriverMobile"]);
                //New Added
                //string Order_NumberingScheme = Convert.ToString(OrderEditdt.Rows[0]["Challan_NumScheme"]);
                //End
                ddl_numbering.Visible = false;

                string Requisition_Date = Convert.ToString(OrderEditdt.Rows[0]["Requisition_Date"]);
                string Indent_date = Convert.ToString(OrderEditdt.Rows[0]["Indent_Date"]);

                string Purpose = Convert.ToString(OrderEditdt.Rows[0]["Stk_Purpose"]);
                ...
                ddl_transferTo_Branch.Enabled = false;
                ddl_VehicleNo.SelectedValue = vehicleNo;
        ...
        protected void acpAvailableStock_Callback(object source, DevExpress.Web.CallbackEventArgsBase e)
        {
            ...
            //Subhabrata on 23-06-2017
            //string strBranch = Convert.ToString(Session["userbranchID"]);
            string strBranch = Convert.ToString(hddnBranchNumberingSchemeWise.Value);
            //End
            string strDate = Convert.ToString(dt_BTOut.Date);
            acpAvailableStock.JSProperties["cpstock"] = "0.00";
        ...
        protected void ComponentDatePanel_Callback(object sender, CallbackEventArgsBase e)
        {
            ...
            if (strSplitCommand == "BindQuotationDate")
            {
                ...
                DataTable dt_QuotationDetails = objSlaesActivitiesBL.GetBranchRequisitionDate(Quote_No);
                if (dt_QuotationDetails != null && dt_QuotationDetails.Rows.Count > 0)
                {
                    string quotationdate = Convert.ToString(dt_QuotationDetails.Rows[0]["Indent_Date"]);
                    if (!string.IsNullOrEmpty(quotationdate))
                    {
        ...
        {
            if (Session["BTOUTData"] != null)
            {
                lookup_order.DataSource = (DataTable)Session["BTOUTData"];
            }
        }
        protected void BindLookUp(string OrderDate)
        {
            ...
            string ddlNumberingScheme = string.Empty;
            if (!string.IsNullOrEmpty(ddl_numberingScheme.SelectedValue))
            {
                ddlNumberingScheme = Convert.ToString(ddl_numberingScheme.SelectedValue.Split('~')[3]);
            }

            strBranchId = ddlNumberingScheme;
            DataTable SalesOrderTable;


            //SalesOrderTable = objBL.GetBRRequisition(OrderDate, status, strBranchId);

            if (Convert.ToString(Session["ActionType"]).ToUpper() != "ADD")
            {
                SalesOrderTable = objBL.GetBRRequisition(OrderDate, status, Convert.ToString(Session["userbranchHierarchy"]));
            }
            else
            {
                SalesOrderTable = objBL.GetBRRequisition(OrderDate, status, strBranchId);
            ...
            Session["BTOUTData"] = SalesOrderTable;
        }
        ...
        public DataTable GetBillingAddress()
        {
            ...
            proc.AddVarcharPara("@Challan_Id", 20, Convert.ToString(Session["BTOutID"]));
            dt = proc.GetTable();
            return dt;
        }

        public string GetBOIsExistInBI(string keyValue)
        {
            CRMSalesOrderDtlBL objCRMSalesOrderDtlBL = new CRMSalesOrderDtlBL();
        ...
        public DataTable GetOrderWarehouseData()
        {
            try
            {
                DataTable dt = new DataTable();
                ProcedureExecute proc = new ProcedureExecute("prc_SalesOrder_Details");
                proc.AddVarcharPara("@Action", 500, "BTOutDetailsWareHouse");
                proc.AddVarcharPara("@Order_Id", 500, Convert.ToString(Session["BTOutID"]));
                dt = proc.GetTable();
                ...
                //proc.AddVarcharPara("@PCNumber", 500, Convert.ToString(Session["BTOutID"]));
                //proc.AddVarcharPara("@Finyear", 500, Convert.ToString(Session["LastFinYear"]));
                //proc.AddVarcharPara("@ProductID", 500, Convert.ToString(hdfProductID.Value));
                ...
                Session["BTOut_LoopWarehouse"] = Convert.ToString(Convert.ToInt32(strNewVal) + 1);
        ...
        public static string GetSerialId(string id, string wareHouseStr, string BatchID, string ProducttId)
        {
            ...
            {
                dt = objCRMSalesOrderDtlBL.GetSerialataOnFIFOBasisForBTOut(wareHouseStr, BatchID, Serial, ProducttId, id, LastSerial);
            }
            else
            {
                dt = objCRMSalesOrderDtlBL.GetSerialataOnFIFOBasisForBTOut(wareHouseStr, BatchID, Serial, ProducttId, id, Serial);
            }
        ...
        protected void GrdWarehouse_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
         {
            ...
            {
                int loopId = Convert.ToInt32(Session["BTOut_LoopWarehouse"]);
                ...
                if (Type == "WBS")
                {
                    ...
                    if (editWarehouseID == "0")
                    {
                        ...
                        {
                            string strSrlID = Convert.ToString(SerialIDList[i]);
                            string strSrlName = SerialNameList[i];
                            var updaterows = Warehousedt.Select("WarehouseID ='" + WarehouseID + "' AND BatchID ='" + BatchName + "' AND SerialID='" + strSrlID + "'");
                            if (updaterows.Length == 0)
                            {
                                ...
                                {
                                    string maxID = (Convert.ToString(Warehousedt.Compute("MAX([SrlNo])", "")) != "") ? Convert.ToString(Convert.ToInt32(Warehousedt.Compute("MAX([SrlNo])", "")) + 1) : "1";
                                    Warehousedt.Rows.Add(ProductSerialID, maxID, WarehouseID, "", "", BatchID, "", strSrlID, strSrlName, "", Sales_UOM_Code, "", "", Stk_UOM_Code, "", "0", "", "", "", "", loopId, SerialIDList.Length, "D");
                                }
                            }
                            else
                            {
                    ...
                    else
                    {
                        ...
                        for (int i = 0; i < SerialIDList.Length; i++)
                        {
                            ...
                            {
                                string maxID = (Convert.ToString(Warehousedt.Compute("MAX([SrlNo])", "")) != "") ? Convert.ToString(Convert.ToInt32(Warehousedt.Compute("MAX([SrlNo])", "")) + 1) : "1";
                                Warehousedt.Rows.Add(ProductSerialID, maxID, WarehouseID, "", "", BatchID, "", strSrlID, strSrlName, "", Sales_UOM_Code, "", "", Stk_UOM_Code, "", "0", "", "", "", "", strLoopID, SerialIDList.Length, repute);
                            }
                        }
                    }
                }
                ...
                else if (Type == "WS")
                {
                    ...
                    if (editWarehouseID == "0")
                    {
                        for (int i = 0; i < SerialIDList.Length; i++)
                        {
                            string strSrlID = SerialIDList[i];
                            string strSrlName = SerialNameList[i];
                            var updaterows = Warehousedt.Select("WarehouseID ='" + WarehouseID + "' AND SerialID='" + strSrlID + "'");
                            if (updaterows.Length == 0)
                            {
                                if (i == 0)
                                {
                                    ...
                                    Warehousedt.Rows.Add(ProductSerialID, maxID, WarehouseID, WarehouseName, SerialIDList.Length, "0", BatchName, strSrlID, strSrlName, Sales_UOM_Name, Sales_UOM_Code, SerialIDList.Length + " " + Sales_UOM_Name, Stk_UOM_Name, Stk_UOM_Code, stkqtn + " " + Stk_UOM_Name, Convert.ToString(Conversion_Multiplier), Convert.ToString(Math.Round(Convert.ToDecimal(Trans_Stock))) + " " + Stk_UOM_Name, Convert.ToString(Math.Round(BalanceStk, 2)) + " " + Stk_UOM_Name, MfgDate, ExpiryDate, loopId, SerialIDList.Length, "D");
                                }
                                else
                                {
                                    string maxID = (Convert.ToString(Warehousedt.Compute("MAX([SrlNo])", "")) != "") ? Convert.ToString(Convert.ToInt32(Warehousedt.Compute("MAX([SrlNo])", "")) + 1) : "1";
                                    ...
                                    Warehousedt.Rows.Add(ProductSerialID, maxID, WarehouseID, "", "", "0", "", strSrlID, strSrlName, "", Sales_UOM_Code, "", "", Stk_UOM_Code, "", "0", "", "", "", "", loopId, SerialIDList.Length, "D");
                                }
                            }
                ...
                Session["BTOut_LoopWarehouse"] = loopId + 1;

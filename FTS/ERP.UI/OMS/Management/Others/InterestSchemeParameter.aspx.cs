...
{
    public partial class Management_Others_InterestSchemeParameter : System.Web.UI.Page
    {
        ...
        private void Save()
        {
            try
            {
                ...
                {
                    strSpParam[6] = "STMainAccountID|" + BusinessLogicLayer.GenericStoreProcedure.ParamDBType.Varchar + "|20|" + txtSTMainAc_hidden.Value.Split('*')[1] + "|" + BusinessLogicLayer.GenericStoreProcedure.ParamType.ExParam;
                }
                else
                {

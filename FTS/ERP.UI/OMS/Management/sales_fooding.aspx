<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/OMS/MasterPage/ERP.Master"   Inherits="ERP.OMS.Management.management_sales_fooding" Codebehind="sales_fooding.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
        ...
        <tr>
            <td>
                <dxe:ASPxPageControl ID="ASPxPageControl1" runat="server" ActiveTabIndex="4" ClientInstanceName="page" Font-Size="12px"><TabPages>
                            ...
                            <dxe:ContentControl runat="server">
                                <dxe:ASPxGridView ID="gridLodging" ClientInstanceName="grid" DataSourceID="SqlLodging" runat="server" KeyFieldName="expnd_internalId"   Width="100%" AutoGenerateColumns="False" OnInitNewRow="gridLodging_InitNewRow">
                                    <Columns>
                                        ...
                                        <dxe:GridViewDataComboBoxColumn Caption="Food Type" FieldName="expnd_FoodType"
                                        ...
                                        <dxe:GridViewDataTextColumn Caption="Amount" FieldName="expnd_FoodExpnseAmount"
                                        ...
                                        <dxe:GridViewCommandColumn VisibleIndex="3" ShowEditButton="True" ShowDeleteButton="True">
                                            <HeaderTemplate>
                                    ...
                                    <SettingsText PopupEditFormCaption="Add/Modify Fooding" ConfirmDelete="Confirm delete?" />

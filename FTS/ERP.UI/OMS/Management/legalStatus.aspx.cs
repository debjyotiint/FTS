    ...
    public partial class management_legalStatus : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (HttpContext.Current.Session["EntryProfileType"] != null)
            {
                ...
                {
                    LegalStatus.ConnectionString = ConfigurationSettings.AppSettings["DBReadOnlyConnection"];
                }
                else
                {
                    LegalStatus.ConnectionString = ConfigurationSettings.AppSettings["DBConnectionDefault"];
                }
            }

<%@ Page Title="GSTR  Purchase Register" Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" EnableEventValidation="false" AutoEventWireup="true"
    CodeBehind="GSTR-PurchaseRegister.aspx.cs" Inherits="ERP.OMS.Reports.Master.GSTR_PurchaseRegister" %>
                                        ...
                                        <div>
                                            <dxe:ASPxGridView runat="server" ID="ShowGrid" ClientInstanceName="Grid" Width="100%" EnableRowsCache="false"
                                                ...
                                                <Columns>
                                                    ...
                                                    <dxe:GridViewDataTextColumn FieldName="globaltax" Caption="Other Charges(Line)" VisibleIndex="27" PropertiesTextEdit-DisplayFormatString="0.00">
                                                    </dxe:GridViewDataTextColumn>

                                                    <dxe:GridViewDataTextColumn FieldName="Net" Caption="Amount with Tax" VisibleIndex="28" CellStyle-HorizontalAlign="Right" PropertiesTextEdit-DisplayFormatString="0.00">
                                                    </dxe:GridViewDataTextColumn>


                                                    <dxe:GridViewDataTextColumn FieldName="othertax" Caption="Other Charges(Global)" VisibleIndex="29" PropertiesTextEdit-DisplayFormatString="0.00">
                                                    </dxe:GridViewDataTextColumn>



                                                    <dxe:GridViewDataTextColumn FieldName="Totalnet" Caption="Total Bill Amount" VisibleIndex="30" Width="120px" PropertiesTextEdit-DisplayFormatString="0.00">
                                                    </dxe:GridViewDataTextColumn>
                                        ...
                                        <div>
                                            <dxe:ASPxGridView runat="server" ID="ShowGrid2" ClientInstanceName="Gridreturn" Width="100%" EnableRowsCache="false"
                                                ...
                                                <Columns>
                                                    ...
                                                    <dxe:GridViewDataTextColumn FieldName="TAxAmt" Caption="Purchase Price (Before tax)" VisibleIndex="18" PropertiesTextEdit-DisplayFormatString="0.00">
                                                    </dxe:GridViewDataTextColumn>
                                                    ...
                                                    <dxe:GridViewDataTextColumn FieldName="Net" Caption="Amount with Tax" VisibleIndex="28" PropertiesTextEdit-DisplayFormatString="0.00">
                                                    </dxe:GridViewDataTextColumn>
                                                    <dxe:GridViewDataTextColumn FieldName="othertax" Caption="Other Charges(Global)" VisibleIndex="29" PropertiesTextEdit-DisplayFormatString="0.000">
                                                    </dxe:GridViewDataTextColumn>



                                                    <dxe:GridViewDataTextColumn FieldName="Totalnet" Caption="Total Bill Amount" Width="120px" VisibleIndex="30" PropertiesTextEdit-DisplayFormatString="0.00">
                                                    </dxe:GridViewDataTextColumn>

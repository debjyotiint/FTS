<%@ Page Title="GSTR  Customer Payment receipt" Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" EnableEventValidation="false" AutoEventWireup="true"
    CodeBehind="GSTR-Customerpaymentreceipt.aspx.cs" Inherits="ERP.OMS.Reports.Master.GSTR_Customerpaymentreceipt" %>
                    ...
                    <div onkeypress="OnWaitingGridKeyPress(event)">
                        <dxe:ASPxGridView runat="server" ID="ShowGrid" ClientInstanceName="Grid" Width="100%" EnableRowsCache="false"
                            ...
                            <Columns>
                                ...
                                <dxe:GridViewDataTextColumn FieldName="Transaction Type" Caption="Transaction Type" FixedStyle="Left" VisibleIndex="4" Width="135px">
                                </dxe:GridViewDataTextColumn>


                                <dxe:GridViewDataTextColumn FieldName="Customer" Caption="Customer's Name" FixedStyle="Left" VisibleIndex="5" Width="200px">
                                </dxe:GridViewDataTextColumn>
                            ...
                            <TotalSummary>
                                ...
                                <dxe:ASPxSummaryItem FieldName="Invoice_Number" SummaryType="Custom"  />

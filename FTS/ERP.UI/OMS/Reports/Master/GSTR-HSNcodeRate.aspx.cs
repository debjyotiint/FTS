    ...
    public partial class GSTR_HSNcodeRate : System.Web.UI.Page
    {
        ...
        public void bindexport(int Filter)
        {
            ...
            if (ASPxPageControl1.ActiveTabIndex == 0)
            {
                ...
                FileHeader = RptHeader.CommonReportHeader(Convert.ToString(Session["LastCompany"]), Convert.ToString(Session["LastFinYear"]), true, true, true, true, true) + Environment.NewLine + "GST Rate HSN Code(Input)";
            ...
            else
            {
                ...
                FileHeader = RptHeader.CommonReportHeader(Convert.ToString(Session["LastCompany"]), Convert.ToString(Session["LastFinYear"]), true, true, true, true, true) + Environment.NewLine + "GST Rate HSN Code(Output)";

<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/OMS/MasterPage/ERP.Master" Inherits="ERP.OMS.Reports.management_journalPopupReport" Codebehind="journalPopupReport.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        <div>
            ...
            <table class="TableMain100">
                    ...
                    <td>
                        <table class="TableMain100">
                            ...
                            <tr>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:TextBox ID="txtNarration" runat="server" TextMode="MultiLine" Width="436px"
                                                    TabIndex="8" Font-Size="15px" Height="60px"></asp:TextBox>
                                            </td>
                                            <td>
                                                <table width="100%">
                                                    <tr>
                                ...
                                <td style="text-align: left;" id="tdSeg1">
                                    Segment2 :
                                </td>
                ...
                <tr>
                    <td style="text-align:left;">
                        <asp:Button ID="btnDeleteAllVoucher" runat="server" Text="Delete Total Voucher" CssClass="btnUpdate" Height="27px" OnClick="btnDeleteAllVoucher_Click" Width="259px" OnClientClick="javascript:return confirm('Do You want To Delete This Voucher !!')"/>
                    </td>
                </tr>
            </table>

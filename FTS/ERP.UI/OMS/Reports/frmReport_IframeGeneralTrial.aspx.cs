    ...
    public partial class Reports_frmReport_IframeGeneralTrial : System.Web.UI.Page, System.Web.UI.ICallbackEventHandler
    {
        ...
        public void bindexport(int Filter)
        {
            ...
            if (Convert.ToBoolean(strPeriod))
            {
                ...
                FileHeader = RptHeader.CommonReportHeader(Convert.ToString(Session["LastCompany"]), Convert.ToString(Session["LastFinYear"]), true, true, true, true, true) + Environment.NewLine + "GeneralTrial Period" + Environment.NewLine + "For the period " + Convert.ToDateTime(dtFrom.Date).ToString("dd-MM-yyyy") + " To " + Convert.ToDateTime(dtTo.Date).ToString("dd-MM-yyyy");
            ...
            else
            {
                ...
                FileHeader = RptHeader.CommonReportHeader(Convert.ToString(Session["LastCompany"]), Convert.ToString(Session["LastFinYear"]), true, true, true, true, true) + Environment.NewLine + "GeneralTrial As On Date" + Environment.NewLine + "As on  " + Convert.ToDateTime(dtTo.Date).ToString("dd-MM-yyyy");

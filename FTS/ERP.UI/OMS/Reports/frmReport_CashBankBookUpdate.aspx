<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/OMS/MasterPage/ERP.Master" Inherits="ERP.OMS.Reports.Reports_frmReport_CashBankBookUpdate" Codebehind="frmReport_CashBankBookUpdate.aspx.cs" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function OnInstmentTypeChange(obj) {
            ...
            if (obj1 == "P") {
                ...
                if (objInstType == "D") {
                    ...
                    if (onlyforcdsl == 'CDSL CLIENTS' || onlyforcdsl == 'NSDL CLIENTS') {
                        document.getElementById("trCustomerBank").style.display = 'none';
                    }
                    else {
        ...
        function PopulateData() {
            // parent.FillValues();
            parent.document.getElementById("IFRAME_ForAllPages").contentWindow.FillValues();
        }
        function btnCancel_Click() {
            var answer = confirm("Do you Want To Close This Window?");
            if (answer) {
                //                    window.opener.FillValues();
                //                    window.close();
                parent.FillValues();
            }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        <div>
            ...
            <table style="width: 100%; border-right: #3300ff thin solid; border-top: #3300ff thin solid;
                border-bottom-width: thin; border-bottom-color: #3300ff; border-left: #3300ff thin solid;
                border-bottom: #3300ff thin solid; background-color: #ddecfe;">
                <tr>
                    <td>
                        <table style="width: 100%; background-color: #ddecfe; border-top-width: thin; border-left-width: thin;
                            border-left-color: #3300ff; border-top-color: #3300ff;" border="0" id="main"
                            cellspacing="0">
                            <tr style="height: 8px;">
                            </tr>
                            <tr id="">
                            ...
                            <tr id="trBankCashType">
                                ...
                                <td style="text-align: left;" id="tdBankAccountNo1">
                                    <asp:DropDownList ID="cmbBranch" runat="server" DataSourceID="dsBranch" DataTextField="BANKBRANCH_NAME"
                                        DataValueField="BANKBRANCH_ID" Width="100px" Font-Size="12px" TabIndex="5">
                                    </asp:DropDownList>
                                </td>
                                <td style="text-align: left;" id="tdcb">
                                    Cash/Bank A/c :
                                </td>
                            ...
                            <tr id="tr6" style="background-color: #ddecfe;" align="center">
                                ...
                                <td colspan="2" style="text-align: left">
                                    <table cellpadding="0px" cellspacing="0px">
                                        ...
                                        <tr>
                                            <td style="text-align: left;" id="td13">
                                                Curr. A/C Balan.:
                                            </td>
                                    ...
                                    <asp:UpdatePanel ID="UpdatePanel4" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            <asp:GridView ID="grdAdd" runat="server" DataKeyNames="CashReportID" CssClass="gridcellleft"
                                                ...
                                                ShowFooter="false" OnRowCommand="grdAdd_RowCommand" OnRowCreated="grdAdd_RowCreated"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Date">
                                                        ...
                                                        <EditItemTemplate>
                                                            <dxe:ASPxDateEdit ID="dtEditAspxDate" runat="server" Value='<%# Eval("CashBank_InstrumentDate") %>'
                                                                EditFormat="Custom" TabIndex="17" EditFormatString="dd-MM-yyyy" UseMaskBehavior="True"
                                                        ...
                                                        <FooterTemplate>
                                                            <dxe:ASPxDateEdit ID="dtAspxDate" runat="server" EditFormat="Custom" TabIndex="17" ClientInstanceName="dtAspxDate"
                                                                UseMaskBehavior="True" Font-Size="12px" Width="80px"
                                                    ...
                                                    <asp:TemplateField ShowHeader="False">
                                                        ...
                                                        <FooterTemplate>
                                                            <asp:Button ID="Button1" runat="server" Text="Add" CausesValidation="false" TabIndex="20" CommandName="Insert" onfocus="overChange(this)" onBlur="OutChange(this)"/>
                                                        </FooterTemplate>
                                                    </asp:TemplateField>
                                                </Columns>
                                            </asp:GridView>
                                ...
                                <td>
                                    <table>
                                       ...
                                       <tr id="trCustomerBank" style="display: none">
                                            <td style="text-align: left;" id="tdCustomerBank">
                                                Customer Bank
                                            </td>
                                        ...
                                        <tr>
                                            <td style="text-align: left;" id="tdauth">
                                                Auth. Letter Ref
                                            </td>
                                        ...
                                        <tr id="trDetails"  style="display: none">
                                            <td style="text-align: left;" id="trDetails1">
                                                Payee:
                                            </td>
            ...
            <table width="100%">
                ...
                <tr>
                    <td>
                        <asp:Button ID="btnAllVouDelete" runat="server" Text="Voucher Delete" CssClass="btnUpdate" OnClick="btnAllVouDelete_Click" OnClientClick="javascript:return confirm('Do You want To Delete This Voucher !!')"/>
                    </td>
                </tr>
            </table>
        </div>
        <asp:SqlDataSource ID="dsCashBank" runat="server" ConflictDetection="CompareAllValues"
            ...
            InsertCommand="insert into table1 (temp123) values('11')" UpdateCommand="update table1 set temp123='123'">
        </asp:SqlDataSource>
        ...
        <asp:SqlDataSource ID="dsBranch" runat="server" ConnectionString="<%$ ConnectionStrings:crmConnectionString %>"
            ConflictDetection="CompareAllValues" SelectCommand="SELECT BRANCH_id AS BANKBRANCH_ID , BRANCH_DESCRIPTION AS BANKBRANCH_NAME  FROM TBL_MASTER_BRANCH">
        </asp:SqlDataSource>
        <asp:SqlDataSource ID="MainAccount" runat="server" ConnectionString="<%$ ConnectionStrings:crmConnectionString %>"
            SelectCommand="Select MainAccount_AccountCode as CashBank_MainAccountID, MainAccount_AccountCode+'-'+MainAccount_Name+' [ '+MainAccount_BankAcNumber+' ]'+' ~ '+MainAccount_BankCashType as MainAccount_Name from Master_MainAccount where MainAccount_BankCashType='Bank' or MainAccount_BankCashType='Cash'">
        </asp:SqlDataSource>
        <asp:SqlDataSource ID="dsgrdClientbank" runat="server" ConflictDetection="CompareAllValues"
            ...
            SelectCommand="select A.* , MB.bnk_id,MB.bnk_bankName,MB.bnk_BranchName,MB.bnk_micrno from (Select TCBD.cbd_id,TCBD.cbd_cntId,TCBD.cbd_bankCode, TCBD.cbd_Accountcategory,TCBD.cbd_Accountcategory as AccountType,TCBD.cbd_accountNumber,TCBD.cbd_accountType,cbd_accountName from tbl_trans_contactBankDetails as  TCBD where TCBD.cbd_cntId=@SubAccountCode) as A inner  join tbl_master_Bank as MB on MB.bnk_id=a.cbd_bankCode">
            <SelectParameters>

<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/OMS/MasterPage/ERP.Master"
    Inherits="ERP.OMS.Reports.Reports_frm_Attendance_FromMyPage" Codebehind="frm_Attendance_FromMyPage.aspx.cs" %>
                        ...
                        <tr>
                            <td class="gridcellcenter">
                                <dxe:ASPxGridView ID="ASPx_EmployeeAtdd" ClientInstanceName="ASPx_EmployeeAtdd"
                                    ...
                                    <Columns>
                                        <dxe:GridViewDataTextColumn Caption="Employee Name" FieldName="empName" Width="100px"
                                            VisibleIndex="0" FixedStyle="Left">
                                            <CellStyle Wrap="False" CssClass="gridcellleft">
                                            </CellStyle>
                                        </dxe:GridViewDataTextColumn>
                                        <dxe:GridViewDataTextColumn Caption="Emp. Code" FieldName="code" Width="100px" VisibleIndex="1"
                                            FixedStyle="Left">
                                            <CellStyle Wrap="False" CssClass="gridcellleft">
                                            </CellStyle>
                                        </dxe:GridViewDataTextColumn>
                                        <dxe:GridViewDataTextColumn Caption="Company Name" FieldName="cmp_Name" Width="100px"
                                            VisibleIndex="2">
                                            <CellStyle Wrap="False" CssClass="gridcellleft">
                                            </CellStyle>
                                        </dxe:GridViewDataTextColumn>
                                        <dxe:GridViewDataTextColumn Caption="Branch" FieldName="branch_description" Width="60px"
                                            VisibleIndex="3">
                                            <CellStyle Wrap="False" CssClass="gridcellleft">
                                            </CellStyle>
                                        </dxe:GridViewDataTextColumn>
                                        <dxe:GridViewDataTextColumn Caption="1" FieldName="day1" Width="20px" VisibleIndex="4">
                                        </dxe:GridViewDataTextColumn>
                                        <dxe:GridViewDataTextColumn Caption="2" FieldName="day2" Width="20px" VisibleIndex="5">
                                        </dxe:GridViewDataTextColumn>
                                        <dxe:GridViewDataTextColumn Caption="3" FieldName="day3" Width="20px" VisibleIndex="6">
                                        </dxe:GridViewDataTextColumn>
                                        <dxe:GridViewDataTextColumn Caption="4" FieldName="day4" Width="20px" VisibleIndex="7">
                                        </dxe:GridViewDataTextColumn>
                                        <dxe:GridViewDataTextColumn Caption="5" FieldName="day5" Width="20px" VisibleIndex="8">
                                        </dxe:GridViewDataTextColumn>
                                        <dxe:GridViewDataTextColumn Caption="6" FieldName="day6" Width="20px" VisibleIndex="9">
                                        </dxe:GridViewDataTextColumn>
                                        <dxe:GridViewDataTextColumn Caption="7" FieldName="day7" Width="20px" VisibleIndex="10">
                                        </dxe:GridViewDataTextColumn>
                                        <dxe:GridViewDataTextColumn Caption="8" FieldName="day8" Width="20px" VisibleIndex="11">
                                        </dxe:GridViewDataTextColumn>
                                        <dxe:GridViewDataTextColumn Caption="9" FieldName="day9" Width="20px" VisibleIndex="12">
                                        </dxe:GridViewDataTextColumn>
                                        <dxe:GridViewDataTextColumn Caption="10" FieldName="day10" Width="20px" VisibleIndex="13">
                                        </dxe:GridViewDataTextColumn>
                                        <dxe:GridViewDataTextColumn Caption="11" FieldName="day11" Width="20px" VisibleIndex="14">
                                        </dxe:GridViewDataTextColumn>
                                        <dxe:GridViewDataTextColumn Caption="12" FieldName="day12" Width="20px" VisibleIndex="15">
                                        </dxe:GridViewDataTextColumn>
                                        <dxe:GridViewDataTextColumn Caption="13" FieldName="day13" Width="20px" VisibleIndex="16">
                                        </dxe:GridViewDataTextColumn>
                                        <dxe:GridViewDataTextColumn Caption="14" FieldName="day14" Width="20px" VisibleIndex="17">
                                        </dxe:GridViewDataTextColumn>
                                        <dxe:GridViewDataTextColumn Caption="15" FieldName="day15" Width="20px" VisibleIndex="18">
                                        </dxe:GridViewDataTextColumn>
                                        <dxe:GridViewDataTextColumn Caption="16" FieldName="day16" Width="20px" VisibleIndex="19">
                                        </dxe:GridViewDataTextColumn>
                                        <dxe:GridViewDataTextColumn Caption="17" FieldName="day17" Width="20px" VisibleIndex="20">
                                        </dxe:GridViewDataTextColumn>
                                        <dxe:GridViewDataTextColumn Caption="18" FieldName="day18" Width="20px" VisibleIndex="21">
                                        </dxe:GridViewDataTextColumn>
                                        <dxe:GridViewDataTextColumn Caption="19" FieldName="day19" Width="20px" VisibleIndex="22">
                                        </dxe:GridViewDataTextColumn>
                                        <dxe:GridViewDataTextColumn Caption="20" FieldName="day20" Width="20px" VisibleIndex="23">
                                        </dxe:GridViewDataTextColumn>
                                        <dxe:GridViewDataTextColumn Caption="21" FieldName="day21" Width="20px" VisibleIndex="24">
                                        </dxe:GridViewDataTextColumn>
                                        <dxe:GridViewDataTextColumn Caption="22" FieldName="day22" Width="20px" VisibleIndex="25">
                                        </dxe:GridViewDataTextColumn>
                                        <dxe:GridViewDataTextColumn Caption="23" FieldName="day23" Width="20px" VisibleIndex="26">
                                        </dxe:GridViewDataTextColumn>
                                        <dxe:GridViewDataTextColumn Caption="24" FieldName="day24" Width="20px" VisibleIndex="27">
                                        </dxe:GridViewDataTextColumn>
                                        <dxe:GridViewDataTextColumn Caption="25" FieldName="day25" Width="20px" VisibleIndex="28">
                                        </dxe:GridViewDataTextColumn>
                                        <dxe:GridViewDataTextColumn Caption="26" FieldName="day26" Width="20px" VisibleIndex="29">
                                        </dxe:GridViewDataTextColumn>
                                        <dxe:GridViewDataTextColumn Caption="27" FieldName="day27" Width="20px" VisibleIndex="30">
                                        </dxe:GridViewDataTextColumn>
                                        <dxe:GridViewDataTextColumn Caption="28" FieldName="day28" Width="20px" VisibleIndex="31">
                                        </dxe:GridViewDataTextColumn>
                                        <dxe:GridViewDataTextColumn Caption="29" FieldName="day29" Width="20px" VisibleIndex="32">
                                        </dxe:GridViewDataTextColumn>
                                        <dxe:GridViewDataTextColumn Caption="30" FieldName="day30" Width="20px" VisibleIndex="33">
                                        </dxe:GridViewDataTextColumn>
                                        <dxe:GridViewDataTextColumn Caption="31" FieldName="day31" VisibleIndex="34"  Width="20px">
                                        </dxe:GridViewDataTextColumn>
                                    </Columns>

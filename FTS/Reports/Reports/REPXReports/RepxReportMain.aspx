...
<div class="form_main clearfix">
                    ...
                    <table class="padTable">
                        ...
                        <tr>
                            <td colspan="3" style="padding-top:15px">
                                ...
                                <dxe:aspxbutton ID="btnPreview" runat="server" ToolTip="Click on Preview the report" AutoPostBack="false" Text="Preview" OnClick="btnPreview_Click" CssClass="btn btn-primary" >
    ...
    <div class="PopUpArea">
        <dxe:aspxpopupcontrol ID="AspxDocDescpopup" runat="server" ClientInstanceName="cDocDescPopup"
            Width="500px" HeaderText="" PopupHorizontalAlign="WindowCenter"
            PopupVerticalAlign="WindowCenter" CloseAction="CloseButton"
            Modal="True" ContentStyle-VerticalAlign="Top" EnableHierarchyRecreation="True">
            <ContentCollection>
                <dxe:PopupControlContentControl runat="server">
                    ...
                    <dxe:ASPxGridView runat="server" KeyFieldName="ID" ClientInstanceName="cgriddocdesc" ID="grid_DocDesc" OnDataBinding="grid_DocDesc_DataBinding" OnDataBound="gridDocDesc_DataBound"
                        ...
                        <Columns>
                            <dxe:GridViewCommandColumn VisibleIndex="1" ShowSelectCheckbox="True" Width="7" Caption=" " />
                            <dxe:GridViewDataTextColumn VisibleIndex="1" FieldName="SrlNo" Width="0" ReadOnly="true" Caption="Sl. No.">
                            </dxe:GridViewDataTextColumn>
                            ...
                            <dxe:GridViewDataTextColumn VisibleIndex="4" FieldName="Description" Width="50" ReadOnly="true" Caption="">
                            </dxe:GridViewDataTextColumn>

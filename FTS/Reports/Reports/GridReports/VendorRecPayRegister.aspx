...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel-heading">
        <div class="panel-title">
            ...
            <h3>Vendor Payment/Receipt Register Report</h3>
        ...
        <div class="row">
            ...
            <div class="col-md-2">
                <div style="padding-left: 15px;padding-top:20px;">
                    <asp:CheckBox ID="chkallvendors" Text="Select all Vendors" type="checkbox" runat="server" Checked="false" ClientInstanceName="cchkallvendors" onChange="GetChecked()"></asp:CheckBox>
                </div>
            </div>
                    ...
                    <div>
                        <dxe:ASPxGridView runat="server" ID="ShowGrid" ClientInstanceName="Grid" Width="100%" EnableRowsCache="false" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <dxe:GridViewDataTextColumn FieldName="Vendor" Caption="Vendor(s)" VisibleIndex="7" Width="150px"/>
                                ...
                                <dxe:GridViewDataTextColumn FieldName="VRPTax_Amount" Caption="Taxable" VisibleIndex="11" PropertiesTextEdit-DisplayFormatString="0.00" Width="80px">

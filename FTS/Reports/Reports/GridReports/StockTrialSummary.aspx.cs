...
namespace Reports.Reports.GridReports
{
    public partial class StockTrialSummary : System.Web.UI.Page
    {
        ...
        protected void Grid_CustomCallback(object sender, DevExpress.Web.ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            Task PopulateStockTrialDataTask = new Task(() => Getstocktrial(FROMDATE, TODATE, BRANCH_ID, PRODUCTID, strClassList, strBrandList, HEAD_BRANCH));
            PopulateStockTrialDataTask.RunSynchronously();
        ...
        public void Getstocktrial(string FROMDATE, string TODATE, string BRANCH_ID, string ProductsId, string classname, string brand, string HEAD_BRANCH)
        {
            try
            {

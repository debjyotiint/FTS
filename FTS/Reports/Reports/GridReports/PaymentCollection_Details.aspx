<%@ Page Title="" Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true" CodeBehind="PaymentCollection_Details.aspx.cs" 
    Inherits="Reports.Reports.GridReports.PaymentCollection_Details" %>
                    ...
                    <div>
                        <dxe:ASPxGridView runat="server" ID="ShowGrid" ClientInstanceName="Grid" Width="100%" EnableRowsCache="false" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <dxe:GridViewDataTextColumn FieldName="Amount" Caption="Voucher Amt." VisibleIndex="16" PropertiesTextEdit-DisplayFormatString="0.00" Width="80px">
                                      <HeaderStyle HorizontalAlign="Right" />
                                </dxe:GridViewDataTextColumn>

...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <td colspan="2">
                    <div onkeypress="OnWaitingGridKeyPress(event)">
                        <dxe:ASPxGridView runat="server" ID="ShowGrid" ClientInstanceName="Grid" Width="100%" EnableRowsCache="false" AutoGenerateColumns="False"
                            OnCustomCallback="Grid_CustomCallback" OnDataBinding="grid2_DataBinding" OnSummaryDisplayText="ShowGrid_SummaryDisplayText" ClientSideEvents-BeginCallback="Callback_EndCallback">
                            <Columns>
                                ...
                                <dxe:GridViewDataTextColumn FieldName="Sale Value" Caption="Sale Value" Width="15%" VisibleIndex="4">
    ...
    <dxe:ASPxPopupControl ID="popupApproval" runat="server" ClientInstanceName="cpopupApproval"
        Width="1300px" Height="600px" ScrollBars="Vertical" HeaderText="Sales Register Report Details" PopupHorizontalAlign="WindowCenter" HeaderStyle-CssClass="wht"
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <dxe:ASPxGridView ID="gridPendingApproval" runat="server" KeyFieldName="SLNO" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                <dxe:GridViewDataTextColumn Caption="Serial" FieldName="SLNO"
                                    VisibleIndex="0" FixedStyle="Left">
                                    <CellStyle CssClass="gridcellleft" Wrap="true">
                                    </CellStyle>
                                </dxe:GridViewDataTextColumn>
                                <dxe:GridViewDataTextColumn Caption="Unit" FieldName="Branch" Width="11%"
                                    VisibleIndex="1" FixedStyle="Left">
                                    <CellStyle CssClass="gridcellleft" Wrap="true">
                                    </CellStyle>
                                </dxe:GridViewDataTextColumn>
                                <dxe:GridViewDataTextColumn Caption="Customer Name" Width="16%" FieldName="Customer Name"
                                    VisibleIndex="2" FixedStyle="Left">
                                    <CellStyle CssClass="gridcellleft" Wrap="true">
                                    </CellStyle>
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn Caption="Address" Width="16%" FieldName="CUST_ADDRESS"
                                ...
                                <dxe:GridViewDataTextColumn VisibleIndex="4" FieldName="Bill No" Width="12%" Caption="Invoice No" FixedStyle="Left">
                                    <CellStyle HorizontalAlign="Left">
                                    </CellStyle>
                                    <HeaderStyle HorizontalAlign="Center" />
                                    <DataItemTemplate>
                                ...
                                <dxe:GridViewDataTextColumn Caption="Invoice Date" Width="10%" FieldName="Invoice_Date"
                                    VisibleIndex="5">
                                ...
                                <dxe:GridViewDataTextColumn Caption="Sale Value" FieldName="Sale Value" Width="10%"
                                    VisibleIndex="6">
                                ...
                                <dxe:GridViewDataTextColumn FieldName="CGST_Amt" Caption="CGST Amount" Width="7%" VisibleIndex="7">
                                    <PropertiesTextEdit DisplayFormatString="0.00"></PropertiesTextEdit>
                                </dxe:GridViewDataTextColumn>
                                <dxe:GridViewDataTextColumn FieldName="SGST_Amt" Caption="SGST Amount" Width="7%" VisibleIndex="8">
                                    <PropertiesTextEdit DisplayFormatString="0.00"></PropertiesTextEdit>
                                </dxe:GridViewDataTextColumn>
                                <dxe:GridViewDataTextColumn FieldName="IGST_Amt" Caption="IGST Amount" Width="7%" VisibleIndex="9">
                                    <PropertiesTextEdit DisplayFormatString="0.00"></PropertiesTextEdit>
                                </dxe:GridViewDataTextColumn>
                                <dxe:GridViewDataTextColumn FieldName="UTGST_Amt" Caption="UTGST Amount" Width="7%" VisibleIndex="10">
                                    <PropertiesTextEdit DisplayFormatString="0.00"></PropertiesTextEdit>
                                </dxe:GridViewDataTextColumn>
                                ...
                                <dxe:GridViewDataTextColumn Caption="Others Charges" FieldName="Others_Charges" Width="7%"
                                    VisibleIndex="11">
                                ...
                                <dxe:GridViewDataTextColumn Caption="Tax Misc." FieldName="Tax Misc." Width="7%"
                                    VisibleIndex="12">

                                    <PropertiesTextEdit DisplayFormatString="0.00"></PropertiesTextEdit>
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn Caption="Old Unit" FieldName="Old_unit" Width="7%"
                                    VisibleIndex="13">
                                ...
                                <dxe:GridViewDataTextColumn Caption="Bill Amount" FieldName="Total Value" Width="7%"
                                    VisibleIndex="14">

...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function btn_ShowRecordsClick(e) {
            e.preventDefault;
            var data = "OnDateChanged";
              GridRet.PerformCallback(data + '~' + $("#ddlbranchHO").val());
        }
        ...
        <table class="TableMain100">
            <tr>
                <td colspan="2">
                            ...
                            OnCustomCallback="GridRet_CustomCallback" OnDataBinding="ShowGridRet_DataBinding" Settings-HorizontalScrollBarMode="Visible"
                            ...
                            <Columns>
                               <%-- <dxe:GridViewDataTextColumn FieldName="SLNO" Caption="Serial" Width="50px" VisibleIndex="0" FixedStyle="Left">
                                ...
                                <dxe:GridViewDataTextColumn VisibleIndex="3" FieldName="Return No" Width="130px" Caption="Return No." FixedStyle="Left">
                                    <CellStyle HorizontalAlign="Left">
                                    </CellStyle>
                                    <HeaderStyle HorizontalAlign="Center" />
                                    <DataItemTemplate>

                                        <a href="javascript:void(0)" target="_blank" onclick="OpenPOSDetails('<%#Eval("Return_id") %>','<%#Eval("Module_Type") %>')">
                                            <%#Eval("Return No")%>
                                        </a>
                                    </DataItemTemplate>
                                ...
                                <dxe:GridViewDataTextColumn Caption="Ret. Date" Width="80px" FieldName="Return_Date"
                                    VisibleIndex="4">
                                    <PropertiesTextEdit DisplayFormatString="dd-MM-yyyy"></PropertiesTextEdit>
                                </dxe:GridViewDataTextColumn>
                                 <dxe:GridViewDataTextColumn Caption="Transaction Type" Width="80px" FieldName="Module_Type_Desc"
                                    VisibleIndex="5">
                                </dxe:GridViewDataTextColumn>
                                ...
                                <dxe:GridViewDataTextColumn FieldName="ReturnPrice" Caption="Rate" Width="90px" VisibleIndex="7">
                                    <PropertiesTextEdit DisplayFormatString="0.00"></PropertiesTextEdit>
                                     <HeaderStyle HorizontalAlign="Right" />
                                </dxe:GridViewDataTextColumn>
                                <dxe:GridViewDataTextColumn FieldName="Return Value" Caption="Sales Value" Width="90px" VisibleIndex="8">
                                    <PropertiesTextEdit DisplayFormatString="0.00"></PropertiesTextEdit>
                                     <HeaderStyle HorizontalAlign="Right" />
                                </dxe:GridViewDataTextColumn>
                            ...
                            <TotalSummary>
                                ...
                                <dxe:ASPxSummaryItem FieldName="Return Value" SummaryType="Sum" />

                                            ...
                                            <dxe:ASPxGridView runat="server" ID="grid_CDNUR" ClientInstanceName="cgridCDNUR" Width="100%" EnableRowsCache="false" BeginCallback="Callback_BeginCallback"
                                              ...
                                              AutoGenerateColumns="False"  Settings-HorizontalScrollBarMode="Visible" Settings-VerticalScrollableHeight="300" Settings-VerticalScrollBarMode="Visible">
                                                 ...
                                                 <Columns>
                                                    ...
                                                    <dxe:GridViewDataTextColumn FieldName="Reason For Issuing Document" Caption="Reason For Issuing document" VisibleIndex="8" Width="170px">
                                                    </dxe:GridViewDataTextColumn> 
                                                    <dxe:GridViewDataTextColumn FieldName="Supply Type" Caption="Supply Type" VisibleIndex="9"  Width="90px">
                                                    </dxe:GridViewDataTextColumn> 
                        ...
                        <dxe:ContentControl runat="server">                            
                            ...
                            <dxe:ASPxGridView runat="server" ID="grid_HSNSUM" ClientInstanceName="cgridHSNSUM" Width="100%" EnableRowsCache="false" BeginCallback="Callback_BeginCallback"
                                ...
                                AutoGenerateColumns="False" Settings-HorizontalScrollBarMode="Auto" Settings-VerticalScrollableHeight="300" Settings-VerticalScrollBarMode="Visible">                                                 
                                    ...
                                    <dxe:GridViewDataTextColumn FieldName="Total_Qty" Caption="Total Quantity" VisibleIndex="3" PropertiesTextEdit-DisplayFormatString="0.00" Width="180">
                                    </dxe:GridViewDataTextColumn>                                                   
                                    <dxe:GridViewDataTextColumn FieldName="Total_Value" Caption="Total Value" VisibleIndex="4" PropertiesTextEdit-DisplayFormatString="0.00" Width="180">
                                    </dxe:GridViewDataTextColumn> 
                                    <dxe:GridViewDataTextColumn FieldName="Taxable_Value" Caption="Taxable Value" VisibleIndex="5" PropertiesTextEdit-DisplayFormatString="0.00" Width="180">
                                    </dxe:GridViewDataTextColumn> 
                                    <dxe:GridViewDataTextColumn FieldName="IGSTAmount" Caption="Integrated Tax Amount" VisibleIndex="6" PropertiesTextEdit-DisplayFormatString="0.00" Width="180">
                                    </dxe:GridViewDataTextColumn> 
                                    <dxe:GridViewDataTextColumn FieldName="CGSTAmount" Caption="Central Tax Amount" VisibleIndex="7" PropertiesTextEdit-DisplayFormatString="0.00" Width="180">
                                    </dxe:GridViewDataTextColumn> 
                                    <dxe:GridViewDataTextColumn FieldName="SGSTAmount_UTGSTAmount" Caption="State/UT Tax Amount" VisibleIndex="8" PropertiesTextEdit-DisplayFormatString="0.00" Width="180">
                                    </dxe:GridViewDataTextColumn> 
                                    <dxe:GridViewDataTextColumn FieldName="Cess_Amount" Caption="Cess Amount" VisibleIndex="8" PropertiesTextEdit-DisplayFormatString="0.00" Width="180">
                                    </dxe:GridViewDataTextColumn> 
                                </Columns>

...
namespace Reports.Reports.GridReports
{
    ...
    public partial class Jsonparse_Gstr1 : System.Web.UI.Page
    {

        public EntityLayer.CommonELS.UserRightsForPage rights = new UserRightsForPage();
        protected void Page_Load(object sender, EventArgs e)
        {
            rights = BusinessLogicLayer.CommonBLS.CommonBL.GetUserRightSession("/GridReports/JsonParse-Gstr1.aspx");
        ...
        public void LoadJson(string folder, string fileName)
        {
            ...
            using (StreamReader r = new StreamReader(Server.MapPath("~/CommonFolder/" + folder + "/" + fileName)))
            {
                ...
                SqlCommand cmd = new SqlCommand("Proc_JSON_Reconsile_GSTR1", con);
        ...
        {
            string filename = "GSTR-1 Reconciliation(JSON)";

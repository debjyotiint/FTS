...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            cProductComponentPanel.PerformCallback('BindComponentGrid' + '~' + 1);
            ...
            <tr>
                ...
                <td>
                    <div style="padding-left: 15px">
                        <asp:Label ID="Label2" runat="Server" Text="Exclude Cash Invoice : " CssClass="mylabel1"
                ...
                <td>
                    <div style="padding-left: 15px">
                        <asp:Label ID="Label4" runat="Server" Text="Select all Customers : " CssClass="mylabel1"
                            Width="160px"></asp:Label>
                        <asp:CheckBox ID="chkallcustomers" type="checkbox" runat="server" Checked="false" ClientInstanceName="cchkallcustomers" onChange="GetChecked()"></asp:CheckBox>
                    </div>
                ...
                <td colspan="2">
                    <div>
                        <dxe:ASPxGridView runat="server" ID="ShowGrid" ClientInstanceName="Grid" Width="100%" EnableRowsCache="false" AutoGenerateColumns="False"
                            ...
                            OnCustomSummaryCalculate="dgvVIEW_CustomSummaryCalculate" OnCustomCallback="Grid_CustomCallback">

                            <Columns>


                                <%--<dxe:GridViewDataTextColumn FieldName="RID" Caption="RID" Width="50px" VisibleIndex="1" />--%>
                                <dxe:GridViewDataTextColumn FieldName="BRANCH_DESC" Caption="Unit" VisibleIndex="2" />
                                ...
                                <dxe:GridViewDataTextColumn VisibleIndex="5" FieldName="Voucher_No" Caption="Voucher No.">
                                ...
                                <dxe:GridViewDataTextColumn FieldName="Particulars" Caption="Particulars" VisibleIndex="9" />

                                <dxe:GridViewDataTextColumn FieldName="DEBIT" Caption="Debit" VisibleIndex="10" PropertiesTextEdit-DisplayFormatString="0.00" />
                                ...
                                <dxe:GridViewDataTextColumn FieldName="Closing_Balance" Caption="Closing Balance" VisibleIndex="12" PropertiesTextEdit-DisplayFormatString="0.00" />
                                <dxe:GridViewDataTextColumn FieldName="Closebal_DBCR" Caption="DbCrType" VisibleIndex="13" />

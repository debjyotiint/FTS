...
{
    public partial class CashBankBookSummary : System.Web.UI.Page
    {
        ...
        {
            string filename = "Cash Bank Book Summary";
            exporter.FileName = filename;
            string FileHeader = "";

            BusinessLogicLayer.Reports RptHeader = new BusinessLogicLayer.Reports();

            FileHeader = RptHeader.CommonReportHeader(Convert.ToString(Session["LastCompany"]), Convert.ToString(Session["LastFinYear"]), true, true, true, true, true) + Environment.NewLine + "Cash Bank Book Summary" + Environment.NewLine + "For the period " + Convert.ToDateTime(ASPxFromDate.Date).ToString("dd-MM-yyyy") + " To " + Convert.ToDateTime(ASPxToDate.Date).ToString("dd-MM-yyyy");
        ...
        protected void Grid_CustomCallback(object sender, DevExpress.Web.ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            Task PopulateStockTrialDataTask = new Task(() => GetPurchaseRegisterdata(FROMDATE, TODATE, BRANCH_ID, HEAD_BRANCH, strType, cashbankList));
            PopulateStockTrialDataTask.RunSynchronously();
        }
        public void GetPurchaseRegisterdata(string FROMDATE, string TODATE, string BRANCH_ID, string HEAD_BRANCH, string strType, string cashbankList)
        {
            try
            {
                DataSet ds = new DataSet();
                SqlConnection con = new SqlConnection(ConfigurationManager.AppSettings["DBConnectionDefault"]);
                SqlCommand cmd = new SqlCommand("PRC_CASHBANKBOOKSUMMARY_REPORT", con);
        ...
        public DataTable GetCashBankList()
        {
            ...
            {
                lookupCardBank.Columns["Name"].Caption = "Card Name";
            }

<%@ Page Title="JSON Parse GSTR2" Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true"
    CodeBehind="JsonParse.aspx.cs" Inherits="Reports.Reports.GridReports.JsonParse" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel-heading">
        <div class="panel-title clearfix">
            <h3 class="pull-left">GSTR-2 Reconciliation [With JSON]</h3>
        </div>
    </div>
    <div id="pageheaderContent">
        ...
        <dxe:ASPxGridView runat="server" ID="ShowGrid" ClientInstanceName="Grid" Width="100%" EnableRowsCache="false" AutoGenerateColumns="false"
            ...
            <Columns>
                <dxe:GridViewDataTextColumn FieldName="idt" Caption="Party Invoice Date" VisibleIndex="1" Width="200px">
                </dxe:GridViewDataTextColumn>


                <dxe:GridViewDataTextColumn FieldName="inum" Caption="Party Invoice Number" VisibleIndex="2" Width="130px">
                </dxe:GridViewDataTextColumn>
                ...
                <dxe:GridViewDataTextColumn FieldName="tx_c" Caption="CGST Amount" VisibleIndex="5" Width="100px" PropertiesTextEdit-DisplayFormatString="0.00">
                </dxe:GridViewDataTextColumn>

                <dxe:GridViewDataTextColumn FieldName="tx_s" Caption="SGST Amount" VisibleIndex="6" Width="100px" PropertiesTextEdit-DisplayFormatString="0.00">
                </dxe:GridViewDataTextColumn>


                <dxe:GridViewDataTextColumn FieldName="tx_i" Caption="IGST Amount" VisibleIndex="7" Width="100px" PropertiesTextEdit-DisplayFormatString="0.00">
                </dxe:GridViewDataTextColumn>
                ...
                <dxe:GridViewDataTextColumn VisibleIndex="11" FieldName="Bill Number" Width="200px" Caption="Purchase Invoice No.">
                    <CellStyle>
                    </CellStyle>
                ...
                <dxe:GridViewDataTextColumn FieldName="Bill Date" Caption="Purchase Invoice Date" VisibleIndex="12" Width="150px">
                </dxe:GridViewDataTextColumn>
            ...
            <TotalSummary>
                ...
                <dxe:ASPxSummaryItem FieldName="tx_i" SummaryType="Sum" />
                <dxe:ASPxSummaryItem FieldName="tx_s" SummaryType="Sum" />
                <dxe:ASPxSummaryItem FieldName="tx_c" SummaryType="Sum" />

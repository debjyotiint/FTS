...
{
	public partial class CustomerRecPayRegister : System.Web.UI.Page
	{
        ...
        {
            rights = BusinessLogicLayer.CommonBLS.CommonBL.GetUserRightSession("/Reports/master/CustomerRecPayRegister.aspx");
            DateTime dtFrom;
            DateTime dtTo;
            if (!IsPostBack)
            {
        ...
        {
            string filename = "Customer Receipt/Payment Register Report";
            ...
            FileHeader = RptHeader.CommonReportHeader(Convert.ToString(Session["LastCompany"]), Convert.ToString(Session["LastFinYear"]), true, true, true, true, true) + Environment.NewLine + "Customer Receipt/Payment Register Report" + Environment.NewLine + "For the period " + Convert.ToDateTime(ASPxFromDate.Date).ToString("dd-MM-yyyy") + " To " + Convert.ToDateTime(ASPxToDate.Date).ToString("dd-MM-yyyy");
        ...
        protected void Grid_CustomCallback(object sender, DevExpress.Web.ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            Task PopulateStockTrialDataTask = new Task(() => GetCustRecPayRegisterdata(FROMDATE, TODATE, BRANCH_ID,HEAD_BRANCH,CUSTVENDID));
            PopulateStockTrialDataTask.RunSynchronously();

        }

        public void GetCustRecPayRegisterdata(string FROMDATE, string TODATE, string BRANCH_ID, string HEAD_BRANCH, string CUSTVENDID)
        {
            try
            {

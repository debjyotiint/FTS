                        ...
                        <dxe:ASPxGridView runat="server" ID="ShowGrid" ClientInstanceName="Grid" Width="100%" EnableRowsCache="false" AutoGenerateColumns="False"
                            ...
                            <Columns>
                               <%-- <dxe:GridViewDataTextColumn FieldName="SLNO" Caption="Serial" Width="50px" VisibleIndex="0" FixedStyle="Left">
                                ...
                                <dxe:GridViewDataTextColumn Caption="Return Date" Width="80px" FieldName="Return_Date"
                                    VisibleIndex="4">
                                ...
                                <dxe:GridViewDataTextColumn FieldName="Purchase Value" Caption="Purc. Value" Width="90px" VisibleIndex="8">
                                    <PropertiesTextEdit DisplayFormatString="0.00"></PropertiesTextEdit>
                                     <HeaderStyle HorizontalAlign="Right" />
                                </dxe:GridViewDataTextColumn>
                                ...
                                <dxe:GridViewDataTextColumn FieldName="Total Value" Caption="Total Value" Width="90px" VisibleIndex="15">
                                    <PropertiesTextEdit DisplayFormatString="0.00"></PropertiesTextEdit>
                                     <HeaderStyle HorizontalAlign="Right" />
                                </dxe:GridViewDataTextColumn>
                            </Columns>

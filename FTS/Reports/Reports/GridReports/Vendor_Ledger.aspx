...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function GetChecked() {
            //debugger
            //alert($("#chkallvendors").is(":checked"));
        ...
        <table class="pull-left paddtable">
            ...
            <tr>
                ...
                <td id="ckpar" style="padding-left: 10px">
                    ...
                    <asp:CheckBox runat="server" ID="chkparty" Checked="true" Text="Search by Party Inv. Date" />
                </td>
                <td id="ckpar" style="padding-left: 10px">
                    <asp:CheckBox runat="server" ID="chkallvendors" type="checkbox" Checked="false" ClientInstanceName="cchkallvendors" onChange="GetChecked()"/>
                    <asp:Label ID="Label4" runat="Server" Text="Select all Vendors" CssClass="mylabel1"

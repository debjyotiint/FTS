                        ...
                        <dxe:ASPxGridView runat="server" ID="ShowGrid" ClientInstanceName="Grid" Width="100%" EnableRowsCache="false" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <dxe:GridViewDataTextColumn VisibleIndex="3" FieldName="PONO" Width="130px" Caption="Order No." FixedStyle="Left">
                                    ...
                                    <DataItemTemplate>
                                        <a href="javascript:void(0)" target="_blank" onclick="OpenPOSDetails('<%#Eval("PONO") %>','PO')">
                                            <%#Eval("PONO")%>
                                        </a>
                                    </DataItemTemplate>
                                ...
                                <dxe:GridViewDataTextColumn FieldName="QTY" Caption="Qty" Width="70px" VisibleIndex="6">
                                    <PropertiesTextEdit DisplayFormatString="0.00"></PropertiesTextEdit>
                                     <HeaderStyle HorizontalAlign="Right" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn FieldName="RATE" Caption="Rate" Width="90px" VisibleIndex="7">
                                    <PropertiesTextEdit DisplayFormatString="0.00"></PropertiesTextEdit>
                                     <HeaderStyle HorizontalAlign="Right" />
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn FieldName="GROSAMOUNT" Caption="Purchase Value" Width="90px" VisibleIndex="8">
                                    <PropertiesTextEdit DisplayFormatString="0.00"></PropertiesTextEdit>
                                     <HeaderStyle HorizontalAlign="Right" />
                                </dxe:GridViewDataTextColumn>
                                ...
                                <dxe:GridViewDataTextColumn FieldName="OTHER_AMT" Caption="Other Charges" Width="90px" VisibleIndex="13">
                                    <PropertiesTextEdit DisplayFormatString="0.00"></PropertiesTextEdit>
                                     <HeaderStyle HorizontalAlign="Right" />
                                </dxe:GridViewDataTextColumn>
                                ...
                                <dxe:GridViewDataTextColumn FieldName="TOTALAMOUNT" Caption="Total Value" Width="90px" VisibleIndex="15">
                                    <PropertiesTextEdit DisplayFormatString="0.00"></PropertiesTextEdit>
                                     <HeaderStyle HorizontalAlign="Right" />
                                </dxe:GridViewDataTextColumn>

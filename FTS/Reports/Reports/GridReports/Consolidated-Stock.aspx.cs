...
namespace Reports.Reports.GridReports
{
    public partial class Consolidated_Stock : System.Web.UI.Page
    {
        ...
        public void bindexport(int Filter)
        {
            ...
            FileHeader = RptHeader.CommonReportHeader(Convert.ToString(Session["LastCompany"]), Convert.ToString(Session["LastFinYear"]), true, true, true, true, true) + Environment.NewLine + "Consolidated Stock" + Environment.NewLine + "As on " + Convert.ToDateTime(ASPxToDate.Date).ToString("dd-MM-yyyy");

    ...
    <script type="text/javascript">
        ...
        function OnWaitingGridKeyPress(e) {
            ...
            if (e.code == "Enter" || e.code == "NumpadEnter") {
                ...
                cCustdetails.PerformCallback(branchdesc + "~" + custvenddesc + "~" + branchid + "~" + CustVendCode + "~" + CustVendType);
                cpopup2ndLevel.Show();
            }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel-heading">
        <div class="panel-title">
            ...
            <h3>Branch Wise Party Outstanding Report </h3>
                            ...
                            <dxe:PanelContent runat="server">
                                <dxe:ASPxGridLookup ID="lookup_branch" SelectionMode="Multiple" runat="server" ClientInstanceName="gridbranchLookup"
                                    ...
                                    <Columns>
                                        ...
                                        <dxe:GridViewDataColumn FieldName="branch_code" Visible="true"  VisibleIndex="1" width="160px" Caption="Branch code" Settings-AutoFilterCondition="Contains">
                                            <Settings AutoFilterCondition="Contains" />
                                        </dxe:GridViewDataColumn>

                                        <dxe:GridViewDataColumn FieldName="branch_description" Visible="true" VisibleIndex="2" width="160px"  Caption="Branch Name" Settings-AutoFilterCondition="Contains">
                                            <Settings AutoFilterCondition="Contains" />
                                        </dxe:GridViewDataColumn>
                                    </Columns>
                ...
                <td colspan="2">
                    <div onkeypress="OnWaitingGridKeyPress(event)">
                        <dxe:ASPxGridView runat="server" ID="ShowGrid" ClientInstanceName="Grid" Width="100%" EnableRowsCache="false" AutoGenerateColumns="False" KeyboardSupport="true"
                         OnSummaryDisplayText="ShowGrid_SummaryDisplayText" OnDataBound="Showgrid_Htmlprepared" OnDataBinding="ShowGrid_DataBinding" KeyFieldName="CODE" OnCustomCallback="Grid_CustomCallback" 
                            ...
                            <Columns>
                                ...
                                <dxe:GridViewDataTextColumn FieldName="For_BranchDescription" Caption="For Branch" Width="30%" VisibleIndex="2" >
                                    <Settings ShowFilterRowMenu="True"></Settings>
                                </dxe:GridViewDataTextColumn>

                                <dxe:GridViewDataTextColumn FieldName="CustomerVendor" Caption="Customer/Vendor" Width="30%" VisibleIndex="3" >
                                    <Settings ShowFilterRowMenu="True"></Settings>
                                </dxe:GridViewDataTextColumn>
                                <dxe:GridViewDataTextColumn FieldName="UNIQUEID" Caption="Mobile No." Width="15%" VisibleIndex="4" >
                                    <Settings ShowFilterRowMenu="True"></Settings>
                                </dxe:GridViewDataTextColumn>
                                <dxe:GridViewDataTextColumn FieldName="Opening_Dr" Caption="Opening Dr." VisibleIndex="5" Width="15%" PropertiesTextEdit-DisplayFormatString="0.00" />
                                <dxe:GridViewDataTextColumn FieldName="Opening_Cr" Caption="Opening Cr." Width="15%" VisibleIndex="6" PropertiesTextEdit-DisplayFormatString="0.00" />
                                <dxe:GridViewDataTextColumn FieldName="During_Dr" Caption="Period Dr." Width="15%" VisibleIndex="7" PropertiesTextEdit-DisplayFormatString="0.00" />
                                <dxe:GridViewDataTextColumn FieldName="During_Cr" Caption="Period Cr." Width="15%" VisibleIndex="8" PropertiesTextEdit-DisplayFormatString="0.00" />
                                <dxe:GridViewDataTextColumn FieldName="Closing_Dr" Caption="Closing Dr." Width="15%" VisibleIndex="9" PropertiesTextEdit-DisplayFormatString="0.00" />
                                <dxe:GridViewDataTextColumn FieldName="Closing_Cr" Caption="Closing Cr." Width="15%" VisibleIndex="10" PropertiesTextEdit-DisplayFormatString="0.00" />
                                <dxe:GridViewDataTextColumn FieldName="branch_id" Caption="branch_id" Width="0px" VisibleIndex="11"/>
                                <dxe:GridViewDataTextColumn FieldName="CODE" Caption="CODE" Width="0px" VisibleIndex="12" />
                                <dxe:GridViewDataTextColumn FieldName="CustVend" Caption="CustVend" Width="0px" VisibleIndex="13" />
                            </Columns>
                 ...
                 <div class="col-md-12">
                      ...
                      <div onkeypress="OnWaitingGridKeyPress2(event)">
                        <dxe:ASPxGridView runat="server" ID="Custdetails" ClientInstanceName="cCustdetails" Width="100%" EnableRowsCache="false" AutoGenerateColumns="False"
                            OnCustomSummaryCalculate="Custdetails_CustomSummaryCalculate" OnDataBinding="Custdetails_DataBinding"
                            OnSummaryDisplayText="Custdetails_SummaryDisplayText" OnDataBound="Custdetails_Htmlprepared" 
                            OnCustomCallback="cCustdetails_CustomCallback" Settings-HorizontalScrollBarMode="Visible">
                            <Columns>
                                ...
                                <dxe:GridViewDataTextColumn FieldName="Closebal_DBCR" Caption="Dbcrtype" Width="16%" VisibleIndex="13" PropertiesTextEdit-DisplayFormatString="0.00" />
                            </Columns>
                            <SettingsBehavior ConfirmDelete="true" EnableCustomizationWindow="true" EnableRowHotTrack="true" />
                            <Settings ShowFooter="true" ShowGroupPanel="true" ShowGroupFooter="VisibleIfExpanded" />
                            <SettingsEditing Mode="EditForm" />

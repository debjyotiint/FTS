...
namespace Payroll.Controllers
{
    public class payLoginController : Controller
    {
        ...
        {
            Session["ErpConnection"] = @"Data Source=10.0.8.251\MSSQL2016;Initial Catalog=breeze_development;User ID=sa; Password=sql@123";
            Encryption epasswrd = new Encryption();
            string Encryptpass = epasswrd.Encrypt(password);
            BusinessLogicLayer.DBEngine oDBEngine = new BusinessLogicLayer.DBEngine(@"Data Source=10.0.8.251\MSSQL2016;Initial Catalog=breeze_development;User ID=sa; Password=sql@123;pooling='true';Max Pool Size=200");

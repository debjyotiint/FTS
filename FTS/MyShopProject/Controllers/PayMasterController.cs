...
using Payroll.Repostiory.PartialHeaderMenu;
using System;
            ...
            try
            {
                ...
                if (Session["LastCompany"] == null || Session["LocalCurrency"] == null || Session["CompanyBigLogoUrl"] == null || Session["CompanySmallLogoUrl"] == null)
                {
                    ...
                    if (return_msg == "true")
                    {
                        ...
                        Session["LastCompany"] = Convert.ToString(_layout.Tables[1].Rows[0]["cmp_Name"]) + "(" + Convert.ToString(_layout.Tables[2].Rows[0]["branch_description"]) + ")";

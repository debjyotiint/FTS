...
{
    public partial class ConsolidatedVendor : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (Request.QueryString["VendorId"] != null)
                {
                    ...
                    hdncus.Value = "1";
                    hiddnmodid.Value = Request.QueryString["VendorId"];
                    ddl_Branch.Enabled = false;
                    lookup_Customer.ReadOnly = true;
                    ddltype.Enabled = false;
                    OpeningGrid.DataSource = GetConsolidatedCustomerGridData(Request.QueryString["VendorId"], Request.QueryString["branch"]);
        ...
        protected void OpeningGrid_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            List<ConsolidatedVendorClass> customerconsolidate = new List<ConsolidatedVendorClass>();
          ...
          //  string AmountOs = (ddltype.SelectedValue == "PB" || ddltype.SelectedValue == "RET") ? txt_docamt.Text : txt_docamt2.Text;
            ...
            if (WhichCall == "TemporaryData")
            {
                ...
                if (Convert.ToString(dt.Rows[0][0]) == "0" && (ddltype.SelectedValue != "CDB" || ddltype.SelectedValue != "CCR"))
                {
                    ...
                    //}
                    customerconsolidate.Add(new ConsolidatedVendorClass()
                    {
        ...
        public void bindexport2(int Filter)
        {
            ...
            string filename = "VendorCustomerDetails";
            exporter.FileName = filename;
            //    exporter.FileName = "SalesRegiserDetailsReport";

            exporter.PageHeader.Left = "Consolidated Vendor Details Report";

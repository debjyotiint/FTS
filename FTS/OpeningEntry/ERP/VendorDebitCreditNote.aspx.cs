...
{
    public partial class VendorDebitCreditNote : System.Web.UI.Page//ERP.OMS.ViewState_class.VSPage//System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (HttpContext.Current.Session["userid"] != null)
            {
                if (!IsPostBack)
                {
                    ...
                    rights = BusinessLogicLayer.CommonBLS.CommonBL.GetUserRightSession("/ERP/VendorDebitCreditNote.aspx");
        ...
        public static List<ListItem> GetScheme(string sel_type_id)
        {
            ...
            string query = "Select ID,SchemaName From tbl_master_Idschema  Where TYPE_ID=(Case When '" + sel_type_id + "'='Dr' Then '27' Else '28' End) AND IsActive=1 AND Isnull(Branch,'')='" + userbranchID + "' AND Isnull(comapanyInt,'')='" + LastCompany + "'";

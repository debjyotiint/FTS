<%@ Page Title="Purchase Invoice" Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" EnableEventValidation="false" AutoEventWireup="true"
     CodeBehind="PurchaseInvoice.aspx.cs" Inherits="Openingentry.ERP.PurchaseInvoice" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
            ...
            if (value == "E") {
                ...
                if (PurchaseOrder_Number != "") {
                    jAlert(Order_Msg, 'Alert Dialog: [PurchaseInvoice]', function (r) {
                        ...
                        grid.cpSalesOrderNo = null;
                        if (r == true) {
                            window.location.assign("purchaseinvoice.aspx?key=ADD");
                        }
                    });
    ...
    $('#<%=hdnisedited.ClientID %>').val("false");
                        ...
                        var ProductName = SpliteDetails[14] ? SpliteDetails[14] : "";
                        var ratevalue = "0";
                        var rate = "0";
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="panel-title clearfix">
            ...
            <div id="btncross" class="crossBtn" runat="server" margin-left: "50px;"><a href="purchaseinvoicelist.aspx"><i class="fa fa-times"></i></a></div>
        </div>
                    ...
                    <TabPages>
                         <dxe:TabPage Name="General" Text="General">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3" runat="server" id="divNumberingScheme" >
                                            ...
                                            <asp:DropDownList ID="ddl_numberingScheme" runat="server" Width="100%" DataSourceID="SqlSchematype"  DataTextField="SchemaName" DataValueField="ID"
                                                 onchange="CmbScheme_ValueChange()" TabIndex="1" >
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <dxe:ASPxDateEdit ID="dt_PLQuote" runat="server" EditFormat="Custom" EditFormatString="dd-MM-yyyy" ClientInstanceName="cPLQuoteDate"  Width="100%" TabIndex="3">
                                     ...
                                     <div class="col-md-2">
                                            ...
                                            <dxe:ASPxTextBox ID="txt_Refference" runat="server"  Width="100%" TabIndex="5">
                                            </dxe:ASPxTextBox>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <dxe:ASPxComboBox ID="cmbContactPerson" runat="server" OnCallback="cmbContactPerson_Callback"  Width="100%" ClientInstanceName="cContactPerson" Font-Size="12px" TabIndex="7">
                                        ...
                                        <div class="col-md-2" style="display:none;">
                                             <asp:RadioButtonList ID="rdl_PurchaseInvoice" runat="server" RepeatDirection="Horizontal" onchange="return selectValue();" TabIndex="8" Width="150px">
                                                <asp:ListItem Text="Order" Value="PO"></asp:ListItem>
                                                <asp:ListItem Text="Challan" Value="PC"></asp:ListItem>
                                            </asp:RadioButtonList>
                                            <dxe:ASPxCallbackPanel runat="server" ID="ComponentQuotationPanel" ClientInstanceName="cQuotationComponentPanel" OnCallback="ComponentQuotation_Callback">
                                                ...
                                                <dxe:PanelContent runat="server">
                                                    <dxe:ASPxGridLookup ID="lookup_quotation" SelectionMode="Multiple" runat="server" TabIndex="9" ClientInstanceName="gridquotationLookup" 
                                                        ...
                                                        <%--ComponentID ComponentNumber ComponentDate CustomerName BalanceQty--%>
                                                        <Columns>
                                                           ...
                                                           <dxe:GridViewDataColumn FieldName="CustomerName" Visible="true" VisibleIndex="1"  Caption="Customer Name"  Settings-AutoFilterCondition="Contains" Width="120"/>
                            ...
                            <SettingsDataSecurity AllowEdit="true" />
                                        ...
                                        <div class="col-md-2" style="display:none;">
                                          ...
                                          <%--      <dxe:ASPxDateEdit ID="txtDateIndentRequis" runat="server" EditFormat="Custom" EditFormatString="dd-MM-yyyy" 
                                              ClientInstanceName="cIndentRequisDate"
                                                 ...
                                                 <asp:Label ID="lbl_MultipleDate" runat="server" Text="Multiple Select Indent Dates" Style="display: none" TabIndex="10"></asp:Label>
                                        ...
                                        <div class="col-md-2 lblmTop8" style="padding-top: 18px;">
                                            <asp:CheckBox ID="chk_reversemechenism" runat="server" TabIndex="11" />
                                    ...
                                    <div style="clear: both"></div> 
                                        ...
                                        <div class="col-md-2 lblmTop8">
                                            ...
                                            <dxe:ASPxComboBox ID="ddl_cashBank" runat="server" ClientIDMode="Static" ClientInstanceName="cddl_cashBank" TabIndex="12" Width="100%">
                                        ...
                                        <div class="col-md-2 lblmTop8">
                                            ...
                                            <asp:DropDownList ID="ddl_Currency" runat="server" Width="100%"  onchange="ddl_Currency_Rate_Change()" TabIndex="13">
                                            </asp:DropDownList>
                                        ...
                                        <div class="col-md-3 lblmTop8" style="margin-bottom:15px">
                                            ...
                                            <dxe:ASPxComboBox ID="ddl_VatGstCst" runat="server" ClientInstanceName="cddlVatGstCst" Width="100%" OnCallback="ddl_VatGstCst_Callback" TabIndex="16">
                                        ...
                                        <div class="col-md-12">         
                                            ...
                                            <dxe:ASPxGridView runat="server" OnBatchUpdate="grid_BatchUpdate" KeyFieldName="PurchaseInvoiceDetailID" ClientInstanceName="grid" ID="grid"
                                               ...
                                               Settings-VerticalScrollBarMode="auto" Settings-VerticalScrollableHeight="150" RowHeight="2">
                                                ...
                                                <Columns>
                                                    <dxe:GridViewCommandColumn ShowDeleteButton="false" ShowNewButtonInHeader="false" Width="30" VisibleIndex="0"
                                                         Caption="">
                                                        <CustomButtons>
                                                    ...
                                                    <dxe:GridViewDataTextColumn FieldName="SrlNo" Caption="Sl" ReadOnly="true" VisibleIndex="1" Width="20px">
                                                     ...
                                                     <dxe:GridViewDataTextColumn FieldName="ComponentNumber" Caption="Doc Number" VisibleIndex="2" visible="false" ReadOnly="True" Width="6.5%">
                                                    </dxe:GridViewDataTextColumn>
                                                    <dxe:GridViewDataButtonEditColumn FieldName="ProductName" Caption="Product" VisibleIndex="3" Width="130">
                                                   ...
                                                   <%-- <dxe:GridViewDataComboBoxColumn Caption="Product" FieldName="ProductID" VisibleIndex="2" Width="15%">
                                                    ...
                                                    <dxe:GridViewDataTextColumn FieldName="Quantity" Caption="Quantity" VisibleIndex="5" Width="80" HeaderStyle-HorizontalAlign="Right">
                                                        <PropertiesTextEdit>
                                                    ...
                                                    <dxe:GridViewDataTextColumn FieldName="UOM" Caption="UOM(Purc.)" VisibleIndex="6" Width="8%"  >
                                                        <PropertiesTextEdit>
                                                              <ClientSideEvents LostFocus="QuantityTextChange"  />
                                                        </PropertiesTextEdit>
                                                    </dxe:GridViewDataTextColumn>
                                                    ...
                                                    <dxe:GridViewDataTextColumn FieldName="PurchasePrice" Caption="Purc. Price" VisibleIndex="7" Width="9%" HeaderStyle-HorizontalAlign="Right">
                                                        <PropertiesTextEdit>
                                                    ...
                                                    <dxe:GridViewDataTextColumn FieldName="Discount" Caption="Disc(%)" VisibleIndex="8" Width="6%" HeaderStyle-HorizontalAlign="Right">
                                                        <PropertiesTextEdit>
                                                            <MaskSettings Mask="<0..999999999999999999>.<0..99>" AllowMouseWheel="false" />
                                                    ...
                                                    <dxe:GridViewDataTextColumn FieldName="Amount" Caption="Amount" VisibleIndex="9" Width="6%" HeaderStyle-HorizontalAlign="Right">
                                                   ...
                                                   <%-- <dxe:GridViewDataTextColumn FieldName="TaxAmount" Caption="Tax Amount" VisibleIndex="12" Width="6%">
                                                    ...
                                                    <dxe:GridViewDataTextColumn FieldName="TotalAmount" Caption="Net Amount" VisibleIndex="11" Width="8%" HeaderStyle-HorizontalAlign="Right">
                                                        <PropertiesTextEdit>
                                                            <MaskSettings Mask="<0..999999999>.<0..9999>" AllowMouseWheel="false" />
                                                        </PropertiesTextEdit>
                                                          <CellStyle HorizontalAlign="Right"></CellStyle>
                                        ...
                                        <div class="col-md-12 pdTop15" >
                                            <dxe:ASPxButton ID="btn_SaveRecords" ClientInstanceName="cbtn_SaveRecords" runat="server" AccessKey="X" AutoPostBack="False" Text="S&#818;ave & New" CssClass="btn btn-primary" meta:resourcekey="btnSaveRecordsResource1" UseSubmitBehavior ="False">
        ...
        <%--<asp:SqlDataSource ID="SqlSchematype" runat="server" ConnectionString="<%$ ConnectionStrings:crmConnectionString %>"
            SelectCommand="Select * From ((Select '0' as ID,'Select' as SchemaName) Union (Select ID,SchemaName From tbl_master_Idschema  Where TYPE_ID='17')) as X Order By ID ASC"></asp:SqlDataSource>--%>
                <asp:SqlDataSource ID="SqlSchematype" runat="server" ConnectionString="<%$ ConnectionStrings:crmConnectionString %>"
           SelectCommand="Select * From ((Select '0' as ID,'Select' as SchemaName) Union (Select ID,SchemaName From tbl_master_Idschema  Where TYPE_ID='19' 
                    and financial_year_id IN(select FinYear_ID from Master_FinYear where FinYear_Code=@year) 
                    and Isnull(Branch,'') in (select s FROM dbo.GetSplit(',',@userbranchHierarchy)) and comapanyInt='COR0000002')) as X Order By ID ASC">

...
namespace OpeningEntry.ERP
{
    public partial class SalesInvoice : System.Web.UI.Page
    {
        ...
        {
            rights = BusinessLogicLayer.CommonBLS.CommonBL.GetUserRightSession("/ERP/SalesInvoice.aspx");
        ...
        public void SetInvoiceDetails(string strInvoiceId)
        {
            ...
            if (QuotationEditdt != null && QuotationEditdt.Rows.Count > 0)
            {
                ...
                if (!String.IsNullOrEmpty(InvoiceCreatedFromDoc_Ids))
                {
                    ...
                    {
                        BindLookUp(Customer_Id, Quote_Date, InvoiceCreatedFromDoc);
        ...
        protected void BindLookUp(string Customer, string OrderDate, string ComponentType)
        {
            ...
            string FinYear = Convert.ToString(Session["LastFinYear"]);
            DataTable ComponentTable = GetComponent(Customer, OrderDate, ComponentType, FinYear, Action, strInvoiceID);
        ...
        public DataTable GetComponent(string Customer, string Date, string ComponentType, string FinYear,  string Action, string strInvoiceID)
        {
            DataTable dt = new DataTable();
               ...
               //// ############# Added By : Samrat Roy -- 02/05/2017 -- To check Transporter Mandatory Control 
                ...
                else
                {
                    ...
                    ModifyQuatation(MainInvoiceID, strSchemeType, UniqueQuotation, strInvoiceDate, strCustomer, strContactName,
                                    ...
                                    approveStatus, ActionType, ref strIsComplete, ref strQuoteID, strFinYear);
        ...
        public void ModifyQuatation(string QuotationID, string strSchemeType, string strQuoteNo, string strQuoteDate, string strCustomer, string strContactName,
                                    ...
                                    ref int strIsComplete, ref int strInvoiceID,string FinYear)
        {
            try
            {
                // ASPxTextBox txtDriverName = (ASPxTextBox)VehicleDetailsControl.FindControl("txtDriverName");
        ...
        public void GetAllDropDownDetailForSalesQuotation(string userbranch)
        {
            ...
            //Opening Entry
            DataTable Schemadt = objSlaesActivitiesBL.GetNumberingSchemaOpening(strCompanyID, userbranchHierarchy, FinYear, "11", "Y");

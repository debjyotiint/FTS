<%@ Page Title="" Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master"  AutoEventWireup="true" 
    CodeBehind="CustomerNote.aspx.cs" Inherits="OpeningEntry.ERP.CustomerNote" EnableEventValidation="false" %>
    ...
    <script>
        ...
        function DateChange() {
            ...
            if (SelectedDateNumericValue >= FinYearStartDateNumericValue && SelectedDateNumericValue <= FinYearEndDatNumbericValue) {
                ...
                jAlert('Enter Date Is Outside Of Financial Year111 !!');
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="panel-heading">
        <div class="panel-title clearfix">
            <h3 class="clearfix"><span class="pull-left">
                <asp:Label ID="lblHeading" runat="server" Text="Customer Debit/Credit Note"></asp:Label></span>
            </h3>
                ...
                <dxe:ASPxGridView ID="GvJvSearch" runat="server" AutoGenerateColumns="False" SettingsBehavior-AllowSort="true"
                    ...
                    <Columns>
                       <%-- <dxe:GridViewDataTextColumn VisibleIndex="0" FieldName="NoteType" Caption="Type">
                        ...
                        <dxe:GridViewDataTextColumn VisibleIndex="4" FieldName="CustomerName" Caption="Customer Name">
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlSchematype" runat="server" ConnectionString="<%$ ConnectionStrings:crmConnectionString %>"
            SelectCommand="Select * From ((Select '0' as ID,'Select' as SchemaName) Union (Select ID,SchemaName From tbl_master_Idschema  Where TYPE_ID=(Case When @NoteType='Dr' Then '25' Else '26' End) AND IsActive=1 AND Isnull(Branch,'')=@userbranchID AND Isnull(comapanyInt,'')=@LastCompany AND financial_year_id=(Select Top 1 FinYear_ID FROM Master_FinYear WHERE FinYear_Code=@LastFinYear))) as x Order By ID asc">
            <SelectParameters>
    ...
    <dxe:ASPxGridViewExporter ID="exporter" runat="server" Landscape="false" PaperKind="A3" PageHeader-Font-Size="Larger" PageHeader-Font-Bold="true"></dxe:ASPxGridViewExporter>

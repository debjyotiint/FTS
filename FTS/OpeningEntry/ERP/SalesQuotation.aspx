<%@ Page Title="" Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master" AutoEventWireup="true"
     ...
     EnableEventValidation="false" CodeBehind="SalesQuotation.aspx.cs" Inherits="OpeningEntry.ERP.SalesQuotation" %>
        ...
        function OpenUdf(s, e) {
            if (document.getElementById('IsUdfpresent').value == '0') {
              ...
              var keyVal=document.getElementById('Keyval_internalId').value;
                var url = '/Opening/ERP/frm_BranchUdfPopUp.aspx?Type=SQO&&KeyVal_InternalID=' + keyVal;
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                                ...
                                <dxe:ContentControl runat="server">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2 lblmTop8">
                                            ...
                                            <%--<dxe:ASPxDateEdit ID="dt_PLQuote" runat="server" EditFormat="Custom" EditFormatString="dd-MM-yyyy" ClientInstanceName="cPLQuoteDate" TabIndex="3" Width="100%">
                                        ...
                                        <div class="col-md-2 lblmTop8">
                                            ...
                                            <span id="MandatoryEgSDate" style="display: none" class="validclass">
                                                <img id="2gridHistory_DXPEForm_efnew_DXEFL_DXEditor12_EI" class="dxEditors_edtError_PlasticBlue" src="/DXR.axd?r=1_36-tyKfc" title="Expiry Date must be greater than or equal to Proformat Date."></span>
                                            <%--<dxe:ASPxDateEdit ID="dt_PlQuoteExpiry" runat="server" ClientInstanceName="cExpiryDate" EditFormat="Custom" EditFormatString="dd-MM-yyyy" TabIndex="4" Width="100%">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <dxe:ASPxTextBox ID="txt_Rate" ClientInstanceName="ctxt_Rate" runat="server" TabIndex="11" Width="100%" Height="28px">
                                                            ...
                                                            <div class="clearfix" style="background: #fff; border: 1px solid #ccc; padding: 0px 0 10px 0;">
                                                                ...
                                                                <div style="padding-right: 8px">
                                                                    ...
                                                                    <div class="col-md-8">
                                                                        ...
                                                                        <div class="Left_Content relative">
                                                                            <dxe:ASPxComboBox ID="CmbCountry" ClientInstanceName="CmbCountry" runat="server" TabIndex="6" ValueType="System.String" Width="100%"  SelectedIndex="0"
                                                                              >
                                                                    ...
                                                                    <div class="col-md-8">
                                                                        ...
                                                                        <div class="Left_Content relative">
                                                                            <dxe:ASPxComboBox ID="CmbCity" ClientInstanceName="CmbCity" runat="server" TabIndex="8"
                                                                                ValueType="System.String" Width="100%" EnableSynchronization="True" OnCallback="cmbCity_OnCallback"
                                                                    ...
                                                                    <div class="col-md-8">
                                                                        ...
                                                                        <div class="Left_Content">
                                                                            <dxe:ASPxComboBox ID="CmbArea" ClientInstanceName="CmbArea" runat="server" TabIndex="10"
                                                                                ValueType="System.String" Width="100%"  SelectedIndex="0"  OnCallback="cmbArea_OnCallback" >
                                                                                <ClearButton DisplayMode="Always"></ClearButton>
	...
	closeWarehouse(s, e);}" />
            ...
            <dxe:ASPxPopupControl ID="ProductpopUp" runat="server" ClientInstanceName="cProductpopUp"
                ...
                <ContentCollection>
                    <dxe:PopupControlContentControl runat="server">
                        <label><strong>Search By Product Name</strong></label>  <span style="color: red;"></span>

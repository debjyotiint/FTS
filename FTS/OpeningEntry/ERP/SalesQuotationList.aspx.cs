...
{
    public partial class frm_SalesQuotationMain : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            rights = BusinessLogicLayer.CommonBLS.CommonBL.GetUserRightSession("/ERP/SalesQuotationList.aspx");
        ...
        public void GetQuotationListGridData(string userbranch, string lastCompany)
        {
            ...
            //  dtdata = objCRMSalesDtlBL.GetQuotationListGridData(userbranch, lastCompany); 
        ...
        #region Sales Quotation  Opening

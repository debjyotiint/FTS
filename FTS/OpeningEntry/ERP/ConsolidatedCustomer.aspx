    ...
    <div class="form_main">
        ...
        <table id="salepurchaseret">
            ...
            <tr>
                ...
                <td style="padding-right: 25px; max-width: 400px" class="relative">
        ...
        <div id="divsaleretu" runat="server">
            <table id="tbldescripion" style="display: none;">
                ...
                <tr>
                    <td>
                        <dxe:ASPxTextBox ID="txt_Docno" runat="server" ClientInstanceName="ctxt_doccno" Width="100%" TabIndex="4">
                        </dxe:ASPxTextBox>

                    </td>
                    <td>
                        <dxe:ASPxDateEdit ID="dt_date" runat="server" EditFormat="Custom" EditFormatString="dd-MM-yyyy" ClientInstanceName="tsdate" Width="100%" TabIndex="5">
                    ...
                    <td>
                        <dxe:ASPxDateEdit ID="dtdate_Due" runat="server" EditFormat="Custom" EditFormatString="dd-MM-yyyy" TabIndex="6" ClientInstanceName="tstartdate" Width="100%">
                            <ButtonStyle Width="13px">
                            </ButtonStyle>
                    ...
                    <td>
                        <dxe:ASPxDateEdit ID="dtdate_Ref" runat="server" EditFormat="Custom" EditFormatString="dd-MM-yyyy" ClientInstanceName="trefdate" TabIndex="7" Width="100%">
                            <ButtonStyle Width="13px">
                            </ButtonStyle>
                ...
                <tr>
                    <td>
                        ...
                        <dxe:ASPxTextBox ID="txt_disamt" runat="server" ClientInstanceName="ctxt_disamt" Width="100%" TabIndex="8">
                    ...
                    <td>
                        ...
                        <dxe:ASPxTextBox ID="txt_docamt" runat="server" ClientInstanceName="ctxt_docamt" Width="100%" TabIndex="9">
                ...
                <tr>
                    <td>
                        <dxe:ASPxComboBox ID="cmbContactPerson" runat="server" OnCallback="cmbContactPerson_Callback" TabIndex="10"
                            Width="100%"
                    ...
                    <td>
                        <dxe:ASPxTextBox ID="txt_commprcntg" runat="server" ClientInstanceName="ctxt_commprcntg" Width="100%" TabIndex="11">
                    ...
                    <td>
                        ...
                        <dxe:ASPxTextBox ID="txt_commAmt" runat="server" ClientInstanceName="ctxt_commAmt" Width="100%" TabIndex="12">
        ...
        <div style="padding-top: 15px;">
            <dxe:ASPxButton ID="FinalSave" runat="server" AutoPostBack="false" TabIndex="18" CssClass="btn btn-primary"
        ...
        <div class="GridViewArea" id="divgrid">
            ...
            <dxe:ASPxGridView ID="OpeningGrid" runat="server" AutoGenerateColumns="False" ClientInstanceName="cOpeningGrid"
                ...
                <Columns>
                    ...
                    <dxe:GridViewDataTextColumn Caption="Doc Number" FieldName="DocNumber" ReadOnly="True" Visible="True" VisibleIndex="3">
                        <Settings AutoFilterCondition="Contains" />
                    </dxe:GridViewDataTextColumn>
                    ...
                    <dxe:GridViewDataTextColumn Caption="Agent Name" FieldName="AgentName" ReadOnly="True" Visible="True" VisibleIndex="10">
                        <Settings AutoFilterCondition="Contains" />
                    </dxe:GridViewDataTextColumn>


                    <dxe:GridViewDataTextColumn Caption="Comm %" FieldName="Commper" ReadOnly="True" Visible="True" VisibleIndex="11">
                        <PropertiesTextEdit DisplayFormatString="0.00"></PropertiesTextEdit>
                        <Settings AutoFilterCondition="Contains" />
                    </dxe:GridViewDataTextColumn>


                    <dxe:GridViewDataTextColumn Caption="Comm Amount" FieldName="Commamount" ReadOnly="True" Visible="True" VisibleIndex="12">
                        <PropertiesTextEdit DisplayFormatString="0.00"></PropertiesTextEdit>
                        <Settings AutoFilterCondition="Contains" />
                    </dxe:GridViewDataTextColumn>
                    ...
                    <dxe:GridViewDataTextColumn Caption="Type" FieldName="Branch" ReadOnly="True" Visible="False" VisibleIndex="13">
                        <Settings AutoFilterCondition="Contains" />
                    </dxe:GridViewDataTextColumn>

                    <dxe:GridViewDataTextColumn ReadOnly="True" CellStyle-HorizontalAlign="Center" VisibleIndex="14">
                        ...
                        <DataItemTemplate>
                            ...
                            <a href="javascript:void(0);" onclick="onOpeningEdit('<%#Eval("ModId")%>','<%#Eval("CustomerId")%>',
                                ...
                                '<%#Eval("DocAmount")%>','<%#Eval("OSAmount")%>','<%#Eval("Commper")%>','<%#Eval("Commamount")%>','<%#Eval("Unpaidamt")%>','<%#Eval("SalesmanId")%>','<%#Eval("cUS_nAME")%>')"

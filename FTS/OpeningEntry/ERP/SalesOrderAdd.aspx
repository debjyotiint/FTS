<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SalesOrderAdd.aspx.cs" MasterPageFile="~/OMS/MasterPage/ERP.Master"
    Inherits="OpeningEntry.ERP.SalesOrderAdd" EnableEventValidation="false" %>
    ...
    <%--    function Currency_Rate() {
        ...
        function OpenUdf() {
            if (document.getElementById('IsUdfpresent').value == '0') {
                ...
                //  alert(keyval);
                var url = '/Opening/ERP/frm_BranchUdfPopUp.aspx?Type=SO&&KeyVal_InternalID=' + keyval;
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel-title clearfix">
        ...
        <div id="divcross" runat="server" class="crossBtn"><a href="SalesQuotationList.aspx"><i class="fa fa-times"></i></a></div>
                    ...
                    <tabpages>
                        ...
                        <clientsideevents selectedindexchanged="function(s, e) { QuotationNumberChanged();}" />
                            ...
                            <clientsideevents valuechanged="function(s,e){Currency_Rate()}"></clientsideevents>
                                        ...
                                        <div class="col-md-2">
                                            <label style="margin: 3px 0; display: block">Exchange Rate:  </label>
                                            <div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <dxe:ASPxGridView runat="server" KeyFieldName="OrderID"
                                                ...
                                                <Columns>
                                                    ...
                                                    <dxe:GridViewDataTextColumn Caption="Quotation" Visible="false" FieldName="Quotation_Num" ReadOnly="True" Width="80" VisibleIndex="2">
                                                        <PropertiesTextEdit>
                                                        </PropertiesTextEdit>
                                                    </dxe:GridViewDataTextColumn>
                                                    ...
                                                    <dxe:GridViewDataTextColumn FieldName="Amount" Caption="Amount" VisibleIndex="10" Width="100" ReadOnly="true" CellStyle-HorizontalAlign="Right">
                                                        <PropertiesTextEdit DisplayFormatString="0.00" Style-HorizontalAlign="Right"></PropertiesTextEdit>
                                                        <PropertiesTextEdit>
                                            ...
                                            <div class="lblHolder">
                                                <table>
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td>
                                                               <strong> <dxe:ASPxLabel ID="txtProductNetAmount" runat="server" Text="ASPxLabel" ClientInstanceName="ctxtProductNetAmount"></dxe:ASPxLabel></strong>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
	...
	closeWarehouse(s, e);}" />
            ...
            <asp:SqlDataSource runat="server" ID="ProductDataSource" ConnectionString="<%$ ConnectionStrings:crmConnectionString %>"
                SelectCommand="prc__Opening_SalesCRM_Details" SelectCommandType="StoredProcedure">
                <SelectParameters>
                            ...
                            <div class="col-sm-3">
                                <div class="lblHolder">
                                    <table>
                                        <tbody>
                                            <tr>
                                                <td>Gross Amount <dxe:ASPxLabel ID="ASPxLabel1" runat="server" Text="(Taxable)" ClientInstanceName="clblTaxableGross"></dxe:ASPxLabel></td>
                                            </tr>
                                            <tr>
                                                <td>
                            ...
                            <div class="col-sm-3">
                                <div class="lblHolder">
                                    <table>
                                        <tbody>
                                            <tr>
                                                <td>Net Amount <dxe:ASPxLabel ID="ASPxLabel5" runat="server" Text="(Taxable)" ClientInstanceName="clblTaxableNet"></dxe:ASPxLabel></td>
                                            </tr>
                                            <tr>
                                                <td>

<%@ Page Title="Proforma Invoice/ Quotation" Language="C#" MasterPageFile="~/OMS/MasterPage/ERP.Master"  AutoEventWireup="true" 
    CodeBehind="SalesQuotationList.aspx.cs" Inherits="OpeningEntry.ERP.frm_SalesQuotationMain" %>
    ...
    <script>
       ...
       //     window.location.href = "../../reports/XtraReports/QuotationReportViewer.aspx?id=" + id;
            ...
            if (ActiveUser != null) {
                $.ajax({
                    ...
                    success: function (msg) {
                        var status = msg.d;
                        var url = 'SalesQuotation.aspx?key=' + keyValue + '&Permission=' + status;
        ...
        function OnclickViewAttachment(obj) {
            ...
            var URL = '/ERP/EntriesDocuments.aspx?idbldng=' + obj + '&type=Quotation';
            window.location.href = URL;
        }
        ...
        function OnGetApprovedRowValues(obj) { 
            uri = "SalesQuotation.aspx?key=" + obj + "&status=2";
        ...
        function OnGetRejectedRowValues(obj) {
            uri = "SalesQuotation.aspx?key=" + obj + "&status=3";
            popup.SetContentUrl(uri);
            popup.Show();
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="GridViewArea">
        <dxe:ASPxGridView ID="GrdQuotation" runat="server" KeyFieldName="Quote_Id" AutoGenerateColumns="False"
        ...
        <dxe:ASPxPopupControl ID="popupApproval" runat="server" ClientInstanceName="cpopupApproval"
            ...
            <ContentCollection>
                <dxe:PopupControlContentControl runat="server">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <dxe:ASPxGridView ID="gridPendingApproval" runat="server" KeyFieldName="Quote_Id" AutoGenerateColumns="False"  
